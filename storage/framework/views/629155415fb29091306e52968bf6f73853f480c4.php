                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('quotation_sales/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
									...
									<?php if($photos!='') { $arrp = explode(',',$photos); $i=1; ?>
											...
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-live-thumbs">
														<a href="<?php echo e(asset('uploads/jobestimate/'.$prow)); ?>" target="_blank">View Image <?php echo e($i); ?></a>
													</div>
												</div>
										...
										<?php endforeach; ?>
									<?php } ?>
										<input type="file" id="input-23" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('job_estimate/upload/')); ?>" multiple="">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" name="quantity[]" <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?> autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" autocomplete="off" <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?> class="form-control line-cost" value="<?php echo e($unit_price); ?>">
												</td>
												<td width="6%">
