        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									<td colspan="2"  width="100%" align="center"><h4><u><?php echo e($heading); ?> History</u></h4>
								</tr>
							</table><br/>
                        </div>
						<?php if(count($items) > 0) { ?>
						<p>Item Code: <b><?php echo e($items[0]->item_code); ?></b> &nbsp; Item Name: <b><?php echo e($items[0]->item_name); ?></b> &nbsp; <?php if($cussupid!='') { ?>Customer/Supplier: <b><?php echo e($items[0]->master_name); ?></b><?php } ?></p>
                        <div class="col-md-12">
							<table class="table" border="0">
								...
								<body><?php $netqty = $net_uprice = $netotal = $net_octotal = 0; ?>
                                    ...
                                    <tr>
										...
										<td><?php echo e($item->master_name); ?></td>
										<td class="text-right"><?php echo e($item->quantity); ?></td>
										<td class="text-right"><?php echo e(number_format($item->unit_price+$item->othercost_unit,2)); ?></td>
										<td class="text-right"><?php echo e(number_format(($item->unit_price+$item->othercost_unit)*$item->quantity,2)); ?></td>
										<?php if($heading=='Purchase Invoice') {?>
										<td class="text-right"><?php echo e(number_format($item->othercost_unit,2)); ?></td>
										<?php } ?>
                                    </tr>
									<?php endforeach; ?>
									...
									<tr>
										...
										<td></td>
										<td><b>Total: </b></td>
										<td class="text-right"><b><?php echo e($netqty); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($net_uprice,2)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($netotal,2)); ?></b></td>
										<?php if($heading=='Purchase Invoice') {?>
										<td class="text-right"><b><?php echo e(number_format($net_octotal,2)); ?></b></td>
										<?php } ?>
									</tr>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('itemenquiry/export')); ?>">
						<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
						<input type="hidden" name="custsupp_id" value="<?php echo e($cussupid); ?>" >
