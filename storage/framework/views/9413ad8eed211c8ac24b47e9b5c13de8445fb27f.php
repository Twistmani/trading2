				...
				<?php if(sizeof($vouchers)==0) { ?>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pv-print'))) : ?>
								 <a href="<?php echo e(url('stock_transferout/print/'.$printid->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="<?php echo e(url('stock_transferout/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('stock_transferout')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('stock_transferout/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('stock_transferout/checkrefno/')); ?>";
...
$(function() {	
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('stock_transferout/checkvchrno/')); ?>", 
			type: 'get',
