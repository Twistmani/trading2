...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('goods_return/add')); ?>" class="btn btn-primary btn-sm">
                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><?php echo e($order->jobname); ?></td>
											<td><?php echo e(number_format($order->net_amount,2)); ?></td>
											<td>
												<p><button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('goods_return/edit/'.$order->id)); ?>'"><span class="glyphicon glyphicon-pencil"></span></button></p>
											</td>
											<td>
												<p><a href="<?php echo e(url('goods_return/print/'.$order->id)); ?>" target="_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>
											</td>
											<td>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmReport" id="frmReport" target="_blank" action="<?php echo e(url('goods_return/search')); ?>">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('goods_return/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePorders").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('goods_return/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
