...
$(document).ready(function () {
	...
	$(function() {
		...
		var dtInstance = $("#tableInvDataList").DataTable({
			...
			"serverSide": true,
			"ajax":{
					 "url": "<?php echo e(url('sales_split/paging_split_data/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
...
function setTransfer() {
	...
	//alert(items);
	 invoiceurl = "<?php echo e(url('sales_split_return/add/')); ?>/"+item;
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('sales_split/item_details/')); ?>";
