                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('qs-print'))) : ?>
								 <a href="<?php echo e(url('quotation_sales/print/'.$printid.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales"  id="frmQuotationSales" enctype="multipart/form-data" action="<?php echo e(url('quotation_sales/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>" autocomplete="off" data-language='en' id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<?php if($formdata['loc_item']==1) { ?>	
												<div style="float:left; padding-right:5px;">
													<button type="button" id="marginItm_<?php echo e($j); ?>" class="btn btn-primary btn-xs margin">Margin</button>
												</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" value="<?php echo e(old('net_amount_hid')); ?>" class="form-control spl" readonly>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description"><?php echo e($headerdata); ?></textarea>
                                    </div>
                                </div>
								<?php } ?>
...
//	$('#lpo_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
    ...
    $(document).on('click', '#importFile', function(e) { 
		if($('#import_file').val()=='') {
			...
			$('#frmQuotationSales').attr('action', "<?php echo e(url('quotation_sales/import')); ?>").submit();
		}
	});
	...
	$(document).on('click', '.margin', function(e) { 
	   ...
	   if(item_id!='') {
		   var marUrl = "<?php echo e(url('itemmaster/get_margin/')); ?>/"+item_id+"/"+cost; 
...
function getQuotation() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('quotation_sales/get_quotations/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
