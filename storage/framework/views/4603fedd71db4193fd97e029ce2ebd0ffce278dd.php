                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="" class="itms" data-id="<?php echo e($item->id); ?>" data-code="<?php echo e($item->item_code); ?>" data-name="<?php echo e($item->description); ?>" data-unit="<?php echo e($item->unit_name); ?>" data-dismiss="modal"><?php echo e($item->item_name); ?></a></td>
                                        <td><?php echo e($item->unit_name); ?></td>
                                        <td><?php echo e($item->quantity); ?></td>
										<td><?php echo e($item->unit_price); ?></td>
										<td><?php echo e($item->vat); ?>% - <?php echo e($item->vat_amount); ?></td>
