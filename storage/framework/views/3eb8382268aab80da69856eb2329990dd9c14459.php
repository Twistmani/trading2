                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('gr-print'))) : ?>
							 <a href="<?php echo e(url('goods_return/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsInvoice" id="frmGoodsInvoice" action="<?php echo e(url('goods_return/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="goods_return_id" id="goods_return_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>"  id="voucher_date" placeholder="GR. Date" autocomplete="off"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('goods_return')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('goods_return/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('goods_return/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	//new change............
	var stockurl = "<?php echo e(url('account_master/stockac_data/')); ?>";
