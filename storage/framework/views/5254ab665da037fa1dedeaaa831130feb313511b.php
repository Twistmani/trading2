            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                           ...
                           <div class="pull-right">
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('contra_voucher/printgrp/'.$printid->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <form class="form-horizontal" role="form" method="POST" name="frmContraVchr" id="frmContraVchr" action="<?php echo e(url('contra_voucher/save')); ?>">
                                    ...
                                    <div class="itemdivPrnt">
											<div class="itemdivChld">
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_1">
													<div class="col-sm-2"> <span class="small">Account Name</span>
														<input type="text" id="draccount_1" name="account_name[]" placeholder="Select Account" value="<?php echo e($vchrdata->bank); ?>" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#bank_modal">
														<input type="hidden" name="account_id[]" id="draccountid_1" value="<?php echo e($vchrdata->bank_account_id); ?>">
													</div>
                                            ...
                                            <div class="itemdivChld">
												<div class="form-group classtrn" style="margin-bottom:1px;" id="trns_2">
													<div class="col-sm-2"> <span class="small">Account Name</span>
														<input type="text" id="draccount_2" name="account_name[]" placeholder="Select Account" value="<?php echo e($vchrdata->cash); ?>" class="form-control acname" autocomplete="off" data-toggle="modal" data-target="#cash_modal">
														<input type="hidden" name="account_id[]" id="draccountid_2" value="<?php echo e($vchrdata->cash_account_id); ?>">
													</div>
														<div class="col-xs-3" style="width:25%;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="<?php echo e(url('contra_voucher')); ?>" class="btn btn-danger">Cancel</a>
                                        <a href="<?php echo e(url('contra_voucher')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="bank_data">
                            <table class="table horizontal_table table-striped" id="table-bank">
                                ...
                                <tr>
                                    <td><a href="" class="bankRow" data-id="<?php echo e($account->id); ?>" data-name="<?php echo e($account->master_name); ?>" data-dismiss="modal"><?php echo e($account->account_id); ?></a></td>
                                    <td><a href="" class="bankRow" data-id="<?php echo e($account->id); ?>" data-name="<?php echo e($account->master_name); ?>" data-dismiss="modal"><?php echo e($account->master_name); ?></a></td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="cash_data">
                            <table class="table horizontal_table table-striped" id="table-cash">
                                ...
                                <tbody>
                                <?php foreach($cash as $account): ?>
                                <tr>
                                    <td><a href="" class="cashRow" data-id="<?php echo e($account->id); ?>" data-name="<?php echo e($account->master_name); ?>" data-dismiss="modal"><?php echo e($account->account_id); ?></a></td>
                                    <td><a href="" class="cashRow" data-id="<?php echo e($account->id); ?>" data-name="<?php echo e($account->master_name); ?>" data-dismiss="modal"><?php echo e($account->master_name); ?></a></td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
...
$(document).ready(function () {
	...
	var urlcv = "<?php echo e(url('contra_voucher/checkvchrno/')); ?>"; 
