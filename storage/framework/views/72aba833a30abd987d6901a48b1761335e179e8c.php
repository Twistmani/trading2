               ...
               <div >
                       ...
                       <div >
							...
							<table border="0" style="width:100%;">
								...
								<tr>
									<td align="center"><h4><b><u><?php echo e($heading); ?> Address List</u></b></h4>
									</td>
								</tr>
							</table><br/>
                        </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped" id="Acmaster">
                                    ...
                                    <tbody>
										...
										<!--<td><?php echo e($row->state.' '.$row->city); ?></td>-->
						...
						<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('account_enquiry/address_export')); ?>">
						<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
						<input type="hidden" name="account_name" value="<?php echo e($name); ?>" >
						<input type="hidden" name="account_type" value="<?php echo e($type); ?>" >
						</form>
                    </div>
