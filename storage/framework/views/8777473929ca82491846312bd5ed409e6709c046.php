                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                ...
                                <table class="table horizontal_table table-striped" id="tableCustList">
                                    ...
                                    <tr>
                                        <td><a href="" class="custRow" data-id="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->master_name); ?>" data-dismiss="modal" <?php if($num!=null) { ?>onclick="selectCust(this)"<?php } ?>><?php echo e($customer->account_id); ?></a></td>
                                        <td><a href="" class="custRow" data-id="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->master_name); ?>" data-dismiss="modal" <?php if($num!=null) { ?>onclick="selectCust(this)"<?php } ?>><?php echo e($customer->master_name); ?></a></td>
