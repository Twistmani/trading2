            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmLedger" id="frmLedger" action="<?php echo e(url('ledger_moments/search')); ?>" target="_blank">
...
function getDetail() {	
	document.frmLedger.action = "<?php echo e(url('ledger_moments/print')); ?>";
