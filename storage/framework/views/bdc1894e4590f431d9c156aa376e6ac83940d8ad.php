            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="GET" name="frmTrialBalance" id="frmTrialBalance" target="_blank" action="<?php echo e(url('balancesheet2/search')); ?>">
								...
								<div class="row">
									...
									<div class="col-xs-6">
                                        ...
                                        <br/>
                                        <?php /*<span>Opening Balance:</span> <input type="checkbox" name="chkob" value="1"></input>*/ ?>
                                        <span></span><br/>
