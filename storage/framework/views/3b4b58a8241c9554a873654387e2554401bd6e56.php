...
<head>
   ...
   <link rel="shortcut icon" href="<?php echo e(asset('assets/img/favicon.ico')); ?>"/>
    ...
    <!-- end of bootstrap -->
    <!--page level css -->
    <link type="text/css" href="<?php echo e(asset('assets/css/font-awesome.min.css')); ?>" rel="stylesheet"/>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendors/simple-line-icons/css/simple-line-icons.css')); ?>">
    ...
    <div class="row">
        <div class="panel-header">
            <h2 class="text-center">
                <img src="<?php echo e(asset('assets/numaklogo-small.jpg')); ?>" alt="logo"/><br/><br/>
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
						...
						<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control  form-control-lg" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="E-mail">
                            </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/custom_js/login2.js')); ?>"></script>
