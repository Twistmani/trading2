<div class="panel-body">
	<input type="hidden" name="num" id="anum" value="<?php echo e($num); ?>">
	<div class="table-responsive m-t-10" id="accountListOc">
		...
		<table class="table horizontal_table table-striped" id="tableAcntListall">
			...
			<tr>
				<td><a href="" class="accountRowall" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-dismiss="modal"><?php echo e($account->account_id); ?></a></td>
				<td><a href="" class="accountRowall" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-dismiss="modal"><?php echo e($account->master_name); ?></a></td>
				<td></td>
