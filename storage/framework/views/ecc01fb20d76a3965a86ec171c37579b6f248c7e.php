                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tbody>
									<?php foreach($mrdata as $po): ?>
                                    <tr>
										<td><input type="checkbox" name="purchaseOrd[]" value="<?php echo e($po->id); ?>"/></td>
                                        <td><?php echo e($po->voucher_no); ?></td>
                                        <td><?php echo e(date('d-m-Y',strtotime($po->voucher_date))); ?></td>
										<td><?php echo e($po->master_name); ?></td>
										<td><?php echo e($po->net_total); ?></td>
										<td><a href="#" class="poclk" data-id="<?php echo e($po->id); ?>" data-name="<?php echo e($po->voucher_no); ?>" data-toggle="modal" data-target="#item_modal">View Items</a></td>
                                    </tr>
                                   <?php endforeach; ?>
                                    </tbody>
                                </table>
...
function setTransfer() {
	...
	if(curl=='SO')
		sdourl = "<?php echo e(url('purchase_order/add-from-so/')); ?>/"+items+"/SO";
