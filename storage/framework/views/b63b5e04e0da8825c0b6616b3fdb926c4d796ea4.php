    ...
    <!-- Content Header (Page header) -->
        ...
        <?php endforeach; ?>
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmMaterialRequisition" id="frmMaterialRequisition" action="<?php echo e(url('material_requisition/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('goods_issued/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	if(doc=='PO')
		var pourl = "<?php echo e(url('purchase_order/po_datatrans/')); ?>/"+supplier_id+"/PO";
	else if(doc=='SDO')
