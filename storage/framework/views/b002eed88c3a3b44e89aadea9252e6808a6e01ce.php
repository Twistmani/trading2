        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
										...
										<td colspan="2" align="center">
											...
											?>
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($row['net_amount'],2)); ?></td>
												</tr>
												<?php endforeach; ?>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												<td><b>SI.No:</b> <?php echo e(++$i); ?> <b>MR#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>Job Name:</b> <?php echo e($report[0]->jobname); ?></td>
												<td><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
												<td></td>
												<td><b>Engineer:</b> <?php echo e($report[0]->salesman); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
											...
											?>
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($unit_price,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($net_amount,2)); ?></td>
												</tr>
												<?php endforeach; ?>
												<tr>
												...
												<?php  $qty_gtotal += $qty_total; $grand_total += $net_total;  ?>
											<?php endforeach; ?>	
												<tr>
													<td></td>
													<td class="text-right"><b>Grand Total:</b></td>
													<td class="text-right"><b><?php echo e($qty_gtotal); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($grand_total,2)); ?></b></td>
												</tr>
											</body>
										</table>
								</td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php foreach($reports as $report): ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($report[0]->voucher_no); ?>  <b>MR#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td ><b>Job Name:</b> <?php echo e($report[0]->jobname); ?></td>
												<td ><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
												<td colspan="6"><b>Engineer:</b> <?php echo e($report[0]->salesman); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
											...
											<?php $poqty_total = $ponet_total = $invqty_total = $pndqty_total = $pndnet_total = 0; ?>
												...
												<?php  $poqty_gtotal += $poqty_total; $ponet_gtotal += $ponet_total; $invqty_gtotal += $invqty_total; 
														$pndqty_gtotal += $pndqty_total; $pndnet_gtotal += $pndnet_total;  ?>
											<?php endforeach; ?>
												<tr>
													<td></td>
													<td class="text-right"><b>Grand Total:</b></td>
													<td class="text-right"><b><?php echo e($poqty_gtotal); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($ponet_gtotal,2)); ?></b></td>
													<td class="text-right"><b><?php echo e($invqty_gtotal); ?></b></td>
													<td class="text-right"><b><?php echo e($pndqty_gtotal); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($pndnet_gtotal,2)); ?></b></td>
												</tr>
											</body>
										</table>
								</td>
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td ><b>MR#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>MR Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td ><b>MR Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
												<td ><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
												<td ><b>Supplier Name:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('material_requisition/export')); ?>">
