                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<div class="pull-right">
							 ...
							 <a href="<?php echo e(url('stock_transferout/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="<?php echo e(url('stock_transferout/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" data-language='en' id="voucher_date" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" placeholder="STO. Date"/>
                                    </div>
                                </div>
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('stock_transferout/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
