                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsReturn" id="frmGoodsReturn" action="<?php echo e(url('goods_return/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<?php } else { ?>
										<div class="input-group">
											<input type="text" class="form-control" id="voucher_no" name="voucher_no" <?php if($voucherno->autoincrement==1) { ?> readonly value="<?php echo e($vouchers[0]['voucher_no']); ?>" <?php } else { ?> value="<?php echo e(old('voucher_no')); ?>" <?php } ?>>
											<input type="hidden" value="<?php echo e($voucherno->prefix); ?>" name="prefix">
											<input type="hidden" value="<?php echo e($voucherno->voucher_type); ?>" name="voucher_type">
											<input type="hidden" value="<?php echo e($voucherno->autoincrement); ?>" name="autoincrement">
											<span class="input-group-addon inputvn"><i class="fa fa-fw fa-edit"></i></span>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" tabindex="1" name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" tabindex="3" name="stock_account" id="stock_account" class="form-control"  autocomplete="off" value="<?php echo e($voucher['dr_master_name']); ?> "  data-toggle="modal" data-target="#stockac_modal" placeholder="Stock Account">
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="<?php echo e($vouchers[0]['dr_account_master_id']); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" tabindex="4" name="job_account" id="job_account" value="<?php echo e($vouchers[0]['account_id'].'-'.$vouchers[0]['master_name']); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Job Cost Account">
										<input type="hidden" name="job_account_id" id="job_account_id" value="<?php echo e($vouchers[0]['cr_account_master_id']); ?>">
									</div>
                                </div>
...
$(function() {	
	...
	var acurl = "<?php echo e(url('account_master/expenseac_data/')); ?>";
	...
	$('#voucher_id').on('change', function(e){
		var vchr_id = e.target.value; 
		$.get("<?php echo e(url('goods_issued/getvoucher/')); ?>/" + vchr_id, function(data) { 
			$('#voucher_no').val(data.voucher_no);
