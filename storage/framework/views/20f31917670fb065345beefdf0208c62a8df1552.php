                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('so-print'))) : ?>
							 <a href="<?php echo e(url('purchase_order/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('purchase_order/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="purchase_order_id" id="purchase_order_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="PO. Date"/>
                                    </div>
                                </div>
									...
									<div class="itemdivChld">
											<table border="0" class="table-dy-row">
												<tr>
													...
													<input type="text" id="vatdiv_<?php echo e($j); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e(old('vatdiv')[$i]); ?>"><!--<div class="h5" id="vatdiv_1"></div>--> 
											...
											<div class="form-group oc" id="othrcstItm_1">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-2">
														<span class="small">Other Cost/Unit</span> <input type="hidden" id="othrcst_<?php echo e($j); ?>" value="<?php echo e(old('othr_cost')[$i]); ?>" step="any" name="othr_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-2">
														<span class="small">Net Cost/Unit</span> <input type="hidden" id="netcst_<?php echo e($j); ?>" step="any" value="<?php echo e(old('net_cost')[$i]); ?>" name="net_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-1">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="9%">
														<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" autocomplete="off" name="quantity[]" class="form-control line-quantity" <?php echo e(($orderrow->is_editable == 1)?'readonly':''); ?> value="<?php echo e($item->quantity); ?>">
													</td>
													<td width="9%">
														<input type="number" id="itmcst_<?php echo e($i); ?>" autocomplete="off" step="any" name="cost[]" class="form-control line-cost" <?php echo e(($orderrow->is_editable == 1)?'readonly':''); ?> value="<?php echo e($unit_price); ?>">
													</td>
													<td width="6%">
														<select id="taxcode_<?php echo e($i); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR" <?php if($item->tax_code=="SR") echo 'selected'; ?>>SR</option><option value="RC" <?php if($item->tax_code=="RC") echo 'selected'; ?>>RC</option></select>
													</td>
													<td width="6%">
													...
													<td width="9%">
														<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:(($item->pkno > $item->packing)?$item->pkno:$item->packing)); ?>">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="7%">
														...
														<input type="number" name="oc_rate[]" id="ocrate_<?php echo e($i); ?>" step="any" value="<?php echo e(($row->currency_rate==0)?1:$row->currency_rate); ?>" readonly class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e((old('total'))?old('total'):(($orderrow->is_fc==1)?$orderrow->total_fc:$orderrow->total)); ?>">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency <?php echo e($bcurrency); ?></span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" value="<?php echo e((old('total_fc'))?old('total_fc'):$orderrow->total); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" autocomplete="off" value="<?php echo e((old('discount'))?old('discount'):(($orderrow->is_fc==1)?$orderrow->discount_fc:$orderrow->discount)); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" autocomplete="off" value="<?php echo e((old('discount_fc'))?old('discount_fc'):$orderrow->discount); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="<?php echo e((old('net_amount_fc'))?old('net_amount_fc'):$orderrow->net_amount); ?>">
										</div>
									</div>
                                </div>
								<hr/>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="headermsg" name="header" value="<?php echo e($orderrow->header); ?>" autocomplete="off" data-toggle="modal" data-target="#header_modal">
                                    </div>
                                </div>
								<?php } else { ?>
								<input type="hidden" name="header_id" id="header_id">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="footermsg" name="footer" value="<?php echo e($orderrow->footer); ?>" autocomplete="off" data-toggle="modal" data-target="#footer_modal">
                                    </div>
                                </div>
								<?php } else { ?>
								<input type="hidden" name="footer_id" id="footer_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_order')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('purchase_order/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
