        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
						...
						if($type=='summary') { ?>
								<table class="table" border="0">
									...
									<?php foreach($reports as $key => $report): ?>
										...
										<?php endforeach; ?>
										<tr>
											<td><b><?php echo e($row->voucher_no); ?></b></td>
											...
											<td class="text-right"><b><?php echo e(number_format($amount_total,2)); ?></b></td>
										</tr>
										<?php $nettotal += $total;
								...
								<table class="table" border="0">
									...
									<?php foreach($reports as $key => $report): ?>
										...
										<td><?php echo e($row->voucher_no); ?> </td>
											...
											<td><?php echo e($row->name_cr); ?></td>
											<td ><?php echo e($row->quantity); ?></td>
											<td class="text-right"><?php echo e(number_format($row->price,2)); ?></td>
											<td class="text-right"><?php echo e(number_format($row->discount,2)); ?></td>
									
											<td class="text-right"><?php echo e(number_format($row->item_total,2)); ?></td>
										</tr>
										<?php endforeach; ?>
										<?php $total += $row->price;
											  $discount += $row->discount;
							...
							<?php } elseif($type=="job_orderclosed") { ?>
								...
								<table class="table" border="0">
									...
									<?php foreach($reports as $key => $report): ?>
										<?php  $total=$discount=$vat_amount=$amount_total=0; ?>
										<tr><td colspan="9"><b>Cust.Name:<?php echo e($key); ?></b></td></tr>
										<?php foreach($report as $row): ?>
										<tr>
										...
										<td></td>
											...
											<td ><b><?php echo e(number_format($amount_total,2)); ?></b></td>
										</tr>
										<?php $nettotal += $total;
											  $netdiscount += $discount;
											  $netvat_amount += $vat_amount;
									...
									<?php endforeach; ?>
										...
										<tr>
											...
											<td ><b><?php echo e(number_format($net_amount_total,2)); ?></b></td>
										</tr>
									</body>
								</table>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('stock_transferin/export')); ?>">
