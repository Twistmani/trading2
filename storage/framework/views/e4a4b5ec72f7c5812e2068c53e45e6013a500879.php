                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<a href="<?php echo e(url('emp_category/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tbody>
								<?php foreach($empcategory as $category): ?>
                                <tr>
                                    ...
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('emp_category/edit/'.$category->id)); ?>'"><span
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('emp_category/delete/')); ?>";
