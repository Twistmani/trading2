...
$(document).ready(function () {
	...
	//$("input[id*=Hours]").rules("add", "required"); addField

	//$('#frmJournal').bootstrapValidator('revalidateField', 'debit');

	/*$(document).on('click', '.accountRowall', function() {
		$('#frmJournal').bootstrapValidator('revalidateField', "party_name[]");
	})*/

	/*$('#frmJournal').bootstrapValidator('validateField',"line_amount[]"); 
			$('#frmJournal').bootstrapValidator('validateField',"bank_id[]"); 
			$('#frmJournal').bootstrapValidator('validateField',"cheque_no[]"); 
			$('#frmJournal').bootstrapValidator('validateField',"cheque_date[]"); 
...
//$('#frmJournal').bootstrapValidator('revalidateField', 'description[]');
