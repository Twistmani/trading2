        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
											...
											<?php $total_net = $net_amount = $total_vat = $total_gross = $i =$amt=$net_amt= 0;?>
												...
												<tr>
													...
													<td class="text-right"></td>
														<td class="text-right"><?php echo e(number_format($net_amt,2)); ?></td>
										...
										<td colspan="2" align="center">
											...
											?>
												...
												<tr>
													...
													<td class="text-right"><b><?php echo e(number_format($total_gross,2)); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($net_amt,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($total_vat,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($total_net,2)); ?></b></td>
												</tr>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												<td><b>SI.No:</b> <?php echo e(++$i); ?></td>
												<td><b>GRN#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>GRN Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>GRN Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
												<td><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
												<td colspan="3"><b>Supplier Name:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
											...
											?>
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($unit_vat,2)); ?></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php foreach($reports as $report): ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td ><b>GNR#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>GRN Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td ><b>GNR Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
												<td ><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
												<td colspan="5"><b>Supplier Name:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('suppliers_do/export')); ?>">
						...
						<input type="hidden" name="currency_id" value="<?php echo e($curid); ?>" >
						<input type="hidden" name="job_id[]" value="<?php echo e($jobids[0]); ?>" >
						<input type="hidden" name="supplier_id" value="<?php echo e($supplierid); ?>" >
					</form>
