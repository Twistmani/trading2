	...
	<div class="panel-body">
		...
		<div class="table-responsive m-t-10">
			...
			<table class="table horizontal_table table-striped" id="tableSuppList">
				...
				<tr>
					<td><a href="" class="supp" data-id="<?php echo e($supplier->id); ?>" data-name="<?php echo e($supplier->master_name); ?>" data-dismiss="modal"><?php echo e($supplier->account_id); ?></a></td>
					<td><a href="" class="supp" data-id="<?php echo e($supplier->id); ?>" data-name="<?php echo e($supplier->master_name); ?>" data-dismiss="modal"><?php echo e($supplier->master_name); ?></a></td>
