										...
										<td colspan="2" align="center" class="innerTable">
											<table class="table table-bordered" border="1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php for($i = 0; $i < $maxCategories; $i++): ?>
                                                        <tr>
                                                            <?php /* Liabilities Subcategory */ ?>
                                                            <?php if(isset($liabilitiesAndEquity[$i])): ?>
                                                                <td class="subcategory"><strong><?php echo e($liabilitiesAndEquity[$i]['name']); ?></strong></td>
                                                                <td class="subcategory total"><strong><?php echo e(formatAmount($liabilitiesAndEquity[$i]['total'])); ?></strong></td>
                                                            <?php else: ?>
                                                                <td></td><td></td>
                                                            <?php endif; ?>

                                                            <?php /* Assets Subcategory */ ?>
                                                            <?php if(isset($assets[$i])): ?>
                                                                <td class="subcategory"><strong><?php echo e($assets[$i]['name']); ?></strong></td>
                                                                <td class="subcategory total"><strong><?php echo e(formatAmount($assets[$i]['total'])); ?></strong></td>
                                                            <?php else: ?>
                                                                <td></td><td></td>
                                                            <?php endif; ?>
                                                        </tr>
                                                        ...
                                                        <?php for($g = 0; $g < $maxGroups; $g++): ?>
                                                            <tr>
                                                                <?php /* Liabilities Group */ ?>
                                                                <?php if(isset($liabGroups[$g])): ?>
                                                                    <td class="group"><?php echo e($liabGroups[$g]['group_name']); ?></td>
                                                                    <td class="group total"><?php echo e(formatAmount($liabGroups[$g]['group_total'])); ?></td>
                                                                <?php else: ?>
                                                                    <td></td><td></td>
                                                                <?php endif; ?>

                                                                <?php /* Assets Group */ ?>
                                                                <?php if(isset($assetGroups[$g])): ?>
                                                                    <td class="group"><?php echo e($assetGroups[$g]['group_name']); ?></td>
                                                                    <td class="group total"><?php echo e(formatAmount($assetGroups[$g]['group_total'])); ?></td>
                                                                <?php else: ?>
                                                                    <td></td><td></td>
                                                                <?php endif; ?>
                                                            </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><strong><?php echo e(formatAmount(collect($liabilitiesAndEquity)->sum('total'))); ?></strong></td>
                                                        <td><strong>Total Assets</strong></td>
                                                        <td><strong><?php echo e(formatAmount(collect($assets)->sum('total'))); ?></strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
										</td>
                    ...
                    <div class="btn-section">
                        <div class="col-md-12 col-sm-12 col-xs-12">
								...
								<button type="button" onclick="javascript:window.close();"
                                    ...
                                    <form method="GET" action="<?php echo e(url('balancesheet2/search')); ?>">
                                        <input type="hidden" name="date_from" value="<?php echo e($fromDate); ?>">
                                        <input type="hidden" name="date_to" value="<?php echo e($toDate); ?>">
                                        <input type="hidden" name="search_type" value="<?php echo e($searchtype); ?>">
