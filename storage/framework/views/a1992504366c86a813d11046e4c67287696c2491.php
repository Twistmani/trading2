<div class="panel-body">
	...
	<div class="table-responsive m-t-10" id="accountList">
		...
		<table class="table horizontal_table table-striped" id="tableAcntList">
			...
			<tr>
				<td><a href="" class="accountRowinc" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-vat="<?php echo e($account->vat_percentage); ?>" data-dismiss="modal"><?php echo e($account->account_id); ?></a></td>
				<td><a href="" class="accountRowinc" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-vat="<?php echo e($account->vat_percentage); ?>" data-dismiss="modal"><?php echo e($account->master_name); ?></a></td>
