                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmLocTransfer" id="frmLocTransfer" action="<?php echo e(url('location_transfer/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('location_transfer/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
