                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="<?php echo e(url('suppliers_do/save/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                  <font color="#16A085">   <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('supplier_name')) echo 'form-error';?>"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php echo e($orderrow->supplier); ?>" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_id" readonly value="<?php echo e($pordid); ?>" name="document_id" placeholder="Document ID" autocomplete="off" onclick="getDocument()">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<option value="<?php echo e($curr['id']); ?>" <?php if($curr['id']==$orderrow->currency_id) echo 'selected'; ?>><?php echo e($curr['code']); ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-xs-5">
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control"  autocomplete="off" data-toggle="modal" data-target="#item_modal" value="<?php echo e($poitem->item_code); ?>">
												</td>
												<td width="29%">
												...
												<td width="8%">
													<input type="hidden" name="actual_quantity[]" id="itmactqty_1" value="<?php echo e($actual_quantity); ?>"> 
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" autocomplete="off" name="quantity[]" class="form-control line-quantity" value="<?php echo e($quantity); ?>" <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>><!--NOV24-->
												</td>
												<td width="8%">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="10%">
														...
														<input type="number" name="oc_amount[]" step="any" id="ocamt_<?php echo e($i); ?>" value="<?php echo e(intval($row->oc_amount*100)/100); ?>" autocomplete="off" class="form-control oc-line" placeholder="Amount">
													</td>
													<td width="5%">
													...
													<td width="10%">
														<div class="oc-amount-fc">
															...
															<input type="number" name="oc_fc_amount[]" id="ocfcamt_<?php echo e($i); ?>" step="any" value="<?php echo e(intval($row->oc_fc_amount*100)/100); ?>" autocomplete="off" class="form-control oc-line-fc" placeholder="FC Amount">
														</div>
													</td>
													<td width="5%"><br/>
								...
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" value="<?php echo e($orderrow->other_cost_fc); ?>" readonly class="form-control spl" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" autocomplete="off" value="<?php echo e((old('discount'))?old('discount'):$orderrow->discount); ?>">
										</div>
										<div class="col-xs-2">
