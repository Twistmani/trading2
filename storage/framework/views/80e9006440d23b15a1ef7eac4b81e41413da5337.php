...
<?php $__env->startSection('header_styles'); ?>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/custom_css/radio_checkbox.css')); ?>">	
<?php $__env->stopSection(); ?>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> <?php echo e($role->display_name); ?> Permissions List
                        </h3>
                        
                    </div>
                    <div class="panel-body">
					  <form class="form-horizontal" role="form" method="POST" name="frmPermission" id="frmPermission" action="<?php echo e(url('permission/update')); ?>">
                        ...
                        <div id="accordion" class="panel-group">
									  ...
									  <div class="box-body">
										<div class="row">
                                            <div class="col-md-12">
												...
												<?php if(isset($permissions['GRN'][3])): ?>
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="checkbox checkbox-primary">
												...
												<?php endif; ?>
												<?php if(isset($permissions['GRN'][4])): ?>
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="checkbox checkbox-primary">
						 ...
						 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="<?php echo e(url('roles')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
					  </form>
                    </div>
