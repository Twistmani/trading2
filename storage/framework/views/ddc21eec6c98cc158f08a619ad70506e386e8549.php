...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="fa fa-fw fa-list-alt"></i> <?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?>
                        </h3>
                        <div class="pull-right">
                             <?php if (\Entrust::can(('do-create'))) : ?>
							 <a href="<?php echo e(url('customers_do/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tablePordersList">
                                    <thead>
                                    <tr>
										<th><?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?> No</th>
										<!--<th>Reference No</th>-->
										<!--<th>Description</th>-->
										<th>Customer</th>
										<th><?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?> Date</th>
										<th>Amount</th>
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<!--<td><?php echo e($order->reference_no); ?></td>-->
											...
											<td>
												<?php if (\Entrust::can(('do-edit'))) : ?><p><button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('customers_do/edit/'.$order->id)); ?>'"><span class="glyphicon glyphicon-pencil"></span></button></p><?php endif; // Entrust::can ?>
											</td>
											<td>
												<?php if (\Entrust::can(('do-print'))) : ?><p><a href="<?php echo e(url('customers_do/print/'.$order->id)); ?>" target="_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p><?php endif; // Entrust::can ?>
											</td>
											<?php if($order->is_fc==1) { ?><td>
												<?php if (\Entrust::can(('do-print'))) : ?><p><a href="<?php echo e(url('customers_do/print/'.$order->id.'/FC')); ?>" target="_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span> FC</a></p><?php endif; // Entrust::can ?>
											</td><?php } ?>
											
											<td>
												<?php if (\Entrust::can(('do-delete'))) : ?><p><button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($order->id); ?>')"><span class="glyphicon glyphicon-trash"></span></button></p><?php endif; // Entrust::can ?>
											</td>
										</tr>
										<?php endforeach; ?>
                                    </tbody>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('customers_do/search')); ?>">
			 ...
			 <div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left m-t-6">
								<i class="fa fa-fw fa-list-alt"></i> <?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?> Report
							</h3>
						</div>
						<div class="panel-body">
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<select id="search_type" class="form-control select2" style="width:100%" name="search_type">
											...
											<!--<option value="summary_pending">Summary(Pending <?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?>)</option>
											
											<option value="detail_pending">Detail(Pending <?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?>)</option>
...
function funDelete(id,no) {
    if(no=='0') {
    	...
    	if(con==true) {
    		var url = "<?php echo e(url('customers_do/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('customers_do/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			<?php if (\Entrust::can(('do-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('do-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('do-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('do-delete'))) : ?>{ "data": "delete","bSortable": false },<?php endif; // Entrust::can ?>
		]	
			...
			$('#select23').on('change', function(e){
			    ...
			    console.log(cust_id);
			     if(cust_id !=''){
			    $.get("<?php echo e(url('customers_do/getjob/')); ?>/" + cust_id, function(data) {
