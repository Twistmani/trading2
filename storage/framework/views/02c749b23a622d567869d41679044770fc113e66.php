                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('job_invoice/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sales_account" id="sales_account" class="form-control" readonly value="<?php echo e(($salesac!='')?$salesac:$vouchers[0]['account_id'].'-'.$vouchers[0]['master_name']); ?>">
								...
								<?php if(Session::get('mod_vehicle_cust')==0): ?>
    								...
    								<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="document" readonly name="document" value="<?php echo e(old('document')?old('document'):$docrow->voucher_no); ?>" autocomplete="off" onclick="getDocument()">
    								...
    								<div class="form-group">
    									...
    									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
    										...
    										<div class="col-xs-10" style="float: right;" id="vehicleInfo">
    											...
    											<div class="col-xs-2">
    												<span class="small">ChasisNo</span> <input type="text" id="chasis_no" name="chasis_no" value="<?php echo e($docrow->chasis_no); ?>" readonly class="form-control">
    											</div>
    											<div class="col-xs-2">
    											...
    											<div class="col-xs-1">
    												<span class="small">MetreIn</span> <input type="text" id="metre_in" name="metre_in" value="<?php echo e($docrow->metre_in); ?>" class="form-control">
    											</div>
    											<div class="col-xs-1">
    												<span class="small">MetreOut</span> <input type="text" id="metre_out" name="metre_out"value="<?php echo e($docrow->metre_out); ?>"  class="form-control">
    											</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_type" class="form-control select2 <?php if($errors->has('job_type')) echo 'form-error';?>" style="width:100%" name="job_type">
											...
											<option value="<?php echo e($row->id); ?>" <?php if($docrow->job_type==$row->id) echo 'selected'; ?>><?php echo e($row->name); ?></option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" value="<?php echo e($docrow->salesman); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Technician">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" tabindex="2" class="form-control" autocomplete="off" data-toggle="modal" value="<?php echo e($docrow->code); ?>" data-target="#job_modal" placeholder="Job Code">
								...
								<?php if($formdata['items_description']==1) { ?>
										   <div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" id="items_description" autocomplete="off" name="items_description" value="<?php echo e($docrow->items_description); ?>" placeholder="Items Description">
											</div>
											</div>
								           <?php } else {?>
									...
									<div class="itemdivChld">	
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="11%">
													<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" class="form-control line-total" readonly value="<?php echo e(intval($line_total*100)/100); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" value="<?php echo (old('total_fc'))?old('total_fc'):intval($docrow->line_total*100)/100; ?>" step="any" name="total_fc" class="form-control spl" value="<?php echo e($total_dh); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
														...
														<div class="file-drop-disabled">
															<div class="file-preview-thumbnails">
																<div class="file-live-thumbs">
																	<a href="<?php echo e(asset('uploads/joborder/'.$prow->photo)); ?>" target="_blank">View Image <?php echo e($i); ?></a>
																</div>
															</div>
