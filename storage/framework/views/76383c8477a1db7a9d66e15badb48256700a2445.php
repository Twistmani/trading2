                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('ce-print'))) : ?>
								 <a href="<?php echo e(url('customer_enquiry/print/'.$printid)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" enctype="multipart/form-data"  id="frmQuotationSales" action="<?php echo e(url('customer_enquiry/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CE. No.</label>
                                    <div class="col-sm-10">
										<input type="hidden" value="<?php echo e(($lrow)?$lrow->id:''); ?>" name="lead_id">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" name="reference_no" value="<?php echo e(($lrow)?$lrow->lead_no:old('reference_no')); ?>" placeholder="Reference No.">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>" readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								<!-- <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">CE. Date</label>
                                    ...
                                    <div class="col-sm-10">
										 ...
										 <input type="text" class="form-control pull-right" value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>"  name="voucher_date" autocomplete="off" data-language='en' id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/> 
                                    </div>
                                </div> -->
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" value="<?php echo e(($lrow)?$lrow->master_name:old('customer_name')); ?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e(($lrow)?$lrow->customer_id:old('customer_id')); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" class="form-control" value="<?php echo e(($lrow)?$lrow->name:old('salesman')); ?>" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
										<input type="hidden" name="salesman_id" id="salesman_id" value="<?php echo e(($lrow)?$lrow->salesman_id:old('salesman_id')); ?>">
									</div>
                                </div>
								<?php } else { ?>
							...
							<div id="showmenu">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('customer_enquiry/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('ce-history'))) : ?>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('customer_enquiry/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	var custurl = "<?php echo e(url('sales_order/customer_data/')); ?>";//customer_enquiry
    ...
    $(document).on('click', '#importFile', function(e) { 
        ...
        if($('#import_file').val()=='') {
			...
			$('#frmQuotationSales').attr('action', "<?php echo e(url('customer_enquiry/import')); ?>").submit();
		}
