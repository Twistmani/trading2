                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
								<?php if (\Entrust::can(('pv-print'))) : ?>
								 <a href="<?php echo e(url('supplier_payment/print/'.$crrow->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
							<?php  $ispdc = false;  ?>
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="<?php echo e(url('supplier_payment/update/'.$crrow->id)); ?>">
								...
								<?php endif; ?>
								<input type="hidden" name="pv_id" id="pv_id" value="<?php echo e($crrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" value="<?php echo e(date('d-m-Y', strtotime($crrow->voucher_date))); ?>" data-language='en' autocomplete="off" id="voucher_date" placeholder="Voucher Date"/>
                                    </div>
                                </div>
												...
												<?php  $ispdc = true;  ?>
													<?php if($isdept): ?> <!-- PDC WITH DEPARTEMNT -->
														<div class="col-xs-1" style="width:11%;"> <span class="small">Account Name</span>
															...
															<input type="hidden" id="invoiceid_<?php echo e($i); ?>" name="purchase_invoice_id[]" value="<?php echo e($item->purchase_invoice_id); ?>">
															<input type="hidden" name="bill_type[]" value="<?php echo e($item->bill_type); ?>" id="biltyp_<?php echo e($i); ?>">
														...
														<div class="col-xs-2" style="width:9%;">
															...
															<input type="text" id="ref_<?php echo e($i); ?>" name="reference[]" value="<?php echo e($item->reference); ?>" class="form-control <?php if($item->entry_type=='Dr') echo 'ref-invoice'; ?>" <?php if($item->entry_type=='Dr') { ?>data-toggle="modal" data-target="#reference_modal" <?php } ?>>
															</div>
															<input type="hidden" name="inv_id[]" id="invid_<?php echo e($i); ?>" value="<?php echo e($item->purchase_invoice_id); ?>">
													...
													<?php else: ?>  <!-- PDC WITHOUT DEPARTEMNT -->
													...
													<?php endif; ?> <!-- END PDC WITHOUT DEPARTEMNT -->
													
												<?php elseif($item->category=='BANK'): ?>
												    <?php if($isdept): ?> <!-- BANK WITH DEPARTEMNT -->
													...
													<?php else: ?>  <!-- BANK WITHOUT DEPARTEMNT -->
													...
													<?php endif; ?> <!-- END BANK WITHOUT DEPARTEMNT -->
													
												<?php else: ?>  <!-- NON PDC SECTION -->
													<?php if($isdept): ?> <!-- NON PDC WITH DEPARTEMNT -->
													...
													<?php else: ?> <!-- NON PDC WITHOUT DEPARTEMNT -->
													...
													<?php endif; ?> <!-- END NON PDC WITHOUT DEPARTEMNT -->
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-5"> 
											<span class="small"><b>Supplier Name</b></span><input type="text" id="supname_1" value="<?php echo e($crrow->supplier_name); ?>" name="supplier_name" class="form-control" >
										</div>
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" name="trn_no" value="<?php echo e($crrow->trn_no); ?>" class="form-control">
										</div>
                                </div>
								<?php } ?>
								...
								<!--	<div class="form-group">
                                    ...
                                    <div class="col-sm-1">
										<label class="radio-inline iradio"></label>
											<input type="checkbox" class="debit_icheck bank-chk" id="is_debit" name="is_debit" <?php echo e(($ischk)?'checked':''); ?> value="1">
                                    </div>
									<span class="bnk-info">
                                    <label for="input-text" class="col-sm-1 control-label">Cheque No</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="chkno" name="chq_no" value="<?php echo e($chkno); ?>">
                                    </div>
									<label for="input-text" class="col-sm-2 control-label">Cheque Date</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="chkdt" name="chq_date" data-language='en' value="<?php echo e($chkdate); ?>">
                                    </div>
									</span>
                                </div> -->
...
$(document).on('click', '#account_modal .custRow', function(e) { 
	...
	$(document).on('click', '.ref-invoice', function(e) {
		...
		if( $('#groupid_'+curNum).val()=='CUSTOMER') { //customer type.............
			var purl = "<?php echo e(url('sales_invoice/get_invoice/')); ?>/"+$('#draccountid_'+curNum).val();
		   ...
		   $('#invoiceData').load(url+'/1/PV/'+pvid, function(result){ 
			...
			/* var purl = "<?php echo e(url('purchase_invoice/get_invoice/')); ?>/"+$('#draccountid_'+curNum).val();
			var reid = $('#jeid_'+curNum).val();
			if((reid!='') && (this.value!='')) {
				$('#invoiceData').load(purl+'/'+curNum+'/'+this.value+'/'+reid, function(result){ //.modal-body item
					$('#myModal').modal({show:true});
