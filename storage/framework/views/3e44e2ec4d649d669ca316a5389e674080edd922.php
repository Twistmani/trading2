                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmCategory" id="frmCategory" action="<?php echo e(url('category/update/'.$catrow->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit
                                                         ...
                                                         <a href="<?php echo e(url('category')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
<script>
"use strict";
var url = "<?php echo e(url('category/checkname/')); ?>";
