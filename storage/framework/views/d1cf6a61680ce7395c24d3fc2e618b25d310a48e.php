...
<?php $__env->startSection('header_styles'); ?>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/custom_css/wizard.css')); ?>" rel="stylesheet">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Employeee
                            </h3>
                           
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" name="frmEmployee" id="frmEmployee" action="<?php echo e(url('employee/update/'.$row->id)); ?>">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
                                          ...
                                          <div class="form-group">
                                    			<label for="input-text" class="col-sm-2 control-label"><b>Department</b></label>
                                    				<div class="col-sm-10">
                                       					<select id="department_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="department_id">
															...
															<option value="<?php echo e($drow->id); ?>" <?php echo e(($row->department_id==$drow->id)?'selected':''); ?> ><?php echo e($drow->name); ?></option>
																<?php endforeach; ?>
                                        				</select>
                                    				</div>
                                		   </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control required" id="code2" name="code2" value="<?php echo e($row->code); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="designation" name="designation" value="<?php echo e($row->designation); ?>">
												</div>
											</div>
                                                ...
                                                <div class="col-sm-10">
                                                   <select id="division_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="division_id">
												           ...
												           <?php foreach($divisions as $drow): ?>
															<option value="<?php echo e($drow->id); ?>" <?php echo e(($row->division_id==$drow->id)?'selected':''); ?> ><?php echo e($drow->div_name); ?></option>
															<?php endforeach; ?>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="nationality" name="nationality" value="<?php echo e($row->nationality); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="address1" name="address1" value="<?php echo e($row->address1); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="address2" name="address2" value="<?php echo e($row->address2); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="phone2" name="phone2" value="<?php echo e($row->phone2); ?>">
												</div>
											</div>
											...
											<!--<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="address3" name="address3" value="<?php echo e($row->address3); ?>">
												</div>
											</div>-->
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="email" class="form-control" id="email" name="email" value="<?php echo e($row->email); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php if(isset($photos['PF'])) { $arrp = explode(',',$photos['PF']); $i=1; ?>
														...
														<div class="file-drop-disabled">
															<div class="file-preview-thumbnails">
																<div class="file-live-thumbs">
																	<a href="<?php echo e(asset('uploads/employee/'.$prow)); ?>" target="_blank">View Photo <?php echo e($i); ?></a>
																</div>
															</div>
													...
													<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/upload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="loading"></p>
													<input type="hidden" name="photo_name" id="photo_name" value="<?php echo e(isset($photos['PF'])?$photos['PF']:''); ?>">
													<input type="hidden" name="old_photo_name" id="old_photo_name" value="<?php echo e(isset($photos['PF'])?$photos['PF']:''); ?>">
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="pp_id" name="pp_id" value="<?php echo e($row->pp_id); ?>" placeholder="Passport ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removePP" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/passport/'.$prow)); ?>" target="_blank">View Passport Image <?php echo e($i); ?></a>
															</div>
														</div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23p" name="pimage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/pupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="ploading"></p>
													<input type="hidden" name="pimage_name" id="pimage_name" value="<?php echo e(isset($photos['PSP'])?$photos['PSP']:''); ?>">
													<input type="hidden" name="old_pimage_name" id="old_pimage_name" value="<?php echo e(isset($photos['PSP'])?$photos['PSP']:''); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="v_designation" name="v_designation" value="<?php echo $row->v_designation;?>" value="<?php echo e($row->v_designation); ?>" placeholder="Visa Designation">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="v_id" name="v_id" value="<?php echo e($row->v_id); ?>" placeholder="Visa ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeV" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs"> 
																<a href="<?php echo e(asset('uploads/visa/'.$prow)); ?>" target="_blank">View Visa Image <?php echo e($i); ?></a>
															</div>
														</div>
														<div class="clearfix"></div><div class="file-preview-status text-center text-success"></div>
														<div class="kv-fileinput-error file-error-message" style="display: none;"></div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23v" name="vimage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/vupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="vloading"></p>
													<input type="hidden" name="vimage_name" id="vimage_name" value="<?php echo e(isset($photos['VS'])?$photos['VS']:''); ?>">
													<input type="hidden" name="old_vimage_name" id="old_vimage_name" value="<?php echo e(isset($photos['VS'])?$photos['VS']:''); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="lc_id" name="lc_id" value="<?php echo e($row->lc_id); ?>" placeholder="Labour Card ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeL" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/labour/'.$prow)); ?>" target="_blank">View Labour Card Image <?php echo e($i); ?></a>
															</div>
														</div>
														<div class="clearfix"></div> <div class="file-preview-status text-center text-success"></div>
														<div class="kv-fileinput-error file-error-message" style="display: none;"></div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23l" name="limage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/lupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="lloading"></p>
													<input type="hidden" name="limage_name" id="limage_name" value="<?php echo e(isset($photos['LB'])?$photos['LB']:''); ?>">
													<input type="hidden" name="old_limage_name" id="old_limage_name" value="<?php echo e(isset($photos['LB'])?$photos['LB']:''); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="hc_id" name="hc_id" placeholder="Health Card ID" value="<?php echo e($row->hc_id); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="hc_info" name="hc_info" value="<?php echo e($row->hc_info); ?>" placeholder="Health Card Info">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeH" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/health/'.$prow)); ?>" target="_blank">View Health Card  Image <?php echo e($i); ?></a>
															</div>
														</div>
														<div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>
														<div class="kv-fileinput-error file-error-message" style="display: none;"></div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23h" name="himage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/hupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="hloading"></p>
													<input type="hidden" name="himage_name" id="himage_name" value="<?php echo e(isset($photos['HL'])?$photos['HL']:''); ?>">
													<input type="hidden" name="old_himage_name" id="old_himage_name" value="<?php echo e(isset($photos['HL'])?$photos['HL']:''); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="ic_id" name="ic_id" value="<?php echo e($row->ic_id); ?>" placeholder="ID Card ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeI" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/idcard/'.$prow)); ?>" target="_blank">View ID Card Image <?php echo e($i); ?></a>
															</div>
														</div>
														<div class="clearfix"></div> <div class="file-preview-status text-center text-success"></div>
														<div class="kv-fileinput-error file-error-message" style="display: none;"></div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23i" name="iimage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/iupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="iloading"></p>
													<input type="hidden" name="iimage_name" id="iimage_name" value="<?php echo e(isset($photos['IDC'])?$photos['IDC']:''); ?>">
													<input type="hidden" name="old_iimage_name" id="old_iimage_name" value="<?php echo e(isset($photos['IDC'])?$photos['IDC']:''); ?>">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="me_id" name="me_id" value="<?php echo e($row->me_id); ?>" placeholder="Exam ID">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeM" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/medical/'.$prow)); ?>" target="_blank">View Medical Exam Image <?php echo e($i); ?></a>
															</div>
														</div>
														<div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>
														<div class="kv-fileinput-error file-error-message" style="display: none;"></div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23me" name="meimage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/meupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="meloading"></p>
													<input type="hidden" name="meimage_name" id="meimage_name" value="<?php echo e(isset($photos['MD'])?$photos['MD']:''); ?>">
													<input type="hidden" name="old_meimage_name" id="old_meimage_name" value="<?php echo e(isset($photos['MD'])?$photos['MD']:''); ?>">
                                        ...
                                        <div class="tab-pane" id="tab3">
											...
											<!--<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control" id="contract_salary" name="contract_salary" value="<?php echo e($row->contract_salary); ?>" placeholder="Contract Salary">
												</div>
											</div>-->
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control salcal" id="basic_pay" name="basic_pay" value="<?php echo e($row->basic_pay); ?>" placeholder="Basic Pay"> 
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control salcal" id="hra" name="hra" value="<?php echo e($row->hra); ?>" placeholder="HRA">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control salcal" id="transport" name="transport" value="<?php echo e($row->transport); ?>" placeholder="Transport">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control salcal" id="allowance" name="allowance" value="<?php echo e($row->allowance); ?>" placeholder="Allowance1">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control salcal" id="allowance2" name="allowance2" value="<?php echo e($row->allowance2); ?>" placeholder="Allowance2">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control" id="net_salary" name="net_salary" value="<?php echo e($row->net_salary); ?>" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													 <input type="number" step="any" class="form-control" id="nwh" name="nwh" value="<?php echo e($row->nwh); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													 <input type="number" step="any" class="form-control" id="lpm" name="lev_per_mth" value="<?php echo e($row->lev_per_mth); ?>">
												</div>
												<label for="input-text" class="col-sm-3 control-label">Air Ticket Allotment after</label>
												<div class="col-sm-2">
													 <input type="number" step="any" class="form-control" id="air_tkt" name="air_tkt" value="<?php echo e($row->air_tkt); ?>">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													 <input type="number" step="any" class="form-control" id="anual_ml" name="anual_ml" value="<?php echo e($row->anual_ml); ?>">
												</div>
												<label for="input-text" class="col-sm-3 control-label">Alloted Anual CL</label>
												<div class="col-sm-2">
													 <input type="number" step="any" class="form-control" id="anual_cl" name="anual_cl" value="<?php echo e($row->anual_cl); ?>">
												</div>
											</div>
										...
										<div class="tab-pane" id="tab4">
										 <h2 class="hidden">&nbsp;</h2>
											<div class="form-group">
												...
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="remarks" name="remarks" value="<?php echo e($row->remarks); ?>" placeholder="Remarks">
												</div>
											</div>
											...
											<input type="hidden" class="form-control" id="duty_status" name="duty_status" value="<?php echo e($row->duty_status); ?>">
											
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Other Info</label>
												<div class="col-sm-10">
													 <input type="text" class="form-control" id="other_info" name="other_info" value="<?php echo e($row->other_info); ?>" placeholder="Other Info">
												</div>
											</div>
											   ...
											   <div class="form-group">
												...
												<?php foreach($arrp as $prow): ?>
													<div class="file-preview">
														<div class="close fileinput-remove removeOF" data-val="<?php echo e($prow); ?>">×</div>
														<div class="file-drop-disabled">
														<div class="file-preview-thumbnails">
															<div class="file-live-thumbs">
																<a href="<?php echo e(asset('uploads/medical/'.$prow)); ?>" target="_blank">View Other Files <?php echo e($i); ?></a>
															</div>
														</div>
												...
												<?php endforeach; ?>
												<?php } ?>
													<input type="file" id="input-23f" name="fimage" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('employee/fupload/')); ?>" multiple="">
													<div id="files_list"></div>
													<p id="floading"></p>
													<input type="hidden" name="fimage_name" id="fimage_name" value="<?php echo e(isset($photos['OF'])?$photos['OF']:''); ?>">
													<input type="hidden" name="old_fimage_name" id="fld_fimage_name" value="<?php echo e(isset($photos['OF'])?$photos['OF']:''); ?>">
...
<script src="<?php echo e(asset('assets/vendors/bootstrapwizard/js/jquery.bootstrap.wizard.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('assets/js/custom_js/form_wizards.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/js/vendor/jquery.ui.widget.js')); ?>"></script>
...
<script>
"use strict";
//var urlcode = "<?php echo e(url('employee/')); ?>"; //checkcode
var saveurl = "<?php echo e(url('employee/save')); ?>";
var tkn = "<?php echo e(csrf_token()); ?>";
var returl = "<?php echo e(url('employee')); ?>";
