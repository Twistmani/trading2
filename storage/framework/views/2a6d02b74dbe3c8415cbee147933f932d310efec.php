...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('job_estimate/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" action="<?php echo e(url('job_estimate/search')); ?>" target="_blank">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('job_estimate/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePorders1").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('job_estimate/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			<?php if (\Entrust::can(('qs-view'))) : ?>{ "data": "view","bSortable": false },<?php endif; // Entrust::can ?>
