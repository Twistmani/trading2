                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseSplit" id="frmPurchaseSplit" action="<?php echo e(url('jobmaster/budgsave/')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label"></span>	<input type="number" id="totalinc" step="any" name="totalinc" class="form-control spl" readonly value="<?php echo e(old('totalinc')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="discountinc" name="discountinc" autocomplete="off" class="form-control spl discount-cal" value="<?php echo e(old('discountinc')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="subtotalinc" step="any" name="subtotalinc" class="form-control spl" readonly value="<?php echo e(old('subtotalinc')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="vatinc" name="vatinc" class="form-control spl" placeholder="0" value="<?php echo e(old('vat')); ?>" readonly>
										</div>
										
									</div>
                                </div>
								
								<input type="hidden" step="any" id="other_costinc" name="other_costinc" readonly class="form-control" value="<?php echo e(old('other_costinc')); ?>" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fcinc" name="other_cost_fcinc" readonly class="form-control spl" value="<?php echo e(old('other_cost_fcinc')); ?>" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hidinc" name="net_amount_hidinc" class="form-control" value="<?php echo e(old('net_amount_hidinc')); ?>" readonly>
											<input type="hidden" step="any" id="net_amountinc" name="net_amount" class="form-control spl" readonly value="<?php echo e(old('net_amountinc')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label"></span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e(old('total')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="discount" name="discount" autocomplete="off" class="form-control spl discount-cal" value="<?php echo e(old('discount')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="subtotal" step="any" name="subtotal" class="form-control spl" readonly value="<?php echo e(old('subtotal')); ?>" placeholder="0">
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="<?php echo e(old('vat')); ?>" readonly>
										</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="hidden" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e(old('net_amount')); ?>" placeholder="0">
										</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('jobmster')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	//new change............
	 var acurl = "<?php echo e(url('account_master/get_accountbudginc/')); ?>";

//	var acurl = "<?php echo e(url('account_master/get_account_all/')); ?>";
...
$(function() {	
	...
	//new change............
	  ...
	  var acurl = "<?php echo e(url('account_master/get_accountbudg/')); ?>";
//	var acurl = "<?php echo e(url('account_master/get_account_all/')); ?>";
