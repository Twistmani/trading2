                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pi-print'))) : ?>
								 <a href="<?php echo e(url('manufacture/print/'.$printid->id)); ?>" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmManufacture" id="frmManufacture" action="<?php echo e(url('manufacture/save')); ?>">
								...
								<div id="trinDV">									
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="hidden" name="account_dr" id="account_dr_id" value="<?php echo e($vouchers[0]['dr_account_master_id']); ?>" class="form-control">
												<input type="text" name="purchase_account" id="account_dr_name" class="form-control" value="<?php echo e($vouchers[0]['dr_master_name']); ?>" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="hidden" name="account_cr" id="account_cr_id" value="<?php echo e($vouchers[0]['cr_account_master_id']); ?>" class="form-control">
												<input type="text" name="purchase_account" id="account_cr_name" class="form-control" value="<?php echo e($vouchers[0]['master_name']); ?>" readonly>
										</div>
									</div>
								</div>
								...
								<div id="troutDV">							
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Debit Account</label>
										<div class="col-sm-10">
											<input type="hidden" name="account_dr_to" id="account_dr_id" value="<?php echo e($vouchers[0]['dr_account_master_id_to']); ?>" class="form-control">
												<input type="text" name="purchase_account_to" id="account_dr_name_to" class="form-control" value="<?php echo e($vouchers[0]['dr_master_name_to']); ?>" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Credit Account</label>
										<div class="col-sm-10">
											<input type="hidden" name="account_cr_to" id="account_cr_id_to" value="<?php echo e($vouchers[0]['cr_account_master_id_to']); ?>" class="form-control">
												<input type="text" name="purchase_account_to" id="account_cr_name_to" class="form-control" value="<?php echo e($vouchers[0]['cr_master_name_to']); ?>" readonly>
										</div>
									</div>
								</div>
									...
									<div class="itemdivPrnt">
										...
										<div class="itemdivChld">	
											<table border="0" class="table-dy-row">
												...
												<div class="rawmatPrntItm" id="rawmatPrntItm_<?php echo e($j); ?>">
													<div class="rawmatChldItm">							
														<div class="table-responsive rawmat-data" id="rawmatData_<?php echo e($j); ?>"></div>
													</div>
												</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e(old('total')); ?>" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="discount" name="discount" class="form-control spl discount-cal" value="<?php echo e(old('discount')); ?>">
											<input type="number" step="any" id="net_amount" name="total_price" class="form-control spl" readonly value="<?php echo e(old('total_price')); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
										</div>
									</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('manufacture')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('manufacture/add')); ?>" class="btn btn-warning">Clear</a>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('manufacture/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('manufacture/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
	$('.rMat').hide();
...
$(function() {	
	...
	var hisurl = "<?php echo e(url('manufacture/order_history/')); ?>";
	...
	var acturl = "<?php echo e(url('manufacture/account_data/')); ?>";
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('manufacture/getvoucher/')); ?>/" + vchr_id, function(data) { 
    ...
    $(document).on('click', '#weadd', function(e) { 
	   ...
	   var item_id = $('#itmid_'+curNum).val();
	   if(item_id!='') {
		   var rwUrl = "<?php echo e(url('itemmaster/get_rawmatwe/')); ?>/"+item_id;
...
function getAccount(e) { 
	...
	var res = e.id.split('_');
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('manufacture/account_data/')); ?>/"+curNum;
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
function getAccountCr(e) { 
	...
	var res = e.id.split('_');
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('manufacture/account_data/')); ?>/"+curNum+"/cr";
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
function getDocument() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('production/get_data')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
