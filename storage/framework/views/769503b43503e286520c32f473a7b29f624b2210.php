                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if($isprint) { ?>
							<?php if (\Entrust::can(('ce-print'))) : ?>
							 <a href="<?php echo e(url('customer_enquiry/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('customer_enquiry/update/'.$orderrow->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('customer_enquiry')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('customer_enquiry/edit/'.$orderrow->id)); ?>" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('customer_enquiry/checkrefno/')); ?>";
...
$(function() {	
	...
	var custurl = "<?php echo e(url('customer_enquiry/customer_data/')); ?>";
	...
	var supurl = "<?php echo e(url('customer_enquiry/salesman_data/')); ?>";
