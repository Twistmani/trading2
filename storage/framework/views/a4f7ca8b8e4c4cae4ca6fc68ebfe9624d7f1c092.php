                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New <?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?>
                            </h3>
							<div class="pull-right">
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('do-print'))) : ?>
								 <a href="<?php echo e(url('customers_do/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="<?php echo e(url('customers_do/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="curno" id="curno" value="<?php echo e((old('curno'))?old('curno'):$voucherno); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" name="reference_no" value="<?php echo e(old('reference_no')); ?>" autocomplete="off" placeholder="Reference No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" autocomplete="off" id="description" value="<?php echo e(old('customer_id')); ?>" name="description" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" step="any" name="quantity[]" autocomplete="off" value="<?php echo e(old('quantity')[$i]); ?>" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" placeholder="Qty.">
												</td>
												<td width="8%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($j); ?>" value="<?php echo e(old('vatdiv')[$i]); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" placeholder="VAT Amt"> 
													<input type="hidden" id="vat_<?php echo e($j); ?>" value="<?php echo e(old('line_vat')[$i]); ?>" name="line_vat[]" class="form-control vat">
												...
												<td width="11%">
													...
													<input type="number" id="itmttl_<?php echo e($j); ?>" step="any" name="line_total[]" value="<?php echo e(old('line_total')[$i]); ?>" class="form-control line-total" >
												</td>
												<td width="1%">
									...
									<?php $i++; } } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_1" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" placeholder="Qty." <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>><!--NOV24-->
												</td>
												<td width="8%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('customers_do/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('do-history'))) : ?>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('customers_do/checkvchrno/')); ?>"; //CHNG
...
//	$('#lpo_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
	...
	$('#customer_name').on('blur', function(e){ //$('#document_type').on('change', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('customers_do/set_session/')); ?>",
			type: 'get',
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('customers_do/checkvchrno/')); ?>", 
			type: 'get',
...
function getCustomerDo() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('customers_do/get_customerdo/')); ?>";
...
function getDocument() { 
	...
	if(doc=='QS')
		...
		var pourl = "<?php echo e(url('sales_order/get_order/')); ?>/"+customer_id+"/SOD";
