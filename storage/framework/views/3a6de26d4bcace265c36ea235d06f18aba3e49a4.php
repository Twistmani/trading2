        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
									    	<tr>
												...
												<td><b>PR#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>PR Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>PR Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
										...
										<tr>
											...
											<td class="text-right"><?php echo e(number_format($tprice,2)); ?></td>
								...
								<tbody id="bod">
									...
									<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											...
											Sup.Name: <?php echo e($report[0]['supplier']); ?></b></h6>
										</td>
										<td align="right" style="padding-left:0px;">
											<p></p>
										</td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('purchase_return/export')); ?>">
					...
					<input type="hidden" name="supplier_id" value="<?php echo e($supplier); ?>" >
