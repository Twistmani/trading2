                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('qs-print'))) : ?>
							 <a href="<?php echo e(url('job_estimate/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('job_estimate/save')); ?>">
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="hidden" name="curno" id="curno" value="<?php echo e($voucherno->no); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>"  id="voucher_date" placeholder="Estimate Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document_no" readonly name="document_no" value="<?php echo e($orderrow->voucher_no); ?>" autocomplete="off">
                                        <input type="hidden" id="document_id" name="document_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                  <font color="#16A085"><label for="input-text" class="col-sm-2 control-label"><b>Job Code</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" class="form-control" autocomplete="off" data-toggle="modal" data-target="#job_modal" value="<?php echo e($orderrow->name); ?>">
								...
								<input type="hidden" id="descNum" value="<?php echo e($descnum); ?>">
								<input type="hidden" id="remdesc" name="remove_desc">
									...
									<div class="descdivChld">
										<div class="form-group">
											<input type="hidden" id="descid_<?php echo e($i); ?>" name="jobdetail_id[]" value="<?php echo e($val->id); ?>">
											<label for="input-text" class="col-sm-2 control-label desclbl" id="lblid_<?php echo e($i); ?>">Description <?php echo e($i); ?></label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="oprdescid_<?php echo e($i); ?>" autocomplete="off" name="opr_description[]" value="<?php echo e($val->description); ?>" placeholder="Description">
											</div>
											<div class="col-sm-3">
												<input type="text" class="form-control" id="oprcmntid_<?php echo e($i); ?>" autocomplete="off" name="opr_comment[]" value="<?php echo e($val->comment); ?>" placeholder="Comments">
											</div>
											<div class="col-sm-1">
												<button type="button" class="btn-success btn-add-desc-com">
													<i class="fa fa-fw fa-plus-square"></i>
												</button>
												<button type="button" class="btn-danger btn-remove-desc-com" data-id="rem_<?php echo e($i); ?>">
								...
								<input type="hidden" id="rowNum" value="<?php echo e(($num==0)?$num+1:$num); ?>">
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="hidden" name="so_item_id[]" id="so_itemid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
														...
														<div class="file-drop-disabled">
															<div class="file-preview-thumbnails">
																<div class="file-live-thumbs">
																	<a href="<?php echo e(asset('uploads/jobestimate/'.$prow->photo)); ?>" target="_blank">View Image <?php echo e($i); ?></a>
																</div>
															</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('job_estimate')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('job_estimate/edit/'.$orderrow->id)); ?>" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
