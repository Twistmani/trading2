            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmStockLedger" id="frmStockLedger" target="_blank	" action="<?php echo e(url('stock_ledger/search')); ?>">
								...
								<div class="table-responsive">
									<table class="table table-striped" id="stockLedger">
										...
										<?php $i++; ?>
										<tr>
											<td><input type="radio" name="document_id" class="opt-account" value="<?php echo e($report->id); ?>" <?php if($i==1) echo 'checked';?>/></td>
...
function getPrint() {	
	document.frmStockLedger.action = "<?php echo e(url('stock_ledger/print')); ?>";
