...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('job-invoice-create'))) : ?>
                             <a href="<?php echo e(url('job_invoice/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
						 <div class="row">
							<!--<div class="col-xs-6">
								<a href="<?php echo e(url('sales_report')); ?>" class="btn btn-primary btn-sm">
										<span class="btn-label">
										<i class="fa fa-fw fa-hdd-o"></i>
									</span>View Report
								</a>
								
								<a href="<?php echo e(url('vat_report')); ?>" class="btn btn-primary btn-sm">
										<span class="btn-label">
                        ...
                        <div class="table-responsive m-t-10">
							<table class="table horizontal_table table-striped" id="SalesInvoiceList">
								...
								<tr>
									...
									<th>Chasis No.</th>
									<th>Amount</th>
									<?php if (\Entrust::can(('job-invoice-edit'))) : ?><th></th><?php endif; // Entrust::can ?>
									<?php if (\Entrust::can(('job-invoice-view'))) : ?><th></th><?php endif; // Entrust::can ?>
									<?php if (\Entrust::can(('job-invoice-print'))) : ?><th></th><?php endif; // Entrust::can ?>
									<?php if (\Entrust::can(('job-invoice-delete'))) : ?><th></th><?php endif; // Entrust::can ?>
									<th></th>
								</tr>
								</thead>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('job_invoice/search')); ?>">
...
function openWin(id) {
  myWindow = window.open("<?php echo e(url('job_invoice/print/')); ?>/"+id, "", "width=400, height=477");
}
function funDelete(id) {
	var con = confirm('Are you sure delete this sales invoice?');
	if(con==true) {
		var url = "<?php echo e(url('job_invoice/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#SalesInvoiceList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('job_invoice/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			{ "data": "chasis_no" },
			{ "data": "net_total" },
			<?php if (\Entrust::can(('job-invoice-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('job-invoice-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('job-invoice-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('job-invoice-delete'))) : ?>{ "data": "delete","bSortable": false },<?php endif; // Entrust::can ?>
		...
		$('#select1').on('change', function(e){
			    ...
			    console.log(cust_id);
			     if(cust_id !=''){
			    $.get("<?php echo e(url('sales_invoice/getjob/')); ?>/" + cust_id, function(data) {
