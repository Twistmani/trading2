                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<a href="<?php echo e(url('accategory/add')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                             <table class="table horizontal_table table-striped" id="tableAcgroup">
                                ...
                                <td><input type='checkbox' name='categoryid[]' class='chk-categoryid' value='<?php echo e($category->id); ?>'/></td>
									...
									<td><?php echo e($category->account_type); ?></td>
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('accategory/edit/'.$category->id)); ?>'"><span
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('accategory/delete')); ?>";
    ...
    if (!checked) {
        ...
        if(con==true) {
           ...
           $('#chkids').val(id);
            ...
            document.frmUnits.action="<?php echo e(url('accategory/destroy')); ?>"
