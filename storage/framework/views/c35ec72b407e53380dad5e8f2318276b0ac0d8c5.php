				...
				<?php } else { ?>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('sales_rental/save')); ?>">
							...
							<input type="hidden" name="is_rental" id="is_rental" value="1">
								...
								<div class="form-group">
                                    ...
                                    <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											...
											<?php if($svchrid) { ?>
												<option value="<?php echo e($voucher['id']); ?>" <?php if($svchrid==$voucher['id']) echo 'selected'; ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php } else { ?>
												<option value="<?php echo e($voucher['id']); ?>" <?php if($svchrid==$voucher['id']) echo 'selected'; ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php } ?>
											<?php endforeach; ?>
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											...
											<?php if($svchrid) { ?>
												<option value="<?php echo e($voucher['id']); ?>" <?php if($svchrid==$voucher['id']) echo 'selected'; ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php } else { ?>
												<option value="<?php echo e($voucher['id']); ?>" <?php if(old('voucher_id')==$voucher['id']) echo 'selected'; ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php } ?>
											<?php endforeach; ?>
                                        </select>
                                    </div>
							...
							<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="text" name="sales_account" id="sales_account" class="form-control" value="<?php echo e((old('sales_account'))?old('sales_account'):$vouchers[0]['master_name']); ?>" readonly>
											<?php } ?>
								...
								<div class="form-group">
                                 <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
										<?php if($scstname) {?>
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo e($scstname); ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer" readonly>
                                        <?php } else { ?>
										<input type="text" name="customer_name" id="customer_name" value="<?php echo e(old('customer_name')); ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer" readonly>
										<?php } ?>
										
										<?php if($scstid) { ?>
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e($scstid); ?>">
										<?php } else { ?>
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e(old('customer_id')); ?>">
										<?php } ?>
										
										<?php if($sdrid) { ?>
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="<?php echo e($sdrid); ?>">
										<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_id" class="form-control select2" style="width:100%" name="job_id">
											...
											<option value="<?php echo e($job['id']); ?>" <?php if($job['id']==old('job_id')) echo 'selected'; ?>><?php echo e($job['code']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<table border="0" class="table-dy-row">
									<tr>
										<td width="10%">
											<input type="hidden" id="rv_voucher" name="rv_voucher" value="<?php echo e($rvid); ?>"/>
										...
										<td width="10%">
											...
											<input type="text" name="rv_voucher_no" value="<?php echo e($rvvoucher['voucher_no']); ?>" id="rv_voucher_no" autocomplete="off" class="form-control">
										</td>
										<td width="20%">
											<span class="small">Debit Account</span>
											<input type="text" name="rv_dr_account" id="rv_dr_account" autocomplete="off" class="form-control" value="<?php echo e($rvvoucher['account_name']); ?>">
											<input type="hidden" id="rv_dr_account_id" name="rv_dr_account_id" value="<?php echo e($rvvoucher['id']); ?>">
										</td>
										<td width="15%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_rental')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('sales_rental/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('si-history'))) : ?>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('sales_rental/checkvchrno/')); ?>"; //CHNG
	var urlcode = "<?php echo e(url('sales_rental/checkrefno/')); ?>";
...
$(function() {	
	...
	$('#sales_location').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_rental/getsaleloc/')); ?>/" + loc_id, function(data) {
			if(data) {
...
//	$('#department_id').on('change', function(e){ 
	...
	//	dptTxt = $( "#department_id option:selected" ).text();
	//	console.log(dept_id);
	//	$.get("<?php echo e(url('sales_rental/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	//	
...
//	});
	...
	$('#voucher_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('sales_rental/getvoucher/')); ?>/" + vchr_id, function(data) { 
	...
	var supurl = "<?php echo e(url('sales_rental/salesman_data/')); ?>";
	...
	var ordhisurl = "<?php echo e(url('sales_rental/order_history/')); ?>";
	...
	$('#document_type').on('change', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('sales_rental/set_session/')); ?>",
			type: 'post',
	...
	$(document).on('focus', '#customer_trn', function(e) { 
		...
		$.get("<?php echo e(url('sales_rental/get_trnno/')); ?>/" + name, function(data) { //console.log(data);
	...
	$('.cust-history').click(function() {
		var hisurl = "<?php echo e(url('sales_rental/cust_history/')); ?>";
	...
	$('.cust-history-phone').click(function() {
		var phisurl = "<?php echo e(url('sales_rental/cust_history_phone/')); ?>";
		var phone = $('#customer_phone').val();
	...
	///Customer search...
	var srccust = "<?php echo e(url('sales_rental/ajax_customer/')); ?>";
