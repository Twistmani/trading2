                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="table5">
                                    ...
                                    <tr>
										...
										<td><?php echo e($po->net_amount); ?></td>
...
function setTransfer() {
	...
	if(curl=='SDO')
		url = "<?php echo e(url('suppliers_do/add/')); ?>/"+items+"/PO";
	else
		url = "<?php echo e(url('purchase_invoice/add/')); ?>/"+items+"/PO";
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('purchase_order/item_details/')); ?>";
