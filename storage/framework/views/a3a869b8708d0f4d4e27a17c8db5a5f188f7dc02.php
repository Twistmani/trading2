                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										<?php foreach($jobpos as $row): ?>
										<tr>
											<td><input type="checkbox" name="quotaion[]" value="<?php echo e($row->id); ?>"/></td>
											<td><?php echo e($row->voucher_no); ?></td>
											<td><?php echo e(date('d-m-Y',strtotime($row->voucher_date))); ?></td>
											<td><?php echo e($row->description); ?></td>
											<td><?php echo e($row->net_total); ?></td>
											<td><a href="#" class="quot-data" data-id="<?php echo e($row->id); ?>" data-name="<?php echo e($row->voucher_no); ?>" data-toggle="modal" data-target="#quot_modal">View Items</a></td>
...
function setTransfer() {
	...
	var url = "<?php echo e(url('sales_order/poadd/')); ?>/"+items;
