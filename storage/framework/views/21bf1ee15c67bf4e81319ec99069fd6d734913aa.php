...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link type="text/css" href="<?php echo e(asset('assets/css/buttons_sass.css')); ?>" rel="stylesheet">
    <link type="text/css" href="<?php echo e(asset('assets/css/advbuttons.css')); ?>" rel="stylesheet">
    								...
    								<div class="col-md-12">
    									...
    									<div class="panel-body">
    										...
    										<div class="flatbuttons_small">
    										 ...
    										 <?php /*<div class="flatbuttons_small">
                                                <ul>
...
function InventoryLogUpdate(doc) {
    document.frmUtility.action="<?php echo e(url('utilities/inventory-log-update')); ?>/"+doc;
	document.frmUtility.submit();
}

function updateStock() {
	document.frmUtility.action="<?php echo e(url('utilities/update/stock')); ?>";
	document.frmUtility.submit();
}

function updateStockLocation() {
	document.frmUtility.action="<?php echo e(url('utilities/update/stockLoc')); ?>";
	document.frmUtility.submit();
}


function updateAvgCost() {
	document.frmUtility.action="<?php echo e(url('utilities/update/avgcost')); ?>";
	document.frmUtility.submit();
}

function updateCA() {
	document.frmUtility.action="<?php echo e(url('utilities/update/CA')); ?>";
	document.frmUtility.submit();
}

function updateCOS(doc) {
    document.frmUtility.action="<?php echo e(url('utilities/update-cos')); ?>/"+doc;
	document.frmUtility.submit();
}

function updateSIH(doc) {
    document.frmUtility.action="<?php echo e(url('utilities/update-sih')); ?>/"+doc;
	document.frmUtility.submit();
}
