                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurReturn" id="frmPurReturn" action="<?php echo e(url('purchase_return/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="voucher_no" value="<?php echo $vouchers[0]['voucher_no']; ?>" readonly name="voucher_no">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="purchase_invoice_no" name="purchase_invoice_no" value="<?php echo e($pino); ?>" autocomplete="off" onclick="getPurchaseInvoice(this)">
										<input type="hidden" class="form-control" id="purchase_invoice_id" name="purchase_invoice_id" value="<?php echo e($piid); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" value="<?php echo e($orderrow->supplier); ?>">
										<input type="hidden" name="supplier_id" id="supplier_id" value="<?php echo e($orderrow->supplier_id); ?>">
									</div>
                                </div>
								...
								<?php if($formdata['reference_no']==1) { ?>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" value="<?php echo e($orderrow->reference_no); ?>" name="reference_no" placeholder="Reference No.">
										</div>
									</div>
								<?php } else { ?>
								...
								<?php /**/ $i = 0; $num = count($pitems); $total = $vattotal = $nettotal = $nettotal_dh = $total_dh = $vattotal_dh = 0; /**/ ?>
								...
								<div class="itemdivPrnt">
									<?php if(old('item_code')) { $i = 0; 
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
												<input type="hidden" name="purchase_invoice_item_id[]" id="p_invitmid_<?php echo e($j); ?>" value="<?php echo e(old('purchase_invoice_item_id')[$i]); ?>">
												...
												<td width="8%">
													<input type="hidden" name="actual_cost[]" id="itmactcst_<?php echo e($j); ?>" value="<?php echo e(old('actual_cost')[$i]); ?>"> 
											...
											<div id="moreinfo" style="float:left; padding-right:5px;">
												<button type="button" id="moreinfoItm_<?php echo e($j); ?>" class="btn btn-primary btn-xs more-info">More Info1</button>
											</div>
									...
									<?php 
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<input type="hidden" name="purchase_invoice_item_id[]" id="p_invitmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
												<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($item->item_id); ?>">
												<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" value="<?php echo e($item->item_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#item_modal" value="<?php echo e($item->item_code); ?>">
												</td>
												<td width="24%">
												...
												<td width="7%">
													...
													<?php endif; ?>
												<td width="8%">
													<input type="hidden" name="actual_quantity[]" id="itmactqty_<?php echo e($i); ?>" value="<?php echo e(($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity); ?>">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" class="form-control line-quantity" min="1" value="<?php echo e(($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity); ?>" ><!--NOV24-->
												</td>
												<td width="8%">
													<input type="hidden" name="actual_cost[]" id="itmactcst_<?php echo e($i); ?>" value="<?php echo e($unit_price); ?>">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" class="form-control line-cost" value="<?php echo e($unit_price); ?>">
												</td>
												<td width="6%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control cost" value="<?php echo e($item->vat.'% - '.$vat_amount); ?>"><!--<div class="h5" id="vatdiv_1"></div>--> 
													<input type="hidden" id="vat_<?php echo e($i); ?>" name="line_vat[]" class="form-control cost" value="<?php echo e($item->vat); ?>">
													...
													<input type="hidden" id="itmdsnt_<?php echo e($i); ?>" step="any" name="line_discount[]" class="form-control line-discount" placeholder="Discount">
												</td>
												<td width="11%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span> <input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" value="<?php echo e((old('total_fc'))?old('total_fc'):$orderrow->total); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" name="pi_amount" value="<?php echo e((old('pi_amount')?old('pi_amount'):$orderrow->is_fc==1)?$orderrow->net_amount_fc:$orderrow->net_amount); ?>">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="<?php echo e((old('net_amount_fc'))?old('net_amount_fc'):$orderrow->net_amount); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								<hr/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_return')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	$(document).on('blur', '#purchase_invoice_no', function(e) { 
		...
		if(id!='') {
			var urlcode = "<?php echo e(url('purchase_invoice/check_invoice/')); ?>";
			$.ajax({
				url: urlcode,
	...
	$(document).on('change', '.line-unit', function(e) {
		...
		var res = this.id.split('_');
		var curNum = res[1];
		$.get("<?php echo e(url('itemmaster/get_vat/')); ?>/" + unit_id, function(data) {
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('purchase_return/checkvchrno/')); ?>", 
			type: 'get',
...
function getPurchaseInvoice(e) {
	if(e.value=='') { 
		var ht = $(window).height();
		var wt = $(window).width();
		var pourl = "<?php echo e(url('purchase_invoice/pi_data/')); ?>";
