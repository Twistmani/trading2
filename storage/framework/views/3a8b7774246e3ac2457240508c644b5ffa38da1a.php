                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('pi-print'))) : ?>
							 <a href="<?php echo e(url('sales_split/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplit" id="frmSalesSplit" action="<?php echo e(url('sales_split/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="sales_split_id" id="sales_split_id" value="<?php echo e($orderrow->id); ?>">
								<input type="hidden" name="voucher_id" value="<?php echo e($orderrow->voucher_id); ?>">
								<input type="hidden" name="is_pettycash" value="<?php echo e($orderrow->is_pettycash); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="SS. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<!--	<div class="col-xs-8">
												<span class="small">Customer Name</span> <input type="text" id="suppliername" name="suppliername" value="<?php echo e($orderrow->customer_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#newsupplier_modal">
											</div>-->
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         <input type="text" name="jobname" id="jobname" class="form-control" autocomplete="off" data-toggle="modal" data-target="#jobb_modal" value="<?php echo e($orderrow->code); ?>">
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="16%">
														...
														<input type="hidden" name="account_id[]" id="acntid_<?php echo e($i); ?>" value="<?php echo e($item->account_id); ?>">
														<input type="text" id="accod_<?php echo e($i); ?>" name="ac_code[]" class="form-control" autocomplete="off" value="<?php echo e($item->master_name); ?>" data-toggle="modal" data-target="#ac_modal" placeholder="A/C Name">
													</td>
													<td width="29%">
														<input type="text" name="item_description[]" id="acdes_<?php echo e($i); ?>" autocomplete="off" class="form-control" value="<?php echo e($item->item_description); ?>">
													</td>
													<td width="8%">
														<input type="hidden" name="jobid[]" id="jobid_<?php echo e($i); ?>" value="<?php echo e($item->item_jobid); ?>">
														<input type="text" id="jobcod_<?php echo e($i); ?>" autocomplete="off" name="jobcod[]" class="form-control" value="<?php echo e($item->jobcode); ?>" autocomplete="off" data-toggle="modal" data-target="#job_modal" placeholder="Jobcode">
													</td>
													<td width="7%">
														<select id="itmunt_<?php echo e($i); ?>" class="form-control select2 line-unit" style="width:100%" name="unit_id[]">
														<?php foreach($units as $unit): ?>
														<?php  $sel = ($unit->unit_name==$item->unit_id)?'selected':'';  ?>
														<option id="<?php echo e($unit->id); ?>" <?php echo e($sel); ?>><?php echo e($unit->unit_name); ?></option>
														<?php endforeach; ?>
													</td>
													<td width="5%">
														<input type="hidden" name="actual_quantity[]" id="itmactqty_<?php echo e($i); ?>" value="<?php echo e($item->quantity); ?>">
														<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off"step="any"  name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
													</td>
													<td width="8%">
														<input type="number" id="itmcst_<?php echo e($i); ?>" autocomplete="off" step="any" name="cost[]" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" value="<?php echo e(($orderrow->is_fc==1)?$item->unit_price_fc:$item->unit_price); ?>">
													</td>
													<td width="6%">
													...
													<td width="9%">
														<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '); ?><?php echo e(($orderrow->is_fc==1)?$item->item_vat_fc:$item->item_vat); ?>">
													...
													<td width="11%">
														<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" class="form-control line-total" readonly value="<?php echo e(($orderrow->is_fc==1)?$item->item_total_fc:$item->item_total); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span><input type="text" id="total_fc" step="any" name="total_fc" class="form-control spl" value="<?php echo e((old('total_fc'))?old('total_fc'):$orderrow->total); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_split')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('sales_split/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('sales_split/checkrefno/')); ?>";
...
$(function() {	
	...
	$('#department_id').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_split/getdeptvoucher/')); ?>/" + dept_id, function(data) {  console.log(data);
    ...
    { 
		...
		var jobburl = "<?php echo e(url('jobmaster/jobb_data/')); ?>";
	...
	var acturl = "<?php echo e(url('sales_split/account_data/')); ?>";
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_split/getvoucher/')); ?>/" + vchr_id, function(data) { //console.log(data);
...
function getAccount(e) { 
	...
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('purchase_split/cash_data/')); ?>/sales";
