            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmReportSearch" id="frmReportSearch" action="<?php echo e(url('voucherwise_report/print')); ?>" target="_blank">
								<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<div class="row">
									<div class="col-xs-6">
										<span>Date From:</span>
										<input type="text" name="date_from" value="<?php echo e($datefrom); ?>" data-language='en' id="date_from" class="form-control" autocomplete="off">
										<span>Date To:</span>
										<input type="text" name="date_to" data-language='en' value="<?php echo e($dateto); ?>" id="date_to" class="form-control" autocomplete="off">
									</div>
									<div class="col-xs-6">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('account_master/delete/')); ?>";
	 location.href = url+'/'+id;
	}
}

function preview() {
	document.frmReportSearch.action = "<?php echo e(url('voucherwise_report/print')); ?>";
