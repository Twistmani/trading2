        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
               ...
               <div class="panel-body" style="width:100%; !important; border:0px solid red;">
									...
									<tr style="border:0px solid black;">
										<td colspan="2" align="center">
												...
												<?php	$bl_total+=$row->balance; ?>
													...
													<tr style="background-color: #f0f0f0; font-weight: bold;">
                                                     <?php 
														...
														?>
														<td><?php echo e($row->categories); ?></td>
														<td></td>
														
													<!--	<td class="emptyrow text-right"><?php echo e(number_format($row->debit,2)); ?></td>
														<td class="emptyrow text-right"><?php echo e(number_format($row->credit,2)); ?></td>-->
														<td class="emptyrow text-right"><?php echo e(number_format($row->balance,2)); ?></td>
													</tr>
													<?php } ?>
													<?php endforeach; ?>
												...
												<tr style="background-color:#ccc">
													...
													<tr style="background-color:#ccc">
														...
														<td class="emptyrow text-right"><strong>Net Cash In Hand :</strong></td>
															<td class="emptyrow text-right"><strong><?php echo e(number_format($bl_total,2)); ?></strong></td>
													</tr>
													</tbody>
												</table>
											...
											<?php }else if($type == 'Details' ) {  ?>
											 <?php $net_total = 0; ?>
											<?php foreach($results as $category =>$rows): ?>
                                                   <h4><strong><?php echo e($category); ?></strong></h4>
                                                     <table border="1" class="table table" cellpadding="5" cellspaching="0">
													<thead>
													<tr style="background-color:#ccc">
														<th>
													...
													?>
                                                      ...
                                                      <tr style="background-color: #f0f0f0; font-weight: bold;">
														...
														<td class="emptyrow text-right"><strong>Total :</strong></td>
															<td class="emptyrow text-right"><strong><?php echo e(number_format($total,2)); ?></strong></td>
													</tr>
                                                  ...
                                                  <?php 
                                                   ...
                                                   <table class="table table">
														...
														<td class="emptyrow text-right"><strong>Net Cash In Hand :</strong></td>
															<td class="emptyrow text-right"><strong><?php echo e(number_format($net_total,2)); ?></strong></td>
													</tr>
												</table>	
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('cash_inhand/export')); ?>">
						...
						<input type="hidden" name="selectedcategory" value="<?php echo e($selectedcategories); ?>" >
