                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							...
							<a href="<?php echo e(url('customer_receipt/add-rv')); ?>" class="btn btn-primary btn-sm">
									<span class="btn-label">
									<i class="glyphicon glyphicon-plus"></i>
								</span> Multi Entry
							</a>
                            <?php endif; ?>
                             <a href="<?php echo e(url('customer_receipt/add')); ?>" class="btn btn-primary btn-sm">
									<span class="btn-label">
									<i class="glyphicon glyphicon-plus"></i>
								</span> Add New
							</a>
...
$(function() {
		...
		var dtInstance = $("#tableRVlist").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('customer_receipt/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
