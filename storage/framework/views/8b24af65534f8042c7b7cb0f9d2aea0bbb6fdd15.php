                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="#" class="quot-data" data-id="<?php echo e($quotation->id); ?>" data-name="<?php echo e($quotation->voucher_no); ?>" data-toggle="modal" data-target="#quot_modal"><?php echo e($quotation->prefix.$quotation->voucher_no); ?></a></td>
...
function setTransfer() {
	...
	var curl = $('#url').val();
	if(curl=='so')
		url = "<?php echo e(url('job_order/add/')); ?>/"+items+"/SO";
	else if(curl=='cdo')
		...
		url = "<?php echo e(url('job_invoice/add/')); ?>/"+items+"/QS";
