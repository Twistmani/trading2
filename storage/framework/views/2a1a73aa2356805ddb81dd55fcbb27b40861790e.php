                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<div class="pull-right">
							 ...
							 <a href="<?php echo e(url('manufacture/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmManufacture" id="frmManufacture" action="<?php echo e(url('manufacture/update/'.$mid)); ?>">
									 ...
									 <div class="col-sm-10">
									   <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
										   <?php foreach($vouchers as $voucher): ?>
											<option value="<?php echo e($voucher['id']); ?>" <?php echo ($orderrow->voucher_id==$voucher['id'])?'selected':'';?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" data-language='en'  id="voucher_date" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" placeholder="STI. Date"/>
                                    </div>
                                </div>
								...
								<div id="trinDV">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="debit_account" id="account_dr_name" class="form-control" readonly value="<?php echo e($mfgrow->dr_name); ?>">
											<input type="hidden" name="account_dr" id="account_dr_id" class="form-control" value="<?php echo e($mfgrow->account_dr); ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="credit_account" id="account_cr_name" class="form-control" readonly value="<?php echo e($mfgrow->cr_name); ?>">
											<input type="hidden" name="account_cr" id="account_cr_id" class="form-control" value="<?php echo e($mfgrow->account_dr); ?>">
										</div>
									</div>
								</div>
								...
								<div id="troutDV">							
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Debit Account</label>
										<div class="col-sm-10">
											<input type="hidden" name="account_dr_to" id="account_dr_id" value="<?php echo e($mfgrow->account_dr_to); ?>" class="form-control">
											<input type="text" name="purchase_account_to" id="account_dr_name_to" class="form-control" value="<?php echo e($mfgrow->dr_name_to); ?>" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										<label for="input-text" class="col-sm-2 control-label">Credit Account</label>
										<div class="col-sm-10">
											<input type="hidden" name="account_cr_to" id="account_cr_id_to" value="<?php echo e($mfgrow->account_dr_to); ?>" class="form-control">
												<input type="text" name="purchase_account_to" id="account_cr_name_to" class="form-control" value="<?php echo e($mfgrow->cr_name_to); ?>" readonly>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" autocomplete="off" value="<?php echo e($orderrow->description); ?>" placeholder="Description">
                                    </div>
                                </div>
								 <?php } else { ?>
								...
								<?php foreach($orditems as $key => $item): ?>
								<?php /**/ $i++; /**/ ?>
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
												<tr>
													<td width="16%" >
														<input type="hidden" name="transfer_item_id[]" id="ltitmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
														<input type="hidden" name="mf_item_id[]" id="mfitmid_<?php echo e($i); ?>" value="<?php echo e($mfitems[$key]->id); ?>">
														<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($item->item_id); ?>">
														
														<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" data-toggle="modal" data-target="#item_modal" placeholder="Item Code" value="<?php echo e($item->item_code); ?>">
													</td>
													<td width="29%">
														<input type="text" name="item_name[]" id="itmdes_<?php echo e($i); ?>" autocomplete="off" class="form-control" value="<?php echo e($item->item_name); ?>" placeholder="Item Description">
													</td>
													<td width="7%">
														<select id="itmunt_<?php echo e($i); ?>" class="form-control select2 line-unit" style="width:100%" name="unit_id[]"><option value="<?php echo e($item->unit_id); ?>"><?php echo e($item->unit_name); ?></option></select>
													</td>
													<td width="8%" class="itcod">
														<input type="hidden" name="actual_quantity[]" id="itmactqty_<?php echo e($i); ?>" value="<?php echo e($item->quantity); ?>">
														<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off" name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>" placeholder="Qty.">
													</td>
													<td width="8%">
														<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:$item->packing); ?>">
														<input type="number" id="itmcst_<?php echo e($i); ?>" value="<?php echo e($item->price); ?>" autocomplete="off" step="any" name="cost[]" class="form-control line-cost" placeholder="Cost/Unit">
													</td>
													<td width="11%">
														<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" value="<?php echo e($item->item_total); ?>" class="form-control line-total" readonly placeholder="Total">
														<input type="hidden" id="itmtot_<?php echo e($i); ?>" name="item_total[]">
														<input type="hidden" name="actcost[]" id="itmcsthd_<?php echo e($i); ?>">
													</td>
													<td width="1%">
													<?php if($num==$i): ?>
											...
											<div id="moreinfo" style="float:left;padding-right:5px;">
												<button type="button" id="rawmat_<?php echo e($i); ?>" class="btn btn-primary btn-xs raw-mat">Raw Materials</button>
											</div>
											<?php } else { ?>
											...
											<div id="admoreinfo" style="float:left;padding-right:5px;">
												<button type="button" id="adrawmat_<?php echo e($i); ?>" class="btn btn-primary btn-xs ad-raw-mat">Add Raw Materials</button>
											</div>
												<?php } else { ?>
											...
											<div class="rawmatPrntItm" id="rawmatPrntItm_<?php echo e($i); ?>" style="float:left;padding-right:5px;padding-top:2px;">
												<div class="rawmatChldItm">							
													<div class="table-responsive rawmat-data" id="rawmatData_<?php echo e($i); ?>"></div>
												</div>
											</div>
											
											<div id="rMat_<?php echo e($i); ?>" class="rMat" style="float:right;padding-left:195px;padding-top:2px;">
												<fieldset>
												<legend style="margin-bottom:0px !important;"><h5><span class="itmDtls">New Raw Materials</span></h5></legend>
													...
													<table border="0" class="table-dy-row">
														<tr>
															<td width="16%">
																<input type="hidden" id="rmitmid_<?php echo e($i); ?>" name="rmitem_id[]">
																<input type="text" id="rmitmcod_<?php echo e($i); ?>" name="rmitemcode[]" class="form-control" autocomplete="off" placeholder="Item Code" data-toggle="modal" data-target="#rmitem_modal">
															</td>
															<td width="29%">
																<input type="text" name="rmitem_name[]" id="rmitmdes_<?php echo e($i); ?>" autocomplete="off" class="form-control" placeholder="Item Description">
															</td>
															<td width="8%">
																<input type="number" id="rmitmqty_<?php echo e($i); ?>" step="any" name="rmquantity[]" autocomplete="off" class="form-control rmline-quantity" placeholder="Qty.">
															</td>
															<td width="8%">
																<input type="number" id="rmitmcst_<?php echo e($i); ?>" step="any" name="rmcost[]" autocomplete="off" class="form-control rmline-cost" placeholder="Cost/Unit">
															</td>
															<td width="11%">
																<input type="number" id="rmitmttl_<?php echo e($i); ?>" step="any" name="rmline_total[]" class="form-control rmline-total" readonly placeholder="Total">
																<input type="hidden" id="rmitmtot_<?php echo e($i); ?>" name="rmitem_total[]">
															</td>
															<td width="1%">
																 <button type="button" id="rmbtn_<?php echo e($i); ?>" class="btn-success btn-add-rmitem">
								...
								<fieldset>
									...
									<input type="hidden" id="ocrowNum" value="<?php echo e(($ocnum==0)?1:$ocnum); ?>">
									<div class="OCdivPrnt">
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="15%">
														...
														<input type="hidden" name="dr_acnt_id[]" id="dracntid_<?php echo e($i); ?>" value="<?php echo e($row->dr_account_id); ?>">
														<input type="hidden" name="cur_dr_acnt_id[]" id="curdracntid_<?php echo e($i); ?>" value="<?php echo e($row->dr_account_id); ?>">
													...
													<td width="12%">
														...
														<input type="text" name="oc_reference[]" id="ocref_<?php echo e($i); ?>" value="<?php echo e($row->reference); ?>" autocomplete="off" class="form-control" placeholder="Reference">
													</td>
													<td width="15%">
														<span class="small">Description</span>
														<input type="text" name="oc_description[]" id="ocdesc_<?php echo e($i); ?>" value="<?php echo e($row->description); ?>" autocomplete="off" class="form-control" placeholder="Description">
													</td>
													<td width="8%">
														<span class="small">Amount</span>
														<input type="number" name="oc_amount[]" step="any" id="ocamt_<?php echo e($i); ?>" value="<?php echo e($row->amount); ?>" autocomplete="off" class="form-control oc-line" placeholder="Amount">
													</td>
													<td width="18%">
														<span class="small">Credit Account</span>
														<input type="hidden" name="cr_acnt_id[]" id="cracntid_<?php echo e($i); ?>" value="<?php echo e($row->cr_account_id); ?>">
														<input type="hidden" name="cur_cr_acnt_id[]" id="curcracntid_<?php echo e($i); ?>" value="<?php echo e($row->cr_account_id); ?>">
								...
								<fieldset>
									...
									<div id="weData_1">
									<?php  $wenum = count($werow);  ?>
									<?php if(count($werow) > 0): ?>
									<div class="col-xs-10">
										<table class="table table-bordered table-hover">
											...
											<tbody>
											<?php  $i=0;  ?>   
											<?php foreach($werow as $row): ?>
											<?php  $i++;  ?>
											<tr>
												<td><input type="hidden" name="weid[]" value="<?php echo e($row->id); ?>"> <?php echo e($row->item_code); ?> <input type="hidden" name="weitem[]" value="<?php echo e($row->item_id); ?>"></td>
												<td><?php echo e($row->description); ?></td>
												<td><input type="text" name="wqty[]" id="wqty_<?php echo e($i); ?>" class="we-qty" value="<?php echo e($row->quantity); ?>"></td>
												...
												<td><input type="text" name="weqtytot[]" id="wqtytot_<?php echo e($i); ?>" value="<?php echo e($row->total); ?>"></td>
											</tr>
											<?php endforeach; ?>
											</tbody>
										</table>
								...
								<hr/>
								<input type="hidden" id="other_cost" name="other_cost" value="<?php echo e($mfgrow->other_cost); ?>">
								<input type="hidden" id="total_hd" step="any" name="total_hd" value="<?php echo e(($mfgrow->amount-$mfgrow->other_cost)); ?>">
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e($orderrow->total_amt); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="total_price" class="form-control spl" readonly value="<?php echo e($orderrow->total_amt); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
										</div>
									</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('location_transfer')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('location_transfer/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('location_transfer/checkrefno/')); ?>";
	...
	/* function getAutoPrice(curNum) {
		...
		$.ajax({
			url: "<?php echo e(url('itemmaster/get_item_cost_avg/')); ?>",  //get_sale_cost_avg
			type: 'get',
	...
	function getAutoPrice(curNum) {
		...
		$.ajax({
			url: "<?php echo e(url('itemmaster/get_cost_avg_mfg/')); ?>",
			type: 'get',
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('manufacture/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	//raw materials............
	var rmitmurl = "<?php echo e(url('itemmaster/rmitem_data/')); ?>";
	...
	var itmurlrw = "<?php echo e(url('itemmaster/item_data_rw/')); ?>";
	...
	$(document).on('click', '.btn-add-rmitem', function(e) {
		...
		if(rmi!='' && sitmid!='' && qty!='' && cst!='') {
			...
			$.ajax({
				url: "<?php echo e(url('itemmaster/add_rawmaterial/')); ?>",
				type: 'post',
	...
	$(document).on('click', '.raw-mat', function(e) { 
	   ...
	   var item_id = $('#itmid_'+curNum).val();
	   if(item_id!='') {
		   var rwUrl = "<?php echo e(url('itemmaster/get_rawmat/')); ?>/"+item_id;
