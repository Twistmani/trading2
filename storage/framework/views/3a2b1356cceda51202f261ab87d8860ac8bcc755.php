                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmWageEntry" id="frmWageEntry" action="<?php echo e(url('wage_entry/save')); ?>">
								...
								<!--<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="payment_date" data-language='en' readonly id="payment_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>-->
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-4">
										<input type="number" id="otg_net" step="any" name="otg_net" class="form-control" value="<?php echo e($parameter->ot_general); ?>" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-4">
										<input type="number" id="oth_net" step="any" name="oth_net" class="form-control" value="<?php echo e($parameter->ot_holiday); ?>" readonly>
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         <a href="<?php echo e(url('wage_entry')); ?>" class="btn btn-danger">Cancel</a>
										 <a href="<?php echo e(url('wage_entry/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () {
	...
	var urldesc = "<?php echo e(url('employee/checkdesc/')); ?>";
	...
	$('#payment_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
});
...
$(function() {	
	...
	var empurl = "<?php echo e(url('employee/employee_data/')); ?>";
	...
	var et = $('#entry_type option:selected').val();
	   ...
	   var url = "<?php echo e(url('employee/get_employee/')); ?>/"+$(this).attr("data-id")+"/"+et+"/"+yr+"/"+mh;
	   ...
	   $.get("<?php echo e(url('employee/get_empdata/')); ?>/" + $(this).attr("data-id"), function(data) { console.log(data);
