                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotation" id="frmQuotation" enctype="multipart/form-data" action="<?php echo e(url('quotation/save')); ?>">
...
$(function() {	
    ...
    $(document).on('click', '#importFile', function(e) { 
		if($('#input-23').val()=='') {
			...
			$('#frmQuotation').attr('action', "<?php echo e(url('quotation/import')); ?>").submit();
		}
	});
...
function getEnquiry() { 
	...
	var wt = $(window).width();
	var supplier_id = $("#supplier_id").val();
	var pourl = "<?php echo e(url('material_requisition/get_enquiry/')); ?>/"+supplier_id+"/PO";
...
function getQuotation() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('quotation/get_quotations/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
