										...
										<td colspan="2" align="center">
                                           <table border="1" cellpadding="5" cellspacing="0" class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach($grouped as $group => $amounts): ?>
                                                        <tr>
                                                            <td><?php echo e($group); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($amounts['debit'], 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($amounts['credit'], 2)); ?></td>
                                                        </tr>
                                                        <?php 
