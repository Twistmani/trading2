					 ...
					 <table class="table horizontal_table table-striped" id="tblJobbs">
						...
						<tbody>
						   <?php foreach($jobs as $job): ?>
							 <tr>
								<td><a href="" class="jobbRow" data-id="<?php echo e($job['id']); ?>" data-name="<?php echo e($job['name']); ?>" data-cod="<?php echo e($job['code']); ?>" data-dismiss="modal"><?php echo e($job['code']); ?></a></td>
								<td><a href="" class="jobbRow" data-id="<?php echo e($job['id']); ?>" data-name="<?php echo e($job['name']); ?>" data-cod="<?php echo e($job['code']); ?>" data-dismiss="modal"><?php echo e($job['name']); ?></a></td>
								<td><?php echo e($job['master_name']); ?></td>
							</tr>
							<?php endforeach; ?>
						 </tbody>
					</table>
						...
						<div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select id="customer_id" class="form-control select2" style="width:100%" name="customer_id">
												...
												<?php foreach($customers as $con): ?>
												<option value="<?php echo e($con->id); ?>"><?php echo e($con->master_name); ?></option>
												<?php endforeach; ?>
										</select>
                                    </div>
                        </div>
...
$(function() {
    ...
    $('#createnew').on('click', function(e) { 
        ...
        if(name=="") {
            ...
            $.ajax({
                url: "<?php echo e(url('jobmaster/ajax_create/')); ?>",
                type: 'get',
