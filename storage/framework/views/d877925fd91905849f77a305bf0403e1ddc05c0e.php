                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('so-print'))) : ?>
							 <a href="<?php echo e(url('sales_order/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
							<form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="<?php echo e(url('sales_order/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="sales_order_id" id="sales_order_id" value="<?php echo e($orderrow->id); ?>">
								<?php if($modwork==1) { ?>
								<input type="hidden" name="is_revice" value="<?php echo e($orderrow->job_type); ?>">
								<input type="hidden" name="parent_id" value="<?php echo e($orderrow->fabrication); ?>">
								<?php } ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" data-language='en' autocomplete="off"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="jobtype" class="form-control select2" style="width:100%" name="jobtype">
                                            <option value="0" <?php echo e(($orderrow->job_type==0)?'selected': ''); ?>>No</option>
                                            <option value="1" <?php echo e(($orderrow->job_type==1)?'selected': ''); ?>>Yes</option>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group parnt-job">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="parent_job" id="select22" style="width:100%" />
											<option value="<?php echo e($orderrow->fabrication); ?>"><?php echo e($orderrow->items_inside); ?></option>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="quotation_no" readonly name="quotation_no" placeholder="Quotation No" autocomplete="off" value="<?php echo e($orderrow->qsno); ?>">
                                        <input type="hidden" id="quotation_id" name="quotation_id" value="<?php echo e($orderrow->qutation_id); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>" <?php if($term['id']==$orderrow->terms_id) echo 'selected'; ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="order_type" class="form-control select2" style="width:100%" name="order_type">
											...
											<option value="Tr"  <?php echo e(($orderrow->order_type=='Tr')?'selected': ''); ?>>Trading</option>
											<option value="Pr"  <?php echo e(($orderrow->order_type=='Pr')?'selected': ''); ?> >Production</option>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e($orderrow->currency_rate); ?>" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" data-toggle="modal" data-target="#item_modal" value="<?php echo e($item->item_code); ?>">
												</td>
												<td width="29%">
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>" <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?>>
													<input type="hidden" name="max_quantity[]" id="itmaxqty_<?php echo e($i); ?>" value="<?php echo e($max_quantity); ?>"><!--APR25-->
												</td>
												<td width="8%"> 
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" autocomplete="off" class="form-control line-cost" value="<?php echo e($unit_price); ?>" <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?>>
												</td>
												<td width="6%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e((old('total')?old('total'):$orderrow->is_fc==1)?$orderrow->total_fc:$orderrow->total); ?>">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" value="<?php echo e((old('subtotal_fc'))?old('subtotal_fc'):$orderrow->subtotal); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="footermsg" name="footer" placeholder="Footer" value="<?php echo e($orderrow->footer_text); ?>" autocomplete="off" data-toggle="modal" data-target="#footer_modal">
                                    </div>
                                </div>
								<?php } else { ?>
									<input type="hidden" name="footer_id" id="footer_id">
								...
								<div class="infodivPrnt">
									...
									<div class="infodivChld">							
										<div class="form-group">
										    ...
										    <input type="hidden" name="infoid[]" value="<?php echo e($info->id); ?>" >
											<div class="col-xs-10">
												<div class="col-xs-5">
													<input type="text" name="title[]" value="<?php echo e($info->title); ?>" class="form-control" placeholder="Title">
												</div>
												<div class="col-xs-5">
													<input type="text" name="desc[]" class="form-control" value="<?php echo e($info->description); ?>" placeholder="Description">
												</div>
												<div class="col-xs-1">
													 <button type="button" class="btn btn-success btn-add-info" >
														<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
													 </button>
													 <button type="button" class="btn btn-danger btn-remove-info" data-id="<?php echo e($info->id); ?>">
														<span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
													  </button>
												</div>
											</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_order')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('sales_order/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('sales_order/checkrefno/')); ?>";
...
$(function() {	
	...
	var supurl = "<?php echo e(url('sales_order/salesman_data/')); ?>";
	...
	$('#customer_name').on('blur', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('sales_order/set_session/')); ?>",
			type: 'get',
	...
	$("#select22").select2({
		...
		ajax: { 
         url: "<?php echo e(url('sales_order/get_orderno/')); ?>",
         type: "post",
         dataType: 'json',
         delay: 250,
	...
	$(document).on('change', '#select22', function(e) {  
		$.get("<?php echo e(url('sales_order/getcounter/')); ?>/" + $(this).val(), function(data) {
			data = $.parseJSON(data);
	...
	/*$(document).on('blur', 'input[name="item_name[]"]', function(e) {
		...
		$.get("<?php echo e(url('purchase_order/getunit/')); ?>", function(data) {
			$('#itmunt_'+rowNum).find('option').remove().end();
			$.each(data, function(key, value) {   
			$('#itmunt_'+rowNum).find('option').end()
			 .append($("<option></option>")
...
function getQuotation() { 
	...
	var wt = $(window).width();
	var customer_id = $("#customer_id").val();
	var pourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id+"/so";
