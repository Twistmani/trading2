                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pv-print'))) : ?>
								 <a href="<?php echo e(url('stock_transferin/print/'.$printid->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="<?php echo e(url('stock_transferin/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="account_dr" id="account_dr" value="<?php echo e($vouchers[0]->dr_account_master_id); ?>" class="form-control">
										
											<input type="text" name="debit_account" id="debit_account" class="form-control" value="<?php echo e($vouchers[0]->dr_master_name); ?>" readonly>
							...
							<?php endif; // Entrust::can ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="account_cr" id="account_cr" value="<?php echo e($vouchers[0]->cr_account_master_id); ?>" class="form-control">
										
											<input type="text" name="credit_account" id="credit_account" class="form-control" value="<?php echo e($vouchers[0]->master_name); ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('stock_transferin')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('stock_transferin/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('stock_transferin/checkrefno/')); ?>";
...
$(function() {	
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('stock_transferin/checkvchrno/')); ?>", 
			type: 'get',
