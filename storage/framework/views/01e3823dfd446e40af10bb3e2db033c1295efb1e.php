            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmPayrollReport" id="frmPayrollReport" action="<?php echo e(url('timesheet_payrollreport/search')); ?>" target="_blank">
