                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pi-print'))) : ?>
								 <a href="<?php echo e(url('purchase_invoice/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" enctype="multipart/form-data" action="<?php echo e(url('purchase_invoice/save')); ?>">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="department_id">
											<?php foreach($departments as $drow): ?>
												<option value="<?php echo e($drow->id); ?>" <?php echo e(($pideptid==$drow->id)?'selected':''); ?> ><?php echo e($drow->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
                                           <?php foreach($vouchers as $voucher): ?>
											<option value="<?php echo e($voucher['id']); ?>" <?php echo e(($pivchrid==$voucher['id'])?'selected':''); ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
										   ...
										   <?php if(old('voucher_id') && old('voucher_id')==$voucher['id']): ?>
											   <?php  $sel = 'selected';  ?>
										   <?php elseif($pivchrid): ?>==$voucher['id'])
												<?php  $sel = 'selected';  ?>
										   <?php else: ?>
											   <?php  $sel = '';  ?>
										   <?php endif; ?>
								...
								<div class="form-group">
                                 ...
                                 <font color="#16A085"><label for="input-text" class="col-sm-2 control-label <?php if($errors->has('reference_no')) echo 'form-error';?>"><b>Reference No.</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" name="reference_no" autocomplete="off" value="<?php echo e(old('reference_no')); ?>" placeholder="Reference No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="account_master_id" id="account_master_id" value="<?php echo e($vouchers[0]['dr_account_master_id']); ?>" class="form-control">
										<!--<input type="text" name="purchase_account" id="purchase_account" class="form-control" value="<?php echo e($voucher['account_id'].'-'.$voucher['master_name']); ?>" readonly onclick="getAccount(this)">-->
										<div class="input-group">

											<input type="text" name="purchase_account" id="purchase_account" class="form-control" value="<?php echo e($voucher['account_id'].'-'.$voucher['master_name']); ?>" readonly>
								...
								<div class="form-group" id="saleloc">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="sales_location" class="form-control select2" style="width:100%" name="sales_location">
											...
											?>
											<option value="<?php echo e($sloc->id); ?>"><?php echo e($sloc->name); ?></option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085">   <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('supplier_name')) echo 'form-error';?>"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" value="<?php echo e(old('supplier_name')); ?>" class="form-control <?php if($errors->has('supplier_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
										<input type="hidden" name="supplier_id" id="supplier_id" value="<?php echo e(old('supplier_id')); ?>">
										...
										<div class="col-xs-10" id="newsupplierInfo">
											<div class="col-xs-8">
												<span class="small">Supplier Name</span> <input type="text" id="suppliername" name="suppliername" value="<?php echo e(old('suppliername')); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#newsupplier_modal">
											</div>
										</div>
									</div>
                                </div>
								...
								<div class="form-group has-warning" id="trninfo">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="vat_no" autocomplete="off" name="vat_no" value="<?php echo e(old('vat_no')); ?>" placeholder="TRN No.">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo e(old('description')); ?>" autocomplete="off" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>" <?php if($term['id']==old('terms_id')) echo 'selected'; ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="location_id" class="form-control select2" style="width:100%" name="location_id">
											...
											if($loc->is_default==1)
												$is_default = 1;
											?>
											<option value="<?php echo e($loc['id']); ?>" <?php if($loc['id']==old('location_id')) echo 'selected'; ?>><?php echo e($loc['name']); ?></option>
											<?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										<div class="col-xs-1">
											...
											<input type="checkbox" class="custom_icheck" id="is_fc" name="is_fc" value="1" <?php if(old('is_fc')=="1"): ?> checked <?php endif; ?>>
										</label>
										</div>
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<option value="<?php echo e($curr['id']); ?>" <?php if($curr['id']==old('currency_id')) echo 'selected'; ?>><?php echo e($curr['code']); ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e(old('currency_rate')); ?>" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										<div class="col-xs-1">
											<label class="radio-inline iradio">
											<input type="checkbox" class="import" id="import" name="is_import" value="1" <?php if(old('is_import')=="1"): ?> checked <?php endif; ?>>
											</label>
										</div>
									</div>
                                </div>
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="16%" >
														...
														<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" value="<?php echo e($item); ?>" data-toggle="modal" data-target="#item_modal" placeholder="Item Code">
													</td>
													<td width="29%">
														<input type="text" name="item_name[]" id="itmdes_<?php echo e($j); ?>" value="<?php echo e(old('item_name')[$i]); ?>" autocomplete="off" class="form-control" placeholder="Item Description">
													</td>
													<td width="7%">
														<select id="itmunt_<?php echo e($j); ?>" class="form-control select2 <?php if($errors->has('unit_id.'.$i)) echo 'form-error';?> line-unit" style="width:100%" name="unit_id[]"><option value="<?php echo e(old('unit_id')[$i]); ?>"><?php echo e(old('unit_id')[$i]); ?></option></select>
													</td>
													<td width="8%" class="itcod">
														<input type="number" id="itmqty_<?php echo e($j); ?>" value="<?php echo e(old('quantity')[$i]); ?>" autocomplete="off" step="any" name="quantity[]" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" placeholder="Qty.">
													</td>
													<td width="8%">
														<input type="number" id="itmcst_<?php echo e($j); ?>" value="<?php echo e(old('cost')[$i]); ?>" autocomplete="off" step="any" name="cost[]" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" placeholder="Cost/Unit">
													</td>
													<td width="6%">
														<select id="taxcode_<?php echo e($j); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]">
														<option value="SR" <?php if(old('tax_code')[$i]=="SR"): ?> selected <?php endif; ?>>SR</option><option value="RC" <?php if(old('tax_code')[$i]=="RC"): ?> selected <?php endif; ?>>RC</option><option value="ZR" <?php if(old('tax_code')[$i]=="ZR"): ?> selected <?php endif; ?>>ZR</option><option value="EX" <?php if(old('tax_code')[$i]=="EX"): ?> selected <?php endif; ?>>EX</option></select>
													</td>
													<td width="6%">
														<select id="txincld_<?php echo e($j); ?>" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0" <?php echo e(($settings->pi_vat_inc==0) ? 'selected' : ''); ?>>No</option><option value="1" <?php echo e(($settings->pi_vat_inc==1) ? 'selected' : ''); ?>>Yes</option></select>
													</td>
													<td width="9%">
														...
														<input type="text" id="vatdiv_<?php echo e($j); ?>" value="<?php echo e(old('vatdiv')[$i]); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" placeholder="VAT Amount">
														<input type="hidden" id="vat_<?php echo e($j); ?>" name="line_vat[]" value="<?php echo e(old('line_vat')[$i]); ?>" class="form-control vat">
														<input type="hidden" id="vatlineamt_<?php echo e($j); ?>" value="<?php echo e(old('vatline_amt')[$i]); ?>" name="vatline_amt[]" class="form-control vatline-amt" value="0">
														<input type="hidden" id="itmdsnt_<?php echo e($j); ?>" name="line_discount[]" value="<?php echo e(old('line_discount')[$i]); ?>">
													</td>
													<td width="11%">
														<input type="number" id="itmttl_<?php echo e($j); ?>" step="any" name="line_total[]" value="<?php echo e(old('line_total')[$i]); ?>" class="form-control line-total" readonly placeholder="Total">
								...
								<?php if($formdata['net_cost']==1) { ?>
											<div id="othrcst" style="float:left;padding-right:5px;">
												<button type="button" id="ocost_<?php echo e($j); ?>" class="btn btn-primary btn-xs net-cost">Net Cost/Unit</button>
											</div>
											<?php } else { ?>
								...
								<div id="itmInfo">
									<button type="button" id="itmInfo_<?php echo e($j); ?>" class="btn btn-primary btn-xs">Dimension</button>
								</div>
									<?php } else { ?>
								<input type="hidden" name="dimension" id="dimension">
								<?php } ?>
											<div class="form-group oc" id="othrcstItm_<?php echo e($j); ?>">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-2">
														<span class="small">Other Cost/Unit</span> <input type="text" id="othrcst_<?php echo e($j); ?>" value="<?php echo e(old('othr_cost')[$i]); ?>" step="any" name="othr_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-2">
														<span class="small">Net Cost/Unit</span> <input type="text" id="netcst_<?php echo e($j); ?>" step="any" value="<?php echo e(old('net_cost')[$i]); ?>" name="net_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-1">
										...
										<?php $i++; } } else { ?>
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<?php endif; ?>
													<td width="8%" class="itcod">
														<input type="number" id="itmqty_1" autocomplete="off" step="any" name="quantity[]" class="form-control line-quantity" placeholder="Qty." <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>><!--NOV24-->
													</td>
													<td width="8%">
													...
													<td width="6%">
														<select id="txincld_1" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0" <?php echo e(($settings->pi_vat_inc==0) ? 'selected' : ''); ?>>No</option><option value="1" <?php echo e(($settings->pi_vat_inc==1) ? 'selected' : ''); ?>>Yes</option></select>
													</td>
													<td width="9%">
								...
								<fieldset>
									...
									<?php if(old('dr_acnt')) { $k = 0; 
										...
										<div class="OCdivChld">
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="15%">
														<input type="hidden" name="dr_acnt_id[]" value="<?php echo e($vouchers[0]['dr_account_master_id']); ?>" id="dracntid_<?php echo e($l); ?>">
														<span class="small">Debit Account</span>
														<input type="text" id="dracnt_<?php echo e($l); ?>" name="dr_acnt[]" class="form-control" autocomplete="off" value="<?php echo e($voucher['account_id'].'-'.$voucher['master_name']); ?>" data-toggle="modal" data-target="#account_modal" placeholder="Debit Account">
													</td>
													<td width="1%">
													...
													<td width="8%">
															...
															<select id="occrncy_<?php echo e($l); ?>" class="form-control select2 oc-curr" style="width:100%" name="oc_currency[]">
															    <option value="<?php echo e($settings->bcurrency_id); ?>">Select</option>
																<?php foreach($fcurrency as $curr): ?>
									...
									<div class="OCdivChld">
											...
											<table border="0" class="table-dy-row">
												<tr>
													<td width="15%">
														<input type="hidden" name="dr_acnt_id[]" id="dracntid_1" value="<?php echo e($vouchers[0]['dr_account_master_id']); ?>">
														<span class="small">Debit Account</span>
														<input type="text" id="dracnt_1" name="dr_acnt[]" class="form-control" value="<?php echo e($voucher['account_id'].'-'.$voucher['master_name']); ?>" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Debit Account">
													</td>
													<td width="10%">
														<span class="small">Reference</span>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e(old('total')); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency <?php echo e($bcurrency); ?></span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" readonly value="<?php echo e(old('total_fc')); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" autocomplete="off" class="form-control spl discount-cal" value="<?php echo e(old('discount')); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" autocomplete="off" class="form-control spl" value="<?php echo e(old('discount_fc')); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" class="form-control spl" readonly value="<?php echo e(old('subtotal')); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" class="form-control spl" readonly value="<?php echo e(old('subtotal_fc')); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="<?php echo e(old('vat')); ?>" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" placeholder="0" value="<?php echo e(old('vat_fc')); ?>" readonly>
										</div>
									</div>
                                </div>
								
								<input type="hidden" step="any" id="other_cost" name="other_cost" readonly class="form-control" value="<?php echo e(old('other_cost')); ?>" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" readonly class="form-control spl" value="<?php echo e(old('other_cost_fc')); ?>" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" value="<?php echo e(old('net_amount_hid')); ?>" readonly>
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e(old('net_amount')); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="<?php echo e(old('net_amount_fc')); ?>" placeholder="0">
										</div>
									</div>
                                </div>
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" data-toggle="modal" data-target="#customer_modalRV" class="form-control" value="<?php echo e($pvvoucher['account_name']); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description"><?php echo e(isset($footer)?$footer:''); ?></textarea>
                                    </div>
                                </div>
								<?php } ?>
								<hr/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_invoice/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('pi-history'))) : ?>
...
$(document).ready(function () { 
	...
	<?php  if(!old('dr_acnt')[0]) { ?>
		 $('.OCdivPrnt').toggle();$('.oc-amount-fc').toggle();
	<?php  } ?><?php  } ?>
	var urlvchr = "<?php echo e(url('purchase_invoice/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('purchase_invoice/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
	...
	<?php if( sizeof($vouchers) > 0 && $vouchers[0]->is_cash_voucher==1) { ?> //cash customer.... 
		...
		$('#supplier_id').val(<?php echo e($vouchers[0]->default_account_id); ?>);
		$('#dr_account_id').val(<?php echo e($vouchers[0]->default_account_id); ?>);
		$('#supplier_name').val('<?php echo e($vouchers[0]->default_account); ?>');
	<?php }  else { ?>
...
$(function() {	
	...
	$('#supplier_name').click(function() {
		if($('#department_id').length)
			supurl = "<?php echo e(url('purchase_order/supplier_datadept/')); ?>"+'/'+$('#department_id option:selected').val();
		else
			supurl = "<?php echo e(url('purchase_order/supplier_data/')); ?>";
	...
	var hisurl = "<?php echo e(url('purchase_invoice/order_history/')); ?>";
	...
	$('#document_type').on('change', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('purchase_invoice/set_session/')); ?>",
			type: 'post',
	...
	$(document).on('click', '#importFile', function(e) { 
		if($('#input-23').val()=='') {
			...
			$('#frmPurchaseInvoice').attr('action', "<?php echo e(url('purchase_invoice/import')); ?>").submit();
		}
	});
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('purchase_invoice/checkvchrno/')); ?>", 
			type: 'get',
...
function getAccountCr(e) { 
	...
	var res = e.id.split('_');
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('purchase_invoice/account_data/')); ?>/"+curNum+"/cr";
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
function getDocument() { 
	...
	if(doc=='PO')
		var pourl = "<?php echo e(url('purchase_order/po_data/')); ?>/"+supplier_id+"/PO";
	else if(doc=='MR')
		var pourl = "<?php echo e(url('purchase_order/mr_data/')); ?>/MRI";
	else if(doc=='SDO')
		var pourl = "<?php echo e(url('suppliers_do/sdo_data/')); ?>/"+supplier_id+"/sdo";
