                ...
                <div class="panel panel-info">
                        <div class="panel-heading clearfix  ">
							...
							<?php if (\Entrust::can(('item-create'))) : ?>
                             <a href="<?php echo e(url('itemmaster/add')); ?>" class="btn btn-primary btn-sm">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="posts">
                                  ...
                                  <!--<th>Item Code</th>
										<th>Description</th>
										<th>Qty. in Hand</th>
										<?php if (\Entrust::can(('item-cost-view'))) : ?><th>Cost Avg.</th><?php endif; // Entrust::can ?>
										<?php if (\Entrust::can(('item-cost-view'))) : ?><th>Last P. Cost</th><?php endif; // Entrust::can ?>
										<th>Net Cost</th>
										<th>Rcvd. Qty.</th>
										<th>Issued Qty.</th>
										<th></th>
												...
												<div class="form-group">
													...
													<div class="col-sm-7">
														<select id="vat" class="form-control select2 itemunit" style="width:100%" name="vat">
															...
															<option value="<?php echo e($vat['percentage']); ?>"><?php echo e($vat['name']); ?></option>
															<?php endforeach; ?>
														</select>
													</div>
												</div>
...
$(function() {
	...
	$(document).on('click', '.btn-default', function(e) { 
		location.href = "<?php echo e(url('itemmaster')); ?>";
	});
	...
	$('#createItm').on('click', function(e){
		...
		if(ic=="") {
			...
			$.ajax({
				url: "<?php echo e(url('itemmaster/ajax_create/')); ?>",
				type: 'get',
	...
	$(function() {
            ...
            var dtInstance = $("#posts").DataTable({
				...
				"serverSide": true,
				"ajax":{
						 "url": "<?php echo e(url('itemmaster/paging/')); ?>",
						 "dataType": "json",
						 "type": "POST",
                ...
                { "data": "description" },
                { "data": "quantity" },
                <?php if (\Entrust::can(('item-cost-view'))) : ?>{ "data": "cost_avg" },<?php endif; // Entrust::can ?>
                <?php if (\Entrust::can(('item-cost-view'))) : ?>{ "data": "last_purchase_cost" },<?php endif; // Entrust::can ?>
				{ "data": "other_cost" },
				{ "data": "issued_qty" },
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('itemmaster/delete/')); ?>";
