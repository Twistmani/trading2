    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="#"> <?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?></a>
                </li>
                <li class="active">
                    Edit
                </li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('do-print'))) : ?>
							 <a href="<?php echo e(url('customers_do/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
							<form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="<?php echo e(url('customers_do/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="customer_do_id" id="customer_do_id" value="<?php echo e($orderrow->id); ?>">
								<input type="hidden" name="default_location" value="<?php echo e(Auth::user()->location_id); ?>">
								
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"><?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?>. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"><?php  echo (Session::get('trip_entry')==1)?'DE':'DO';  ?>. Date</label>
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="DO. Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" value="<?php echo e($orderrow->currency_rate); ?>" class="form-control" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" autocomplete="off" name="quantity[]" <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>  <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?> class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('customers_do/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
