                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('so-print'))) : ?>
								 <a href="<?php echo e(url('sales_order/print/'.$printid.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="<?php echo e(url('sales_order/save')); ?>">
								...
								<div class="form-group parnt-job">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="parent_job" id="select22" style="width:100%" />
											<?php foreach($prntjobs as $pjob): ?>
											<option value="<?php echo e($pjob->id); ?>"><?php echo e($pjob->voucher_no); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" class="form-control" value="<?php echo e(old('salesman')); ?>" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_order/add')); ?>" class="btn btn-warning">Clear</a>
...
function submitDraft() {
    $('#is_draft').val(1);
    document.frmSalesOrder.action="<?php echo e(url('sales_order/save_draft')); ?>";
...
$(function() {	
	...
	$(document).on('click', '.desc-info', function(e) { 
	   ...
	   if(item_id!='') {
		   $.ajax({
			url: "<?php echo e(url('itemmaster/get_desc/')); ?>",
			type: 'get',
			data: 'id='+item_id,
			success: function(data) {
				//console.log('g '+data);
...
function getQuotation() { 
	...
	var wt = $(window).width();
	var customer_id = $("#customer_id").val();
	var sourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id+"/so";
...
function getSalesOrder() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('sales_order/get_salesorder/')); ?>";
...
function getPO() { 
	...
	var pourl = "<?php echo e(url('purchase_order/get_jobpo/')); ?>/"+job_id;
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
