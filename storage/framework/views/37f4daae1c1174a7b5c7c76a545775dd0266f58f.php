...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                    ...
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('ss-create'))) : ?>
                             <a href="<?php echo e(url('sales_split/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" id="frmPOReport" action="<?php echo e(url('sales_split/search')); ?>" target="_blank">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('sales_split/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePurSplit").DataTable({
			...
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "<?php echo e(url('sales_split/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
   ...
   /*  $("#multiselect2").multiselect({
	...
	$(document).on('change', '#search_type', function(e) { //$('#search_type').on('change', function(e){
		...
		if(vchr=='customer') {
			...
			$.ajax({
				url: "<?php echo e(url('sales_split/getcustomer/')); ?>",
				//type: 'get',
