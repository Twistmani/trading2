                    ...
                    <div class="print" id="invoicing">
						...
						<table border="0" style="width:100%;height:100%;">
								...
								<tr>
									<td align="left" valign="top" width="35%" style="padding-left:0px; padding-bottom:5px;">
										<div style="border:1px solid #000; padding: 10px;">
											Account No: <?php echo e($details->account_id); ?><br/>
											...
											Telephone No: <?php echo e($details->custphone); ?><br/>
											Customer TRN: <?php echo $vat_no = ($details->vat_no=='')?$details->customer_trn:$details->vat_no; ?><br/>
										</div>
									</td>
									<td align="left" style="padding-left:150px;">
										<div style="border:1px solid #000; padding: 10px;">
											GR No: <?php echo e($details->voucher_no); ?><br/>
											GR Date: <?php echo e(date('d-m-Y',strtotime($details->voucher_date))); ?><br/>
										</div>
									</td>
								</tr>
								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										...
										<tr>
											...
											<td align="center"><?php echo e($item->item_code); ?></td>
											<td align="center"><?php echo e($item->item_name); ?></td>
											<td align="center"><?php echo e($item->unit_name); ?></td>
											<td align="center"><?php echo e($item->quantity); ?></td>
											<td align="center"><?php echo e(number_format($item->unit_price,2)); ?></td>
											<td align="center"><?php echo e(number_format($item->vat_amount,2)); ?></td>
											<td align="center"><?php echo e(number_format($item->total_price,2)); ?></td>
										</tr>
								...
								<tr style="border:1px solid black;">
									<td colspan="2" align="center">
										...
										<tr>
											...
											<b>
												<p><?php echo e(number_format($details->total,2)); ?></p>
												<p><?php echo e(number_format($details->vat_amount,2)); ?></p>
												<?php if($details->discount!=0) { ?><p><?php echo e(number_format($details->discount,2)); ?></p><?php } ?>
												<p><?php echo e(number_format($details->net_amount,2)); ?></p>
											</b>
											</td>
										</tr>
										</table>
							...
							<div class="footer" style="text-align:center; border:0px solid red; width:86%;">
								...
								<img src="<?php echo e(asset('assets/footer_'.Session::get('logo').'')); ?>" />
							</div>
						</div>
                    </div>
