                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('quotation_sales/save')); ?>">
										...
										<table border="0" style="border-spacing: 2px; margin-top:10px;">
											<tr>
												<td width="3%" align="center">
													<input type="text" name="orderno[]" id="ordr_<?php echo e($i); ?>" readonly class="form-control" value="<?php echo e($item->orderno); ?>">
												</td>
												...
												<td width="15%" style="padding-left:2px;">
													<input type="text" name="remarks[]" id="remrk_<?php echo e($i); ?>" autocomplete="on" class="form-control"  value="<?php echo e($item->remarks); ?>" >
													<input type="hidden" id="itmunt_<?php echo e($i); ?>" name="unit_id[]" value="<?php echo e($item->unit_id); ?>">
												</td>
												<td width="7%" style="padding-left:2px;">
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" name="quantity[]" required autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												...
												<td width="7%" style="padding-left:2px;">
													...
													<input type="hidden" id="taxcode_<?php echo e($i); ?>" name="tax_code[]" value="SR">
													<input type="hidden" id="txincld_<?php echo e($i); ?>" name="tax_include[]" value="0">
												</td>
												<td width="15%" style="padding-left:2px;">
												...
												<td width="3%" style="padding-left:2px;">
													<button type="button" class="btn btn-success btn-xs btn-add-item" >
													 ...
													 <button type="button" class="btn btn-danger btn-xs btn-remove-item" data-id="<?php echo e($i); ?>">
