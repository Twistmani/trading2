                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('pi-print'))) : ?>
							 <a href="<?php echo e(url('purchase_split/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('purchase_split/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="purchase_split_id" id="purchase_split_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="PS. Date"/>
                                    </div>
                                </div>
								...
								<div class="itemdivChld">							
											...
											<table border="0" class="table-dy-row">
												...
												<tr>
													...
													<td width="7%">
															<input type="text" id="supname_<?php echo e($i); ?>" autocomplete="off"step="any"  name="supname[]" class="form-control " value="<?php echo e($item->item_supname); ?>">
													</td>
													<td width="6%">
														
														<input type="text" id="taxno_<?php echo e($i); ?>" autocomplete="off"step="any"  name="taxno[]" class="form-control " value="<?php echo e($item->item_vatno); ?>">
													</td>
													...
													<td width="9%">
														<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo $item->vat.'% - '.$vat_amount?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_split')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('purchase_split/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('purchase_split/checkrefno/')); ?>";
...
$(function() {	
	...
	$('#department_id').on('change', function(e){
		...
		$.get("<?php echo e(url('purchase_split/getdeptvoucher/')); ?>/" + dept_id, function(data) {  console.log(data);
	...
	var acturl = "<?php echo e(url('purchase_split/account_data/')); ?>";
...
/*	var supurl = "<?php echo e(url('purchase_order/supplier_data/')); ?>";
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('purchase_split/getvoucher/')); ?>/" + vchr_id, function(data) { //console.log(data);
...
function getAccount(e) { 
	...
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('purchase_split/cash_data/')); ?>/purchase";
