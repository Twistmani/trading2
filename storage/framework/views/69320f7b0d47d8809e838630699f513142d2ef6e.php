                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('pc-create'))) : ?>
                            <!--<a href="<?php echo e(url('pettycash/quick-add')); ?>" class="btn btn-primary btn-sm">
									<span class="btn-label">
									<i class="glyphicon glyphicon-plus"></i>
								</span> Quick Entry
							</a>-->

                             <a href="<?php echo e(url('pettycash/add-pc')); ?>" class="btn btn-primary btn-sm">
									<span class="btn-label">
									<i class="glyphicon glyphicon-plus"></i>
								</span> Add New
							</a>
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('pettycash/delete/')); ?>";
...
$(function() {
		...
		$("#tableTrans").DataTable({
			...
			"ajax":{
					 "url": "<?php echo e(url('pettycash/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			<?php if (\Entrust::can(('pc-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('pc-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('pc-delete'))) : ?>{ "data": "delete","bSortable": false }<?php endif; // Entrust::can ?>
		]
