                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10"> 
                                ...
                                <table class="table horizontal_table table-striped" id="tableSuppList">
                                    ...
                                    <tr>
                                        <td><a href="" class="supp" data-id="<?php echo e($supplier->id); ?>" data-name="<?php echo e($supplier->master_name); ?>" data-clbalance="<?php echo e(number_format($supplier->cl_balance,2)); ?>" data-duedays='".$supplier->duedays."' data-pdc="<?php echo e(number_format($supplier->pdc_amount,2)); ?>" data-crlimit="<?php echo e(number_format($supplier->credit_limit,2)); ?>" data-trnno="<?php echo e($supplier->vat_no); ?>" data-dismiss="modal"><?php echo e($supplier->account_id); ?></a></td>
                                        <td><a href="" class="supp" data-id="<?php echo e($supplier->id); ?>" data-name="<?php echo e($supplier->master_name); ?>" data-clbalance="<?php echo e(number_format($supplier->cl_balance,2)); ?>" data-duedays='".$supplier->duedays."' data-pdc="<?php echo e(number_format($supplier->pdc_amount,2)); ?>" data-crlimit="<?php echo e(number_format($supplier->credit_limit,2)); ?>" data-trnno="<?php echo e($supplier->vat_no); ?>" data-dismiss="modal"><?php echo e($supplier->master_name); ?></a></td>
                                        <td><?php echo e($supplier->category); ?></td>
                                        <td><?php echo e(number_format($supplier->cl_balance, 2, '.', ',')); ?></td>
                                        <td><?php echo e(number_format($supplier->op_balance, 2, '.', ',')); ?></td>
                                    </tr>
                                   <?php endforeach; ?>
                                    </tbody>
                                </table>
					...
					<div class="panel panel-success filterable" id="newSupplierFrm">
						...
						<div class="panel-body">  <button type="button" class="btn btn-primary listCust">List Supplier</button>
							...
							<div class="col-xs-10">
								...
								<input type="hidden" name="department_id" id="department_id" value="<?php echo e($deptid); ?>">
