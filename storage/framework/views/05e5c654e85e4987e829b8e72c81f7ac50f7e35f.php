                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                           ...
                           <div class="pull-right">
								 ...
								 <a href="<?php echo e(url('sales_voucher/print/'.$jrow->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchase Voucher" id="frmPurchase Voucher" action="<?php echo e(url('sales_voucher/update/'.$jrow->id)); ?>">
                               ...
                               <?php if($isdept): ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" value="<?php echo e(date('d-m-Y', strtotime($jrow->voucher_date))); ?>" data-language='en' id="voucher_date" placeholder="Voucher Date"/>
                                    </div>
                                </div>
											...
											<div class="itemdivChld">							
												...
												<div class="form-group">
													...
													<input type="hidden" name="department[]" id="dept_1">
														...
														<div class="col-sm-2"> 
															<span class="small">Cheque No</span><input type="text" id="chkno_<?php echo e($i); ?>" autocomplete="off" value="<?php echo e($item->cheque_no); ?>" name="cheque_no[]" class="form-control" >
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
										...
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" id="trnno_1" name="trn_no" autocomplete="off" value="<?php echo e($jrow->trn_no); ?>" class="form-control">
										</div>
                                </div>
								<?php } ?>
								<div class="form-group">
