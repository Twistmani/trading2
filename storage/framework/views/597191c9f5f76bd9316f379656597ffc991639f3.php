        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
										...
										<td colspan="2" align="center">
											...
											<body>
												...
												<tr>
													...
													<td class="text-right"><b><?php echo e(number_format($total_gross,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($row->discount,2)); ?></b></td>
													<td class="text-right"><?php echo e(number_format($total_amt,2)); ?></td>
													<td class="text-right"><b><?php echo e(number_format($total_vat,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($total_net,2)); ?></b></td>
												</tr>
											</body>
										</table>
										</td>
										...
										<td colspan="2" align="center">
											...
											<body><?php $total_net = $discount = $total_vat = $total_gross =$total_amt=$total= $i = 0;?>
												...
												<tr>
													...
													<td class="text-right"><b>Total:</b></td>
													<td class="text-right"><b><?php echo e(number_format($total_gross,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($discount,2)); ?></b></td>
													<td class="text-right"><?php echo e(number_format($total_amt,2)); ?></td>
													<td class="text-right"><b><?php echo e(number_format($total_vat,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($total_net,2)); ?></b></td>
												</tr>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php  $i++;  ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($i); ?> &nbsp; <b>DO.#:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>DO Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>DO.#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>Job No:</b> <?php echo e($report[0]->jobcode); ?></td>
											...
											<tr>
												...
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($row->line_total,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($row->unit_vat,2)); ?></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php foreach($reports as $report): ?> <?php  $i++;  ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($i); ?> &nbsp; <b>DO.#:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>DO Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>DO.Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
												<td colspan="2"><b>Job No</b> <?php echo e($report[0]->jobcode); ?></td>
												<td colspan="2"><b>Salesman:</b> <?php echo e($report[0]->salesman); ?></td>
												<td colspan="3" class="text-right"><b>Customer:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
												...
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($row->unit_price,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($total_amt,2)); ?></td>
													<td class="text-right"><?php echo e($inv_qty); ?></td>
													<td class="text-right"><?php echo e($pending_qty); ?></td>
													<td class="text-right"><?php echo e(number_format($row->unit_price,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($pending_amt,2)); ?></td>
												</tr>
												<?php endforeach; ?>
												<tr><td colspan="9"><br/></td></tr>
											<?php endforeach; ?>	
											<tr>
													<td></td>
													<td class="text-right"><b>Total:</b></td>
													<td class="text-right"><b><?php echo e($poqty_total); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($ponet_total,2)); ?></b></td>
													<td class="text-right"><b><?php echo e($invqty_total); ?></b></td>
													<td class="text-right"><b><?php echo e($pndqty_total); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($pndnet_total,2)); ?></b></td>
												</tr>
											</body>
										</table>
								</td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php foreach($reports as $report): ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>DO.#:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>DO.Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>DO.Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
												<td colspan="1"><b>Job No.</b> <?php echo e($report[0]->jobcode); ?></td>
												<td colspan="1"><b>Salesman:</b> <?php echo e($report[0]->salesman); ?></td>
												<td colspan="1" class="text-right"><b>Customer:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('customers_do/export')); ?>">
					...
					<input type="hidden" name="job_id" value="<?php echo e($jobids); ?>" >
					</form>
