                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('sales_split_return/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplitReturn" id="frmSalesSplitReturn" enctype="multipart/form-data" action="<?php echo e(url('sales_split_return/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                <input type="hidden" name="is_pettycash" value="<?php echo e($modpettycash); ?>">
										...
										<div class="itemdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="7%">
														<select id="itmunt_1" class="form-control select2 line-unit" style="width:100%" name="unit_id[]"><?php foreach($units as $unit): ?><option id="<?php echo e($unit->id); ?>"><?php echo e($unit->unit_name); ?></option><?php endforeach; ?></select>
													</td>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" readonly value="<?php echo e(old('total_fc')); ?>" placeholder="0">
										</div>
									</div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('sales_split_return/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('sales_split_return/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
...
function getSalesSplit(e) {
	if(e.value=='') { 
		...
		if($('#department_id').length) {
			...
			var pourl = "<?php echo e(url('sales_split/split_data/')); ?>/"+did;
		} else
			var pourl = "<?php echo e(url('sales_split/split_data/')); ?>";
...
function getAccountCr(e) { 
	...
	var res = e.id.split('_');
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('sales_split/account_data/')); ?>/"+curNum+"/cr";
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
