				...
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('si-print'))) : ?>
								 <a href="<?php echo e(url('sales_invoice/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
								...
								<?php if (\Entrust::can(('si-print'))) : ?>
								 <!--<a href="<?php echo e(url('sales_invoice/printdo/'.$printid->id)); ?>" target="_blank" class="btn btn-info btn-sm">
									<span class="btn-label">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('sales_invoice/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="default_location" value="<?php echo e(Auth::user()->location_id); ?>">
								<input type="hidden" name="is_cash" id="is_cash" value="<?php echo e(($siscsh)?$siscsh:$vouchers[0]->is_cash_voucher); ?>">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="department_id">
											<?php foreach($departments as $drow): ?>
												<option value="<?php echo e($drow->id); ?>" <?php echo e(($sideptid==$drow->id)?'selected':''); ?> ><?php echo e($drow->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
                                           <?php foreach($vouchers as $voucher): ?>
											<option value="<?php echo e($voucher['id']); ?>" <?php echo e(($sivchrid==$voucher['id'])?'selected':''); ?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
                                           <?php foreach($vouchers as $voucher): ?>
										   <?php if(old('voucher_id') && old('voucher_id')==$voucher['id']): ?>
											   <?php  $sel = 'selected';  ?>
										   <?php elseif($sivchrid): ?>==$voucher['id'])
												<?php  $sel = 'selected';  ?>
										   <?php else: ?>
											   <?php  $sel = '';  ?>
										   <?php endif; ?>
											<option value="<?php echo e($voucher['id']); ?>" <?php echo e($sel); ?> ><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="hidden" name="curno" id="curno" value="<?php echo e((old('curno'))?old('curno'):$vouchers[0]['voucher_no']); ?>">
                                    <div class="col-sm-10">
										<?php if (\Entrust::can(('si-invno'))) : ?>
										<div class="input-group">
                                        <input type="text" class="form-control" id="voucher_no" value="<?php echo e((old('voucher_no'))?old('voucher_no'):$vouchers[0]['voucher_no']); ?>" readonly name="voucher_no">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right"  <?php if(old('voucher_date')!='') { ?> value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>"<?php } ?> name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" name="lpo_no" value="<?php echo e(old('lpo_no')); ?>" autocomplete="off" placeholder="LPO No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control lpo_date1" id="lpo_date" <?php if(old('lpo_date')!='') { ?> value="<?php echo e(old('lpo_date')); ?>" <?php } ?> name="lpo_date" data-language='en' readonly placeholder="LPO Date">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<?php if($scrid) { ?>
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e($scrid); ?>">
										<?php } else { ?>
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e((old('cr_account_id'))?old('cr_account_id'):$vouchers[0]['cr_account_master_id']); ?>">
										<?php } ?>
										<div class="input-group">
											<?php if($sslsacnt) { ?>
											<input type="text" name="sales_account" id="sales_account" class="form-control" value="<?php echo e($sslsacnt); ?>" readonly>
											<?php } else { ?>
											<input type="text" name="sales_account" id="sales_account" class="form-control" value="<?php echo e((old('sales_account'))?old('sales_account'):$vouchers[0]['account_id'].'-'.$vouchers[0]['master_name']); ?>" readonly>
											<?php } ?>
								...
								<div class="form-group" id="saleloc">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="sales_location" class="form-control select2" style="width:100%" name="sales_location">
											...
											?>
											<option value="<?php echo e($sloc->id); ?>" <?php if(old('sales_location')==$sloc->id) echo 'selected'; ?>><?php echo e($sloc->name); ?></option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                 <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo e((old('customer_name'))?old('customer_name'):$vouchers[0]->default_account); ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer" readonly>
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e((old('customer_id'))?old('customer_id'):$vouchers[0]->default_account_id); ?>">
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="<?php echo e((old('dr_account_id'))?old('dr_account_id'):$vouchers[0]->default_account_id); ?>">

										<div class="col-xs-10" id="customerInfo">
											<div class="col-xs-2">
												<span class="small">Current Balance</span> <input type="text" id="cr_balance" name="cbal" value="<?php echo e(old('cbal')); ?>" readonly class="form-control line-quantity">
											</div>
											<div class="col-xs-2">
												<span class="small">PDC</span> <input type="text" id="pdc" name="pdc" value="<?php echo e(old('pdc')); ?>" readonly class="form-control line-cost">
											</div>
											<!--<div class="col-xs-2">
												<span class="small">Crdit Limit</span> <input type="text" id="cr_limit" name="clmt" value="<?php echo e(old('clmt')); ?>" readonly readonly class="form-control cost">
											</div>-->
											<div class="col-xs-2">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e(old('customer_phone')); ?>" class="form-control cpno" autocomplete="off">
											</div>
											<?php if($formdata['vehicle_no']==1) { ?>
											<div class="col-xs-2">
												<span class="small">Vehicle No.</span> <input type="text" id="vehicle_no" name="vehicle_no" value="<?php echo e(old('vehicle_no')); ?>" class="form-control vno" autocomplete="off">
											</div>
											<?php } else { ?><input type="hidden" name="vehicle_no" id="vehicle_no"><?php } ?>
											<?php if($formdata['km_miles']==1) { ?>
											<div class="col-xs-2">
												<span class="small">Kilometer/Miles</span> <input type="text" id="kilometer" name="kilometer" value="<?php echo e(old('kilometer')); ?>" class="form-control km" autocomplete="off">
											</div>
										...
										<div class="col-xs-10" id="newcustomerInfo">
											<div class="col-xs-3">
												<span class="small">Customer Name</span> <input type="text" id="customername" name="customername" value="<?php echo e(old('customername')); ?>" class="form-control" autocomplete="off" >
											</div>
											<div class="col-xs-2">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e(old('customer_phone')); ?>" class="form-control cpno" autocomplete="off">
											</div>
											<div class="col-xs-2">
												<span class="small">TRN No</span> <input type="text" id="customer_trn" name="customer_trn" value="<?php echo e(old('customer_trn')); ?>" class="form-control" autocomplete="off">
											</div>
											<?php if($formdata['vehicle_no']==1) { ?>
											<div class="col-xs-2">
												<span class="small">Vehicle No.</span> <input type="text" id="vehicle_no" name="vehicle_no" value="<?php echo e(old('vehicle_no')); ?>" class="form-control vno" autocomplete="off">
								...
								<div class="form-group has-warning" id="trninfo">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="vat_no" name="vat_no" placeholder="TRN No." value="<?php echo e(old('vat_no')); ?>" autocomplete="off">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										...
										<option value="CDO"><?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?></option>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>"><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="due_date" data-language='en' id="due_date" value="<?php echo e(date('d-m-Y')); ?>"/>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="location_id" class="form-control select2" style="width:100%" name="location_id">
											...
											if($loc->is_default==1)
												$is_default = 1;
											?>
											<option value="<?php echo e($loc['id']); ?>" <?php if(old('location_id')==$loc['id']) echo 'selected'; ?>><?php echo e($loc['name']); ?></option>
											<?php } ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" value="<?php echo e($item); ?>" autocomplete="off" placeholder="Item Code" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="29%">
													<input type="text" name="item_name[]" value="<?php echo e(old('item_name')[$i]); ?>" id="itmdes_<?php echo e($j); ?>" autocomplete="off" class="form-control" placeholder="Item Description">
												</td>
												<td width="7%">
													<select id="itmunt_<?php echo e($j); ?>" class="form-control select2 <?php if($errors->has('unit_id.'.$i)) echo 'form-error';?> line-unit" style="width:100%" name="unit_id[]"><option value="<?php echo e(old('unit_id')[$i]); ?>"><?php echo e(old('hidunit')[$i]); ?></option></select>
												</td>
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" step="any" name="quantity[]" value="<?php echo e(old('quantity')[$i]); ?>" autocomplete="off" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" placeholder="Qty.">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($j); ?>" step="any" name="cost[]" value="<?php echo e(old('cost')[$i]); ?>" autocomplete="off" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" placeholder="Cost/Unit">
												</td>
												<td width="6%">
													<select id="taxcode_<?php echo e($j); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR">SR</option><option value="EX">EX</option><option value="ZR">ZR</option></select>
												</td>
												<td width="6%">
													<select id="txincld_<?php echo e($j); ?>" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0" <?php echo e(($settings->si_vat_inc==0) ? 'selected' : ''); ?>>No</option><option value="1" <?php echo e(($settings->si_vat_inc==1) ? 'selected' : ''); ?> >Yes</option></select>
												</td>
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($j); ?>" step="any" readonly name="vatdiv[]" value="<?php echo e(old('vatdiv')[$i]); ?>" class="form-control vatdiv" placeholder="VAT Amt"> 
													<input type="hidden" id="vat_<?php echo e($j); ?>" name="line_vat[]" value="<?php echo e(old('line_vat')[$i]); ?>" class="form-control vat">
													<input type="hidden" id="vatlineamt_<?php echo e($j); ?>" name="vatline_amt[]" value="<?php echo e(old('vatline_amt')[$i]); ?>" class="form-control vatline-amt" value="0">
													<input type="hidden" id="itmdsnt_<?php echo e($j); ?>" name="line_discount[]" value="<?php echo e(old('line_discount')[$i]); ?>">
													<input type="hidden" id="costavg_<?php echo e($j); ?>" name="costavg[]" value="<?php echo e(old('costavg')[$i]); ?>">
													<input type="hidden" id="purcost_<?php echo e($j); ?>" name="purcost[]" value="<?php echo e(old('purcost')[$i]); ?>">
													<input type="hidden" id="cqty_<?php echo e($j); ?>" name="curqty[]" value="<?php echo e(old('curqty')[$i]); ?>">
												</td>
												<td width="11%">
													<input type="number" id="itmttl_<?php echo e($j); ?>" step="any" name="line_total[]" value="<?php echo e(old('item_total')[$i]); ?>" class="form-control line-total" readonly placeholder="Total">
													<input type="hidden" id="itmtot_<?php echo e($j); ?>" name="item_total[]" value="<?php echo e(old('line_total')[$i]); ?>">
												</td>
												<td width="1%">
								...
								<?php } ?>	
											...
											<div id="cnloc" style="float:left; padding-right:5px;">
												<button type="button" id="cnloc_<?php echo e($j); ?>" class="btn btn-primary btn-xs cnloc-info">Consignment Location</button>
											</div>
											<?php endif; ?>
								...
								<?php } ?>
											<!--
											<div style="float:left;">
												Amount in % <input type="text" style="width:50px;" id="per_<?php echo e($j); ?>" name="per[]" class="perc"/> <input type="text" style="width:250px;" placeholder="Description..." id="perdesc_<?php echo e($j); ?>" name="perdesc[]"/>
											</div>
											-->
											...
											<div class="cnlocPrntItm" id="cnlocPrntItm_<?php echo e($j); ?>">
												<div class="cnlocChldItm">							
													<div class="table-responsive cnloc-data" id="cnlocData_<?php echo e($j); ?>"></div>
												</div>
											</div>
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
											<tr>
												...
												<?php endif; ?>
												<td width="8%">
													<input type="number" id="itmqty_1" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" placeholder="Qty." <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>>
												</td>
												<td width="8%">
												...
												<td width="6%">
													<select id="txincld_1" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0" <?php echo e(($settings->si_vat_inc==0) ? 'selected' : ''); ?>>No</option><option value="1" <?php echo e(($settings->si_vat_inc==1) ? 'selected' : ''); ?>>Yes</option></select>
												</td>
												<td width="9%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" value="<?php echo e(old('total')); ?>" name="total" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" value="<?php echo e(old('total_fc')); ?>" name="total_fc" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="roundoff" name="roundoff" value="<?php echo e(old('roundoff')); ?>" class="form-control spl round-off" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="<?php echo e(old('discount')); ?>" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="<?php echo e(old('discount_fc')); ?>" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								<?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount" name="less_amount" value="<?php echo e(old('less_amount')); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount2" name="less_amount2" value="<?php echo e(old('less_amount2')); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount3" name="less_amount3" value="<?php echo e(old('less_amount3')); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="previnv_amount" name="previnv_amount" value="<?php echo e(old('previnv_amount')); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" value="<?php echo e(old('subtotal')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" value="<?php echo e(old('subtotal_fc')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" value="<?php echo e(old('vat')); ?>" class="form-control spl" placeholder="0" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" value="<?php echo e(old('vat_fc')); ?>" class="form-control spl" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" value="<?php echo e(old('net_amount_hid')); ?>" readonly>
											<input type="number" step="any" id="net_amount" name="net_amount" value="<?php echo e(old('net_amount')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="hidden" step="any" id="other_cost" name="other_cost">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" value="<?php echo e(old('net_amount_fc')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="filedivPrnt">
									<div class="filedivChld">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="file" id="input-51" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('sales_invoice/upload/')); ?>">
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" data-toggle="modal" data-target="#customer_modalRV" class="form-control" value="<?php echo e($rvvoucher['account_name']); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description"><?php echo e($footer); ?></textarea>
                                    </div>
                                </div>
								<?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_invoice/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('si-history'))) : ?>
...
$('#lpo_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>'),autoClose: true } );
...
$(document).ready(function () { 
	...
	$('.crm_info').hide();
	<?php if(old('voucher_date')==''): ?>
		$('#voucher_date').val('<?php echo e(date('d-m-Y')); ?>');
	<?php else: ?>
		$('#voucher_date').val('<?php echo e(old('voucher_date')); ?>'); 
	<?php endif; ?>
	...
	<?php if(!Session::has('is_cash') && sizeof($vouchers) > 0 && $vouchers[0]->is_cash_voucher==1) { ?> //cash customer....  customerInfo
		...
		$('#customer_id').val(<?php echo e($vouchers[0]->default_account_id); ?>);
		$('#dr_account_id').val(<?php echo e($vouchers[0]->default_account_id); ?>);
		$('#customer_name').val('<?php echo e($vouchers[0]->default_account); ?>');
	...
	var urlvchr = "<?php echo e(url('sales_invoice/checkvchrno/')); ?>"; //CHNG
    ...
    $('#frmSalesInvoice').bootstrapValidator({
        fields: {
			...
			<?php if($formdata['location_item']==1): ?> , 'iloc[]': { validators: { notEmpty: { message: 'Item location quantity is required and cannot be empty!' } }},<?php endif; ?>  //NOV24
...
var spPswd = '<?php echo e($settings->special_pswd); ?>';
function pswdOkSubmit() {
	...
	//if(con) {
		...
		if(pswd==spPswd) { 
			//document.frmData.action="<?php echo e(url('data_remove/cleardb_custom')); ?>";
...
$(function() {	
	...
	$(document).on('click', '.btn-add-item', function(e)  { 
        ...
        var controlForm = $('.controls .itemdivPrnt'),
			...
			newEntry.find($('input[name="item_code[]"]')).autocomplete({
					...
					var src2 = "<?php echo e(url('itemmaster/ajax_search2/')); ?>";
	...
	$('#customer_name').click(function() { 
		if($('#department_id').length)
			custurl = "<?php echo e(url('sales_order/customer_data/')); ?>"+'/'+$('#department_id option:selected').val();
		else
			custurl = "<?php echo e(url('sales_order/customer_data/')); ?>";
	...
	$('#sales_location').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_invoice/getsaleloc/')); ?>/" + loc_id, function(data) {
			if(data) {
	...
	$('#department_id').on('change', function(e){ 
		...
		dptTxt = $( "#department_id option:selected" ).text();
		deptid = $( "#department_id option:selected" ).val();
		$.get("<?php echo e(url('sales_invoice/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	/* var custurl2 = "<?php echo e(url('sales_order/customer_data/')); ?>";
	$('#customer_name').click(function() { 
		if($('#department_id').length)
	...
	$(document).on('change', '.line-unit', function(e) {
		...
		if( $('#export').is(":checked") || ($('#taxcode_'+curNum+' option:selected').val()=='EX') ) {
			...
			$.get("<?php echo e(url('itemmaster/get_vat/')); ?>/" + unit_id+"/"+item_id, function(data) { //console.log(data);
				//VAT CHNG
	...
	$('#document_type').on('change', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('sales_invoice/set_session/')); ?>",
			type: 'post',
	...
	$(document).on('click', '.loc-info', function(e) { 
	   ...
	   var item_id = $('#itmid_'+curNum).val();
	   if(item_id!='') {
		   var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+item_id+"/"+curNum
	...
	/*$(document).on('click', '.cnloc-info', function(e) { 
	   ...
	   var cst_id = $('#customer_id').val();
	   if(item_id!='') {
		   let cnlocUrl = "<?php echo e(url('itemmaster/get_cnlocinfo/')); ?>/"+item_id+"/"+curNum+"/"+cst_id
	...
	$(document).on('blur', 'input[name="item_code[]"]', function(e) { 
		...
		/* if(code!='') {
			$.get("<?php echo e(url('itemmaster/item_load/')); ?>/" + code, function(data) {
	...
	$(document).on('focus', '#customer_trn', function(e) { 
		...
		$.get("<?php echo e(url('sales_invoice/get_trnno/')); ?>/" + name, function(data) { //console.log(data);
...
/*	$(document).on('click', '.view-asm-itm', function(e) { 
	...
	$(document).on('click', '.btn-add-file', function(e)  { 
	    ...
	    fNum++;
		$.ajax({
			url: "<?php echo e(url('job_order/get_fileform/SI')); ?>",
			type: 'post',
			data: {'no':fNum},
			success: function(data) {
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('sales_invoice/checkvchrno/')); ?>", 
			type: 'get',
...
function getDocument() { 
	...
	if(doc=='SQ')
		var pourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id+"/QSI";
	else if(doc=='SO')
		var pourl = "<?php echo e(url('sales_order/get_order/')); ?>/"+customer_id+"/SOI";
	else if(doc=='CDO')
		var pourl = "<?php echo e(url('customers_do/get_order/')); ?>/"+customer_id+"/CDO";
...
function getSalesInvoice() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('sales_invoice/get_salesinvoice/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
function getLocation() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('sales_invoice/get_locationTransfer/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
...
function openWin(id) {
  myWindow = window.open("<?php echo e(url('sales_invoice/print/')); ?>/"+id, "", "width=400, height=477");
}
