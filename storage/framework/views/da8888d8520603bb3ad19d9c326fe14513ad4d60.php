            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
						<form method="POST" name="frmPdcReceived" id="frmPdcReceived" action="<?php echo e(url('pdc_received/save')); ?>">
                        ...
                        <div class="table-responsive">
                                <table class="table horizontal_table table-striped" id="tablePDCR" border="0">
                                    ...
                                    <tr>
										...
										<td><?php echo e($pdc->voucher_no); ?>

											<input type="hidden" name="ids[]" id="id_<?php echo e($i); ?>" value="<?php echo e($pdc->id); ?>">
											<input type="hidden" name="voucher_type[]" id="vtype_<?php echo e($i); ?>" value="<?php echo e($pdc->voucher_type); ?>"></td>
										...
										<td><input type="text" name="dr_account[]" id="draccount_<?php echo e($i); ?>" class="form-control" required value="<?php echo e(($baccount)?$baccount->master_name:''); ?>" data-toggle="modal" data-target="#account_modal" style="width:8em;">
											<input type="hidden" name="dr_account_id[]" id="draccountid_<?php echo e($i); ?>" value="<?php echo e(($baccount)?$baccount->dr_account_master_id:''); ?>">
										</td>
										<td><?php echo e($pdc->debitor); ?></td>
										<td class="no_wrap"><?php echo e($pdc->customer); ?><input type="hidden" name="customer_id[]" id="customerid_<?php echo e($i); ?>" value="<?php echo e($pdc->customer_id); ?>">
											<input type="hidden" name="customer[]" id="customer_<?php echo e($i); ?>" value="<?php echo e($pdc->customer); ?>">
										</td>
										<td class="no_wrap"><?php echo e(date('d-m-Y',strtotime($pdc->voucher_date))); ?>

											<input type="hidden" name="cr_account_id[]" id="craccountid_<?php echo e($i); ?>" value="<?php echo e($pdc->cr_account_id); ?>" ></td>
                                    </tr>
									<?php endforeach; ?>
									 <div class="col-sm-3">
									...
									<a href="<?php echo e(url('pdc_received/undo_list')); ?>" class="btn btn-primary">View PDC Submitted List</a>
									 &nbsp; 
									...
									<select class="form-control" id="searchPdc">
										...
										<?php foreach($pdcrs as $row): ?>
										<option value="<?php echo e($row->master_name); ?>"><?php echo e($row->master_name); ?></option>
										<?php endforeach; ?>
									</select>
									</div>
                                    </tbody>
...
$(document).ready(function() {
    ...
    $('.chksubmit').click( function() {
		...
		if (!checked) {
			...
			$.ajax({
				url: "<?php echo e(url('pdc_received/cheque_submit/')); ?>",
				type: "POST",
				data: data+'&voucher_date='+$('#voucher_date').val(),
				success: function(data) { 
					if(data)
						location.href="<?php echo e(url('pdc_received/')); ?>";
				}
			})
	...
	//var acurl = "<?php echo e(url('account_master/get_account_list/BANK')); ?>"; //get_account_list
...
function getDetail() {	
	document.frmPdcReceived.action = "<?php echo e(url('pdc_received/print')); ?>";
	document.frmPdcReceived.submit();
}
...
function setUndo() {
	...
	if (!checked) {
		...
		document.frmPdcReceived.action="<?php echo e(url('pdc_received/undo')); ?>";
		document.frmPdcReceived.submit();
	}
}
