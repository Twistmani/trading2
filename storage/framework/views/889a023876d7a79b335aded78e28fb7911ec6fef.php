                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('pi-print'))) : ?>
							 <a href="<?php echo e(url('purchase_split_return/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank"  class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('purchase_split_return/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="purchasesplit_return_id" id="purchasesplit_return_id" value="<?php echo e($orderrow->id); ?>">
...
function getAccount(e) { 
	...
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('purchase_split/account_data/')); ?>/"+curNum;
