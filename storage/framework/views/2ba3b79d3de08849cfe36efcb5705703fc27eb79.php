                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pr-print'))) : ?>
								 <a href="<?php echo e(url('purchase_return/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurReturn" id="frmPurReturn" action="<?php echo e(url('purchase_return/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="purchase_return_id" id="purchase_return_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"> <b>Purchase Invoice No</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="purchase_invoice_no" name="purchase_invoice_no" value="<?php echo e($orderrow->purchase_invoice_no); ?>" placeholder="Purchase Invoice No" autocomplete="off" onclick="getPurchaseInvoice(this)">
										<input type="hidden" class="form-control" id="purchase_invoice_id" name="purchase_invoice_id" value="<?php echo e($orderrow->purchase_invoice_id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<div class="input-group">
                                        <input type="text" name="stock_account" id="stock_account" class="form-control" value="<?php echo e($orderrow->account); ?>" readonly>
										<span class="input-group-addon inputsa"><i class="fa fa-edit" style="font-size:22px;color:#ff9f2c"></i></span>
										</div>
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="<?php echo e($orderrow->account_master_id); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>Supplier</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="supplier_name" id="supplier_name" class="form-control" value="<?php echo e($orderrow->supplier); ?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal" placeholder="Supplier">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" readonly id="voucher_date" />
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" value="<?php echo e($orderrow->description); ?>" name="description" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '.$vat_amount); ?>"><!--<div class="h5" id="vatdiv_<?php echo e($i); ?>"></div>--> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="<?php echo e(intval($vat_amount_net*100)/100); ?>" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="<?php echo e($orderrow->vat_amount); ?>" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="<?php echo e($net_total); ?>">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e($net_total); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_return/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('purchase_return/checkrefno/')); ?>";
	var urlvchr = "<?php echo e(url('purchase_return/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	var itmurl = "<?php echo e(url('sales_order/item_data/')); ?>";
	...
	$('#voucher_id').on('blur', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('purchase_return/set_session/')); ?>",
			type: 'get',
