                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="<?php echo e(url('production/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<select id="job_id" class="form-control select2" style="width:100%" name="job_id">
											...
											<option value="<?php echo e($job['id']); ?>" <?php if($job['id']==$quoterow->job_id) echo 'selected'; ?>><?php echo e($job['name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('production')); ?>" class="btn btn-danger">Cancel</a>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('production/checkrefno/')); ?>";
