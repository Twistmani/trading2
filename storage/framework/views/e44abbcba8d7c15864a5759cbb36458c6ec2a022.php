                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesReturn" id="frmSalesReturn" action="<?php echo e(url('sales_return/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="voucher_no" value="<?php echo e($vouchers[0]['voucher_no']); ?>" readonly name="voucher_no">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('sales_invoice_id')) echo 'form-error';?>" id="sales_invoice_id" name="sales_invoice_id" value="<?php echo e(old('sales_invoice_id')); ?>" placeholder="Sales Invoice No" autocomplete="off" onclick="getSalesInvoice(this)">
										<input type="hidden" name="is_prior" id="is_prior" value="<?php echo e(old('is_prior')); ?>">
									</div>
                                </div>
									<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name <?php if($errors->has('customer_name')) echo 'form-error';?>" id="customer_name" value="<?php echo e(old('customer_name')); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e(old('customer_id')); ?>">
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e(old('cr_account_id')); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly id="voucher_date" <?php if(old('voucher_date')!='') { ?> value="<?php echo e(old('voucher_date')); ?>" <?php } ?> placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_return/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
//	$('#voucher_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
   ...
   /* $(document).on('click', '.cnloc-info', function(e) { 
	...
	$('#department_id').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_return/getdeptvoucher/')); ?>/" + dept_id, function(data) {  console.log(data);
...
function getSalesInvoice(e) {
	if(e.value=='') { 
		...
		if($('#department_id').length) {
			...
			var pourl = "<?php echo e(url('sales_invoice/invoice_data/')); ?>/"+did;
		} else
