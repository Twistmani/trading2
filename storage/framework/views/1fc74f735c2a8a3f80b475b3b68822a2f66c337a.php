	...
	<div class="table-responsive m-t-10"><button type="button" class="btn btn-primary createSalesman1">Create Engineer</button>
	  <div class="table-responsive m-t-10">
		<table class="table horizontal_table table-striped" id="tablesm">
			...
			<tr>
				<td><a href="" class="salesmanRow" data-id="<?php echo e($salesman->id); ?>" data-name="<?php echo e($salesman->salesman_id); ?>" data-dismiss="modal"><?php echo e($salesman->salesman_id); ?></a></td>
				<td><a href="" class="salesmanRow" data-id="<?php echo e($salesman->id); ?>" data-name="<?php echo e($salesman->name); ?>" data-dismiss="modal"><?php echo e($salesman->name); ?></a></td>
			</tr>
		   <?php endforeach; ?>
			</tbody>
		</table>
...
$(document).ready(function() {  //createSalesman
    ...
    $('#create1').on('click', function(e) { console.log('gg');
        ...
        if(name=="") {
            ...
            $.ajax({
                url: "<?php echo e(url('salesman/ajax_create/')); ?>",
                type: 'get',
