        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<table border="0" style="width:100%;height:100%;">
								...
								<tbody id="bod">
									...
									<body>
										<tr>
											<td colspan="2">
												<table border="0" width="100%">
													...
													<?php if($directexp) { ?>
													<tr class="catrow">
														<td height="20"><strong><?php echo e($directexp['name']); ?></strong></td>
														<?php
														...
														?>
														<td class="text-right"><strong><?php echo e($balance); ?></strong></td>
													</tr>
													<?php foreach($directexp['items'] as $row): ?>
													<?php if($row->cl_balance!=0): ?>
														...
														<?php } else {  ?>
															<td style="padding-left:10px;"><?php echo e($row->master_name); ?></td>
														<?php } ?>
															<?php
																if($row->cl_balance < 0) {
															...
															?>
															<?php if($row->cl_balance!=0) { ?>
															<td class="text-right" height="20"><?php echo e($clbalance); ?></td>
														<?php } ?>
														</tr>
													<?php endif; ?>
													<?php endforeach; ?>
													...
													<tr class="catrow">
														...
														?>
														<td class="text-right"><strong><?php echo e($subtotal); ?></strong></td>
													</tr>
													...
													<tr class="catrow">
														...
														<td class="text-right"><strong><?php echo e($gross_loss_bf); ?></strong></td>
													</tr>
													<?php } ?>
													...
													<tr class="catrow">
														<td height="20"><strong><?php echo e($indirectexp['name']); ?></strong></td>
														<?php
													...
													<?php foreach($indirectexp['items'] as $row): ?>
													<?php if($row->cl_balance != 0) { ?>
														<tr class="catrow" ><?php if($voucherhead=='Profit & Loss - Summary') {?>
															<td style="padding-left:10px;"><?php echo e($row->group_name); ?></td>
														<?php } else { ?>
													...
													<tr class="catrow">
														...
														?>
														<td class="text-right"><h5><strong><?php echo e($netprofit); ?></strong></h5></td>
													</tr>
													<?php } ?>
													</tbody>
												</table>
											...
											<td colspan="2">
												<table border="0" width="100%">
													...
													<?php if($directinc) { ?>
													<tr class="catrow">
														<td height="20"><strong><?php echo e($directinc['name']); ?></strong></td>
														<?php
													...
													<?php foreach($directinc['items'] as $row): ?>
													<?php if($row->cl_balance!=0): ?>
														<tr class="catrow">
														...
														<?php } ?>
															...
															?>
															<td class="text-right" height="20"><?php echo e($cl_balance); ?></td>
														</tr>
													<?php endif; ?>
													<?php endforeach; ?>
													<?php } else { ?>
													...
													<?php if($indirectinc) { ?>
													<tr class="catrow">
														<td height="20"><strong><?php echo e($indirectinc['name']); ?></strong></td>
														<?php
													...
													<?php foreach($indirectinc['items'] as $row): ?>
														<tr class="catrow">
														<?php if($voucherhead=='Profit & Loss - Summary') {?>
															<td style="padding-left:10px;"><?php echo e($row->group_name); ?></td>
														<?php } else { ?>
													...
													<tr >
														<td height="20"><strong>Gross Loss B/F</strong></td>
														<td class="text-right"><strong><?php echo e($netloss); ?></strong></td>
													</tr>
										...
										<tr>
											<td><strong>Total: <?php echo e($currency); ?></strong></td>
											<?php
												if($total < 0) {
													$arr = explode('-', $total);
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('profit_loss/export')); ?>">
						...
						<?php if($clstock) { ?><input type="text" name="cl_stock" value="<?php echo e($clstock); ?>"><?php } ?>
						<?php if($opstock) { ?><input type="text" name="op_stock" value="<?php echo e($opstock); ?>"><?php } ?>
					</form>
