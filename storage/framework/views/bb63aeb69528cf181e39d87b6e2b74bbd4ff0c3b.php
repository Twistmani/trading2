                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="#" class="quot-data" data-id="<?php echo e($order->id); ?>" data-name="<?php echo e($order->voucher_no); ?>" data-toggle="modal" data-target="#quot_modal">View Items</a></td>
										</tr>
										<?php endforeach; ?>
                                    </tbody>
                                </table>
...
function setTransfer() {
	...
	//alert(items);
	if(curl=='SO')
		url = "<?php echo e(url('production/add/')); ?>/"+items+"/SO"; //url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/SO";
	else if(curl=='SOD')
		url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/SO";
	else if(curl=='SOI')
		url = "<?php echo e(url('sales_invoice/add/')); ?>/"+items+"/SO";
     else if(curl=='SRL')
		url = "<?php echo e(url('sales_rental/add/')); ?>/"+items+"/SO";
...
$(document).on('click', '.quot-data', function(e) {
	...
	var itmurl = "<?php echo e(url('sales_order/item_details/')); ?>";
