                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('qs-print'))) : ?>
								 <a href="<?php echo e(url('quotation_sales/print/'.$printid)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="<?php echo e(url('quotation_sales/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<div class="input-group">
											<span class="input-group-addon"><?php echo e($voucherno->prefix); ?></span>
											<input type="text" class="form-control" id="voucher_no" name="voucher_no" <?php if($voucherno->autoincrement==1) { ?> readonly value="<?php echo e($voucherno->no); ?>" <?php } else { ?> value="<?php echo e(old('voucher_no')); ?>" <?php } ?>>
											<input type="hidden" value="<?php echo e($voucherno->prefix); ?>" name="prefix">
											<input type="hidden" value="<?php echo e($voucherno->voucher_type); ?>" name="voucher_type">
											<input type="hidden" value="<?php echo e($voucherno->autoincrement); ?>" name="autoincrement">
										</div>
										<?php } else { ?>
											<input type="text" class="form-control" id="voucher_no" name="voucher_no" <?php if($voucherno->autoincrement==1) { ?> readonly value="<?php echo e($voucherno->no); ?>" <?php } else { ?> value="<?php echo e(old('voucher_no')); ?>" <?php } ?>>
											<input type="hidden" value="<?php echo e($voucherno->prefix); ?>" name="prefix">
								...
								<input type="hidden" name="curno" id="curno" value="<?php echo e((old('curno'))?old('curno'):$voucherno->no); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' id="voucher_date" value="<?php echo e(($voucherdt=='')?date('d-m-Y'):$voucherdt); ?>" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="quotation" value="<?php echo e((old('quotation'))?:$quoterow->voucher_no); ?>" readonly name="quotation" placeholder="Enquiry No" autocomplete="off" onclick="getEnquiry()">
										<input type="hidden" id="quotation_id" name="quotation_id" value="<?php echo e($quoteid); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="subject" name="subject" value="<?php echo e(old('subject')); ?>" placeholder="Subject">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>" <?php if($term['id']==$quoterow->terms_id) echo 'selected'; ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_id" class="form-control select2" style="width:100%" name="job_id">
											...
											<option value="<?php echo e($job['id']); ?>" <?php if($job['id']==old('job_id')) echo 'selected'; ?>><?php echo e($job['name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										<div class="col-xs-1">
											...
											<input type="checkbox" class="custom_icheck" id="is_fc" name="is_fc" <?php echo e($chk); ?> value="1">
										</label>
										</div>
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<?php if($quoterow->currency_id==$curr['id']): ?>
												<?php /**/ $sel = "selected" /**/ ?>
												<?php else: ?>
												<?php /**/ $sel = "" /**/ ?>	
												<?php endif; ?>
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e($quoterow->currency_rate); ?>" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<option value="">Select Location..</option>
											...
											?>
											<option value="<?php echo e($loc['id']); ?>" <?php if($loc['id']==$quoterow->location_id) echo 'selected'; ?>><?php echo e($loc['name']); ?></option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								<?php /**/ $i = 0; $num = count($quoteitems); $total = $vattotal = $nettotal = $nettotal_dh = $total_dh = $vattotal_dh = 0; /**/ ?>
										...
										foreach(old('item_code') as $product) { $j = $i+1;?>
											<div class="itemdivChld">
												<table border="0" class="table-dy-row">
													<tr>
														<td width="16%">
															...
															<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" value="<?php echo e($product); ?>" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#item_modal" placeholder="Item Code">
														</td>
														<td width="29%">
															<input type="text" value="<?php echo e(old('item_name')[$i]); ?>" name="item_name[]" id="itmdes_<?php echo e($j); ?>" autocomplete="off" class="form-control <?php if($errors->has('item_name.'.$i)) echo 'form-error';?>" placeholder="Item Description">
														</td>
														<td width="7%">
														...
														<td width="8%">
															<input type="number" value="<?php echo e(old('quantity')[$i]); ?>" id="itmqty_<?php echo e($j); ?>" step="any" name="quantity[]" autocomplete="off" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" placeholder="Qty.">
														</td>
														<td width="8%">
															<input type="number" id="itmcst_<?php echo e($j); ?>" value="<?php echo e(old('cost')[$i]); ?>" step="any" name="cost[]" autocomplete="off" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" placeholder="Cost/Unit">
														</td>
														<td width="6%">
														...
														<td width="9%">
															...
															<input type="text" id="vatdiv_<?php echo e($j); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" placeholder="VAT Amt" value="<?php echo e(old('vatdiv')[$i]); ?>"> 
												...
												<div style="float:left; padding-right:5px;">
													<button type="button" id="purhisItm_<?php echo e($j); ?>" class="btn btn-primary btn-xs pur-his">Purchse</button>
												</div>
												
												<div style="float:left; padding-right:5px;">
													<button type="button" id="saleshisItm_<?php echo e($j); ?>" class="btn btn-primary btn-xs sales-his">Sales</button>
												</div>
									...
									<?php $i++; } } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="7%">
													<select id="itmunt_<?php echo e($i); ?>" class="form-control select2 line-unit" style="width:100%" name="unit_id[]"><option value="<?php echo e($item->unit_id); ?>"><?php echo e($item->unit_name); ?></option></select></select>
												</td>
												<td width="8%"><input type="hidden" name="actual_quantity[]" id="itmactqty_<?php echo e($i); ?>" value="<?php echo e($actual_quantity); ?>">
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" value="<?php echo e($quantity); ?>">
												</td>
												<td width="8%">
												...
												<td width="9%">
													<input type="hidden" id="hidunit_<?php echo e($i); ?>" name="hidunit[]" class="hidunt">
													<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:$item->packing); ?>">
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '.intval($vat_amount*100)/100); ?>"> 
													<input type="hidden" id="vat_<?php echo e($i); ?>" name="line_vat[]" value="<?php echo e($item->vat); ?>" class="form-control vat">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" value="<?php echo e((old('total'))?old('total'):($quoterow->is_fc==1)?$quoterow->total_fc:$quoterow->total); ?>" step="any" name="total" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" value="<?php echo e((old('total_fc'))?old('total_fc'):$quoterow->total); ?>" step="any" name="total_fc" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="<?php echo e((old('discount'))?old('discount'):($quoterow->is_fc==1)?$quoterow->discount_fc:$quoterow->discount); ?>" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="<?php echo e((old('discount_fc'))?old('discount_fc'):$quoterow->discount); ?>" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" id="subtotal" step="any" name="subtotal" value="<?php echo e((old('subtotal'))?old('subtotal'):($quoterow->is_fc==1)?$quoterow->subtotal_fc:$quoterow->subtotal); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" id="subtotal_fc" step="any" name="subtotal_fc" value="<?php echo e((old('subtotal_fc'))?old('subtotal_fc'):$quoterow->subtotal); ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" value="<?php echo e((old('vat'))?old('vat'):($quoterow->is_fc==1)?$quoterow->vat_amount_fc:$quoterow->vat_amount); ?>" readonly class="form-control spl" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" value="<?php echo e((old('vat_fc'))?old('vat_fc'):$quoterow->vat_amount); ?>" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount'))?old('net_amount'):($quoterow->is_fc==1)?$quoterow->net_total_fc:$quoterow->net_total); ?>">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('quotation_sales')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('quotation_sales/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('qs-history'))) : ?>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('quotation_sales/checkrefno/')); ?>";
	var urlvchr = "<?php echo e(url('quotation_sales/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	var hisurl = "<?php echo e(url('sales_invoice/order_history/')); ?>";
	...
	var custurl = "<?php echo e(url('sales_order/customer_data/')); ?>";//quotation_sales
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('quotation_sales/checkvchrno/')); ?>", 
			type: 'get',
...
function getEnquiry() { 
	...
	var wt = $(window).width();
	var customer_id = $("#customer_id").val();
	var pourl = "<?php echo e(url('customer_enquiry/get_enquiry/')); ?>/"+customer_id+"/so";
