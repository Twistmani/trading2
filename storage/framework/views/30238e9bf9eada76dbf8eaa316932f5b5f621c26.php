...
$(document).ready(function () {
	...
	$(function() {
		...
		var dtInstance = $("#tableInvDataList").DataTable({
			...
			"serverSide": true,
			"ajax":{
					 "url": "<?php echo e(url('sales_invoice/paging_invoice_data/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
...
function setTransfer() {
	...
	//alert(items);
	 invoiceurl = "<?php echo e(url('sales_return/add/')); ?>/"+item;
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('sales_invoice/item_details/')); ?>";
