            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" target="_blank" method="POST" name="frmProfitAnalysis" id="frmProfitAnalysis" action="<?php echo e(url('profit_analysis/search')); ?>">
								...
								<?php if($type=="summary") { ?>
									<table class="table horizontal_table table-striped" id="tableAcmaster" >
										...
										<?php $i=0;$sptotal = $dtotal = $ctotal = $ptotal = $pertotal = $peravg = 0;?>
											...
											?>
											<tr>
												<td><?php echo e($report['voucher_no']); ?></td>
												<td><?php echo e(date('d-m-Y', strtotime($report['voucher_date']))); ?></td>
												<td><?php echo e($report['supplier']); ?></td>
												<td><?php echo e(number_format($sprice,2)); ?></td>
												<td><?php echo e(number_format($report['discount'],2)); ?></td>
												<td><?php echo e(number_format($sprice, 2)); ?></td>
								...
								<?php } 
									...
									<?php foreach($reports as $report) { ?>
										<thead>
											<th style="width:37%;" colspan="3">Inv.#: <?php echo e($report[0]['voucher_no']); ?></th>
											<th style="width:40%;" colspan="4">Cust.Name: <?php echo e($report[0]['supplier']); ?></th>
											<th style="width:23%;" colspan="2">Date: <?php echo e(date('d-m-Y',strtotime($report[0]['voucher_date']))); ?></th>
										</thead>
										...
										<tbody>
											...
											?>
														<tr>
															...
															<td style="width:12%;"><?php echo e($row['item_code']); ?></td>
															<td style="width:20%;"><?php echo e($row['description']); ?></td>
															<td style="width:7%;"><?php echo e($row['squantity']); ?></td>
															<td style="width:10%;" class="text-right"><?php echo e(number_format($row['sunit_price'],2)); ?></td>
															<td style="width:5%;" class="text-right"><?php echo e(number_format($row['discount'],2)); ?></td>
															<td style="width:18%;" class="text-right"><?php echo e(number_format($row['punit_price'],2)); ?></td>
															<td style="width:16%;" class="text-right"><?php echo e(number_format($profit,2)); ?></td>
															<td style="width:7%;" class="text-right"><?php echo e(number_format($percentage,2)); ?></td>
														</tr>
												<?php } $peravg = $pertotal / $n; ?>
											<tr>
												<td colspan="4" align="right"><b>Sub Total:</b></td>
												<td style="width:10%;" class="text-right"><b><?php echo e(number_format($sptotal,2)); ?></b></td>
												<td style="width:5%;" class="text-right"><b><?php echo e(number_format($dtotal,2)); ?></b></td>
												<td style="width:18%;" class="text-right"><b><?php echo e(number_format($ctotal,2)); ?></b></td>
												<td style="width:16%;" class="text-right"><b><?php echo e(number_format($ptotal,2)); ?></b></td>
												<td style="width:7%;" class="text-right"><b><?php echo e(number_format($peravg,2)); ?></b></td>
											</tr>
								...
								<?php } else if($type=="customer") { ?>
									...
									<?php foreach($reports as $report) { ?>
										<thead>
											<th style="width:37%;" colspan="3">Cust.#: <?php echo e($report[0]['account_id']); ?></th>
											<th style="width:40%;" colspan="4">Cust.Name: <?php echo e($report[0]['supplier']); ?></th>
										...
										<tbody>
											...
											?>
														<tr>
															...
															<td style="width:12%;"><?php echo e(date('d-m-Y',strtotime($row['voucher_date']))); ?></td>
															<td style="width:15%;"><?php echo e($row['item_code']); ?></td>
															<td style="width:7%;"><?php echo e($row['squantity']); ?></td>
															<td style="width:10%;" class="text-right"><?php echo e(number_format($row['sunit_price'],2)); ?></td>
															<td style="width:5%;" class="text-right"><?php echo e(number_format($row['discount'],2)); ?></td>
															<td style="width:18%;" class="text-right"><?php echo e(number_format($row['punit_price'],2)); ?></td>
								...
								<?php } else if($type=="item") { ?>
									...
									<?php foreach($reports as $report) { ?>
										<thead>
											<th style="width:37%;" colspan="3">Item Code: <?php echo e($report[0]['item_code']); ?></th>
											<th style="width:40%;" colspan="4">Item Name: <?php echo e($report[0]['description']); ?></th>
											<th style="width:23%;" colspan="2"></th>
										</thead>
										...
										<tbody>
											...
											?>
														<tr>
															...
															<td style="width:17%;"><?php echo e($row['supplier']); ?></td>
															<td style="width:7%;"><?php echo e($row['squantity']); ?></td>
															<td style="width:10%;" class="text-right"><?php echo e(number_format($row['sunit_price'],2)); ?></td>
															<td style="width:5%;" class="text-right"><?php echo e(number_format($row['discount'],2)); ?></td>
															<td style="width:18%;" class="text-right"><?php echo e(number_format($row['punit_price'],2)); ?></td>
	...
	$(document).on('change', '#search_type', function(e) { //$('#search_type').on('change', function(e){
		...
		if(vchr=='customer') {
			...
			if( $("#selitm").is(":visible") )
				$("#selitm").toggle();
			/* $.get("<?php echo e(url('profit_analysis/getcustomer/')); ?>", function(data) {
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getcustomer/')); ?>",
				//type: 'get',
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getsalesman/')); ?>",
				//type: 'get',
				//data: 'item_id='+item_id+'&unit_id='+unit_id,
				success: function(data) {
					$('#selsale').html(data);
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getArea/')); ?>",
				//type: 'get',
				//data: 'item_id='+item_id+'&unit_id='+unit_id,
				success: function(data) {
					$('#selarea').html(data);
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getitems/')); ?>",
				success: function(data) {
					$('#selitm').html(data);
					return true;
				}
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getgroup/')); ?>",
				success: function(data) {
					$('#selgroup').html(data);
					return true;
				}
			...
			$.ajax({
				url: "<?php echo e(url('profit_analysis/getSubGroup/')); ?>",
				success: function(data) {
...
function printInvoice() {	
	document.frmProfitAnalysis.action = "<?php echo e(url('profit_analysis/print')); ?>";
