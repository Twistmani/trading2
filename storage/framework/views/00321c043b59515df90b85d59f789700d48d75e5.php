									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
...
function updateDraft() {
    ...
    document.frmSalesOrder.action="<?php echo e(url('sales_order/update_draft/'.$orderrow->id)); ?>";
