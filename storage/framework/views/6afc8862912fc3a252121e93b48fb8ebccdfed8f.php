                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('so-print'))) : ?>
							 <a href="<?php echo e(url('suppliers_do/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('suppliers_do/update/'.$orderrow->id)); ?>">
								...
								<input type="hidden" name="document_type" id="document_type" value="<?php echo e($orderrow->document_type); ?>">
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	...
																	<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($quantity); ?>" class="loc-qty-<?php echo e($j); ?>" data-id="<?php echo e($j); ?>">
								...
								<?php foreach($orditems as $item): ?>
								    <?php  $max_quantity = $item->po_balance_quantity + $item->quantity;  ?>
								<?php /**/ $i++; /**/ ?>
								<div class="itemdivChld">							
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%">
														...
														<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off"step="any"  name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>" <?php echo e(($formdata['location_item']==1)?'readonly':''); ?>  <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?>>
											...
											<div id="batchdiv_1" style="float:left; padding-right:5px;" class="addBatchBtn">
												...
												<div class="form-group"><input type="hidden" name="batchNos[]" id="batchNos_<?php echo e($i); ?>" style="border:none;color:#000;" value="<?php echo e($batchitems[$item->id]['batches']); ?>"></div>
														 ...
														 <div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	<td><?php echo e($row->name); ?></td>
																	<td><?php echo e($cqty); ?></td>
																	<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($qty_entry); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>" <?php echo e(($orderrow->is_editable==1)?'readonly':''); ?>>
																	<input type="hidden" name="locid[<?php echo $i-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="editid[<?php echo $i-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount')?old('net_amount'):$orderrow->is_fc==1)?$orderrow->net_total_fc:$orderrow->net_total); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" value="<?php echo e((old('net_amount_fc'))?old('net_amount_fc'):$orderrow->net_total); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('suppliers_do')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('suppliers_do/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(function() {	
	...
	$(document).on('click', '.itemRow', function(e) { 
		...
		//DEC24
		$('#itmqty_'+num).val('');
		var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+itm_id+"/"+num
	...
	$(document).on('click', '.loc-info', function(e) { 
	   ...
	   if(item_id!='') {
		   var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+item_id+"/"+curNum+"/"+pi_id+"/SDO";
