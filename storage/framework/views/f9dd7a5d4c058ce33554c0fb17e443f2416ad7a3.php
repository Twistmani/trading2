...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                    ...
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('pi-create'))) : ?>
                             <a href="<?php echo e(url('purchase_invoice/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" target="_blank" id="frmPOReport" action="<?php echo e(url('purchase_invoice/search')); ?>">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('purchase_invoice/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePurInvoice").DataTable({
			...
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "<?php echo e(url('purchase_invoice/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
			...
			{ "data": "supplier" },
			{ "data": "net_total" },
			<?php if (\Entrust::can(('pi-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('pi-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('pi-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('pi-delete'))) : ?>{ "data": "delete","bSortable": false }<?php endif; // Entrust::can ?>
		]	
		...
		$(document).on('change', '#department', function(e) {  
			...
			$('#select22').on('change', function(e){
			    ...
			    if(sup_id !=''){
			    $.get("<?php echo e(url('purchase_invoice/getjob/')); ?>/" + sup_id, function(data) {
