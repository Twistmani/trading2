                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmMaster" id="frmMaster" action="<?php echo e(url('account_master/save')); ?>">
								...
								<input type="hidden" name="category" id="category" value="<?php echo e($catgy); ?>">
								<input type="hidden" name="typetr" id="typetr" value="<?php echo e($typetr); ?>">
								<div class="form-group">
                                    <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>Account ID</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="account_id" name="account_id" value="<?php echo e($accode); ?>" placeholder="Account ID">
                                    </div>
                                </div>
								...
								<div id="addressDtls"><hr/>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="currency_id" class="form-control select2 fcurrency" style="width:100%" name="currency_id">
											...
											<option value="<?php echo e($cur->id); ?>" <?php echo e(($settings->fcurrency_id==$cur->id)?'selected':''); ?>><?php echo e($cur->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
...
$(function() {
	...
	/*$(document).on('blur', 'input[name="tr_date[]"]', function(e) {
		...
		var curNum = res[1];
		$.ajax({
			url: "<?php echo e(url('account_master/check_trndate/')); ?>",
			type: 'get',
