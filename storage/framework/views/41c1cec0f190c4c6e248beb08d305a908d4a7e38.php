        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<tbody id="bod">
								...
								<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											<h6><b>Sup.Name: <?php echo e($report[0]->debitor); ?><br/>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('supplier_payment/export')); ?>">
