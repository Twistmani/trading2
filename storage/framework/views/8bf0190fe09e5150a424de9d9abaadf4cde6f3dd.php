...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('stock_transferin/add')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableLocation">
                                    ...
                                    <tr>
										...
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('stock_transferin/edit/'.$stock->id)); ?>'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
											<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('stock_transferin/viewonly/'.$stock->id)); ?>'">
												<span class="glyphicon glyphicon-eye-open"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($stock->id); ?>','<?php echo e($stock->is_mfg); ?>')"><span class="glyphicon glyphicon-trash"></span></button>
											</p>
										</td>
										<td>
											<p><a href="<?php echo e(url('stock_transferin/print/'.$stock->id)); ?>" target = "_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>
										</td>
                                    </tr>
									<?php endforeach; ?>
        ...
        <section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('stock_transferin/search')); ?>">
...
function funDelete(id,m) {
	if(m=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('stock_transferin/delete/')); ?>";
