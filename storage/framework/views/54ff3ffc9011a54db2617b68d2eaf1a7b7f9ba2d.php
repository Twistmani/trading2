                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesReturn" id="frmSalesReturn" action="<?php echo e(url('sales_return/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
										...
										<option value="<?php echo e($voucher['id']); ?>" <?php if($orderrow->voucher_id==$voucher['id']) echo 'selected';?>><?php echo e($voucher['voucher_name']); ?></option>
										<?php endforeach; ?>
									</select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="sales_invoice_no" name="sales_invoice_no" value="<?php echo e($orderrow->voucher_no); ?>" autocomplete="off" onclick="getSalesInvoice(this)">
										<input type="hidden" class="form-control" id="sales_invoice_id" name="sales_invoice_id" value="<?php echo e($pordid); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" class="form-control" autocomplete="off" data-toggle="modal" data-target="#customer_modal" value="<?php echo e($orderrow->customer); ?>">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e($orderrow->customer_id); ?>">
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e($orderrow->customer_id); ?>">
									</div>
                                </div>
								...
								<?php if($formdata['reference_no']==1) { ?>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" value="<?php echo e($orderrow->voucher_no); ?>" name="reference_no" placeholder="Reference No.">
										</div>
									</div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" autocomplete="off" value="<?php echo e($orderrow->description); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<?php if($orderrow->currency_id==$curr['id']): ?>
												<?php /**/ $sel = "selected" /**/ ?>
												<?php else: ?>
												<?php /**/ $sel = "" /**/ ?>	
												<?php endif; ?>
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e($orderrow->currency_rate); ?>">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<?php if(old('item_code')) { $i = 0; 
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													<input type="hidden" name="sales_invoice_item_id[]" id="p_invitmid_<?php echo e($j); ?>" value="<?php echo e(old('sales_invoice_item_id')[$i]); ?>">
													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e(old('item_id')[$i]); ?>">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($j); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e(old('vatdiv')[$i]); ?>"><!--<div class="h5" id="vatdiv_<?php echo e($j); ?>"></div>--> 
											...
											<div>
												<button type="button" id="cnlocVw_<?php echo e($j); ?>" data-toggle="modal" data-target="#view_conloc_modal" class="btn btn-primary btn-xs view-cnloc-info">View Consignment Location</button>
												<input type="hidden" name="conloc_id[]" id="hdlocid_<?php echo e($j); ?>" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty[]" id="hdlocqty_<?php echo e($j); ?>" value="<?php echo e($item->conloc_qty); ?>">
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	...
																	<td class="num"><input type="number" name="locqty[<?php echo $j-1;?>][]" value="<?php echo e($quantity); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>">
																	<input type="hidden" name="locid[<?php echo $j-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="editid[<?php echo $j-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
																</tbody>
															</table>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="13%">
													...
													<input type="hidden" name="sales_invoice_item_id[]" id="p_invitmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($item->item_id); ?>">
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" value="<?php echo e($item->item_code); ?>">
												</td>
												<td width="19%">
													<input type="text" name="item_name[]" id="itmdes_<?php echo e($i); ?>" autocomplete="off" class="form-control" data-toggle="modal" data-target="#item_modal" value="<?php echo e($item->item_name); ?>">
												</td>
												<td width="13%">
													<select id="itmcat_<?php echo e($i); ?>" class="form-control select2" style="width:100%" name="cat_id[]">
													<option>Select</option>
													<?php foreach($itemcat as $cat): ?>
												...
												<td width="9%">
													...
													<option value="<?php echo e($item->unit_id); ?>"><?php echo e($item->unit_name); ?></option>
													</select>
												</td>
												<?php if($ismpqty==1): ?>
												...
												<?php endif; ?>
												<td width="8%">
													<input type="hidden" name="actual_quantity[]" id="itmactqty_1" value="<?php echo e(($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity); ?>">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" min="1" value="<?php echo e(($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity); ?>" <?php echo e(($item->batch_req==1)?'readonly':''); ?>>
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" autocomplete="off" name="cost[]" class="form-control line-cost" value="<?php echo e($unit_price); ?>">
													<input type="hidden" name="item_cost[]" value="<?php echo e($item->item_cost); ?>">
												</td>
												<td width="6%">
												...
												<td width="9%">
													...
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '.$vat_amount); ?>"><!--<div class="h5" id="vatdiv_1"></div>--> 
													<input type="hidden" id="vat_<?php echo e($i); ?>" name="line_vat[]" class="form-control vat" value="<?php echo e($item->vat); ?>">
													<input type="hidden" id="vatlineamt_<?php echo e($i); ?>" name="vatline_amt[]" class="form-control vatline-amt" value="<?php echo e($item->vat_amount); ?>">
													<input type="hidden" id="itmdsnt_1" name="line_discount[]"  value="<?php echo e($item->discount); ?>">
												</td>
												<td width="11%">
											...
											<div>
												<button type="button" id="cnlocVw_<?php echo e($i); ?>" data-toggle="modal" data-target="#view_conloc_modal" class="btn btn-primary btn-xs view-cnloc-info">View Consignment Location</button>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" value="<?php echo e((old('total')?old('total'):$orderrow->is_fc==1)?$orderrow->total_fc:$orderrow->total); ?>" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" readonly value="<?php echo e((old('total_fc'))?old('total_fc'):$orderrow->total); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" value="<?php echo e((old('discount')?old('discount'):$orderrow->is_fc==1)?$orderrow->discount_fc:$orderrow->discount); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" value="<?php echo e((old('discount_fc'))?old('discount_fc'):$orderrow->discount); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" readonly value="<?php echo e((old('subtotal_fc'))?old('subtotal_fc'):$orderrow->subtotal); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" placeholder="0" value="<?php echo e((old('vat_fc'))?old('vat_fc'):$orderrow->vat_amount); ?>" readonly>
										</div>
									</div>
                                </div>
								
								
								<!--<input type="hidden" step="any" id="discount" name="discount" class="form-control" value="<?php echo e($discount); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="<?php echo e((old('net_amount_hid'))?old('net_amount_hid'):$orderrow->net_total); ?>">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount')?old('net_amount'):$orderrow->is_fc==1)?$orderrow->net_total_fc:$orderrow->net_total); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="<?php echo e((old('net_amount_fc'))?old('net_amount_fc'):$orderrow->net_total); ?>" placeholder="0">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_return')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
"use strict";
var srvat=<?php echo e($vatdata->percentage); ?>;
...
$(function() {	
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_return/getvoucher/')); ?>/" + vchr_id, function(data) {
	...
	$(document).on('blur', '#sales_invoice_id', function(e) { 
		...
		if(id!='') {
			var urlcode = "<?php echo e(url('sales_invoice/check_invoice/')); ?>";
			$.ajax({
				url: urlcode,
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('sales_return/checkvchrno/')); ?>", 
			type: 'get',
...
function getSalesInvoice(e) {
	if(e.value=='') { 
		var ht = $(window).height();
		var wt = $(window).width();
		var pourl = "<?php echo e(url('sales_invoice/invoice_data/')); ?>";
