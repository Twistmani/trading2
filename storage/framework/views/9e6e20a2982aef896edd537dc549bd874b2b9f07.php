                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tablePrint">
                                    ...
                                    <tr>
										...
										<td> <a href="<?php echo e(url('set_report/'.$row->id)); ?>" class="btn btn-primary">Assign Print</a></td>
										<td> <a href="<?php echo e(url('set_infotemplate/'.$row->code)); ?>" target="_blank" class="btn btn-primary">Set Info Template</a></td>
                                    </tr>
									<?php endforeach; ?>
