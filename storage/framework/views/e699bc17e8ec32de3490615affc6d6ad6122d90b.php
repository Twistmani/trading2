        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td><b>PI#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>PI Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>PI Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('purchase_invoice/export')); ?>">
						...
						<input type="hidden" name="isimport" value="<?php echo e($isimport); ?>" >
