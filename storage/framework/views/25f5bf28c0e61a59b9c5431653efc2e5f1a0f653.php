...
<?php $__env->startSection('header_styles'); ?>
	...
	<link href="<?php echo e(asset('assets/vendors/selectize/css/selectize.css')); ?>" rel="stylesheet" type="text/css">
...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body controls">
                            <form class="form-horizontal" role="form" method="POST" name="frmItem" id="frmItem" enctype="multipart/form-data" action="<?php echo e(url('itemmaster/save')); ?>">
								...
								<table id="simple_user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											...
											<td>
												<input type="hidden" value="<?php echo e($vats[0]['percentage']); ?>" type="text" name="vat[]" id="vat_1" class="form-control itemunit" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         <a href="<?php echo e(url('itemmaster')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
           ...
           <?php /* <div id="batch_view_modal" class="modal fade animated" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
