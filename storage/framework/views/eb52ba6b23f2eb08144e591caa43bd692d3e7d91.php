                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplit" id="frmSalesSplit" action="<?php echo e(url('sales_split_return/save/'.$orderrow->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_split_return')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('sales_split/add/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
function getAccount(e) { 
	...
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('sales_split/account_data/')); ?>/"+curNum;
