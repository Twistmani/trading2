                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmCategory" id="frmCategory" action="<?php echo e(url('emp_category/update/'.$empcategory->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="category_name" name="category_name"
                                               placeholder="Category Name" value="<?php echo e($empcategory->category_name); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Description</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="<?php echo e($empcategory->description); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit
                                                         ...
                                                         <a href="<?php echo e(url('emp_category')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
<script>
"use strict";
var url = "<?php echo e(url('emp_category/checkname/')); ?>";
