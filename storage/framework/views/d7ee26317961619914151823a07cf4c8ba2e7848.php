...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('suppliers_do/add')); ?>" class="btn btn-primary btn-sm">
                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><?php echo e(number_format($order->net_total,2)); ?></td>
											<td>
											    <div class='btn-group drop_btn' role='group'>
													...
													<ul style='min-width:100px !important;' class='dropdown-menu' aria-labelledby='exampleIconDropdown1' role='menu'>
														<li role='presentation'><a href="<?php echo e(url('suppliers_do/edit/'.$order->id)); ?>"  role='menuitem'>Edit</a></li>
														<li role='presentation'><a href="<?php echo e(url('suppliers_do/refresh_sdo/'.$order->id)); ?>" role='menuitem'>Refresh</a></li>
													</ul>
												</div>
												
												<p></p>
											</td>
											<td>	<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('suppliers_do/viewonly/'.$order->id)); ?>'">
											...
											<td>
												<div class='btn-group drop_btn' role='group'>
													...
													<ul style='min-width:100px !important;' class='dropdown-menu' aria-labelledby='exampleIconDropdown1' role='menu'>
														...
														<li role='presentation'><a href="<?php echo e(url('suppliers_do/print/'.$order->id.'/'.$doc->id)); ?>" target='_blank' role='menuitem'><?php echo e($doc->name); ?></a></li>
														<?php } ?>
													</ul>
												</div>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('suppliers_do/search')); ?>">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('suppliers_do/delete/')); ?>";
	...
	var dtInstance = $("#tablePorders").DataTable({
		...
		$('#select22').on('change', function(e){
			    var sup_id = $('#select22').val();
			     ...
			     if(sup_id !=''){
			    $.get("<?php echo e(url('suppliers_do/getjob/')); ?>/" + sup_id, function(data) {
