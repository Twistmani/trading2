        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body">
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>
									...
									<?php echo $__env->make('main.print_head', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
									</td
								</tr>
								...
								<tr style="border:0px solid black;">
									...
									<td align="left" style="padding-left:200px; width:50%;">
										<div>
											<b>Mfg. No: <?php echo e($mfgno); ?></b><br/>
											Date:  <?php echo e(date('d-m-Y',strtotime($details->voucher_date))); ?><br/>
										</div>
								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										...
										<tr>
											...
											<td class="text-right"><?php echo e(number_format($uprice,2)); ?></td>
											<td class="text-right"><?php echo e(number_format($uprice * $item->quantity,2)); ?></td>
										</tr>
										...
										<tr>
											...
											<td colspan="5"><b>Raw Materials</b>
												<table class="table horizontal_table table-striped" id="postsrw">
													...
													<?php  $rmtotal = 0;  ?>
													<?php foreach($rawmat[$item->item_id] as $raw): ?>
													<?php  $price = $raw->quantity * $item->quantity * $raw->unit_price; $rmtotal += $price;  ?>
													<tr>
														<td><?php echo e($raw->item_code); ?></td>
														<td><?php echo e($raw->description); ?></td>
														<td><?php echo e($raw->quantity*$item->quantity); ?></td>
														<td class="text-right"><?php echo e(number_format($raw->unit_price,2)); ?></td>
														<td class="text-right"><?php echo e(number_format($price,2)); ?></td>
													</tr>
													<?php endforeach; ?>
													<?php  $gtotal += $rmtotal;  ?>
													<tr><td colspan="4">Total:</td><td class="text-right"><?php echo e(number_format($rmtotal,2)); ?></td></tr>
												</table>
											</td>
											<td></td>
										</tr>
										...
										<?php endforeach; ?>
										<?php  $octotal = 0;  ?>
										<?php foreach($ocost as $cost): ?>
										<?php  $total += $cost->amount; $octotal += $cost->amount;  ?>
										<tr>
											<td></td>
											...
											<td></td>
											<td></td>
											<td class="text-right"><?php echo e(number_format($cost->amount,2)); ?></td>
											</td>
										</tr>
										<?php endforeach; ?>
									</table>
								...
								<tr style="border:1px solid black;">
									<td colspan="2" align="center">
										...
										<tr>
											...
											<b>
												<p><?php echo e(number_format($gtotal,2)); ?></p>
												<p><?php echo e(number_format($octotal,2)); ?></p>
												<p><?php echo e(number_format($gtotal+$octotal,2)); ?></p>
											</b>
											</td>
										</tr>
										</table>
                    ...
                    <form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('manufacture/printexport')); ?>">
