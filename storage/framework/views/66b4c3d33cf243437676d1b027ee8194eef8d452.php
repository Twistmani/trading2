                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('unit/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    <td><input <?php if(($unit->id <=2) && ($aitem==1) ) echo 'disabled';?> type='checkbox' name='unitid[]' class='chk-unitid' value='<?php echo e($unit->id); ?>'/></td>
                                    <td><?php echo e($unit->unit_name); ?></td>
                                    <td><?php echo e($unit->description); ?></td>
                                    <td>
                                        <p>
                                            <button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('unit/edit/'.$unit->id)); ?>'"><span
                                                        class="glyphicon glyphicon-pencil"></span></button>
                                        </p>
                                    </td>
                                    <td>
                                        <p>
                                            <button class="btn btn-danger btn-xs delete"<?php if(($unit->id <=2)  && ($aitem==1)) echo 'disabled';?>  onClick="funDelete('<?php echo e($unit->id); ?>')"><span
...
function funDelete(id) {
    ...
    if(con==true) {
        var url = "<?php echo e(url('unit/delete/')); ?>";
    ...
    if (!checked) {
        ...
        if(con==true) {
           ...
           $('#chkids').val(id);
            ...
            document.frmUnits.action="<?php echo e(url('unit/group_delete')); ?>"
...
function deleteRow() {  
    ...
    if (!checked) {
        ...
        if(con==true) {
            ...
            document.frmOrders.action="<?php echo e(url('unit/group_delete')); ?>"
