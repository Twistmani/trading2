                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="<?php echo e(url('sales_order/save')); ?>">
                                ...
                                <?php if(isset($poso)): ?>
								<input type="hidden" name="po_to_so" value="<?php echo e($poso); ?>">
								<?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' id="voucher_date" value="<?php echo e(($voucherdt=='')?date('d-m-Y'):$voucherdt); ?>" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" name="lpo_date" data-language='en' value="<?php echo e($lpodt); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         <input type="text" class="form-control" id="quotation" readonly name="quotation" value="<?php echo e((old('quotation'))?:$quoterow->voucher_no); ?>" autocomplete="off" onclick="getQuotation()">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" name="jobname" id="jobname" class="form-control" autocomplete="off" data-toggle="modal" data-target="#job_modal" value="<?php echo e($quoterow->code); ?>">
										<input type="hidden" name="job_id" id="job_id" value="<?php echo e($quoterow->job_id); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e($quoterow->currency_rate); ?>">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<?php if(old('item_code')) { $i = 0; 
										...
										<div class="itemdivChld">
											<table border="0" class="table-dy-row">
												<tr>
													<td width="16%">
														<input type="hidden" name="quote_sales_item_id[]" id="quote_sales_itmid_<?php echo e($j); ?>" value="<?php echo e(old('order_item_id')[$i]); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<span class="small" id="fc_label">Currency</span>
											<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e((old('total'))?old('total'):(($quoterow->is_fc==1)?$quoterow->total_fc:$total)); ?>">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" class="form-control spl discount-cal" value="<?php echo e((old('discount'))?old('discount'):(($quoterow->is_fc==1)?$quoterow->discount_fc:$quoterow->discount)); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" value="<?php echo e((old('discount_fc'))?old('discount_fc'):$quoterow->discount); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="<?php echo e((old('subtotal'))?old('subtotal'):(($quoterow->is_fc==1)?$quoterow->subtotal_fc:$total)); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" value="<?php echo e((old('subtotal_fc'))?old('subtotal_fc'):$quoterow->subtotal); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="<?php echo e((old('vat'))?old('vat'):(($quoterow->is_fc==1)?$quoterow->vat_amount_fc:$vattotal)); ?>" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="<?php echo e((old('vat_fc'))?old('vat_fc'):$quoterow->vat_amount); ?>" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" value="<?php echo e((old('net_amount'))?old('net_amount'):(($quoterow->is_fc==1)?(isset($poso))?$quoterow->net_amount_fc:$quoterow->net_total_fc:(isset($poso))?$nettotal:$quoterow->net_total)); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description"><?php echo e($quoterow->foot_description); ?></textarea>
                                    </div>
                                </div>
								<?php } ?>
...
function getQuotation() { 
	...
	var wt = $(window).width();
	var customer_id = $("#customer_id").val();
	var pourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id;
