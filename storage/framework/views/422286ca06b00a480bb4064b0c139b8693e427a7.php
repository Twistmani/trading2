                                                ...
                                                <table class="table table" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php for($i = 0; $i < $maxRows; $i++): ?>
                                                            <tr>
                                                                <td>
                                                                    <?php if(isset($expenseRows[$i]['type']) && $expenseRows[$i]['type'] == 'group'): ?>
                                                                        <strong><?php echo e($expenseRows[$i]['label']); ?></strong>
                                                                    <?php else: ?>
                                                                        <?php echo e(isset($expenseRows[$i]['label']) ? $expenseRows[$i]['label'] : ''); ?>

                                                                    <?php endif; ?>
                                                                </td>
                                                                <td align="right"><?php echo e(isset($expenseRows[$i]['amount']) ? $expenseRows[$i]['amount'] : ''); ?></td>

                                                                <td>
                                                                    <?php if(isset($incomeRows[$i]['type']) && $incomeRows[$i]['type'] == 'group'): ?>
                                                                        <strong><?php echo e($incomeRows[$i]['label']); ?></strong>
                                                                    <?php else: ?>
                                                                        <?php echo e(isset($incomeRows[$i]['label']) ? $incomeRows[$i]['label'] : ''); ?>

                                                                    <?php endif; ?>
                                                                </td>
                                                                <td align="right"><?php echo e(isset($incomeRows[$i]['amount']) ? $incomeRows[$i]['amount'] : ''); ?></td>
                                                            </tr>
                                                        <?php endfor; ?>
                                                    ...
                                                    <tfoot>
                                                        <tr style="font-weight: bold; background-color: #f0f0f0;">
                                                            <td>Total Expense</td>
                                                            <td align="right"><?php echo e(number_format($totalExpense, 2)); ?></td>
                                                            <td>Total Income</td>
                                                            <td align="right"><?php echo e(number_format($totalIncome, 2)); ?></td>
                                                        </tr>
                                                        <tr style="font-weight: bold; background-color: #e0e0e0;">
                                                            <td colspan="2">
                                                                Net <?php echo e($totalIncome - $totalExpense >= 0 ? 'Profit' : 'Loss'); ?>

                                                            </td>
                                                            <td colspan="2" align="right">
                                                                <?php echo e(number_format(abs($totalIncome - $totalExpense), 2)); ?>
