...
<div class="panel panel-success filterable" id="newItemAsmList">
	...
	<input type="hidden" name="num" id="numasm" value="<?php echo e($num); ?>">
...
$(function() {
	...
	$(function() {
		...
		var dtInstance = $("#postsitmsAsm").DataTable({
			...
			"serverSide": true,
			"ajax":{
					 "url": "<?php echo e(url('itemmaster/asmitem_data/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data":{ _token: "<?php echo e(csrf_token()); ?>", "num":<?php echo e($num); ?>, "mod":"<?php echo e($mod); ?>" }
				   },
			"columns": [
