        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<table border="0" style="width:100%;height:100%;">
                                ...
                                <th>SI.#</th>
                                    ...
                                    <td ><?php echo e(++$i); ?></td>
										...
										<td class="text-right"><?php echo e($row->master_name); ?></td>
										
										
										<td class="text-right"><?php echo e(number_format($row->total,2)); ?></td>
										<td class="text-right"><?php echo e(number_format($row->total_discount,2)); ?></td>
										<td class="text-right"><?php echo e(number_format($row->subtotal,2)); ?></td>
										...
										<td class="text-right"><b><?php echo e(number_format($discount_total,2)); ?></b></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php  $i++;  ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($i); ?> &nbsp;  <b>SR Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>SR.#:</b> <?php echo e($report[0]->voucher_no); ?></td>
											...
											<?php $gtotal =$namount=$namount_total=$vtotal=$qtotal =$total_amt=0; ?>
												...
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($row->total_price,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($total_amount,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($row->item_vat,2)); ?></td>
													<td class="text-right"><?php echo e(number_format($namount,2)); ?></td>
												</tr>
												<?php endforeach; ?>
												<tr>
													<td></td>
													<td class="text-right"><b>Sub Total:</b></td>
													<td class="text-right"><b><?php echo e($qtotal); ?></b></td>
													<td class="text-right"></td>
													<td class="text-right"></td>
													<td class="text-right"><b><?php echo e(number_format($gtotal,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($vtotal,2)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($namount_total,2)); ?></b></td>
												</tr>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('sales_return/export')); ?>">
