        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<table border="0" style="width:100%;height:100%;">
								...
								<tbody id="bod">
									...
									<?php foreach($reports as $key => $report): ?>
										...
										<?php endforeach; ?>
										<tr>
										 <td class="text-right"><b><?php echo e($key); ?></b></td>
							...
							<tbody id="bod">
								...
								<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											<h6><b>Job.Name: <?php echo e($report[0]->jobname); ?><br/>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td ><?php echo e($row->jobaccount); ?></td>
												<td ><?php echo e($row->item_name); ?></td>
												<td class="text-right"><?php echo e(number_format($row->quantity,2)); ?></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td  width="3%" class="text-right"><b><?php echo e(number_format($nsptotal,2)); ?></b></td>
										
											<td width="3%" class="text-right"><b><?php echo e(number_format($nctotal,2)); ?></b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('goods_return/export')); ?>">
