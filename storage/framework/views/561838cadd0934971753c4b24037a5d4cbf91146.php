                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php if($orderrow->approval_status==2) { echo 'danger'; } elseif($orderrow->approval_status==1) { echo 'warning'; } else echo 'primary';?>">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmMaterialRequisition" id="frmMaterialRequisition" action="<?php echo e(url('material_requisition/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="material_requisition_id" id="material_requisition_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" readonly data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="GI. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" class="form-control" autocomplete="off" readonly value="<?php echo e($orderrow->code); ?>">
                               ...
                               <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" readonly name="description" value="<?php echo e($orderrow->description); ?>">
                                    </div>
                                </div>
                                <?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" readonly  value="<?php echo e($item->item_code); ?>">
												</td>
												<td width="29%">
													<input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" readonly value="<?php echo e($item->item_name); ?>">
												</td>
												<td width="7%">
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" class="form-control line-quantity" readonly value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" class="form-control line-cost" readonly value="<?php echo e($item->unit_price); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="button" onClick="funReject('<?php echo e($orderrow->id); ?>')" class="btn btn-danger" <?php if($orderrow->approval_status==2) echo 'disabled';?>>Reject</button> 
                                        <a href="<?php echo e(url('material_requisition')); ?>" class="btn btn-warning">Cancel</a>
                                    </div>
                                </div>
...
function funApproval(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('material_requisition/approve/')); ?>";
...
function funReject(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('material_requisition/reject/')); ?>";
		location.href = url+'/'+id;
	}
}
...
$(function() {	
	...
	var smurl = "<?php echo e(url('sales_order/salesman_data/')); ?>";
