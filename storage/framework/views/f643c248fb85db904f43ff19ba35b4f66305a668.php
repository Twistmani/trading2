                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('gi-print'))) : ?>
							 <a href="<?php echo e(url('goods_issued/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsInvoice" id="frmGoodsInvoice" action="<?php echo e(url('goods_issued/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="goods_issued_id" id="goods_issued_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>"  id="voucher_date" placeholder="GI. Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										<div class="col-xs-1">
											...
											<input type="checkbox" class="export" id="item_job" name="item_job" value="1" <?php echo e(($orderrow->is_itemjob==1) ? 'checked':''); ?>>
											</label>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo e($orderrow->description); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="stock_account" id="stock_account" class="form-control" autocomplete="off" data-toggle="modal" data-target="#stockac_modal" value="<?php echo e($orderrow->account); ?>">
								...
								<div class="form-group jobDtls">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="job_account" id="job_account" class="form-control" autocomplete="off" data-toggle="modal" data-target="#account_modal" value="<?php echo e($orderrow->jobaccount); ?>">
										<input type="hidden" name="job_account_id" id="job_account_id" value="<?php echo e($orderrow->job_account_id); ?>">
										<input type="hidden" name="job_account_id_old" value="<?php echo e($orderrow->job_account_id); ?>">
									</div>
                                </div>
									...
									<div class="itemdivChld">
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="29%">
													<input type="text" name="item_name[]" id="itmdes_1" autocomplete="off" class="form-control" data-toggle="modal" data-target="#item_modal" value="<?php echo e($item->item_name); ?>">
												</td>
												<td width="7%">
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" class="form-control line-cost" value="<?php echo e($item->unit_price); ?>">
													<input type="hidden" name="actcost[]" id="itmcsthd_<?php echo e($i); ?>">
													<input type="hidden" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control cost" value="<?php echo e($item->vat.'% - '.$item->vat_amount); ?>"><!--<div class="h5" id="vatdiv_1"></div>--> 
													...
													<input type="hidden" id="itmdsnt_<?php echo e($i); ?>" name="line_discount[]" class="form-control line-discount" value="0">
												</td>
												<td width="11%">
													<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" class="form-control line-total" readonly value="<?php echo e($item->total_price); ?>">
												</td>
												<td width="1%">
													<?php if($num==$i): ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="13%">
													<input type="text" id="jobcod_<?php echo e($i); ?>" autocomplete="off" value="<?php echo e($item->jobcode); ?>" name="jobcod[]" class="form-control" autocomplete="off" data-toggle="modal" data-target="#job_modal" placeholder="Jobcode">
													<input type="hidden" name="jobid[]" id="jobid_<?php echo e($i); ?>" value="<?php echo e($item->job_id); ?>">
												</td>
												<td width="15%">
													<input type="text" id="accod_<?php echo e($i); ?>" name="ac_code[]" value="<?php echo e($item->master_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#ac_modal" placeholder="A/C Name">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span><input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e($orderrow->total); ?>">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e($orderrow->net_amount); ?>">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('goods_issued')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('goods_issued/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	function getAutoPrice(curNum) {
		...
		$.ajax({
			url: "<?php echo e(url('itemmaster/get_sale_cost_avg/')); ?>",
			type: 'get',
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('goods_issued/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	//new change............
	var stockurl = "<?php echo e(url('account_master/get_accounts/')); ?>";
