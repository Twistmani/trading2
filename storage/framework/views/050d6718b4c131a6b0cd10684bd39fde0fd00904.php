<div class="panel-body">
	...
	<div class="table-responsive m-t-10" id="accountList">
		...
		<table class="table horizontal_table table-striped" id="tableAcntList">
			...
			<tr>
				<td><a href="" class="accountRow" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-vat="<?php echo e($account->vat_percentage); ?>" data-dismiss="modal"><?php echo e($account->account_id); ?></a></td>
				<td><a href="" class="accountRow" data-id="<?php echo e($account->id); ?>" data-code="<?php echo e($account->account_id); ?>" data-name="<?php echo e($account->master_name); ?>" data-group="<?php echo e($account->category); ?>" data-vatassign="<?php echo e($account->vat_assign); ?>" data-vat="<?php echo e($account->vat_percentage); ?>" data-dismiss="modal"><?php echo e($account->master_name); ?></a></td>
				<td></td>
...
$(function() {
	...
	$('#frmAccount #create').on('click', function(e){
		...
		if(name=="") {
			...
			$.ajax({
				url: "<?php echo e(url('account_master/ajax_create_acc/')); ?>",
				type: 'get',
	...
	var dtInstance = $("#tableAcntList").DataTable({
		...
		"bDestroy": true,
		"ajax":{
				"url": "<?php echo e(url('sales_order/customer_list/')); ?>",
				"dataType": "json",
				"type": "POST",
				"data":{ _token: "<?php echo e(csrf_token()); ?>", ntype: "<?php echo e($ntype); ?>" }
				},
		"columns": [
			{ "data": "account_id" },
			{ "data": "master_name" },
