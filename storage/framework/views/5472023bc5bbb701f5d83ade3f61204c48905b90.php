                                ...
                                <table class="table horizontal_table table-striped" id="table1" border="0">
                                    ...
                                    <tr>
                                        <td><input type="hidden" name="id[]" value="<?php echo e($pdc->id); ?>">
											...
											<input type="hidden" name="rv_id[]" value="<?php echo e($pdc->voucher_id); ?>">
											</td>
										...
										<td class="no_wrap"><?php echo e($pdc->customer); ?></td>
...
$(function(){
	...
	$(document).on('click', '.delete', function(e) {  
	    ...
	    e.preventDefault();
    	if(con==true) {
    		var url = "<?php echo e(url('pdc_received/delete/')); ?>";
...
function funDelete(id) {
	var con = confirm('Are you sure delete this PDC?');
	if(con==true) {
		var url = "<?php echo e(url('bank/delete/')); ?>";
