                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<a href="<?php echo e(url('acgroup/add')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive m-t-10">
                             <table class="table horizontal_table table-striped" id="tableAcgroup">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('acgroup/edit/'.$group->id)); ?>'">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('acgroup/delete')); ?>";
