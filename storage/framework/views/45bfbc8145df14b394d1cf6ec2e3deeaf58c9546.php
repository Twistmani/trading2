                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('sales_split/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesSplit" id="frmSalesSplit" enctype="multipart/form-data" action="<?php echo e(url('sales_split/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
                                           <?php foreach($vouchers as $voucher): ?>
											<option value="<?php echo e($voucher->id); ?>">Sales Split-Petty Cash</option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                 <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo e($accountname); ?>" class="form-control " autocomplete="off" data-toggle="modal" data-target="#acunt_modal"  placeholder="Customer" >
										<!--<span class="input-group-addon inputsa"><i class="fa fa-edit" style="font-size:22px;color:#ff9f2c"></i></span>-->
										
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e($accountid); ?>">
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('sales_split/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('sales_split/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
