        ...
        <section class="content">
			...
			<?php endforeach; ?>		
							...
							<?php if (\Entrust::can(('gi-print'))) : ?>
							 <a href="<?php echo e(url('material_requisition/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmMaterialRequisition" id="frmMaterialRequisition" action="<?php echo e(url('material_requisition/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="GI. Date"/>
                                    </div>
                                </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('material_requisition')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('material_requisition/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
