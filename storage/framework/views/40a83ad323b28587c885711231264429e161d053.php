        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tbody>
												...
												?>
												<tr>
													<td><?php echo e($report['voucher_no']); ?> <?php echo e(($report['is_assebly']==1)?'(Assembly Item Included)':''); ?></td>
													<td><?php echo e(date('d-m-Y', strtotime($report['voucher_date']))); ?></td>
													<td><?php echo e($report['supplier']); ?></td>
													<td><?php echo e($report['salesman']); ?></td>
													<td class="text-right"><?php echo e(number_format($report['sptotal'],3)); ?></td>
													<td class="text-right"><?php echo e(number_format($report['discount'],3)); ?></td>
													<td class="text-right"><?php echo e(number_format(($report['sptotal']), 3)); ?></td>
													<td class="text-right"><?php echo e(number_format($report['cost'],3)); ?></td>
													<td class="text-right"><?php echo e(number_format($report['profit'], 3)); ?></td>
													<td><?php echo e(number_format($report['percentage'],3)); ?></td>
												</tr>
												<?php endforeach; ?>
												<tr>
													<td></td>
													...
													<td></td>
													<td><b>Total</b></td>
													<td class="text-right"><b><?php echo e(number_format($tot_price,3)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($tot_discount,3)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($tot_sprice, 3)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($tot_cost,3)); ?></b></td>
													<td class="text-right"><b><?php echo e(number_format($tot_profit, 3)); ?></b></td>
													<td></td>
												</tr>
											</tbody>
										</table>
							...
							<tbody id="bod">
								...
								<tr>
									<td align="left" valign="top" style="padding-left:0px;">
										...
										Cust.Name: <?php echo e($report[0]['supplier']); ?></b></h6>
									</td>
									<td align="right" style="padding-left:0px;">
										<h6><b>Date: <?php echo e(date('d-m-Y',strtotime($report[0]['voucher_date']))); ?></b></h6>
									</td>
								</tr>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td ><?php echo e(number_format($row['sunit_price'],3)); ?></td>
											<td><?php echo e($row['squantity']); ?></td>
											<td class="text-right"><?php echo e(number_format($sprice,3)); ?></td>
										
											<td class="text-right"><?php echo e(number_format($pprice,3)); ?></td>
											<td class="text-right"><?php echo e(number_format($profit,3)); ?></td>
											<td class="text-right"><?php echo e(number_format($percentage,3)); ?></td>
										</tr>
									...
									<tr>
										...
										<td class="text-right"><b><?php echo e(number_format($sptotal,3)); ?></b></td>
									
										<td class="text-right"><b><?php echo e(number_format($tcst,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($ptotal,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($peravg,3)); ?></b></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td width="11%" class="text-right"><b><?php echo e(number_format($nsptotal,3)); ?></b></td>
										
											<td width="10%" class="text-right"><b><?php echo e(number_format($nctotal,3)); ?></b></td>
											<td width="9%" class="text-right"><b><?php echo e(number_format($nptotal,3)); ?></b></td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td><?php echo e($row['squantity']); ?></td>
											<td class="text-right"><?php echo e(number_format($sprice,3)); ?></td>
											<td class="text-right"><?php echo e(number_format($row['discount'],3)); ?></td>
											<td class="text-right"><?php echo e(number_format($pprice,3)); ?></td>
											<td class="text-right"><?php echo e(number_format($profit,3)); ?></td>
											<td class="text-right"><?php echo e(number_format($percentage,3)); ?></td>
										</tr>
									...
									<tr>
										<td colspan="4" align="right"><b>Sub Total:</b></td>
										<td class="text-right"><b><?php echo e(number_format($sptotal,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($dtotal,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($tcst,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($ptotal,3)); ?></b></td>
										<td class="text-right"><b><?php echo e(number_format($peravg,3)); ?></b></td>
									</tr>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<tr>
											...
											<td width="12%" class="text-right"><b><?php echo e(number_format($nsptotal,3)); ?></b></td>
											<td width="8%" class="text-right"><b><?php echo e(number_format($ndtotal,3)); ?></b></td>
											<td width="10%" class="text-right"><b><?php echo e(number_format($nctotal,3)); ?></b></td>
											<td width="12%" class="text-right"><b><?php echo e(number_format($nptotal,3)); ?></b></td>
								...
								<tbody id="bod">
									...
									<tr style="border:0px solid black;">
										...
										<table border="0" style="width:100%;" class="tblstyle table-bordered">
											...
											<tr>
												...
												<td class="text-right"><?php echo e(number_format($row['sprice'],3)); ?></td>
												<td class="text-right"><?php echo e(number_format($row['discount'],3)); ?></td>
												<td  class="text-right"><?php echo e(number_format($row['cost'],3)); ?></td>
												<td  class="text-right"><?php echo e(number_format($row['profit'],3)); ?></td>
												<td  class="text-right"><?php echo e(number_format($row['percentage'],3)); ?></td>
											</tr>
										<?php } $peravg = $pertotal / $n;
									...
									?>
										...
										<tr>
											...
											<td class="text-right"><b><?php echo e(number_format($sptotal,3)); ?></b></td>
											<td  class="text-right"><b><?php echo e(number_format($dtotal,3)); ?></b></td>
											<td class="text-right"><b><?php echo e(number_format($ctotal,3)); ?></b></td>
											<td  class="text-right"><b><?php echo e(number_format($ptotal,3)); ?></b></td>
						...
						<?php } else if($type=="item") { ?>
								<table border="0" style="width:100%;height:100%;">
										...
										<tbody id="bod">
											...
											<tr>
												<td align="left" valign="top" style="padding-left:0px;">
													<h6><b>Item Code: <?php echo e($report[0]['item_code']); ?><br/>
													Item Name: <?php echo e($report[0]['description']); ?></b></h6>
												</td>
												<td align="right" style="padding-left:0px;">
													<p></p>
												</td>
    										  ...
    										  <tr style="border:0px solid black;">
            									...
            									<table border="0" style="width:100%;" class="tblstyle table-bordered">
            										...
            										<tr>
            											...
            											<td width="10%" class="text-right"><b><?php echo e(number_format($nsptotal,3)); ?></b></td>
            											<td width="8%" class="text-right"><b><?php echo e(number_format($ndtotal,3)); ?></b></td>
            											<td width="10%" class="text-right"><b><?php echo e(number_format($nctotal,3)); ?></b></td>
            											<td width="12%" class="text-right"><b><?php echo e(number_format($nptotal,3)); ?></b></td>
            											<td width="10%" class="text-right"></td>
										...
										<tbody id="bod">
											<tr style="border:0px solid black;">
												...
												<table border="0" style="width:100%;" class="tblstyle table-bordered">
													...
													<?php  $total_qty = $stock_total = 0;  ?>
													<?php foreach($reports as $row): ?>
													<?php  $stock_total += $row->amount; $total_qty += $row->quantity;  ?>
													<tr>
														<td ><?php echo e($row->group_name); ?></td>
														<td  class="text-right"><?php echo e($row->quantity); ?></td>
														<td  class="text-right"><?php echo e(number_format($row->amount,3)); ?></td>
													</tr>
													<?php endforeach; ?>
													<tr>
														<td align="right"><b>Sub Total:</b></td>
														<td  class="text-right"><b><?php echo e($total_qty); ?></b></td>
														<td class="text-right"><b><?php echo e(number_format($stock_total,3)); ?></b></td>
													</tr>
												</table>
												</td>
											</tr>
									...
									<table border="0" style="width:100%;height:100%;">
										...
										<tbody id="bod">
											<tr style="border:0px solid black;">
												...
												<h6><b>Group Name: <?php echo e($rows[0]->group_name); ?></b></h6>
												<table border="0" style="width:100%;" class="tblstyle table-bordered">
													<tr>
											...
											<tr>
												...
												<td  class="text-right"><b><?php echo e($grtotal); ?></b></td>
											</tr>
										</tbody>
										<tfoot id="inv">
											<tr>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('profit_analysis/export')); ?>">
				...
				<!--	<input type="hidden" name="date_from" value="<?php echo e($fromdate); ?>" >
					...
					<input type="hidden" name="salesman_id" value="<?php echo e($salesman); ?>" >-->
