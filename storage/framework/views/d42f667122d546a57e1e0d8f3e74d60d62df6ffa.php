            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <form class="form-horizontal" role="form" method="POST" name="frmMachine" id="frmMachine" action="<?php echo e(url('cheque_details/update/'.$mrow->id)); ?>">
								<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
	
                                <input type="hidden" name="cheque_id" id="cheque_id" value="<?php echo e($mrow->id); ?>">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cheque_no" value="<?php echo e($mrow->cheque_no); ?>" name="cheque_no" autocomplete="off"  placeholder="Cheque No">
                                    </div>
                                    <label for="input-text" class="col-sm-1 control-label">Cheq.Date</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control pull-right" value="<?php echo e(date('d-m-Y',strtotime($mrow->cheque_date))); ?>" autocomplete="off" id="cheque_date" name="cheque_date" data-language='en'   readonly />
								   </div>
                                </div>
<!-- 
                                    ...
                                    <input type="text" name="customer_name" id="customer_name" readonly value="<?php echo (old('customer'))?old('customer'):$mrow->customer; ?>"  class="form-control" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
                                        ...
                                        <?php foreach($banks as $row): ?>
											<option value="<?php echo e($row->id); ?>" <?php if($row->id==$mrow->bank_id) echo 'selected'; ?>><?php echo e($row->name); ?></option>
											<?php endforeach; ?>
										</select>
                                        </div>
                                </div>
                                ...
                                <label for="input-text" class="col-sm-2 control-label">Amount Number</label>
										  <div class="col-sm-5">
                                          <input type="text" class="form-control" id="amount_number" value="<?php echo e($mrow->amount_number); ?>" readonly name="amount_number" autocomplete="off" placeholder="amount number">
											 </div>
							 ...
							 <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control pull-right" autocomplete="off" readonly value="<?php echo e($mrow->amount_words); ?>" id="amount_words" name="amount_words" placeholder="Amount in Words" />
								   </div>
                                </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<button type="submit" class="btn btn-primary">Submit</button>
											 <a href="<?php echo e(url('cheque_details')); ?>" class="btn btn-danger">Cancel</a>
										</div>
									</div>
...
$(document).ready(function () {
	...
	var urlcode = "<?php echo e(url('machine/checkregno/')); ?>";
