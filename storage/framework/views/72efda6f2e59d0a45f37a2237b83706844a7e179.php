            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('emp-create'))) : ?>
                             <a href="<?php echo e(url('employee/add')); ?>" class="btn btn-primary btn-sm">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('employee/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tableEmployee").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('employee/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			"columns": [
				...
				{ "data": "nationality" },
				{ "data": "phone" },
				<?php if (\Entrust::can(('emp-view'))) : ?>{ "data": "view","bSortable": false },<?php endif; // Entrust::can ?>
				<?php if (\Entrust::can(('emp-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
				{ "data": "payrise","bSortable": false },
				<?php if (\Entrust::can(('emp-delete'))) : ?>{ "data": "delete","bSortable": false },<?php endif; // Entrust::can ?>
			]	
