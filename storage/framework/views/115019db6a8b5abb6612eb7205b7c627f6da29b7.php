                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pv-print'))) : ?>
								 <a href="<?php echo e(url('supplier_payment/print/'.$printid->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmSupPayment" id="frmSupPayment" action="<?php echo e(url('supplier_payment/save')); ?>">
								...
								<?php endif; ?>
								<input type="hidden" name="status" value="<?php echo e(($settings->pv_approval==1)?0:1); ?>">
								<?php if($isdept): ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off"  id="voucher_date" <?php if(old('voucher_date')!='') { ?> value="<?php echo e(old('voucher_date')); ?>" <?php } ?> placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="cr_account" name="cr_account" value="<?php echo e((old('cr_account'))?old('cr_account'):$vchrdata['account_name']); ?>" data-toggle="modal" data-target="#cr_account_modal" autocomplete="off" ><!--data-toggle="modal" data-target="#cr_account_modal"-->
										<input type="hidden" id="cr_account_id" name="cr_account_id" value="<?php echo e((old('cr_account_id'))?old('cr_account_id'):$vchrdata['id']); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="reference" autocomplete="off" name="reference" value="<?php echo e(old('reference')); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="description" autocomplete="off" name="description" value="<?php echo e(old('description')); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										<div class="input-group">
											...
											<input type="number" step="any" class="form-control <?php if($errors->has('amount')) echo 'form-error';?>" value="0" id="amount" name="amount">
								...
								<div id="chequeInput">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control <?php if($errors->has('amount')) echo 'form-error';?>" id="cheque_no" value="<?php echo e(old('cheque_no')); ?>" autocomplete="off" name="cheque_no">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control <?php if($errors->has('amount')) echo 'form-error';?>" id="cheque_date" value="<?php echo e(old('cheque_date')); ?>" autocomplete="off" name="cheque_date" data-language='en' readonly>
										</div>
									</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?php if($errors->has('supplier_account')) echo 'form-error';?>" id="supplier_account" name="supplier_account" value="<?php echo e(old('supplier_account')); ?>" autocomplete="off" data-toggle="modal" data-target="#supplier_modal">
										<input type="hidden" class="form-control" id="supplier_id" name="supplier_id" value="<?php echo e(old('supplier_id')); ?>">
                                    </div>
                                </div>
							...
							<!--	<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <a href="<?php echo e(url('supplier_payment')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('supplier_payment')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () {
	var urlvchr = "<?php echo e(url('supplier_payment/checkvchrno/')); ?>"; //CHNG
	...
	<?php if( (old('supplier_id')!='') || (old('supplier_account')!='') ) { ?>
	   ...
	   var url = "<?php echo e(url('purchase_invoice/get_invoice/')); ?>/<?php echo e(old('supplier_id')); ?>";
	...
	$(document).on('change', '#voucher_type', function(e) {  //$('#voucher_type').on('change', function(e){
		...
		if($('#department_id').length) {
			...
			$.get("<?php echo e(url('supplier_payment/getvoucher/')); ?>/" + vchr_id+'/'+vchr+'/'+$('#department_id option:selected').val(), function(data) {
	...
	$('#voucher').on('change', function(e){
		...
		if($('#department_id').length) {
			...
			$.get("<?php echo e(url('supplier_payment/getvoucher/')); ?>/" + vchr_id+'/'+vchr_type+'/'+$('#department_id option:selected').val(), function(data) {
				$('#voucher_no').val(data.voucher_no);
			...
			$.get("<?php echo e(url('supplier_payment/getvoucher/')); ?>/" + vchr_id+'/'+vchr_type, function(data) {
				$('#voucher_no').val(data.voucher_no);
				$('#curno').val(data.voucher_no); //CHNG
				if(data.id!=null && data.account_name!=null) {
					$('#cr_account').val(data.account_name);
...
$(function(){
  $(':input[type=number]').on('mousewheel',function(e){ $(this).blur(); });
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('supplier_payment/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	$('#supplier_account').click(function() {
		if($('#department_id').length)
			var custurl = "<?php echo e(url('purchase_invoice/supplier_datadpt/')); ?>"+'/'+$('#department_id option:selected').val();
		else
			var custurl = "<?php echo e(url('purchase_order/supplier_data/')); ?>";
	...
	/* $(document).on('click', '.supp', function(e) {
	   ...
	   var url = "<?php echo e(url('purchase_invoice/get_invoice/')); ?>/"+$(this).attr("data-id");
	   $('#drTransactionData').load(url, function(result) {
		  $('#myModal').modal({show:true});
	   });
