                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmMachine" id="frmMachine" action="<?php echo e(url('cheque_details/save')); ?>">
...
<!-- 
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" name="customer_name" id="customer_name" readonly value="<?php echo e(old('customer_name')); ?>" class="form-control" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
