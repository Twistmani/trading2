...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                    ...
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('si-create'))) : ?>
                             <a href="<?php echo e(url('sales_invoice/add')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive m-t-10">
							<table class="table horizontal_table table-striped" id="SalesInvoiceList">
								...
								<tr>
									...
									<?php if (\Entrust::can(('si-view'))) : ?><th></th><?php endif; // Entrust::can ?>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('sales_invoice/search')); ?>">
...
function funDelete(id,no) {
    <?php if(auth()->user()->can('delete-transfered-doc')): ?>
        var con = confirm('Are you sure delete this sales invoice?');
    	if(con==true) {
    		var url = "<?php echo e(url('sales_invoice/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#SalesInvoiceList").DataTable({
			...
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "<?php echo e(url('sales_invoice/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
			...
			<?php if (\Entrust::can(('si-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			...
			<?php if (\Entrust::can(('do-print'))) : ?>{ "data": "amtview","bSortable": false }<?php endif; // Entrust::can ?>
		]	
...
$(function() {	
	...
	var stsurl = "<?php echo e(url('sales_invoice/get_billdata/')); ?>";
	$(document).on('click','.getBill', function() { 
		...
		var ordhisurl = "<?php echo e(url('sales_invoice/index_history/')); ?>";
