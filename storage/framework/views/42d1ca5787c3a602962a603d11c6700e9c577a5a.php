                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="tableRecon">
									...
									<?php foreach($results as $row): ?>
										<tr>
											<td><input type='radio' name='account' class='opt-account' value='<?php echo e($row->id); ?>'/></td>
											<td><?php echo e($row->account_id); ?></td>
											<td><?php echo e($row->master_name); ?></td>
											<td><?php echo e($row->cl_balance); ?></td>
											<td><?php echo e($row->op_balance); ?></td>
										</tr>
									<?php endforeach; ?>
									</tbody>
                                </table>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" role="form" method="POST" target="_blank" name="frmSearchAccount" id="frmSearchAccount" action="<?php echo e(url('account_enquiry/search_account_ar')); ?>">
							...
							<input type="hidden" id="is_custom" name="is_custom" value="0">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="date_from" id="date_from"  class="form-control input-sm" data-language='en' autocomplete="off" value="<?php echo e(date('d-m-Y',strtotime($settings->from_date))); ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="date_to" id="date_to" class="form-control input-sm" data-language='en' autocomplete="off" value="<?php echo e(date('d-m-Y')); ?>">
									</div>
								</div>
