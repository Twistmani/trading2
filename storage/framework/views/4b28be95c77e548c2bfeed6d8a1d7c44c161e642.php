...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('qs-create'))) : ?>
                             <a href="<?php echo e(url('quotation_sales/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('quotation_sales/search')); ?>">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('quotation_sales/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('quotation_sales/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			<?php if (\Entrust::can(('qs-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
				<?php if (\Entrust::can(('qs-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('qs-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			{ "data": "view","bSortable": false },
			<?php if (\Entrust::can(('qs-delete'))) : ?>{ "data": "delete","bSortable": false },<?php endif; // Entrust::can ?>
		],
			...
			$('#select23').on('change', function(e){
			    ...
			    console.log(cust_id);
			     if(cust_id !=''){
			    $.get("<?php echo e(url('quotation_sales/getjob/')); ?>/" + cust_id, function(data) {
