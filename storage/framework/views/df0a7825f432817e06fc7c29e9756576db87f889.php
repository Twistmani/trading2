...
function setTransfer() {
	...
	if(curl=='MRI')
		sdourl = "<?php echo e(url('purchase_invoice/add/')); ?>/"+items+"/MR";
	else if(curl=='MRO')
		sdourl = "<?php echo e(url('purchase_order/add/')); ?>/"+items+"/MR";
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('material_requisition/item_details/')); ?>";
