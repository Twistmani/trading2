							...
							<thead>
								...
								<tr style="border:0px solid black;">
									...
									<td align="left" style="padding-left:200px; width:50%;">
										<div>
											<b>STO. No: <?php echo e($details->voucher_no); ?></b><br/>
											Date:  <?php echo e(date('d-m-Y',strtotime($details->voucher_date))); ?><br/>
											Ref. No: <?php echo e($details->reference_no); ?><br/>
										</div>
								...
								<tr style="border:1px solid black;">
									...
									<table border="0" style="width:100%;" class="table table-bordered">
										...
										<tr>
											...
											<td class="text-right"><?php echo e(number_format($line_total,2)); ?></td>
										</tr>
									...
									<td colspan="2" align="center">
										...
										<tr>
											...
											<b>
												...
												<p><?php echo e(number_format($details->discount,2)); ?></p>
												<p><?php echo e(number_format($details->net_total,2)); ?></p>
											</b>
											</td>
										</tr>
										</table>
