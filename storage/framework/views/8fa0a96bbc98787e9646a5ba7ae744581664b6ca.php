                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    <thead>
                                    <tr>
										<th><input type="hidden" name="url" id="url" value="<?php echo e($url); ?>"></th>
										<th>QS. No</th>
										<th>QS. Date</th>
										<th>Salesman</th>
										<th>Amount</th>
                                    ...
                                    <tbody>
										...
										<tr>
											<td><input type="checkbox" name="quotaion[]" value="<?php echo e($quotation->id); ?>"/></td>
											<td><?php echo e($quotation->voucher_no); ?></td>
											<td><?php echo e(date('d-m-Y',strtotime($quotation->voucher_date))); ?></td>
											<td><?php echo e($quotation->description); ?></td>
											<td><?php echo e($quotation->net_total); ?></td>
											<td><a href="#" class="quot-data" data-id="<?php echo e($quotation->id); ?>" data-name="<?php echo e($quotation->voucher_no); ?>" data-toggle="modal" data-target="#quot_modal">View Items</a></td>
...
function setTransfer() {
	...
	var curl = $('#url').val();
	if(curl=='so')
		url = "<?php echo e(url('sales_order/add/')); ?>/"+items+"/SO";
	else if(curl=='cdo')
		url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/CDO";
	else if(curl=='QS')
		url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/QS"; //url = "<?php echo e(url('sales_invoice/add/')); ?>/"+items+"/QS";
	else if(curl=='QSI')
		url = "<?php echo e(url('sales_invoice/add/')); ?>/"+items+"/QS";
...
$(document).on('click', '.quot-data', function(e) {
	...
	var itmurl = "<?php echo e(url('quotation_sales/item_details/')); ?>";
