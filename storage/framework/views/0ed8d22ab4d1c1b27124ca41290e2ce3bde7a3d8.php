...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
						...
						<?php if (\Entrust::can(('so-create'))) : ?>
                             <a href="<?php echo e(url('sales_order/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('sales_order/search')); ?>">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('sales_order/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('sales_order/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			<?php if (\Entrust::can(('so-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('so-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('so-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('so-delete'))) : ?>{ "data": "delete","bSortable": false },<?php endif; // Entrust::can ?>
		]	
