...
<head>
  ...
  <link href="<?php echo e(asset('stimulsoftV2/css/stimulsoft.designer.office2013.whiteblue.css')); ?>" rel="stylesheet" />
  <link href="<?php echo e(asset('stimulsoftV2/css/stimulsoft.viewer.office2013.whiteblue.css')); ?>" rel="stylesheet" />

  <script src="<?php echo e(asset('stimulsoftV2/js/stimulsoft.reports.js')); ?>"></script>
  <script src="<?php echo e(asset('stimulsoftV2/js/stimulsoft.viewer.js')); ?>"></script>
  <script src="<?php echo e(asset('stimulsoftV2/js/stimulsoft.designer.js')); ?>"></script>
...
(function () {
  var HANDLER_URL = "<?php echo e(url('stimulsoftV2/sti-handler.php')); ?>";
  var LICENSE_URL = "<?php echo e(url('/stimulsoftV2/license')); ?>";
  var DEFAULT_MRT = "<?php echo e(asset('stimulsoftV2/reports/'.$view)); ?>";
