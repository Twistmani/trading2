										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" min="1" value="<?php echo e(($item->balance_quantity > 0)?$item->balance_quantity:$item->quantity); ?>">
												</td>
												<td width="8%">
