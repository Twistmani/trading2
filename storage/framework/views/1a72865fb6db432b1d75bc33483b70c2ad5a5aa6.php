                ...
                <div class="col-md-12">
                    <div class="panel panel-<?php echo ($orderrow->is_editable == 1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('si-print'))) : ?>
							 <a href="<?php echo e(url('sales_invoice/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('sales_invoice/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="sales_invoice_id" id="sales_invoice_id" value="<?php echo e($orderrow->id); ?>">
								<?php /*<input type="hidden" name="voucher_id" value="<?php echo e($orderrow->voucher_id); ?>">*/ ?>
								<input type="hidden" name="default_location" value="<?php echo e(Auth::user()->location_id); ?>">
								...
								<?php endif; ?>
								<input type="hidden" name="mq_loc" value="<?php echo e(($ismqloc)?1:0); ?>">
								<?php if($isdept): ?>
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="department_id">
											<?php foreach($departments as $drow): ?>
												<option value="<?php echo e($drow->id); ?>" <?php echo e(($orderrow->department_id==$drow->id)?'selected':''); ?> ><?php echo e($drow->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											<option value="<?php echo e($vouchers->id); ?>" <?php echo e(($orderrow->voucher_id==$vouchers->id)?'selected':''); ?>><?php echo e($vouchers->voucher_name); ?></option>
                                        </select>
                                    </div>
                                </div>
								<?php endif; ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select id="voucher_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="voucher_id">
										   ...
										   <?php if($orderrow->voucher_id==$vrow['id']): ?>
											   <?php  $sel = 'selected';  ?>
										   <?php else: ?>
											   <?php  $sel = '';  ?>
										   <?php endif; ?>
											<option value="<?php echo e($vrow['id']); ?>" <?php echo e($sel); ?> ><?php echo e($vrow['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
									</div>
								</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" autocomplete="off" data-language='en' readonly id="voucher_date" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" name="lpo_no" autocomplete="off" placeholder="LPO No." value="<?php echo e($orderrow->lpo_no); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									  <div class="input-group">
                                        <input type="text" name="sales_account" id="sales_account" class="form-control" readonly value="<?php echo e($orderrow->account); ?>">
										<input type="hidden" name="cr_account_id" id="cr_account_id" class="form-control" value="<?php echo e($orderrow->cr_account_id); ?>">
										<input type="hidden" name="cr_account_id_old" value="<?php echo e($orderrow->cr_account_id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="old_customer_id" id="old_customer_id" value="<?php echo e($orderrow->customer_id); ?>">
										...
										<div class="col-xs-10" id="customerInfo">
											<div class="col-xs-2">
												<span class="small">Current Balance</span> <input type="text" id="cr_balance" readonly class="form-control line-quantity" value="<?php echo e(number_format($custdata->cl_balance,2)); ?>">
											</div>
											<div class="col-xs-2">
												<span class="small">PDC</span> <input type="text" id="pdc" readonly class="form-control line-cost" value="<?php echo e(number_format($custdata->pdc_amount,2)); ?>">
											</div>
											<!--<div class="col-xs-2">
												<span class="small">Crdit Limit</span> <input type="text" id="cr_limit" readonly readonly class="form-control cost" value="<?php echo e(number_format($custdata->credit_limit,2)); ?>">
											</div>-->
											<div class="col-xs-2">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e($orderrow->customer_phone); ?>" class="form-control cpno" autocomplete="off">
											</div>
										...
										<div class="col-xs-10" id="newcustomerInfo">
											<div class="col-xs-3">
												<span class="small">Customer Name</span> <input type="text" id="customername" name="customername" value="<?php echo e($orderrow->customer_name); ?>" class="form-control" autocomplete="off">
											</div>
											<div class="col-xs-2">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e($orderrow->customer_phone); ?>" class="form-control cpno" autocomplete="off">
											</div>
											<div class="col-xs-2">
												<span class="small">TRN No</span> <input type="text" id="customer_trn" name="customer_trn" value="<?php echo e($orderrow->customer_trn); ?>" class="form-control" autocomplete="off">
											</div>
											...
											<div class="col-xs-1"><br/>
												...
												<?php endif; // Entrust::can ?>-->
												<?php if (\Entrust::can(('siph-history'))) : ?>
								...
								<?php if($formdata['crm_details']==1): ?>
									<?php if(count($crm) > 0): ?>
									<h5><a href="#" id="crmBtn"><b>CRM Details</b></a></h5>
									<hr/>
									<div class="crm_info">
										<?php foreach($crm as $rw): ?>
										<div class="form-group">
											<label for="input-text" class="col-sm-2 control-label"><?php echo e($rw->label); ?></label>
											<input type="hidden" name="tempid[]" value="<?php echo e($rw->id); ?>">
											<?php if($rw->text_no==1): ?>
											<div class="col-sm-10">
												<input type="text" name="crmtext[]" value="<?php echo e($rw->textval); ?>" class="form-control" autocomplete="off">
											...
											<label for="input-text" class="col-sm-2 control-label"><?php echo e($rw->label2); ?></label>
											<div class="col-sm-4">
												<input type="text" name="crmtext2[]" value="<?php echo e($rw->textval2); ?>" class="form-control" autocomplete="off">
											</div>
											<?php endif; ?>
										</div>
										<?php endforeach; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10"> <!-- MY22 -->
									 <select id="document_type" class="form-control select2" style="width:100%" name="document_type">
										<?php if($orderrow->document_type=="CDO"): ?> 
										<option value="CDO">Delivery Order</option>
										<?php elseif($orderrow->document_type=="SQ"): ?>
										<option value="SQ">Sales Quotation</option>
										<?php elseif($orderrow->document_type=="SO"): ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
									<input type="text" class="form-control" id="document" readonly name="document" value="<?php echo e(old('document')?old('document'):$orderrow->doc_nos); ?>" autocomplete="off" <?php /*onclick="getDocument()"*/ ?> >
                                        <input type="hidden" id="document_id" value="<?php echo e($orderrow->document_id); ?>"  readonly name="document_id">
                                    </div>
									<!--<div class="col-sm-1"><button class="btn btn-warning clear-doc">Clear</button></div>-->
                                </div>
								<?php } else { ?>
								<input type="hidden" name="document_id" id="document_id" value="<?php echo e($orderrow->document_id); ?>" >
								<?php } ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>" <?php if($term['id']==$orderrow->term_id) echo 'selected'; ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        	<input type="number" class="form-control" id="duedays" name="duedays" value="<?php echo e($orderrow->duedays); ?>">
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" class="form-control" autocomplete="off" data-toggle="modal" data-target="#job_modal" value="<?php echo e($orderrow->code); ?>">
										<input type="hidden" name="job_id" id="job_id" value="<?php echo e($orderrow->job_id); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
                                    ...
                                    <div class="col-sm-10">
                                        <select id="location_id" class="form-control select2" style="width:100%" name="location_id">
											...
											if($loc->is_default==1)
												$is_default = 1;
											?>
											<option value="<?php echo e($loc['id']); ?>" <?php if($loc['id']==$orderrow->location_id) echo 'selected';?>><?php echo e($loc['name']); ?></option>
											<?php } ?>
									...
									<div class="col-xs-10">
										...
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<option value="<?php echo e($curr['id']); ?>" <?php if($orderrow->currency_id==$curr['id']) echo 'selected'; ?>><?php echo e($curr['code']); ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" autocomplete="off" value="<?php echo e($orderrow->currency_rate); ?>" class="form-control" placeholder="Currency Rate">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<?php if(old('item_code')) { $i = 0; 
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													<input type="hidden" name="order_item_id[]" id="p_orditmid_<?php echo e($j); ?>" value="<?php echo e(old('order_item_id')[$i]); ?>">
													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($j); ?>" value="<?php echo e(old('item_id')[$i]); ?>">
													<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" value="<?php echo e($item); ?>" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="29%">
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" autocomplete="off" step="any" name="quantity[]" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="<?php echo e(old('quantity')[$i]); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($j); ?>" autocomplete="off" step="any" name="cost[]" class="form-control <?php if($errors->has('cost.'.$i)) echo 'form-error';?> line-cost" value="<?php echo e(old('cost')[$i]); ?>">
												</td>
												<td width="6%">
													<select id="taxcode_<?php echo e($j); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR" <?php if(old('tax_code')[$i]=="SR") echo 'selected'; ?>>SR</option><option value="EX" <?php if(old('tax_code')[$i]=="EX") echo 'selected'; ?>>EX</option><option value="ZR" <?php if(old('tax_code')[$i]=="ZR") echo 'selected'; ?>>ZR</option></select>
												</td>
												<td width="6%">
												...
												<td width="9%">
													...
													<input type="hidden" id="cqty_<?php echo e($j); ?>" name="curqty[]" value="<?php echo e(old('curqty')[$i]); ?>">
												</td>
												<td width="11%">
												...
												<td width="1%">
													<?php if($num==$j): ?>
														<button type="button" class="btn-success btn-add-item" >
														 ...
														 <button type="button" class="btn-danger btn-remove-item" data-id="rem_<?php echo e($j); ?>">
								...
								<?php } ?>
											...
											<div class="infodivPrntItm" id="infodivPrntItm_<?php echo e($j); ?>">
												<div class="infodivChldItm">							
													<div class="table-responsive item-data" id="itemData_<?php echo e($j); ?>">
													</div>
												</div>
											</div>
											<?php if($formdata['add_desc']==1) { ?>
											<div id="moredesc" style="float:left; padding-right:5px;">
												<button type="button" id="descinfoItm_<?php echo e($j); ?>" class="btn btn-primary btn-xs desc-info">Add Description</button>
											</div>
											<?php } else { ?>
								...
								<?php } ?>	
											...
											<div id="cnloc" style="float:left; padding-right:5px;">
												<button type="button" id="cnloc_<?php echo e($j); ?>" data-toggle="modal" data-target="#conloc_modal" class="btn btn-primary btn-xs cnloc-info">Consignment Location</button>
												<input type="hidden" name="conloc_id[]" id="conlocid_<?php echo e($j); ?>">
												<input type="hidden" name="conloc_qty[]" id="conlocqty_<?php echo e($j); ?>">
											</div>
											<?php endif; ?>
											<?php if($formdata['supersede']==1) { ?>	
											<div id="ssede" style="float:left; padding-right:5px;">
												<button type="button" id="sede_<?php echo e($j); ?>" class="btn btn-primary btn-xs sup-sede">Supersede</button>
											</div>
											<?php } else { ?>
								...
								<?php } ?><?php if($formdata['customer_sales']==1) { ?>
											<div>
												<button type="button" id="custsaleshisItm_<?php echo e($j); ?>" data-toggle="modal" data-target="#cust_sales_modal" class="btn btn-primary btn-xs cust-sales-his">Customer Sales</button>
											</div>
											<?php } else { ?>
								...
								<div id="itmInfo">
									<button type="button" id="itmInfo_<?php echo e($i); ?>" class="btn btn-primary btn-xs dimn-view">Dimension</button>
								</div>
								<?php } else { ?>
								<input type="hidden" name="dimension" id="dimension">
								<?php } ?>
											
											<div class="sedePrntItm" id="sedePrntItm_<?php echo e($j); ?>">
												<div class="sedeChldItm">							
													<div class="table-responsive sede-data" id="sedeData_<?php echo e($j); ?>"></div>
												</div>
											</div>
											...
											<div class="locPrntItm" id="locPrntItm_<?php echo e($j); ?>">
												<div class="locChldItm">							
													<div class="table-responsive loc-data" id="locData_<?php echo e($j); ?>">
														<?php 
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	...
																	<td><?php echo e($cqty); ?></td>
																	<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($quantity); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>">
																	<input type="hidden" name="locid[<?php echo $i-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="editid[<?php echo $i-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
																</tbody>
															</table>
											...
											foreach($itemdesc[$item] as $desc) { ?>
												<div class="descdivPrntItm" id="descdivPrntItm_<?php echo e($j); ?>">
													<div class="descdivChldItm" >							
														<div class="col-xs-10" style="padding-bottom:5px !important;">
															<div class="col-xs-10">
																<input type="text" name="itemdesc[<?php echo $item;?>][]" autocomplete="off" class="form-control txt-desc" value="<?php echo e($desc->description); ?>" placeholder="Description">
															</div>
															<div class="col-xs-2" style="float:left;">
																 <button type="button" class="btn btn-success btn-add-desc" >
																	<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
																 </button>
																 <button type="button" class="btn btn-danger btn-remove-desc" data-id="remdesc_<?php echo e($j); ?>" data-itmid="<?php echo e($item); ?>">
																	<span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
																 </button>
																 <input type="hidden" name="desc_id[<?php echo $item;?>][]" value="<?php echo e($desc->id); ?>" class="hid-id">
															</div>
														</div>
													</div>
												</div>
											<?php } } else { ?>
												<div class="descdivPrntItm" id="descdivPrntItm_<?php echo e($j); ?>" style="display: none;">
													<div class="descdivChldItm" >							
														<div class="col-xs-10" style="padding-bottom:5px !important;">
															<div class="col-xs-10">
								...
								<?php if($orderrow->is_fc==1) {
									...
									?>
									<div class="itemdivChld">	
									    <input type="hidden" name="order_item_id[]" id="p_orditmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>"> <!--AUG24-->
										<table border="0" class="table-dy-row">
											<tr>
												<td width="13%">
												<input type="hidden" name="item_wit[]" id="itmwit_<?php echo e($i); ?>" value="<?php echo e($item->width); ?>">
												<input type="hidden" name="item_lnt[]" id="itmlnt_<?php echo e($i); ?>" value="<?php echo e($item->length); ?>">
												<input type="hidden" name="doc_row_id[]" id="docrwid_<?php echo e($i); ?>" value="<?php echo e($item->doc_row_id); ?>"><!--APR25-->

													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($item->item_id); ?>">
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" value="<?php echo e($item->item_code); ?>" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="24%">
													<input type="text" name="item_name[]" id="itmdes_<?php echo e($i); ?>" autocomplete="off" class="form-control" value="<?php echo e($item->item_name); ?>">
												</td>
												<td width="7%">
													<select id="itmunt_<?php echo e($i); ?>" class="form-control select2 line-unit" style="width:100%" name="unit_id[]">
													<option value="<?php echo e($item->unit_id); ?>"><?php echo e($item->unit_name); ?></option></select>
													</select>
												</td>
												<?php if($ismpqty==1): ?>
												<td width="8%" class="itcodmp">
													<input type="number" id="itmmpqty_<?php echo e($i); ?>" autocomplete="off" step="any" name="mpquantity[]" <?php echo e(($orderrow->is_editable == 1)?'readonly':''); ?> class="form-control line-mpquantity" value="<?php echo e($item->mp_qty); ?>" placeholder="MP Qty.">
												</td>
												<?php endif; ?>
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off" step="any" name="quantity[]" <?php echo e(($orderrow->is_editable == 1)?'readonly':''); ?> class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
													<input type="hidden" name="quantity_old[]" value="<?php echo e($item->quantity); ?>"><!--APR25-->
													<input type="hidden" name="max_quantity[]" id="itmaxqty_<?php echo e($i); ?>" value="<?php echo e($max_quantity); ?>"><!--APR25-->
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" autocomplete="off" step="any" name="cost[]" <?php echo e(($orderrow->is_editable == 1)?'readonly':''); ?> class="form-control line-cost" value="<?php echo e($unit_price); ?>">
												</td>
												<td width="6%">
													<select id="taxcode_<?php echo e($i); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR" <?php if($item->tax_code=="SR") echo 'selected'; ?>>SR</option><option value="EX" <?php if($item->tax_code=="EX") echo 'selected'; ?>>EX</option><option value="ZR" <?php if($item->tax_code=="ZR") echo 'selected'; ?>>ZR</option></select>
												</td>
												<td width="6%">
													<select id="txincld_<?php echo e($i); ?>" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option <?php if($item->tax_include==0) echo 'selected';?> value="0">No</option><option <?php if($item->tax_include==1) echo 'selected';?> value="1">Yes</option></select>
												</td>
												<td width="9%">
													<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:$item->pkno.'-'.$item->packing); ?>">
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '.intval($vat_amount*100)/100); ?>"><!--<div class="h5" id="vatdiv_<?php echo e($i); ?>"></div>--> 
													<input type="hidden" id="vat_<?php echo e($i); ?>" name="line_vat[]" class="form-control vat" value="<?php echo e($item->vat); ?>">
													...
													<input type="hidden" id="itmdsnt_<?php echo e($i); ?>" name="line_discount[]" value="<?php echo e($item->discount); ?>">
													<input type="hidden" id="cqty_<?php echo e($i); ?>" name="curqty[]" value="<?php echo e($item->cur_quantity); ?>">
												</td>
												<td width="11%">
													<input type="text" id="itmttl_<?php echo e($i); ?>" name="line_total[]" class="form-control line-total" readonly value="<?php echo e($line_total); ?>">
													<input type="hidden" id="itmtot_<?php echo e($i); ?>" name="item_total[]" value="<?php echo e($item->item_total); ?>">
												</td>
												<td width="1%">
													<?php if($num==$i): ?>
														<button type="button" class="btn-success btn-add-item" >
								...
								<?php } ?>
											...
											<div class="infodivPrntItm" id="infodivPrntItm_<?php echo e($i); ?>">
												<div class="infodivChldItm">							
													<div class="table-responsive item-data" id="itemData_<?php echo e($i); ?>">
													</div>
												</div>
											</div>
											<?php if($formdata['add_desc']==1) { ?>
											<div id="moredesc" style="float:left; padding-right:5px;">
												<button type="button" id="descinfoItm_<?php echo e($i); ?>" class="btn btn-primary btn-xs desc-info">Add Description</button>
											</div>
											<?php } else { ?>
            								<input type="hidden" name="add_desc" id="add_desc">
            								<?php } ?><?php if($formdata['location_item']==1) { ?>
            											<div id="loc" style="float:left; padding-right:5px;">
            												...
            												<div class="form-group"><input type="text" name="iloc[]" id="iloc_<?php echo e($i); ?>" style="border:none;color:#FFF;"></div><!-- NOV24 -->
            											</div>	<?php } else { ?>
            								<input type="hidden" name="location_item" id="location_item">
            								<?php } ?>	
            								...
            								<div id="batchdiv_1" style="float:left; padding-right:5px;" class="addBatchBtn">
            									<button type="button" id="btnBth_<?php echo e($i); ?>" class="btn btn-primary btn-xs batch-add" data-toggle="modal" data-target="#batch_modal">Add Batch</button>
            									<div class="form-group"><input type="text" name="batchNos[]" id="bthSelNos_<?php echo e($i); ?>" style="border:none;color:#FFF;" value="<?php echo e($batchitems[$item->id]['batches']); ?>"></div>
            									<input type="hidden" id="bthSelIds_<?php echo e($i); ?>" name="batchIds[]" value="<?php echo e($batchitems[$item->id]['ids']); ?>"> 
                                                <input type="hidden" id="bthSelQty_<?php echo e($i); ?>" name="qtyBatchs[]" value="<?php echo e($batchitems[$item->id]['qtys']); ?>">
                                                <input type="hidden" id="batchRem_<?php echo e($i); ?>" name="batchRem[]">
            								</div>
								
											<?php if($isconloc): ?>
											<div id="cnloc" style="float:left; padding-right:5px;">
												<button type="button" id="cnloc_<?php echo e($i); ?>" class="btn btn-primary btn-xs cnloc-info" data-toggle="modal" data-target="#conloc_modal">Consignment Location</button>
												<input type="hidden" name="conloc_id[]" id="hdlocid_<?php echo e($i); ?>" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty[]" id="hdlocqty_<?php echo e($i); ?>" value="<?php echo e($item->conloc_qty); ?>">
												<input type="hidden" name="conloc_id_old[]" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty_old[]" value="<?php echo e($item->conloc_qty); ?>">
											</div>
											<?php endif; ?>
											<?php if($formdata['supersede']==1) { ?>	
											<div id="ssede" style="float:left; padding-right:5px;">
												<button type="button" id="sede_<?php echo e($i); ?>" class="btn btn-primary btn-xs sup-sede">Supersede</button>
											</div>
											<?php } else { ?>
								<input type="hidden" name="supersede" id="supersede">
								<?php } ?><?php if($formdata['purchase_item']==1) { ?>	
								...
								<?php } ?><?php if($formdata['customer_sales']==1) { ?>
											<div style="float:left; padding-right:10px;">
												<button type="button" id="custsaleshisItm_<?php echo e($i); ?>" data-toggle="modal" data-target="#cust_sales_modal" class="btn btn-primary btn-xs cust-sales-his">Customer Sales</button>
											</div>
											<?php } else { ?>
								<input type="hidden" name="customer_sales" id="customer_sales">
								<?php } ?><?php if($formdata['add_assembley']==1) { ?>
											<div style="float:left; padding-right:10px;">
												<button type="button" id="assemblyItm_<?php echo e($i); ?>" data-toggle="modal" data-target="#assembly_modal" class="btn btn-primary btn-xs asm-itm">Add Assembly Items</button>
												<input type="hidden" name="assembly_items[]" id="asmid_<?php echo e($i); ?>" value="<?php echo e($item->assembly_items); ?>">
												<input type="hidden" name="assembly_items_qty[]" id="asmqt_<?php echo e($i); ?>" value="<?php echo e($item->assembly_items_qty); ?>">
												<input type="hidden" name="assembly_items_old[]" value="<?php echo e($item->assembly_items); ?>">
												<input type="hidden" name="assembly_items_qty_old[]" value="<?php echo e($item->assembly_items_qty); ?>">
											</div>
											<?php } else { ?>
								<input type="hidden" name="add_assembley" id="add_assembley">
								<?php } ?>	<?php if($formdata['view_assembley']==1) { ?>
											<div style="float:left; padding-right:10px;">
												<button type="button" id="assemblyItmVw_<?php echo e($i); ?>" data-toggle="modal" data-target="#view_assembly_modal" class="btn btn-primary btn-xs view-asm-itm">View Assembly Items</button>
											</div>
											<?php } else { ?>
								...
								<?php } ?>
											...
											<div class="dimnInfodivPrntItm" id="dimnInfodivPrntItm_<?php echo e($i); ?>">
												<div class="dimnInfodivChldItm">							
													<div class="table-responsive dimn-item-data" id="dimnitemData_<?php echo e($i); ?>"></div>
												</div>
											</div>

											<div class="sedePrntItm" id="sedePrntItm_<?php echo e($i); ?>">
												<div class="sedeChldItm" style="float:right; padding-right:5px;">							
													<div class="table-responsive sede-data" id="sedeData_<?php echo e($i); ?>"></div>
												</div>
											</div>
											
											<div class="locPrntItm" id="locPrntItm_<?php echo e($i); ?>">
												<div class="locChldItm">							
													<div class="table-responsive loc-data" id="locData_<?php echo e($i); ?>">
														<?php 
														if(array_key_exists($item->id, $itemlocedit)) { 
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	<td><?php echo e($row->name); ?></td>
																	<td><?php echo e($cqty); ?></td>
																	<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($qty_entry); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>" data-qty="<?php echo e($cqty); ?>"><!-- NOV24 -->
																	<input type="hidden" name="locid[<?php echo $i-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="editid[<?php echo $i-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
														...
														</div><script>document.getElementById('iloc_'+<?php echo e($i); ?>).value='<?php echo e($tQty); ?>';</script><!--NOV24-->
															<?php  } ?>
													</div>
												</div>
											</div>
											...
											foreach($itemdesc[$item->id] as $desc) { ?>
												<div class="descdivPrntItm" id="descdivPrntItm_<?php echo e($i); ?>">
													<div class="descdivChldItm" >							
														<div class="col-xs-10" style="padding-bottom:5px !important;">
															<div class="col-xs-10">
																<input type="text" name="itemdesc[<?php echo $item->id;?>][]" autocomplete="off" class="form-control txt-desc" value="<?php echo e($desc->description); ?>" placeholder="Description">
															</div>
															<div class="col-xs-2" style="float:left;">
																 <button type="button" class="btn btn-success btn-add-desc" >
																	<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
																 </button>
																 <button type="button" class="btn btn-danger btn-remove-desc" data-id="remdesc_<?php echo e($i); ?>" data-itmid="<?php echo e($item->id); ?>">
																	<span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
																 </button>
																 <input type="hidden" name="desc_id[<?php echo $item->id;?>][]" value="<?php echo e($desc->id); ?>" class="hid-id">
															</div>
														</div>
													</div>
												</div>
											<?php } } else { ?>
												<div class="descdivPrntItm" id="descdivPrntItm_<?php echo e($i); ?>" style="display: none;">
													<div class="descdivChldItm" >							
														<div class="col-xs-10" style="padding-bottom:5px !important;">
															<div class="col-xs-10">
																<input type="text" name="itemdesc[<?php echo $i-1;?>][]" autocomplete="off" class="form-control txt-desc" placeholder="Description">
									...
									<div class="OCdivPrnt">
										...
										<div class="OCdivChld">
											<table border="0" class="table-dy-row">
												<tr>
													<td width="15%">
														<input type="hidden" name="oc_id[]" id="ocid_<?php echo e($i); ?>" value="<?php echo e($row->id); ?>">
														<input type="hidden" name="dr_acnt_id[]" id="dracntid_<?php echo e($i); ?>" value="<?php echo e($row->dr_id); ?>">
														<input type="hidden" name="cur_dr_acnt_id[]" id="curdracntid_<?php echo e($i); ?>" value="<?php echo e($row->dr_id); ?>">
														<span class="small">Debit Account</span>
														<input type="text" id="dracnt_<?php echo e($i); ?>" name="dr_acnt[]" value="<?php echo e($row->dr_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#account_modal" placeholder="Debit Account">
													</td>
													<td width="12%">
														<span class="small">Reference</span>
														<input type="text" name="oc_reference[]" id="ocref_<?php echo e($i); ?>" value="<?php echo e($row->se_reference); ?>" autocomplete="off" class="form-control" placeholder="Reference">
													</td>
													<td width="15%">
														<span class="small">Description</span>
														<input type="text" name="oc_description[]" id="ocdesc_<?php echo e($i); ?>" value="<?php echo e($row->se_description); ?>" autocomplete="off" class="form-control" placeholder="Description">
													</td>
													<td width="8%">
														<span class="small">Amount</span>
														<input type="number" name="oc_amount[]" step="any" id="ocamt_<?php echo e($i); ?>" value="<?php echo e($row->se_amount); ?>" autocomplete="off" class="form-control oc-line" placeholder="Amount">
														<input type="hidden" name="oc_amount_old[]" value="<?php echo e($row->se_amount); ?>">
													</td>
													<td width="18%">
														<span class="small">Credit Account</span>
														<input type="hidden" name="cr_acnt_id[]" id="cracntid_<?php echo e($i); ?>" value="<?php echo e($row->cr_id); ?>">
														<input type="hidden" name="cur_cr_acnt_id[]" id="curcracntid_<?php echo e($i); ?>" value="<?php echo e($row->cr_id); ?>">
														<input type="text" id="cracnt_<?php echo e($i); ?>" name="cr_acnt[]" value="<?php echo e($row->cr_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#paccount_modal" placeholder="Credit Account">
													</td>
													...
													<?php if(count($serow) == $i) { ?>
														 ...
														 <button type="button" class="btn-danger btn-remove-oc" data-id="rem_<?php echo e($i); ?>">
															<i class="fa fa-fw fa-minus-square"></i>
														 </button>
													<?php } else { ?>
														<button type="button" class="btn-success btn-add-oc" >
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10"> 
										...
										<div class="col-xs-2"></div>                                                                                                                     
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" step="any" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e((old('total'))?old('total'):(($orderrow->is_fc==1)?$orderrow->total_fc:$orderrow->total)); ?>">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" step="any" id="total_fc" name="total_fc" class="form-control spl" value="<?php echo e((old('total_fc'))?old('total_fc'):$orderrow->total); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="roundoff" name="roundoff"value="<?php echo e((old('roundoff'))?old('roundoff'):$orderrow->roundoff); ?>" class="form-control spl round-off" placeholder="0">
											<input type="hidden" id="discount" name="discount" value="<?php echo e(old('discount')); ?>" class="form-control spl discount-cal">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="roundoff_fc" name="roundoff_fc" value="<?php echo e(old('roundoff_fc')); ?>" class="form-control spl">
											<input type="hidden" id="discount_fc" name="discount_fc" value="<?php echo e(old('discount_fc')); ?>" class="form-control spl">
										</div>
									</div>
                                </div>
								<?php else: ?>
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"><!-- MR19 -->
											<input type="number" step="any" id="discount" name="discount" autocomplete="off" class="form-control spl discount-cal" value="<?php echo e((old('discount'))?old('discount'):(($orderrow->is_fc==1)?$orderrow->discount_fc:$orderrow->discount)); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" value="<?php echo e((old('discount'))?old('discount'):number_format($orderrow->discount,2)); ?>" placeholder="0">
										</div>
									</div>
                                </div>
								<?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc" name="less_description" value="<?php echo e((old('less_description'))?old('less_description'):$orderrow->less_description); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount" name="less_amount" value="<?php echo e((old('less_amount'))?old('less_amount'):$orderrow->less_amount); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc2" name="less_description2" value="<?php echo e((old('less_description2'))?old('less_description2'):$orderrow->less_description2); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount2" name="less_amount2" value="<?php echo e((old('less_amount2'))?old('less_amount2'):$orderrow->less_amount2); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc3" name="less_description3" value="<?php echo e((old('less_description3'))?old('less_description3'):$orderrow->less_description3); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount3" name="less_amount3" value="<?php echo e((old('less_amount3'))?old('less_amount3'):$orderrow->less_amount3); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" class="form-control spl" id="previnv_description" name="previnv_description" value="<?php echo e((old('previnv_description'))?old('previnv_description'):$orderrow->previnv_description); ?>" placeholder="Previous Invoice Details" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="previnv_amount" name="previnv_amount" value="<?php echo e((old('previnv_amount'))?old('previnv_amount'):$orderrow->previnv_amount); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal" name="subtotal" class="form-control spl" readonly value="<?php echo e((old('subtotal'))?old('subtotal'):(($orderrow->is_fc==1)?$orderrow->subtotal_fc:$orderrow->subtotal)); ?>">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="subtotal_fc" name="subtotal_fc" class="form-control spl" readonly value="<?php echo e((old('subtotal_fc'))?old('subtotal_fc'):$orderrow->subtotal); ?>">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="hidden" id="vatcur" name="vatcur" value="<?php echo e((old('vatcur'))?old('vatcur'):(($orderrow->is_fc==1)?$orderrow->vat_amount_fc:$orderrow->vat_amount)); ?>">
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" value="<?php echo e((old('vat'))?old('vat'):(($orderrow->is_fc==1)?$orderrow->vat_amount_fc:$orderrow->vat_amount)); ?>" readonly>
										</div>
										<div class="col-xs-2">
								...
								<!--<input type="hidden" step="any" id="discount" name="discount" class="form-control" value="<?php echo e($orderrow->discount); ?>">
								<input type="hidden" step="any" id="discount_fc" name="discount_fc" class="form-control" placeholder="0">-->
								<div class="form-group">
									<input type="hidden" step="any" id="other_cost" name="other_cost" value="<?php echo e($orderrow->other_cost); ?>" readonly class="form-control" placeholder="0">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="<?php echo e((old('net_amount_hid'))?old('net_amount_hid'):(($orderrow->is_fc==1)?$orderrow->net_total_fc:($orderrow->net_total-$orderrow->roundoff))); ?>">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount'))?old('net_amount'):(($orderrow->is_fc==1)?$orderrow->net_total_fc:($orderrow->net_total-$orderrow->roundoff))); ?>">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="footer_id" id="footer_id" value="<?php echo e($orderrow->fid); ?>">
                                        <input type="text" class="form-control" id="footermsg" name="footer" value="<?php echo e($orderrow->footer); ?>" placeholder="Footer" autocomplete="off" data-toggle="modal" data-target="#footer_modal">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<?php if($formdata['images']==1) { ?>
								  ...
								  <?php if(count($photos)>0) { $i=0; ?>
										...
										<div class="filedivChld">
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Uploaded Image <?php echo e($i); ?></label>
												<div class="col-sm-9">
													<div class="file-preview">
														<div class="file-drop-disabled">
															<div class="file-preview-thumbnails">
																<div class="file-live-thumbs">
																	<a href="<?php echo e(asset('uploads/salesinvoice/'.$prow->photo)); ?>" target="_blank">View Image <?php echo e($i); ?></a>
																</div>
															</div>
															<input type="hidden" name="photo_id[]" id="photo_id_<?php echo e($i); ?>" value="<?php echo e($prow->id); ?>">
															<input type="hidden" name="photo_name[]" id="photo_name_<?php echo e($i); ?>" value="<?php echo e($prow->photo); ?>">
												...
												<div class="col-sm-1">
													<button type="button" class="btn-success btn-add-file" id="btn_<?php echo e($i); ?>">
														<i class="fa fa-fw fa-plus-square"></i>
													</button>
													<button type="button" class="btn-danger btn-remove-file" data-id="<?php echo e($prow->id); ?>">
														<i class="fa fa-fw fa-minus-square"></i>
													 </button>
												</div>
												<label for="input-text" class="col-sm-2 control-label filedslbl" id="lblifd_<?php echo e($i); ?>">Description</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="imgdesc_<?php echo e($i); ?>" name="imgdesc[]" value="<?php echo e($prow->description); ?>" placeholder="Description" autocomplete="off">
												</div>
								  ...
								  <?php } else { ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="file" id="input-51" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('job_estimate/upload/')); ?>">
								...
								<div id="rv_form">
									<input type="hidden" id="rvdraccount" value="<?php echo e($rvvoucher['account_name']); ?>">
									<input type="hidden" id="rvdraccountid" value="<?php echo e($rvvoucher['id']); ?>">
									<input type="hidden" name="rvid" value="<?php echo e($rvvoucher['rid']); ?>">
									<input type="hidden" id="remrv" name="remove_rv">
									<div class="RVdivPrnt">
										<?php if(count($rventry) > 0): ?>
										<input type="hidden" name="rvedit_id" value="<?php echo e($rventry[0]->rvid); ?>">
										<?php  $i = 1;  ?>
										<?php foreach($rventry as $rowrv): ?>
										
										<?php if($rowrv->entry_type=='Dr'): ?>
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													<td width="10%">
														<input type="hidden" id="rvvoucher_<?php echo e($i); ?>" name="rv_voucher[]" value="<?php echo e($rvid); ?>"/>
														<input type="hidden" id="rowid_<?php echo e($i); ?>" name="rowid[]" value="<?php echo e($rowrv->id); ?>"/>
														<span class="small">Voucher Type</span>
														<select id="vouchertype_<?php echo e($i); ?>" class="form-control select2 voucher_type" style="width:100%" name="voucher_type[]">
														<option value="CASH" <?php echo e(($rowrv->currency_id==0)?'selected':''); ?>>Cash</option>
														<option value="BANK" <?php echo e(($rowrv->currency_id==1)?'selected':''); ?>>Bank</option>
														<option value="PDCR" <?php echo e(($rowrv->currency_id==2)?'selected':''); ?>>PDC</option>
													</select>
													</td>
													<td width="10%">
														<span class="small">Voucher No</span>
														<input type="text" name="rv_voucher_no[]" value="<?php echo e($rowrv->voucher_no); ?>" id="rvvoucherno_<?php echo e($i); ?>" autocomplete="off" class="form-control">
													</td>
													<td width="20%">
														<span class="small">Debit Account1</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_<?php echo e($i); ?>" autocomplete="off" class="form-control" data-toggle="modal" data-target="#customer_modalRV" value="<?php echo e($rowrv->master_name); ?>">
														<input type="hidden" id="rvdraccountid_<?php echo e($i); ?>" name="rv_dr_account_id[]" value="<?php echo e($rowrv->account_id); ?>">
													</td>
													<td width="15%">
														<span class="small">Amount</span> 
														<input type="number" id="rvamount_<?php echo e($i); ?>" step="any" name="rv_amount[]" value="<?php echo e($rowrv->amount); ?>" class="form-control" placeholder="Amount">
													</td>
													<td width="15%">
														<span class="small lbban_<?php echo e($i); ?>">Bank</span> 
														<select id="bankid_<?php echo e($i); ?>" class="form-control select2 bank" style="width:100%" name="bank_id[]">
														<option>Select</option>
														<?php foreach($banks as $bank): ?>
														<option value="<?php echo e($bank['id']); ?>" <?php echo e(($rowrv->bank_id==$bank['id'])?'selected':''); ?>><?php echo e($bank['name']); ?></option>
														<?php endforeach; ?>
														</select>
													</td>
													<td width="15%">
														<span class="small lbchq_<?php echo e($i); ?>">Cheque No</span>
														<input type="text" name="cheque_no[]" id="chequeno_<?php echo e($i); ?>" value="<?php echo e($rowrv->cheque_no); ?>" class="form-control" placeholder="Cheque No">
													</td>
													<td width="15%">
														<span class="small lbchqd_<?php echo e($i); ?>">Cheque Date</span>
														<input type="text" name="cheque_date[]" id="chequedate_<?php echo e($i); ?>" autocomplete="off" value="<?php echo e(($rowrv->cheque_date!='0000-00-00')?date('d-m-Y',strtotime($rowrv->cheque_date)):''); ?>" class="form-control" data-language='en' readonly placeholder="Cheque Date">
													</td>
													<td width="1%">
														<button type="button" class="btn-success btn-add-rv">
															<i class="fa fa-fw fa-plus-square"></i>
														 </button>
														 <button type="button" class="btn-danger btn-remove-rv" data-id="rem_<?php echo e($i); ?>">
															<i class="fa fa-fw fa-minus-square"></i>
														 </button>
													</td>
												</tr>
										...
										<?php  $i++;  ?>
										<?php else: ?>
											<input type="hidden"  name="rowidcr" value="<?php echo e($rowrv->id); ?>"/>
										<?php endif; ?>
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													<td width="10%">
														<input type="hidden" id="rvvoucher_1" name="rv_voucher[]" value="<?php echo e($rvid); ?>"/>
														<span class="small">Voucher Type</span>
													...
													<td width="10%">
														<span class="small">Voucher No</span>
														<input type="text" name="rv_voucher_no[]" value="<?php echo e($rvvoucher['voucher_no']); ?>" id="rvvoucherno_1" autocomplete="off" class="form-control">
													</td>
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" class="form-control" data-toggle="modal" data-target="#customer_modalRV" value="<?php echo e($rvvoucher['account_name']); ?>">
														<input type="hidden" id="rvdraccountid_1" name="rv_dr_account_id[]" value="<?php echo e($rvvoucher['id']); ?>">
													</td>
													<td width="15%">
														<span class="small">Amount</span> 
													...
													<td width="15%">
														...
														<option>Select</option>
														<?php foreach($banks as $bank): ?>
														<option value="<?php echo e($bank['id']); ?>" <?php if(old('bank_id')==$bank['id']) echo 'selected'; ?>><?php echo e($bank['name']); ?></option>
														<?php endforeach; ?>
														</select>
													</td>
													<td width="15%">
								...
								<p>
									<i style="color:red;">Comments: <?php echo e($orderrow->comment); ?></i>
								</p>
								</div>
								<br/>
									...
									<div class="maildivChld">	
										...
										<div class="form-group">
											<label for="input-text" class="col-sm-2 control-label">Email</label>
												 <div class="col-sm-10">
													<input type="text" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo e($orderrow->email); ?>">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <textarea name="foot_description" id="foot_description" class="form-control editor-cls" placeholder="Description"><?php echo e($orderrow->foot_description); ?></textarea>
                                    </div>
                                </div>
								<?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_invoice')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('sales_invoice/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$('#optHide').toggle(); var srvat=<?php echo e($vatdata->percentage); ?>;
$(document).ready(function () { 
	...
	<?php if( count(array($voucher)) > 0 && $voucher->is_cash_voucher==1) { ?> //cash customer.... 
		...
		$('#customer_id').val(<?php echo e($voucher->default_account_id); ?>);
		$('#dr_account_id').val(<?php echo e($voucher->default_account_id); ?>);
	...
	var urlcode = "<?php echo e(url('sales_invoice/checkrefno/')); ?>";
	...
	function getAutoPrice(curNum) {
		...
		if($('#sales_type option:selected').val()=='normal') {
			$.ajax({
				url: "<?php echo e(url('itemmaster/get_sale_cost/')); ?>", 
				type: 'get',
			...
			$.ajax({
				url: "<?php echo e(url('itemmaster/get_cost_sale/')); ?>", //get_cost_avg
				type: 'get',
...
newEntry.find($('.dimn-view')).attr('id', 'itmInfo_' + rowNum);
	...
	/*$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('sales_invoice/getvoucher/')); ?>/" + vchr_id, function(data) {
	...
	$(document).on('click', '.sup-sede', function(e) { 
	   ...
	   if(item_id!='') {
		   var locUrl = "<?php echo e(url('itemmaster/get_sedeinfo/')); ?>/"+item_id+"/"+curNum
	...
	$(document).on('click', '.itemRow', function(e) { 
		...
		/* TEMPORARLY DISABLED ... } else {
			$.get("<?php echo e(url('itemmaster/getunit/')); ?>", function(data) {
				$('#itmunt_'+num).find('option').remove().end();
				$.each(data, function(key, value) {   
					$('#itmunt_'+num).find('option').end()
					 .append($("<option></option>")
	...
	$(document).on('keyup', '.line-quantity', function(e) {
		...
		if( parseFloat(this.value) == 0 || parseFloat(this.value) < 0) {
			...
			$.get("<?php echo e(url('itemmaster/checkqty/')); ?>/" + itmid, function(data) {  
	...
	$(document).on('blur', '.line-cost', function(e) {
		...
		<?php if(auth()->user()->can('bcost-sale')): ?>
	...
	$(document).on('click', '.dimn-view', function(e) {  console.log('gdfg');
	   ...
	   var item_id = $('#itmid_'+curNum).val();
	   if(item_id!='') {
		   var infoUrl = "<?php echo e(url('itemmaster/get_dimn_info/')); ?>/"+item_id;
	...
	/* $(document).on('click', '.loc-info', function(e) { 
	   ...
	   if(item_id!='') {
		    var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+item_id+"/"+curNum+"/"+si_id+"/SI";
	...
	var cnlocUrl = "<?php echo e(url('itemmaster/conloc_data/')); ?>";
	...
	$('.cust-history').click(function() {
		var hisurl = "<?php echo e(url('sales_invoice/cust_history/')); ?>";
		...
		/* var ordhisurl = "<?php echo e(url('sales_invoice/order_history/')); ?>";
	...
	$('.cust-history-phone').click(function() {
		var phisurl = "<?php echo e(url('sales_invoice/cust_history_phone/')); ?>";
		var phone = $('#customer_phone').val();
	...
	$(document).on('click', '#rvdraccount_1', function(e)  {   
		//if($('#department_id').length)
			//custurl2 = "<?php echo e(url('sales_order/customer_data/')); ?>"+'/'+$('#department_id option:selected').val();
		//else
		var vtype = $('#vouchertype_1 option:selected').val();
		custurl2 = "<?php echo e(url('sales_order/account_data/')); ?>"+'/'+vtype;
	...
	var newcusturl = "<?php echo e(url('sales_order/newcustomer_data/')); ?>";
	...
	///Customer search...
	var srccust = "<?php echo e(url('sales_invoice/ajax_customer/')); ?>";
	...
	$(document).on('click', '.cust-sales-his', function(e) { 
	   ...
	   if(item_id!='') {
		   var infoUrl = "<?php echo e(url('itemmaster/get_custsales_info/')); ?>/"+item_id+"/"+cust_id; 
	...
	var asmitmurl = "<?php echo e(url('itemmaster/asmitem_data/')); ?>";
	...
	$(document).on('click', '.view-asm-itm', function(e) { 
	   ...
	   if(item_id!='') {
		   var vwUrl = "<?php echo e(url('itemmaster/get_assembly_items/')); ?>/"+item_id+'/'+item_qty+'/'+curNum; 
	...
	$(document).on('click', '.view-cnloc-info', function(e) { 
	   ...
	   if(cnloc_id!='') {
		   var vwUrl = "<?php echo e(url('itemmaster/view_conloc_items/')); ?>/"+cnloc_id+'/'+cnloc_qty+'/SI/'+curNum+'/'+rwid; 
	...
	$(document).on('change', '.voucher_type', function(e){ //DEC
		...
		if($('#rowid_'+curNum).val()=='') {
    		$.get("<?php echo e(url('customer_receipt/getvoucher/')); ?>/" + vchr_id+'/'+vchr, function(data) {
...
/*	$(document).on('change', '.voucher_type', function(e){ //$('#voucher_type').on('change', function(e){
	...
	var rvNum = <?php echo e(count($rventry)); ?>;
	...
	$(document).on('click', '.btn-add-file', function(e)  { 
	    ...
	    fNum++;
		$.ajax({
			url: "<?php echo e(url('job_order/get_fileform/QS')); ?>",
			type: 'post',
			data: {'no':fNum},
			success: function(data) {
	...
	$(document).on('click', '.batch-add', function(e) { 
       ...
       var batchurl = "<?php echo e(url('itemmaster/batch-get')); ?>";
...
function getDocument() { 
	...
	if(doc=='SQ')
		var pourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id+"/QS";
	else if(doc=='SO')
		var pourl = "<?php echo e(url('sales_order/get_order/')); ?>/"+customer_id+"/SO";
	else if(doc=='CDO')
		var pourl = "<?php echo e(url('customers_do/get_order/')); ?>/"+customer_id+"/CDO/"+sid;
...
function getAccount(e) { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var itmurl = "<?php echo e(url('purchase_invoice/account_data/')); ?>/sales";
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
