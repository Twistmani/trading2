<div class="panel panel-success filterable" id="newBinList">
	...
	<div class="table-responsive m-t-10"> <button type="button" class="btn btn-primary createBin">Create Bin</button>
		<table class="table horizontal_table table-striped" id="table51">
			...
			<?php foreach($binloc as $row): ?>
			<tr>
				<td><a href="" class="binRow" data-code="<?php echo e($row->code); ?>" data-id="<?php echo e($row->id); ?>" data-dismiss="modal"><?php echo e($row->code); ?></a></td>
				<td><a href="" class="binRow" data-code="<?php echo e($row->code); ?>" data-id="<?php echo e($row->id); ?>" data-dismiss="modal"><?php echo e($row->name); ?></a></td>
			</tr>
			<?php endforeach; ?>
		</table>
...
$(function() {
	...
	$('#createI').on('click', function(e){
		...
		if(ic=="") {
			...
			$.ajax({
				url: "<?php echo e(url('location/ajax_create/')); ?>",
				type: 'get',
