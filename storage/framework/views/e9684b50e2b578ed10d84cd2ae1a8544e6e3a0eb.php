                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('quotation_rental/print/'.$printid.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="<?php echo e(url('quotation_rental/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('quotation_rental')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('quotation_rental/add')); ?>" class="btn btn-warning">Clear</a>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('quotation_rental/checkrefno/')); ?>";
	var urlvchr = "<?php echo e(url('quotation_rental/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	var supurl = "<?php echo e(url('quotation_rental/salesman_data/')); ?>";
