                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('salesman/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableSalesman">
                                    ...
                                    <tr>
                                        <td><?php echo e($salesman->salesman_id); ?></td>
										<td><?php echo e($salesman->name); ?></td>
										<td>
											<p>
												<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('salesman/edit/'.$salesman->id)); ?>'">
												<span class="glyphicon glyphicon-pencil"></span></button>
											</p>
										</td>
										<td>
											<p>
												<button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($salesman->id); ?>')"><span
															class="glyphicon glyphicon-trash"></span></button>
											</p>
										</td>
                                    </tr>
									<?php endforeach; ?>
                                    <?php if(count($salesmans) === 0): ?>
									</tbody>
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('salesman/delete/')); ?>";
