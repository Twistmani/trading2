            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							...
							<br/>
							<form class="form-horizontal" role="form" method="POST" name="frmItemSearch" id="frmItemSearch" target="_blank" action="<?php echo e(url('itemenquiry/details')); ?>">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									...
									<div class="row">
										...
										<div class="col-xs-1">
											...
											<!--<?php if (\Entrust::can(('item-location'))) : ?><a href="" class="btn btn-primary location" data-toggle="modal" data-target="#location_modal">Location</a><?php endif; // Entrust::can ?>-->
										</div>
										<div class="col-xs-1">
...
$(function() {	
	var hisurl = "<?php echo e(url('itemmaster/stock_location/')); ?>";
	...
	var barurl = "<?php echo e(url('itemmaster/barcode/')); ?>";
	...
	var scurl = "<?php echo e(url('itemenquiry/get_custsupp/')); ?>";
	...
	var sdurl = "<?php echo e(url('itemmaster/get_sedeinfo/')); ?>";
	...
	var lqurl = "<?php echo e(url('itemmaster/get_locqty/')); ?>";
	...
	var bthurl = "<?php echo e(url('itemmaster/get_batch/')); ?>";
	...
	$(function() {
            ...
            var dtInstance = $("#ItemEnq").DataTable({
				...
				"serverSide": true,
				"ajax":{
						 "url": "<?php echo e(url('itemenquiry/paging/')); ?>",
						 "dataType": "json",
						 "type": "POST",
...
function setSearch() {
	...
	if (!checked) {
		...
		if( $('#search_type option:selected').val()=='') {
			...
			document.frmItemSearch.action = "<?php echo e(url('itemenquiry/details')); ?>";
			document.frmItemSearch.submit();
		}
	}
}
function updateStock() {
	document.frmItemMasterUtility.action="<?php echo e(url('utilities/updateItemMasterStock/stock')); ?>";
	document.frmItemMasterUtility.submit();
}

function getForm(id) { 
	var itmurl = "<?php echo e(url('itemenquiry/openform/')); ?>/"+id;
