                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="#" class="quot-data" data-id="<?php echo e($order->id); ?>" data-name="<?php echo e($order->voucher_no); ?>" data-toggle="modal" data-target="#quot_modal"><?php echo e($order->prefix.$order->voucher_no); ?></a></td>
											<td><?php echo e(date('d-m-Y', strtotime($order->voucher_date))); ?></td>
											<td><?php echo e($order->vehicle); ?></td>
											<td><?php echo e($order->reg_no); ?></td>
											<td></td>
										</tr>
										<?php endforeach; ?>
                                    </tbody>
...
function setTransfer() {
	...
	//alert(items);
	if(curl=='SO')
		url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/SO"; //url = "<?php echo e(url('sales_invoice/add/')); ?>/"+items+"/SO";
	else if(curl=='SOI')
		url = "<?php echo e(url('job_invoice/add/')); ?>/"+items+"/SO";
	else if(curl=='JE')
		url = "<?php echo e(url('job_estimate/add/')); ?>/"+items;
	else
