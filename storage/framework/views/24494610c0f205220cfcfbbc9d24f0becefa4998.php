        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<tbody id="bod">
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<?php if(count($result) > 0): ?> <?php  $ctotal =$total_qty=$total_ucost= 0;  ?>
										<tr>
											<td colspan="8"><b><?php echo e($key); ?></b></td>
										</tr>
										<?php foreach($result as $row): ?>
										<?php  $ctotal += $row->sale_reference; $total_qty += $row->quantity; $total_ucost += $row->unit_cost;  ?>
										<tr>
										...
										<tr>
											...
											<td class="text-right"><b><?php echo e($total_ucost); ?></b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('stock_transaction/export')); ?>">
