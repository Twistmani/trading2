                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('purchase_order/update/'.$orderrow->id)); ?>">
                                ...
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <button type="button" onClick="funApproval('<?php echo e($orderrow->id); ?>')" class="btn btn-primary" <?php if($orderrow->approval_status==1) echo 'disabled';?>>Approve</button>
...
function funApproval(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('purchase_order/approve/')); ?>";
