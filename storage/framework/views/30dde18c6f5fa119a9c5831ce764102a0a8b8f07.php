                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmVatMaster" id="frmVatMaster" action="<?php echo e(url('vat_master/save')); ?>">
								...
								<?php foreach($departments as $drow): ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="hidden" name="collection_account[]" id="vatacid_<?php echo e($i+$n); ?>">
											<input type="text" name="vat_inputac[]" id="vatac_<?php echo e($i+$n); ?>" class="form-control vat-account" autocomplete="off" data-toggle="modal" data-target="#account_modal">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="vat_outputac[]" id="vatac_<?php echo e($i+$n); ?>" class="form-control vat-account" autocomplete="off" data-toggle="modal" data-target="#account_modal">
											<input type="hidden" name="payment_account[]" id="vatacid_<?php echo e($i+$n); ?>">
										</div>
									</div>
									<?php  $n++;  ?>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="hidden" name="vatinput_import[]" id="vatacid_<?php echo e($i+$n); ?>">
											<input type="text" name="vat_input_import[]" id="vatac_<?php echo e($i+$n); ?>" class="form-control vat-account" autocomplete="off" data-toggle="modal" data-target="#account_modal">
										</div>
									</div>
									<?php  $n++;  ?>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="vat_output_import[]" id="vatac_<?php echo e($i+$n); ?>" class="form-control vat-account" autocomplete="off" data-toggle="modal" data-target="#account_modal">
											<input type="hidden" name="vatoutput_import[]" id="vatacid_<?php echo e($i+$n); ?>">
										</div>
									</div>
									<?php  $n++;  ?>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="expense_ac[]" id="vatac_<?php echo e($i+$n); ?>" class="form-control vat-account" autocomplete="off" data-toggle="modal" data-target="#account_modal">
											<input type="hidden" name="expense_account[]" id="vatacid_<?php echo e($i+$n); ?>">
										</div>
									</div>
