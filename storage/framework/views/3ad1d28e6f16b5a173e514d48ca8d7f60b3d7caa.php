										...
										<td colspan="2" align="center">
                                            <table border="1" class="table table" cellpadding="5" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach($grouped as $groupName => $accounts): ?>
                                                        <tr style="background-color: #f0f0f0; font-weight: bold;">
                                                            <td colspan="8"><?php echo e($groupName ?: 'No Group'); ?></td>
                                                        </tr>
                                                        ...
                                                        <?php foreach($accounts as $account): ?>  
                                                            <tr>
                                                                ...
                                                                <td style="text-align:right"><?php echo e(number_format($account['opening_debit'], 2)); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($account['opening_credit'], 2)); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($account['ytd_debit'], 2)); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($account['ytd_credit'], 2)); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($account['closing_balance'], 2)); ?></td>
                                                            </tr>
                                                        <?php endforeach; ?>

                                                        <?php /* Optional Group Subtotals */ ?>
                                                        <?php 
                                                        ...
                                                        <tr style="font-weight: bold; background-color: #e8e8e8;">
                                                            ...
                                                            <td style="text-align:right"><?php echo e(number_format($subOpDr, 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($subOpCr, 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($subDr, 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($subCr, 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($subCl, 2)); ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                                ...
                                                <tfoot>
                                                        <tr style="font-weight: bold; background-color: #d0f0d0;">
                                                            ...
                                                            <td style="text-align:right"><?php echo e(number_format($grandOpDr, 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($grandOpCr, 2)); ?></td>
                                                            ...
                                                            <td style="text-align:right"><?php echo e(number_format($grandCl, 2)); ?></td>
                                                        </tr>
</tfoot>
