                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmCustomerDO" id="frmCustomerDO" action="<?php echo e(url('customers_do/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="document" readonly name="document" value="<?php echo e($quoterow->voucher_no); ?>" autocomplete="off" onclick="getDocument()">
										<input type="hidden" name="document_id" id="document_id" value="<?php echo e($docid); ?>"/>
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										 <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<option value="<?php echo e($term['id']); ?>" <?php if($term['id']==$quoterow->term_id) echo 'selected'; ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="11%">
													<span class="small">Total</span> <input type="number" id="itmttl_<?php echo e($j); ?>" step="any" name="line_total[]" class="form-control line-total" readonly value="<?php echo e(old('line_total')[$i]); ?>">
...
$(document).ready(function () { 
    ...
    $('#frmCustomerDO').bootstrapValidator({
        fields: {
			...
			<?php if($formdata['location_item']==1): ?> ,'iloc[]': { validators: { notEmpty: { message: 'Item location quantity is required and cannot be empty!' } }} <?php endif; ?>
        }
