...
<div>
    ...
    <table border="0" style="width:100%;">
								<tr><td width="60%" align="center" ><h3><img src="<?php echo e(asset('assets/'.Session::get('logo').'')); ?>" width="900px;" /></td></h3></td>
        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
                    <div class="print" id="invoicing">
							...
							<tbody id="bod">
								<tr style="border:0px solid black;">
									...
									<!-- <td class="text-right"></td> -->
											...
											<td ><b><?php echo e(number_format($nettotal,2)); ?></b></td>
										</tr>
									</table>
								...
								<tr style="border:0px solid black;">
									...
									<?php foreach($reports as $key => $report): ?>
										...
										<tr>
											...
											<td><?php echo e(number_format($total,2)); ?></td>
											<td><?php echo e(number_format($discount,2)); ?><?php //echo date('d-m-Y', strtotime($transaction['invoice_date'])); ?></td>	
											
											<td class="emptyrow text-right"><?php echo e(number_format($vat_amount,2)); ?></td>
											<td class="emptyrow text-right"><?php echo e(number_format($amount_total,2)); ?></td>
							...
							<tbody id="bod">
								...
								<tr>
										<td align="left" valign="top" style="padding-left:0px;">
											<h6><b>Cus.Name: <?php echo e($report[0]->creditor); ?><br/>
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										...
										<!--	<td ><?php echo e($row->debitor); ?></td>-->
											
											<td ><?php echo e(number_format($sprices,2)); ?></td>
									...
									<td></td>
										...
										<td ><b><?php echo e(number_format($sptotal,2)); ?></b></td>
									...
									<td></td>
										...
										<td ><b><?php echo e(number_format($nsptotal,2)); ?></b></td>
						...
						<table border="0" style="width:100%;height:100%;">
							<thead>
								<tr>									
									<td colspan="2" align="center">
										<!-- <b style="font-size:30px;"><img src="<?php echo e(asset('assets/img/alalamia.jpeg')); ?>" alt="Image"/></b><br/> -->
										<b style="font-size:20px;"><?php echo e(Session::get('company')); ?></b>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('customer_receipt/export')); ?>">
