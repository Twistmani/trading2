                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
								...
								<?php if (\Entrust::can(('jv-print'))) : ?>
								<form class="form-horizontal" role="form" method="GET" target="_blank" name="frmItem" id="frmItem" action="<?php echo e(url('journal/getvoucherprint')); ?>">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="<?php echo e(url('journal/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="voucher_type" class="form-control select2" style="width:100%" name="voucher_type">
											<option value="16">JV - Journal Voucher</option>
										<?php /*<option value="5">PIN - Purchase Invoice(Non-Stock)</option>
											<option value="6">SIN - Sales Invoice(Non-Stock)</option>
											<option value="9">RV - Receipt Voucher</option>
											<option value="10">PV - Payment Voucher</option>*/ ?>
										</select>
								...
								<div class="form-group">
									...
									<input type="hidden" value="<?php echo e($voucher->prefix); ?>" name="prefix">
									<input type="hidden" value="<?php echo e($vchrdata['vno']); ?>" name="vno">
									<input type="hidden" value="<?php echo e($voucher->is_prefix); ?>" name="is_prefix">
									<div class="col-sm-10">
										<div class="input-group">
										<input type="text" class="form-control" id="voucher_no" value="<?php echo e($vchrdata['voucher_no']); ?>" readonly name="voucher_no">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' id="voucher_date" autocomplete="off" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
									</div>
...
/*	if(localStorage.getItem("vType")!=null && localStorage.getItem("vName")!=null) {
		...
		$.get("<?php echo e(url('journal/getvouchertype/')); ?>/" + localStorage.getItem("vType"), function(data) { 
			$('#voucher').empty();
...
//	var urlvchr = "<?php echo e(url('journal/checkvchrno/')); ?>"; //CHNG
var urlvchr = "<?php echo e(url('journal/checkvno/')); ?>";
...
/*	$('#voucher_type').on('change', function(e){
		...
		$.get("<?php echo e(url('journal/getvouchertype/')); ?>/" + vchr_id, function(data) { 
    		...
    		$.get("<?php echo e(url('journal/getvoucher/')); ?>/" + vid, function(data) { //console.log(data);
    			$('#voucher_no').val(data);
    			$('#curno').val(data); //CHNG
...
/*	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('journal/checkvno/')); ?>", 
			type: 'get',
