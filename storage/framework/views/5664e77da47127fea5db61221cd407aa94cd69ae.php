...
<body>
  ...
  <script type="text/javascript">
    (async function () {
      const HANDLER_URL = "<?php echo e(url('stimulsoftV2/sti-handler.php')); ?>"; // <-- must match your handler
      const LICENSE_URL = "<?php echo e(url('/stimulsoftV2/license')); ?>";
      const REPORT_FILE = "<?php echo e(asset('stimulsoftV2/reports/'.$view)); ?>";
