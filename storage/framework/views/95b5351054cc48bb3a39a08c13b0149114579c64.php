                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('sales_invoice/save')); ?>">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100%; background-color:#85d3ef;" name="department_id">
											<?php foreach($departments as $drow): ?>
												<option value="<?php echo e($drow->id); ?>" <?php if($dptid==$drow->id) echo 'selected'; ?>><?php echo e($drow->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											...
											<option value="<?php echo e($voucher['id']); ?>" <?php if($voucherid==$voucher['id']) echo 'selected';?>><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' autocomplete="off" readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>" value="<?php echo e(($voucherdt=='')?date('d-m-Y'):$voucherdt); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" name="lpo_no" value="<?php echo e($docrow->reference_no); ?>" autocomplete="off" placeholder="LPO No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" name="lpo_date" autocomplete="off" data-language='en' readonly value="<?php echo e($lpodt); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sales_account" id="sales_account" class="form-control" readonly value="<?php echo e($salesac); ?>">
										<input type="hidden" name="cr_account_id" id="cr_account_id" class="form-control" value="<?php echo e($voucher['cr_account_master_id']); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="document" readonly name="document" value="<?php echo e(old('document')?old('document'):$docnos); ?>" autocomplete="off" onclick="getDocument()">
										<input type="hidden" id="document_id" name="document_id" value="<?php echo e(old('document_id')?old('document_id'):$docid); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="salesman" id="salesman" value="<?php echo e($docrow->salesman); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#salesman_modal" placeholder="Salesman">
										<input type="hidden" name="salesman_id" id="salesman_id" value="<?php echo e($docrow->salesman_id); ?>">
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" autocomplete="off" value="<?php echo e($docrow->description); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="terms_id" class="form-control select2" style="width:100%" name="terms_id">
											...
											<?php if($docrow->terms_id==$term['id']): ?>
											<?php /**/ $sel = "selected" /**/ ?>
											<?php else: ?>
											<?php /**/ $sel = "" /**/ ?>	
											<?php endif; ?>
											<option value="<?php echo e($term['id']); ?>" <?php echo e($sel); ?>><?php echo e($term['description']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<?php } ?>
                                    ...
                                    <div class="col-sm-4">
                                        	<input type="number" class="form-control" id="duedays" name="duedays" value="<?php echo e($docrow->duedays); ?>" placeholder="Due Days">
                                    </div>
								...
								<div class="form-group">
									...
									<div class="col-xs-10">
										...
										<?php endif; ?>
											...
											<input type="checkbox" class="custom_icheck" id="is_fc" name="is_fc" value="1" <?php echo e($chk); ?>>
										</label>
										</div>
										<div class="col-xs-5">
											<select id="currency_id" class="form-control select2" style="width:100%" name="currency_id">
												...
												<?php if($docrow->currency_id==$curr['id']): ?>
												<?php /**/ $sel = "selected" /**/ ?>
												<?php else: ?>
												<?php /**/ $sel = "" /**/ ?>	
												<?php endif; ?>
												<option value="<?php echo e($curr['id']); ?>" <?php echo e($sel); ?>><?php echo e($curr['code']); ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="col-xs-5">
											<input type="text" name="currency_rate" id="currency_rate" class="form-control" value="<?php echo e($docrow->currency_rate); ?>">
										</div>
									</div>
                                </div>
								<?php } else { ?>
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
												<?php if($doctype=='QS'): ?>
												<input type="hidden" name="quote_sales_item_id[]" id="quote_sales_itmid_<?php echo e($j); ?>" value="<?php echo e(old('quote_sales_item_id')[$i]); ?>">
												<?php elseif($doctype=='SO'): ?>
												<input type="hidden" name="sales_order_item_id[]" id="sales_order_itmid_<?php echo e($j); ?>" value="<?php echo e(old('sales_order_item_id')[$i]); ?>">
												<?php elseif($doctype=='CDO'): ?>
												<input type="hidden" name="customer_do_item_id[]" id="customer_do_item_id_<?php echo e($j); ?>" value="<?php echo e(old('customer_do_item_id')[$i]); ?>">
												<?php endif; ?>
													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($j); ?>" value="<?php echo e(old('item_id')[$i]); ?>">
													<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#item_modal" value="<?php echo e($item); ?>">
												</td>
												<td width="29%">
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($j); ?>" step="any" autocomplete="off" name="quantity[]" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="<?php echo e(old('quantity')[$i]); ?>">
												</td>
												<td width="8%">
											...
											<div>
												<input type="hidden" name="conloc_id[]" id="conlocid_<?php echo e($j); ?>" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty[]" id="conlocqty_<?php echo e($j); ?>" value="<?php echo e($item->conloc_qty); ?>">
											...
											<div class="cnlocPrntItm" id="cnlocPrntItm_<?php echo e($j); ?>">
												<div class="cnlocChldItm">							
													<div class="table-responsive cnloc-data" id="cnlocData_<?php echo e($j); ?>">
														<?php 
														...
														<div class="col-xs-5">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	<td><?php echo e($row->name); ?></td>
																	<td class="cnnum"><input type="number" name="cnlocqty[<?php echo $i-1;?>][]" value="<?php echo e($quantity); ?>" class="cnloc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>">
																	<input type="hidden" name="cnlocid[<?php echo $i-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="cneditid[<?php echo $i-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
																</tbody>
															</table>
												...
												<div class="descdivPrntItm" id="descdivPrntItm_<?php echo e($j); ?>">
													<div class="descdivChldItm" >							
														<div class="col-xs-10" style="padding-bottom:5px !important;">
															<div class="col-xs-10">
																<input type="text" name="itemdesc[<?php echo $i-1;?>][]" autocomplete="off" class="form-control txt-desc" value="<?php echo e($desc->description); ?>" placeholder="Description">
															</div>
															<div class="col-xs-2" style="float:left;">
																 ...
																 <input type="hidden" name="desc_id[<?php echo $i-1;?>][]" value="<?php echo e($desc->id); ?>" class="hid-id">
															</div>
														</div>
													</div>
												</div>
									...
									<div class="itemdivChld">	
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
												<?php if($doctype=='QS'): ?>
												<input type="hidden" name="quote_sales_item_id[]" id="quote_sales_itmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
												<?php elseif($doctype=='SO'): ?>
												<input type="hidden" name="sales_order_item_id[]" id="sales_order_itmid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
												<?php elseif($doctype=='CDO'): ?>
												<input type="hidden" name="customer_do_item_id[]" id="customer_do_item_id_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
												<?php endif; ?>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control line-quantity" value="<?php echo e($quantity); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" autocomplete="off" class="form-control line-cost" value="<?php echo e($unit_price); ?>">
												</td>
												<td width="6%">
												...
												<td width="11%">
													<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" class="form-control line-total" readonly value="<?php echo e($line_total); ?>">
											...
											<!--MAY25-->
            								<div id="batchdiv_<?php echo e($i); ?>" style="float:left; padding-right:5px;" class="addBatchBtn">
											...
											<?php if($isconloc): ?>
											<div id="cnloc" style="float:left; padding-right:5px;">
												<button type="button" id="cnloc_<?php echo e($i); ?>" data-toggle="modal" data-target="#conloc_modal" class="btn btn-primary btn-xs cnloc-info">Consignment Location</button>
											</div>
											<div style="float:left; padding-right:5px;">
												<input type="hidden" name="conloc_id[]" id="conlocid_<?php echo e($i); ?>" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty[]" id="conlocqty_<?php echo e($i); ?>" value="<?php echo e($item->conloc_qty); ?>">
												<input type="hidden" name="conloc_id_old[]" value="<?php echo e($item->conloc_id); ?>">
												<input type="hidden" name="conloc_qty_old[]" value="<?php echo e($item->conloc_qty); ?>">
											</div>
											<?php endif; ?>
								...
								<?php } ?>
										...
										<div class="dimnInfodivPrntItm" id="dimnInfodivPrntItm_<?php echo e($i); ?>">
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	<td><?php echo e($row->name); ?></td>
																	<td><?php echo e($cqty); ?></td>
																	<td class="num"><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($qty_entry); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>">
																	<input type="hidden" name="locid[<?php echo $i-1;?>][]" value="<?php echo e($location_id); ?>"/>
																	<input type="hidden" name="editid[<?php echo $i-1;?>][]" value="<?php echo e($id); ?>"/></td>
																</tr>
																<?php } ?>
											...
											<div class="cnlocPrntItm" id="cnlocPrntItm_<?php echo e($i); ?>">
												<div class="cnlocChldItm">							
													<div class="table-responsive cnloc-data" id="cnlocData_<?php echo e($i); ?>">
														<?php 
														if(array_key_exists($item->id, $cnitemlocedit)) { 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" value="<?php echo e((old('total'))?old('total'):($docrow->is_fc==1)?$docrow->total_fc:$docrow->total); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" value="<?php echo e((old('total_fc'))?old('total_fc'):$docrow->total); ?>" step="any" name="total_fc" class="form-control spl" value="<?php echo e($total_dh); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" autocomplete="off" name="discount" class="form-control spl discount-cal" value="<?php echo e((old('discount'))?old('discount'):($docrow->is_fc==1)?$docrow->discount_fc:$docrow->discount); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" class="form-control spl" value="<?php echo e((old('discount_fc'))?old('discount_fc'):$docrow->discount); ?>" placeholder="0">
										</div>
									</div>
                                </div>
                                <?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc" name="less_description" value="<?php echo e((old('less_description'))?old('less_description'):$docrow->less_description); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount" name="less_amount" value="<?php echo e((old('less_amount'))?old('less_amount'):$docrow->less_amount); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc2" name="less_description2" value="<?php echo e((old('less_description2'))?old('less_description2'):$docrow->less_description2); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount2" name="less_amount2" value="<?php echo e((old('less_amount2'))?old('less_amount2'):$docrow->less_amount2); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" step="any" class="form-control spl" id="les_amt_desc3" name="less_description3" value="<?php echo e((old('less_description3'))?old('less_description3'):$docrow->less_description3); ?>" placeholder="Description" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="less_amount3" name="less_amount3" value="<?php echo e((old('less_amount3'))?old('less_amount3'):$docrow->less_amount3); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										<div class="col-xs-8">
											<input type="text" class="form-control spl" id="previnv_description" name="previnv_description" value="<?php echo e((old('previnv_description'))?old('previnv_description'):$docrow->previnv_description); ?>" placeholder="Previous Invoice Details" autocomplete="on">
										</div>
                                    
										<div class="col-xs-2">
											<input type="number" step="any" id="previnv_amount" name="previnv_amount" value="<?php echo e((old('previnv_amount'))?old('previnv_amount'):$docrow->previnv_amount); ?>" class="form-control spl lesamt" placeholder="0">
										</div>
									</div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="vat" name="vat" class="form-control spl" placeholder="0" value="<?php echo e((old('vat'))?old('vat'):($docrow->is_fc==1)?$docrow->vat_amount_fc:$docrow->vat_amount); ?>" readonly>
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="vat_fc" name="vat_fc" class="form-control spl" value="<?php echo e((old('vat_fc'))?old('vat_fc'):$docrow->vat_amount); ?>" placeholder="0" readonly>
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" value="<?php echo e((old('net_amount'))?old('net_amount'):($docrow->is_fc==1)?$docrow->net_total_fc:$docrow->net_total); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('customers_do')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
var srvat=<?php echo e($vatdata->percentage); ?>; var dptTxt;
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('customers_do/checkrefno/')); ?>";
...
newEntry.find($('.dimn-view')).attr('id', 'itmInfo_' + rowNum);
	...
	/*$(document).on('click', '.loc-info', function(e) { 
	   ...
	   var item_id = $('#itmid_'+curNum).val();
	   if(item_id!='') {
		   var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+item_id
	...
	$(document).on('click', '.view-cnloc-info', function(e) { 
	   ...
	   if(cnloc_id!='') {
		   var vwUrl = "<?php echo e(url('itemmaster/view_conloc_items/')); ?>/"+cnloc_id+'/'+cnloc_qty+'/DO/'+curNum+'/'+rwid; 
...
function getDocument() { 
	...
	if(doc==1)
		var pourl = "<?php echo e(url('quotation_sales/get_quotation/')); ?>/"+customer_id+"/cdo";
	else if(doc==2)
		var pourl = "<?php echo e(url('sales_order/get_order/')); ?>/"+customer_id;
