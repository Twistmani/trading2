									...
									<tr style="border:0px solid black;">
                                        ...
                                        <table border="1" cellpadding="5" cellspacing="0" class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach($grouped as $group => $accounts): ?>
                                                        <tr style="background:#eee;">
                                                            <td colspan="3"><strong><?php echo e($group); ?></strong></td>
                                                        </tr>
                                                        <?php foreach($accounts as $acct): ?>
                                                            <tr>
                                                                <td><?php echo e($acct['account_name']); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($acct['debit'], 2)); ?></td>
                                                                <td style="text-align:right"><?php echo e(number_format($acct['credit'], 2)); ?></td>
                                                            </tr>
                                                            <?php 
                                                                $grandDr += $acct['debit'];
                                                                $grandCr += $acct['credit'];
                                                        ...
                                                        <tr style="font-weight:bold;">
                                                            <td>Group Total</td>
                                                            <td style="text-align:right"><?php echo e(number_format($accounts->sum('debit'), 2)); ?></td>
                                                            <td style="text-align:right"><?php echo e(number_format($accounts->sum('credit'), 2)); ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                                <tfoot>
