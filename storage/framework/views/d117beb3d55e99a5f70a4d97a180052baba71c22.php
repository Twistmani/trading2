                        ...
                        <div class="panel-body">
                            <div class="table-responsive m-t-10"> <button type="button" class="btn btn-primary createCust">Create Customer</button>
                                <table class="table horizontal_table table-striped" id="tableCustList">
                                    ...
                                    <tr>
                                        <td><a href="" class="newcustRow" data-id="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->master_name); ?>" data-clbalance="<?php echo e(number_format($customer->cl_balance,2)); ?>" data-pdc="<?php echo e(number_format($customer->pdc_amount,2)); ?>" data-crlimit="<?php echo e(number_format($customer->credit_limit,2)); ?>" data-groupid="<?php echo e($customer->account_group_id); ?>" data-trnno="<?php echo e($customer->vat_no); ?>" data-dismiss="modal"><?php echo e($customer->account_id); ?></a></td>
                                        <td><a href="" class="newcustRow" data-id="<?php echo e($customer->id); ?>" data-name="<?php echo e($customer->master_name); ?>" data-clbalance="<?php echo e(number_format($customer->cl_balance,2)); ?>" data-pdc="<?php echo e(number_format($customer->pdc_amount,2)); ?>" data-crlimit="<?php echo e(number_format($customer->credit_limit,2)); ?>" data-groupid="<?php echo e($customer->account_group_id); ?>" data-trnno="<?php echo e($customer->vat_no); ?>" data-dismiss="modal"><?php echo e($customer->master_name); ?></a></td>
					...
					<div class="panel panel-success filterable" id="newCustomerFrm">
						...
						<div class="panel-body">  <button type="button" class="btn btn-primary listCust">List Customer</button>
							...
							<div class="col-xs-10">
								...
								<input type="hidden" name="department_id" value="<?php echo e($deptid); ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" id="account_id" name="account_id" value="<?php echo e($cusid); ?>">
										</div>
									</div>
