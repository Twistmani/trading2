...
<?php $__env->startSection('header_styles'); ?>
	...
	<link href="<?php echo e(asset('assets/vendors/selectize/css/selectize.bootstrap3.css')); ?>" rel="stylesheet" type="text/css">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body controls">
                            <form class="form-horizontal" role="form" method="POST" name="frmItem" id="frmItem" enctype="multipart/form-data" action="<?php echo e(url('itemmaster/update/'.$itemrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="item_id" value="<?php echo e($itemrow->id); ?>">
								<input type="hidden" name="fromurl" value="<?php echo e($fromurl); ?>">
								<input type="hidden" name="formd" id="formd" value="<?php echo e($formdata['simple_entry']); ?>">

								<input type="hidden" name="itmHt" id="itmHt" value="<?php echo e($itemrow->itmHt); ?>">
								<input type="hidden" name="itmWd" id="itmWd" value="<?php echo e($itemrow->itmWd); ?>">
								<input type="hidden" name="itmLt" id="itmLt" value="<?php echo e($itemrow->itmLt); ?>">

                                <input type="hidden" name="mpqty" id="mpqty" value="<?php echo e($itemrow->mpqty); ?>">
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>Item Code</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="item_code" name="item_code" value="<?php echo e($itemrow->item_code); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>Item Decription</b></label></font>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo e($itemrow->description); ?>">
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>وصف السلعة</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="descriptionar" name="descriptionar" value="<?php echo e($itemrow->description_ar); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								<div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="model_no" name="model_no" placeholder="Model No." value="<?php echo e($itemrow->model_no); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="serial_no" name="serial_no" placeholder="Serial No." value="<?php echo e($itemrow->serial_no); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="machine_model" name="machine_model" value="<?php echo e($itemrow->bin); ?>" placeholder="Machine Model" >
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="size" name="size" value="<?php echo e($itemrow->weight); ?>" placeholder="Size">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="other_info" name="other_info"><?php echo e($itemrow->other_info); ?></textarea>
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="group_id" class="form-control select2" style="width:100%" name="group_id">
											...
											<?php if($itemrow->group_id==$group['id']): ?>
											<?php /**/ $sel = "selected" /**/ ?>
											<?php else: ?>
											<?php /**/ $sel = "" /**/ ?>	
											<?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="subgroup_id" class="form-control select2" style="width:100%" name="subgroup_id">
											...
											<?php if($itemrow->subgroup_id==$subgroup['id']): ?>
											<?php /**/ $sel = "selected" /**/ ?>
											<?php else: ?>
											<?php /**/ $sel = "" /**/ ?>	
											<?php endif; ?>
											<option value="<?php echo e($subgroup['id']); ?>" <?php echo e($sel); ?>><?php echo e($subgroup['name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="category_id" class="form-control select2" style="width:100%" name="category_id">
											...
											<?php if($itemrow->category_id==$cat['id']): ?>
											<?php /**/ $sel = "selected" /**/ ?>
											<?php else: ?>
											<?php /**/ $sel = "" /**/ ?>	
											<?php endif; ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="subcategory_id" class="form-control select2" style="width:100%" name="subcategory_id">
											...
											<?php if($itemrow->subcategory_id==$subcat['id']): ?>
											<?php /**/ $sel = "selected" /**/ ?>
											<?php else: ?>
											<?php /**/ $sel = "" /**/ ?>	
											<?php endif; ?>
											<option value="<?php echo e($subcat['id']); ?>" <?php echo e($sel); ?>><?php echo e($subcat['name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="dimension" class="form-control select2" style="width:100%" name="dimension">
											<option value="0" <?php echo e(($itemrow->dimension==0)?'selected':''); ?>>No</option>
											<option value="1" <?php echo e(($itemrow->dimension==1)?'selected':''); ?>>Yes</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="batch_req" class="form-control select2" style="width:100%" name="batch_req">
											<option value="0" <?php echo e(($itemrow->batch_req==0)?'selected':''); ?>>No</option>
											<option value="1" <?php echo e(($itemrow->batch_req==1)?'selected':''); ?>>Yes</option>
                                        </select>
                                    </div>
                                </div>
								...
								<table id="user" class="table table-bordered table-striped m-t-10">
										...
										<tr>
											<td>
												<select id="unit" class="form-control select2" style="width:100%;background:#87CEFA;<?php echo e(($readonly)?'pointer-events: none;':''); ?>" name="unit[]">
													<option value="">Base</option>
													<?php foreach($units as $unit): ?>
													<option value="<?php echo e($unit['id']); ?>" <?php if($itemunits[0]->unit_id==$unit['id']) echo 'selected';?>><?php echo e($unit['unit_name']); ?></option>
													<?php endforeach; ?>
												</select>
												<input type="hidden" name="item_unit_id[]" id="item_unit_id" class="form-control" value="<?php echo e($itemunits[0]->id); ?>">
											</td>
											
											<td>
												<input type="hidden" name="opn_quantity_cur[]" id="opn_qty_cur_1" value="<?php echo e($itemunits[0]->opn_quantity); ?>">
												<input type="number" name="opn_quantity[]" step="any" id="opn_qty_1" class="form-control" value="<?php echo e($itemunits[0]->opn_quantity); ?>" placeholder="Open Qty.">
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" id="opn_cost_1" class="form-control" value="<?php echo e($itemunits[0]->opn_cost); ?>" placeholder="Open Cost">
											</td>
											
											<td>
												<input type="hidden" name="vat[]" id="vat_1" class="form-control" value="<?php echo e($itemunits[0]->vat); ?>">
												<select id="selvat_1" class="form-control select2 itemunit" style="width:100%;background:#87CEFA" name="selvat[]">
													...
													<option value="<?php echo e($vat['percentage']); ?>" <?php if($vat['percentage']==$itemunits[0]->vat) echo 'selected';?>><?php echo e($vat['name']); ?></option>
													<?php endforeach; ?>
												</select>
											</td>
										<td><input type="hidden" name="pkno[]" id="pkno_1" value="1">
											<input type="hidden" step="any" type="text" name="packing[]" id="packing" class="form-control itemunit" value="<?php echo e($itemunits[0]->packing); ?>" >
								...
								<table id="user" class="table table-bordered table-striped m-t-10">
										...
										<tr>
											<td>
												<select id="unit_1" class="form-control select2" style="width:100%;background:#87CEFA;<?php echo e(($readonly)?'pointer-events: none;':''); ?>" name="unit[]"> 
													<option value="">Base</option>
													<?php foreach($units as $unit): ?>
													<option value="<?php echo e($unit['id']); ?>" <?php if($itemunits[0]->unit_id==$unit['id']) echo 'selected';?>><?php echo e($unit['unit_name']); ?></option>
													<?php endforeach; ?>
												</select>
												<input type="hidden" name="item_unit_id[]" id="item_unit_id_1" class="form-control" value="<?php echo e($itemunits[0]->id); ?>">
											</td>
											<td><input type="hidden" name="pkno[]" id="pkno_1" value="1">
												<input type="text" name="packing[]" id="packing_1" class="form-control" value="<?php echo e($itemunits[0]->packing); ?>" readonly placeholder="Packing">
											</td>
											<td>
												<input type="hidden" name="opn_quantity_cur[]" id="opn_qty_cur_1" value="<?php echo e($itemunits[0]->opn_quantity); ?>">
												<input type="number" name="opn_quantity[]" step="any" id="opn_qty_1" class="form-control" value="<?php echo e($itemunits[0]->opn_quantity); ?>" placeholder="Open Qty.">
											...
											<td>
												<input type="number" step="any" name="sell_price[]" id="sell_price_1" class="form-control" value="<?php echo e($itemunits[0]->sell_price); ?>" placeholder="S.Price(Retail)">
											</td>
											<td>
												<input type="number" step="any" name="wsale_price[]" id="wsale_price_1" class="form-control" value="<?php echo e($itemunits[0]->wsale_price); ?>" placeholder="S.Price(WS)">
											</td>
											<td>
												<input type="number" name="min_quantity[]" id="min_quantity_1" class="form-control" value="<?php echo e($itemunits[0]->min_quantity); ?>" placeholder="Min.Qty.">
											</td>
											<td>
												<input type="number" name="reorder_level[]" id="reorder_level_1" class="form-control" value="<?php echo e($itemunits[0]->reorder_level); ?>" placeholder="Reord. Level">
											</td>
											<td>
												<input type="hidden" name="vat[]" id="vat_1" class="form-control" value="<?php echo e($itemunits[0]->vat); ?>">
												<select id="selvat_1" class="form-control select2 itemunit" style="width:100%;background:#87CEFA" name="selvat[]">
										...
										<tr>
											<td>
												<select id="unit_2" class="form-control select2" style="width:100%;<?php echo e(($readonly)?'pointer-events: none;':''); ?>"  name="unit[]">
													<option value="">P1</option>
													<?php foreach($units as $unit): ?>
													<option value="<?php echo e($unit['id']); ?>" <?php if( (sizeof($itemunits) > 1) && isset($itemunits[1]) && $itemunits[1]->unit_id==$unit['id']) { echo 'selected'; $sub = $unit['unit_name']; }?>><?php echo e($unit['unit_name']); ?></option>
													<?php endforeach; ?>
												</select>
												
											</td>
											<td><?php if(sizeof($itemunits) > 1 && isset($itemunits[1])): ?>
													...
													/**/ ?>
												<?php else: ?>
													<?php /**/ $pkno = $packing = $opn_cost = $opn_qty_cur = $opn_qty = $sell_price = $wsale_price = $min_quantity = $reorder_level = $vat = $item_unit_id = $base = $sub = ''; /**/ ?>
												<?php endif; ?>
												<input type="hidden" name="item_unit_id[]" id="item_unit_id_2" class="form-control" value="<?php echo e($item_unit_id); ?>">
												<div><input type="text" name="pkno[]" id="pkno_22" <?php echo e(($readonly)?'readonly':''); ?> value="<?php echo e($pkno); ?>" style="width:15%;float:left;" class="form-control"> <span id="title_1" style="float:left;"><?php echo e($sub); ?></span><input type="text" name="packing[]" id="packing_22" <?php echo e(($readonly)?'readonly':''); ?> value="<?php echo e($packing); ?>" style="width:40%;float:left;" class="form-control" > <span id="title_12"><?php echo e($base); ?></span>
												<!--<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#editqty_modal">Edit</button></div>-->
											</td>
											<td>
												<input type="hidden" name="opn_quantity_cur[]" id="opn_qty_cur_2" value="<?php echo e($opn_qty_cur); ?>">
												<input type="number" name="opn_quantity[]" step="any" id="opn_qty_2" readonly class="form-control" value="<?php echo e($opn_qty); ?>" placeholder="Open Qty.">
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" id="opn_cost_2" readonly class="form-control" value="<?php echo e($opn_cost); ?>" placeholder="Open Cost">
											</td>
											<td>
												<input type="number" step="any" name="sell_price[]" id="sell_price_2" readonly class="form-control" value="<?php echo e($sell_price); ?>" placeholder="S.Price(Retail)">
											</td>
											<td>
											...
											<td>
												<input type="hidden" value="<?php echo e($vat); ?>" name="vat[]" id="vat_2">
										...
										<tr>
											<td>
												<select id="unit_3" class="form-control select2" style="width:100%;<?php echo e(($readonly)?'pointer-events: none;':''); ?>" name="unit[]">
													<option value="">P2</option>
													<?php foreach($units as $unit): ?>
													<option value="<?php echo e($unit['id']); ?>" <?php if( (sizeof($itemunits) > 2) && $itemunits[2]->unit_id==$unit['id']) { echo 'selected'; $sub = $unit['unit_name']; }?>><?php echo e($unit['unit_name']); ?></option>
													<?php endforeach; ?>
												</select>
											</td>
											<td><?php if(sizeof($itemunits) > 2): ?>
													...
													/**/ ?>
												<?php else: ?>
													<?php /**/ $packing = $opn_cost = $opn_qty_cur = $opn_qty = $sell_price = $wsale_price = $min_quantity = $reorder_level = $vat = $item_unit_id = $base = $sub = ''; /**/ ?>
												<?php endif; ?>
												<input type="hidden" name="item_unit_id[]" id="item_unit_id_3" class="form-control" value="<?php echo e($item_unit_id); ?>"> 
												<div><input type="text" name="pkno[]" id="pkno_23" <?php echo e(($readonly)?'readonly':''); ?> value="<?php echo e($pkno); ?>" style="width:15%;float:left;" class="form-control"> <span id="title_2" style="float:left;"> <?php echo e($sub); ?>=</span><input type="text" name="packing[]" id="packing_23" <?php echo e(($readonly)?'readonly':''); ?> value="<?php echo e($packing); ?>" style="width:40%;float:left;" class="form-control" > <span id="title_13"><?php echo e($base); ?></span></div>
											</td>
											<td>
												<input type="hidden" name="opn_quantity_cur[]" id="opn_qty_cur_3" value="<?php echo e($opn_qty_cur); ?>">
												<input type="number" name="opn_quantity[]" step="any" id="opn_qty_3" readonly class="form-control" value="<?php echo e($opn_qty); ?>" placeholder="Open Qty.">
											</td>
											<td>
												<input type="number" step="any" name="opn_cost[]" id="opn_cost_3" readonly class="form-control" value="<?php echo e($opn_cost); ?>" placeholder="Open Cost">
											</td>
											<td>
												<input type="number" step="any" name="sell_price[]" id="sell_price_3" readonly class="form-control" value="<?php echo e($sell_price); ?>" placeholder="S.Price(Retail)">
											</td>
											<td>
											...
											<td>
												<input type="hidden" value="<?php echo e($vat); ?>" name="vat[]" id="vat_3">
											</td>
										</tr>
									...
									<table id="user" class="table table-bordered table-striped m-t-12">
										...
										<tr>
											<td>
												...
												<input type="hidden" name="packing_d[]" id="packingD_1" value="<?php echo e($itemunits[0]->packing); ?>" class="form-control" readonly>
											</td>
											...
											<select id="unitD_2" class="form-control select2 itemunitD" style="pointer-events: none;" style="width:100%" name="unit_d[]">
													<option value="">P1</option>
													<?php foreach($units as $unit): ?>
													<option value="<?php echo e($unit['id']); ?>" <?php if( (sizeof($itemunits) > 1) && $itemunits[1]->unit_id==$unit['id']) { echo 'selected'; $sub = $unit['unit_name']; }?>><?php echo e($unit['unit_name']); ?></option>
													<?php endforeach; ?>
												</select>
											...
											<td>
												...
												<input type="number" name="opn_quantity_d[]" step="any" id="opn_qtyD_2" value="<?php echo e(isset($itemunits[1])?$itemunits[1]->opn_quantity:''); ?>" class="form-control itemunit" >
											</td>
											...
											<td>
												<input type="number" id="opn_qtyD" step="any" class="form-control" readonly value="<?php echo e($itemunits[0]->opn_quantity); ?>">
											</td>
											<td>
												<input type="number" step="any" name="opn_cost_d[]" id="opn_costD_1" class="form-control" value="<?php echo e($itemunits[0]->opn_cost); ?>">
											...
											<td>
												...
												<select id="selvat_1" class="form-control select2 itemunit" style="width:100%;background:#87CEFA" name="selvat_d[]">
													<?php foreach($vats as $vat): ?>
													<option value="<?php echo e($vat['percentage']); ?>" default><?php echo e($vat['name']); ?></option>
													<?php endforeach; ?>
								...
								<!--<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="profit_per" name="profit_per" value="<?php echo e($itemrow->profit_per); ?>" placeholder="Profit%">
                                    </div>
                                </div>-->
											...
											<div class="col-xs-4">
												<table class="table table-bordered table-hover">
													...
													<tr>
														...
														<td><input type="number" value="<?php echo e($opnqty); ?>" name="locqty[]" class="locqty" <?php if(auth()->user()->can('item-qty-cost-edit')): ?> console.log('') <?php else: ?> readonly <?php endif; ?>>
															<input type="hidden" name="itlocid[]" value="<?php echo e($id); ?>">
														</td>
														<td><?php echo e($qty); ?></td>
														<td><input type="text" name="bin[]" class="bin" id="bin_<?php echo e($i); ?>" value="<?php echo e(isset($stockloc[$row->id])?$stockloc[$row->id][0]->code:''); ?>" autocomplete="off" data-toggle="modal" data-target="#bin_modal">
															<input type="hidden" name="binid[]" id="binid_<?php echo e($i); ?>" value="<?php echo e(isset($stockloc[$row->id])?$stockloc[$row->id][0]->bin_id:''); ?>">
														</td>
													</tr>
													<?php endforeach; ?>
													</tbody>
								...
								<div class="form-group batch-entry">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <input type="hidden" id="batchIds" name="batchIds" value="<?php echo e($batchitems['ids']); ?>">
                                        <input type="hidden" id="batchNos" name="batchNos" value="<?php echo e($batchitems['batches']); ?>">
                                        <input type="hidden" id="mfgDates" name="mfgDates" value="<?php echo e($batchitems['mfgs']); ?>">
                                        <input type="hidden" id="expDates" name="expDates" value="<?php echo e($batchitems['exps']); ?>">
                                        <input type="hidden" id="qtyBatchs" name="qtyBatchs" value="<?php echo e($batchitems['qtys']); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="surface_cost" name="surface_cost" value="<?php echo e($itemrow->surface_cost); ?>" placeholder="Surface Cost">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="other_cost" name="other_cost" value="<?php echo e($itemrow->other_cost); ?>" placeholder="Other Cost">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
                                        <label class="radio-inline iradio">
                                            <input type="radio" id="inlineradio1" class="mfgItm" name="assembly" value="0" <?php echo e($chk1); ?>>
                                            None
                                        </label>
                                        <label class="radio-inline iradio">
                                            <input type="radio" id="inlineradio2" class="mfgItm" name="assembly" value="1" <?php echo e($chk2); ?>>
                                            Mfg. Item
                                        </label>
                                    </div>
                                </div>
                                ...
                                <?php if($itemrow->image != ""): ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Current Image</label>
                                    <div class="col-sm-10">
										<img src="<?php echo e(url('uploads/item/thumb_'.$itemrow->image)); ?>">
                                    </div>
                                </div>
								<?php endif; ?>
								<div class="form-group">
                                    ...
                                    <input id="input-23" name="image" type="file" class="file-loading" data-show-preview="true">
									 <input name="current_image" type="hidden" value="<?php echo e($itemrow->image); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="select22" name="supersede[]" class="form-control select2" multiple style="width:100%">
											...
											<option value="<?php echo e($item->id); ?>" <?php echo e($sel); ?>><?php echo e($item->description); ?></option>
											<?php endforeach; ?>
										</select>
                                    </div>
                                </div>
								...
								<div id="rMat">
									...
									<input type="hidden" id="rowNum" value="<?php echo e((count($rowmaterials)==0)?1:count($rowmaterials)); ?>">
									<input type="hidden" id="remitem" name="remove_item">
									<div class="itemdivPrnt">
									<?php if(count($rowmaterials) > 0) { $i=0; ?>
										<?php foreach($rowmaterials as $irow): ?>
										<?php $i++; ?>
										<div class="itemdivChld">
											<table border="0" class="table-dy-row">
												<tr>
													<td width="16%">
														<input type="hidden" name="row_id[]" id="rowid_<?php echo e($i); ?>" value="<?php echo e($irow->id); ?>">
														<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($irow->subitem_id); ?>">
														<input type="text" id="itmcod_<?php echo e($i); ?>" name="itemcode[]" value="<?php echo e($irow->item_code); ?>" class="form-control" autocomplete="off" placeholder="Item Code" data-toggle="modal" data-target="#item_modal">
													</td>
													<td width="29%">
														<input type="text" name="item_name[]" id="itmdes_<?php echo e($i); ?>" value="<?php echo e($irow->description); ?>" autocomplete="off" class="form-control" placeholder="Item Description">
													</td>
													<td width="8%">
														<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" name="quantity[]" value="<?php echo e($irow->quantity); ?>" autocomplete="off" class="form-control line-quantity" placeholder="Qty.">
													</td>
													<td width="8%">
														<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" value="<?php echo e($irow->unit_price); ?>" autocomplete="off" class="form-control line-cost" placeholder="Cost/Unit">
													</td>
													<td width="11%">
														<input type="number" id="itmttl_<?php echo e($i); ?>" step="any" name="line_total[]" value="<?php echo e($irow->total); ?>" class="form-control line-total" readonly placeholder="Total">
													</td>
													<td width="1%">
								...
								<?php } ?>
								<hr/>
								<?php if($formdata['bin_loc']==1): ?>
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Bin Location</label>
                                    <div class="col-sm-10">
										<input type="text" id="selectize-tags2" class="demo-default" value="<?php echo e($itemrow->bin_location); ?>" name="bin_location">
                                    </div>
                                </div>
								<?php endif; ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         <a href="<?php echo e(url('itemmaster')); ?>" class="btn btn-danger">Cancel</a><br/>
					...
					<div class="modal-content">
						...
						<div class="modal-body"><form class="form-vertical">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="length" autocomplete="off" value="<?php echo e($itemrow->itmLt); ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="weight" autocomplete="off" value="<?php echo e($itemrow->itmWd); ?>">
								</div>
							</div>
...
<script src="<?php echo e(asset('assets/vendors/selectize/js/standalone/selectize.min.js')); ?>" type="text/javascript"></script>
...
$(document).ready(function () {
	...
	<?php if($itemrow->batch_req==1): ?>
		$('.batch-entry').show()
	<?php else: ?>
		$('.batch-entry').hide()
	<?php endif; ?>
    
        <?php if($itemrow->assembly==1): ?>
		  $('#rMat').show();
		<?php else: ?>
		$('#rMat').hide();
		<?php endif; ?>
...
$(function() {
	...
	$('.mfgItm').on('ifChecked', function(event){ 
     ...
     if(text!='') {
		   $.ajax({
			url: "<?php echo e(url('itemmaster/get_langtrans/')); ?>",
			type: 'get',
			data: 'text='+text,
	 ...
	 $(document).on('click', '.loc-info', function(e) { 
	   e.preventDefault();
		   ...
		   var locUrl = "<?php echo e(url('location/get_loc')); ?>";
...
function getAutoPrice(curNum) {
	...
	$.ajax({
		url: "<?php echo e(url('itemmaster/get_cost_avg/')); ?>", //get_cost_sale
		type: 'get',
...
var btno = <?php echo e(($batchcount==0)?1:$batchcount); ?>;
