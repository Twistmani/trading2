        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									<td width="100%" align="center" colspan="2"><h4><u><?php echo e($voucherhead); ?></u></h4>
								</tr>
							</table><br/>
                        </div>
                        ...
                        <div class="col-md-12">
							<?php //if($type=="detail") { ?>
								<table class="table" border="0">
									...
									<tr>
										<td><b>Inv.No:</b> <?php echo e($report[0]->voucher_no); ?></td>
										<td><b>Inv.Date:</b> <?php echo e(date('d-m-Y',strtotime($report[0]->voucher_date))); ?></td>
										<td></td>
										<td></td>
										<td colspan="5" class="text-right"><b><?php echo ($type=='CUSTOMER')?'Customer: ':'Supplier: ';?></b> <?php echo e($report[0]->master_name); ?></td>
									</tr>
									<tr>
										<td><b>Item Code</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('account_reports/export')); ?>">
