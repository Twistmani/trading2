                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<div class="pull-right">
							 ...
							 <a href="<?php echo e(url('stock_transferin/print/'.$orderrow->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmStockTransfer" id="frmStockTransfer" action="<?php echo e(url('stock_transferin/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="transfer_id" id="transfer_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="reference_no" name="reference_no" autocomplete="off" value="<?php echo e($orderrow->reference_no); ?>" placeholder="Reference No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="debit_account" id="debit_account" class="form-control" readonly value="<?php echo e($orderrow->name_dr); ?>">
										<input type="hidden" name="account_dr" id="account_dr" class="form-control" value="<?php echo e($orderrow->account_dr); ?>">
									</div>
                                </div>
								<?php else: ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="credit_account" id="credit_account" class="form-control" readonly value="<?php echo e($orderrow->name_cr); ?>">
										<input type="hidden" name="account_cr" id="account_cr" class="form-control" value="<?php echo e($orderrow->account_cr); ?>">
									</div>
                                </div>
                                 <?php else: ?>
								...
								<?php /**/ $i = $total_hd = 0; $num = count($orditems); /**/ ?>
										...
										<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%" class="itcod">
														...
														<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off" step="any" name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>" placeholder="Qty.">
													</td>
													<td width="8%">
													...
													<td width="11%">
														...
														<input type="hidden" id="othrcst_1" step="any" name="othr_cost[]" class="form-control" value="<?php echo e($item->othercost_unit); ?>">
														<input type="hidden" id="netcst_1" step="any" name="net_cost[]" class="form-control" value="<?php echo e($item->netcost_unit); ?>">
													</td>
													<td width="1%"> <?php  $total_hd += $item->item_total;  ?>
													<?php if($num==$i): ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<input type="number" id="totalqty" step="any" name="total" class="form-control spl" value="<?php echo e($orderrow->total_qty); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								<input type="hidden" id="total" step="any" name="total_hd" value="<?php echo e($total_hd); ?>">
								<input type="hidden" step="any" id="other_cost" name="other_cost" readonly class="form-control" value="<?php echo e($orderrow->other_cost); ?>" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" readonly class="form-control" value="<?php echo e($orderrow->other_cost); ?>" placeholder="0">
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<input type="number" id="totalamt" step="any" name="total_price" class="form-control spl" value="<?php echo e($orderrow->total_amt); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div> 
...
$(function() {	
	...
	$('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('stock_transferin/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
