                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmJobmaster" id="frmJobmaster" action="<?php echo e(url('jobmaster/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="code" name="code" <?php if($voucherno->autoincrement==1) { ?> value="<?php echo e($voucherno->no); ?>" <?php } else { ?> value="<?php echo e(old('voucher_no')); ?>" <?php } ?>>
                                ...
                                <?php if($formdata['date']==1) { ?>
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control pull-right" autocomplete="öff"  id="date" name="date"  data-language='en' value="<?php echo e(date('d-m-Y')); ?>" />
                               ...
                               <?php if($formdata['consignee']==1) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="<?php echo e(url('jobmaster/budget')); ?>" target="_blank" class="btn btn-info">Project Budgeting</a>
                                        <a href="<?php echo e(url('jobmaster/viewbudget')); ?>" target="_blank" class="btn btn-primary">View Project Budgeting</a>
                                    </div>
                                </div>
...
$(function() {  
	...
	$(document).on('change', '#transport_type', function(e) { 
		...
		$.ajax({
			url: "<?php echo e(url('jobtype/getjobno')); ?>/"+$(this).val(), 
			type: 'get',
			success: function(data) { data = $.parseJSON(data);
				//$('#prefix').val(data.name);
				$('#code').val(data.name+<?php echo e(date('Y')); ?>+'-'+data.job_no);
				return true;
			}
		}); 
