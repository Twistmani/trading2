					 ...
					 <table class="table horizontal_table table-striped" id="tblJobs">
						...
						<tbody>
						   <?php foreach($jobs as $job): ?>
							 <tr>
								<td><a href="" class="jobRow" data-id="<?php echo e($job['id']); ?>" data-name="<?php echo e($job['name']); ?>" data-cod="<?php echo e($job['code']); ?>" data-dismiss="modal"><?php echo e($job['code']); ?></a></td>
								<td><a href="" class="jobRow" data-id="<?php echo e($job['id']); ?>" data-name="<?php echo e($job['name']); ?>" data-cod="<?php echo e($job['code']); ?>" data-dismiss="modal"><?php echo e($job['name']); ?></a></td>
