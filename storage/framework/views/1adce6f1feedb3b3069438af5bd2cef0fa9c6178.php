				...
				<?php } else { ?>
                    <div class="panel panel-primary">
						   ...
						   <div class="pull-right">
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('rv-print'))) : ?>
								 <a href="<?php echo e(url('customer_receipt/printgrp/'.$printid->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmCustReceipt" id="frmCustReceipt" action="<?php echo e(url('customer_receipt/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                       <select id="voucher" class="form-control select2" style="width:100%" name="voucher">
											...
											<option value="<?php echo e($voucher['vid']); ?>"><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>	
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="hidden" name="curno" id="curno" value="<?php echo e($vchrdata['voucher_no']); ?>">
                                    <div class="col-sm-9">
										<div class="input-group">
											<?php if($vchrdata['is_prefix']==0): ?>
											<input type="text" class="form-control" id="voucher_no" readonly name="voucher_no" value="<?php echo e($vchrdata['voucher_no']); ?>">
											<span class="input-group-addon"><i class="fa fa-fw fa-edit"></i></span>
											<?php else: ?>
											<span class="input-group-addon"><?php echo e($vchrdata['prefix']); ?><input type="hidden" id="hdn_voucher_no" value="<?php echo e($vchrdata['voucher_no']); ?>" name="voucher_no" ></span>
											<input type="text" class="form-control" id="voucher_no" readonly name="voucher_no2" value="<?php echo e($vchrdata['number']); ?>">
											<span class="input-group-addon"><i class="fa fa-fw fa-edit"></i></span>
											<?php endif; ?>
										</div>
                                    </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' <?php if(old('voucher_date')!='') { ?> value="<?php echo e(old('voucher_date')); ?>" <?php } ?>  id="voucher_date" autocomplete="off" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="dr_account" name="dr_account" value="<?php echo e((old('dr_account'))?old('dr_account'):$vchrdata['account_name']); ?>" autocomplete="off" data-toggle="modal" data-target="#dr_account_modal">
										<input type="hidden" id="dr_account_id" name="dr_account_id" value="<?php echo e((old('dr_account_id'))?old('dr_account_id'):$vchrdata['id']); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="reference" name="reference" autocomplete="off" value="<?php echo e(old('reference')); ?>">
                                    </div>
                                </div>
                                	<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="description" name="description" autocomplete="off" value="<?php echo e(old('description')); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div id="chequeInput">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select id="bank_id" class="form-control select2 <?php if($errors->has('bank_id')) echo 'form-error';?>" style="width:100%" name="bank_id">
												...
												<option value="<?php echo e($bank['id']); ?>" <?php if(old('bank_id')==$bank['id']) echo 'selected'; ?>><?php echo e($bank['code'].' - '.$bank['name']); ?></option>
												<?php endforeach; ?>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control <?php if($errors->has('cheque_date')) echo 'form-error';?>" id="cheque_date" name="cheque_date" value="<?php echo e(old('cheque_date')); ?>" autocomplete="off" data-language='en' readonly>
										</div>
									</div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?php if($errors->has('customer_account')) echo 'form-error';?>" value="<?php echo e(old('customer_account')); ?>" id="customer_account" name="customer_account" autocomplete="off" data-toggle="modal" data-target="#customer_modal">
										<input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?php echo e(old('customer_id')); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="debit" name="debit" value="<?php echo e((old('debit'))); ?>" readonly placeholder="0.00">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="credit" name="credit" value="<?php echo e((old('credit'))); ?>" readonly placeholder="0.00">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <a href="<?php echo e(url('customer_receipt')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('customer_receipt')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
                            </form>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('customer_receipt/checkvchrno/')); ?>"; //CHNG
    ...
    $(document).on('change', '#voucher_type', function(e) { //$('#voucher_type').on('change', function(e){
		...
		//$.get("<?php echo e(url('account_master/get_account/')); ?>/" + vchr, function(data) {
		...
		if($('#department_id').length) {
			...
			$.get("<?php echo e(url('customer_receipt/getvoucher/')); ?>/" + vchr_id+'/'+vchr+'/'+$('#department_id option:selected').val(), function(data) {
	...
	<?php if( (old('customer_id')!='') || (old('customer_account')!='') ) { ?>
	   var url = "<?php echo e(url('sales_invoice/get_invoice/')); ?>/<?php echo e(old('customer_id')); ?>";
	...
	var slurl = "<?php echo e(url('sales_invoice/salesman_data/')); ?>";
...
$(function(){
  ...
  $(':input[type=number]').on('mousewheel',function(e){ $(this).blur(); });
   ...
   $('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('customer_receipt/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
	...
	$('#customer_account').click(function() {
		if($('#department_id').length)
			custurl = "<?php echo e(url('sales_invoice/customer_datadpt/')); ?>"+'/'+$('#department_id option:selected').val();
		else
	...
	/* $(document).on('click', '.custRow', function(e) {
	   ...
	   var url = "<?php echo e(url('sales_invoice/get_invoice/')); ?>/"+$(this).attr("data-id");
	   $('#crTransactionData').load(url, function(result) {
		  $('#myModal').modal({show:true});
	   });
	...
	$(document).on('click', '.custRow', function(e) {
	   ...
	   var url = "<?php echo e(url('account_enquiry/os_bills/')); ?>/"+$(this).attr("data-id");
	   $('#crTransactionData').load(url, function(result) {
		  $('#myModal').modal({show:true});
	   });
	...
	$('#dr_account').click(function() {
		...
		vtype = (vtype=='')?0:vtype;
		var acnturl = "<?php echo e(url('account_master/get_account_list/')); ?>/"+vtype; 
	...
	$('#voucher').on('change', function(e){
		...
		if($('#department_id').length) {
			...
			$.get("<?php echo e(url('customer_receipt/getvoucher/')); ?>/" + vchr_id+'/'+vchr_type+'/'+$('#department_id option:selected').val(), function(data) {
				$('#voucher_no').val(data.voucher_no);
			...
			$.get("<?php echo e(url('customer_receipt/getvoucher/')); ?>/" + vchr_id+'/'+vchr_type, function(data) {
				$('#voucher_no').val(data.voucher_no);
				$('#curno').val(data.voucher_no); //CHNG
				if(data.id!=null && data.account_name!=null) {
					$('#dr_account').val(data.account_name);
	...
	$(document).on('keyup', '#voucher_no', function(e) {
		$('#hdn_voucher_no').val('<?php echo e($vchrdata['prefix']); ?>'+$('#voucher_no').val());
	});
