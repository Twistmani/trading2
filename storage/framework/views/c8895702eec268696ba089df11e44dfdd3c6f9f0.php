...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('po-create'))) : ?>
                             <a href="<?php echo e(url('purchase_order/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" target="_blank" id="frmPOReport" action="<?php echo e(url('purchase_order/search')); ?>">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('purchase_order/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePorders").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('purchase_order/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
			...
			{ "data": "net_total" },
			{ "data": "approval" },
			<?php if (\Entrust::can(('po-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('po-view'))) : ?>{ "data": "viewonly","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('po-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			{ "data": "view","bSortable": false },
			<?php if (\Entrust::can(('po-delete'))) : ?>{ "data": "delete","bSortable": false }<?php endif; // Entrust::can ?>
		],
		...
		$('#select22').on('change', function(e){
			    ...
			    var sup_id = $('#select22').val();
			     ...
			     if(sup_id !=''){
			    $.get("<?php echo e(url('purchase_order/getjob/')); ?>/" + sup_id, function(data) {
