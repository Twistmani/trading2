...
<!-- horizontal menu ends -->
           <div class="col-md-12">
							<table border="0" style="width:100%;">
								...
								<tr>
									<td  width="100%" align="center"><h4><u><?php echo e($voucherhead); ?></u></h4></td>
								</tr>
							</table><br/>
             </div>
 ...
 <div>
	...
	<b><?php if($fromdate!='' && $todate!='') { echo 'Date From: '.$fromdate.' To Date: '.$todate; } ?></b><br/><br/>
		<table border="1" width="100%" class="pay">
			...
			<tr>
				...
				<td class="txtdoc"><?php echo e($result->designation); ?></td>
				<td class="txtdoc"><?php echo e($result->nationality); ?></td>
				<td class="txtdoc"><?php echo e(($result->gender==1)?'Male':'Female'); ?></td>
				<td class="txtdoc"><?php echo e($result->address1); ?> <?php echo e($result->address2); ?> <?php echo e($result->address3); ?></td>
				<td class="txtdoc"><?php echo e($result->phone); ?></td>
				<td class="txtdoc"><?php echo e(($result->dob=='0000-00-00')?'':date('d-m-Y', strtotime($result->dob))); ?></td>
				<td class="txtdoc"><?php echo e(($result->join_date=='0000-00-00')?'':date('d-m-Y', strtotime($result->join_date))); ?></td>
			</tr>
			<?php } ?>
		</table>
		<?php } else { ?>
	...
	<div class="btn-section">
			...
			<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('employee_report/export')); ?>">
				...
				<input type="hidden" name="designation" value="<?php echo e($designation); ?>" >
				<input type="hidden" name="nationality" value="<?php echo e($nationality); ?>" >
			</form>
