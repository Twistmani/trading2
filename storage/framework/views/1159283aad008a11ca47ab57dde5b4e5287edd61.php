                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('so-print'))) : ?>
								 <a href="<?php echo e(url('job_order/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="<?php echo e(url('job_order/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('reference_no')) echo 'form-error';?>" id="reference_no" autocomplete="off" value="<?php echo e(old('reference_no')); ?>" name="reference_no" placeholder="Reference No">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" data-language='en' id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" autocomplete="off" value="<?php echo e(old('description')); ?>" name="description" placeholder="Description">
                                    </div>
                                </div>
								<?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($j); ?>" name="item_code[]" class="form-control <?php if($errors->has('item_code.'.$i)) echo 'form-error';?>" value="<?php echo e($item); ?>" autocomplete="off" data-toggle="modal" data-target="#item_modal" placeholder="Item Code">
												</td>
												<td width="29%">
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" step="any" value="<?php echo e(old('quantity')[$i]); ?>" name="quantity[]" autocomplete="off" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" placeholder="Qty.">
												</td>
												<td width="8%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" value="<?php echo e(old('total')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" value="<?php echo e(old('total_fc')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="<?php echo e(old('dicount_fc')); ?>" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
									...
									<div class="filedivChld">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="file" id="input-51" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('job_order/upload/')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('job_order')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('job_order/add')); ?>" class="btn btn-warning">Clear</a>
										<?php if (\Entrust::can(('so-history'))) : ?>
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('sales_order/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	$(document).on('click', '.btn-add-file', function(e)  { 
	    ...
	    fNum++;
		$.ajax({
			url: "<?php echo e(url('job_order/get_fileform/SO')); ?>",
			type: 'post',
			data: {'no':fNum},
			success: function(data) {
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('sales_order/checkvchrno/')); ?>", 
			type: 'get',
...
function getJobOrder() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('job_order/getjo/')); ?>";
...
function getQuotation() { 
	...
	var wt = $(window).width();
	var customer_id = $("#customer_id").val();
	var pourl = "<?php echo e(url('job_estimate/get_quotation/')); ?>/"+customer_id+"/so";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
