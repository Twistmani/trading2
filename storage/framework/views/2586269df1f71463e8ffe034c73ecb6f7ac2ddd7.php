                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
							<form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="<?php echo e(url('job_order/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" autocomplete="off" id="voucher_date" placeholder="JO. Date"/>
                                    </div>
                                </div>
							...
							<div class="form-group">
								...
								<?php } else { ?>
								<input type="hidden" name="salesman_id" id="salesman_id" value="<?php echo e($orderrow->salesman_id); ?>">
								<?php } ?>
									...
									<div class="col-sm-10">
                                       <div class="col-xs-10" id="kilometerInfo">
											...
											<div class="col-xs-3">
												...
												<span class="small">Next Due date</span> <input type="text" id="next_due" name="next_due" value="<?php echo e(date('d-m-Y',strtotime($orderrow->next_due))); ?>"  data-language='en'  class="form-control">
											</div>
											</div>	
									...
									<div class="col-sm-10">
                                       <div class="col-xs-10" id="kilometerInfo">
											...
											<div class="col-xs-3">
												...
												<span class="small">Next Due date</span> <input type="text" id="next_due" name="next_due" readonly value="<?php echo e(date('d-m-Y',strtotime($orderrow->next_due))); ?>"  data-language='en'  class="form-control">
											</div>
											</div>	
									...
									<div class="descdivChld">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<button type="button" class="btn-danger btn-remove-desc" data-id="rem_<?php echo e($i); ?>">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" name="quantity[]" step="any" autocomplete="off" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="<?php echo e(old('quantity')[$i]); ?>">
												</td>
												<td width="8%">
							...
							<input type="hidden" name="rem_photo_id" id="rem_photo_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('job_order')); ?>" class="btn btn-primary">Back</a>
