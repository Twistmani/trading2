        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
										...
										<td colspan="2" align="center">
											...
											<?php $total_net = $net_amount = $total_vat = $total_gross =$amount=$net_amt=$disc= 0;?>
												...
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($vat_amount,2)); ?></td>
												...
												<tr>
													...
													<td class="text-right"><?php echo e(number_format($disc,2)); ?></td>
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td><b>PO#:</b> <?php echo e($report[0]->voucher_no); ?></td>
												<td><b>PO Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>PO Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('purchase_order/export')); ?>">
