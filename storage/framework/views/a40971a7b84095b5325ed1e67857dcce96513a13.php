				...
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                           ...
                           <div class="pull-right">
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('sales_voucher/print/'.$printid->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="<?php echo e(url('sales_voucher/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="voucher_type" value="<?php echo e($voucher['voucher_type_id']); ?>">
                                    </div>
                                </div>
								
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">SIN. No.</label>
									<input type="hidden" name="curno" id="curno" value="<?php echo e($voucher['voucher_no']); ?>">
									
									<input type="hidden" value="<?php echo e($voucher->prefix); ?>" name="prefix">
									<input type="hidden" value="<?php echo e($voucher['vno']); ?>" name="vno">
									<input type="hidden" value="<?php echo e($voucher->is_prefix); ?>" name="is_prefix">
									
                                    <div class="col-sm-10">
										<div class="input-group">
                                        <input type="text" class="form-control" id="voucher_no" value="<?php echo e($voucher['voucher_no']); ?>"readonly name="voucher_no">
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('click', '.custRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			var trnurl = "<?php echo e(url('sales_voucher/set_transactions/')); ?>";
