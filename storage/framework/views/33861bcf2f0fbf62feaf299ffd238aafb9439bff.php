                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('job_estimate/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>"  id="voucher_date" placeholder="Estimate Date" autocomplete="off"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085"><label for="input-text" class="col-sm-2 control-label"><b>Job Code</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" class="form-control" readonly autocomplete="off" value="<?php echo e($orderrow->name); ?>">
								...
								<label for="input-text" class="col-sm-2 control-label " id="">Items Description </label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="items_description" autocomplete="off"  readonly name="items_description"value="<?php echo e($orderrow->items_description); ?>" placeholder="Items Description">
											</div>
								</div>
								<?php } else {?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" readonly autocomplete="off" value="<?php echo e($item->item_code); ?>" >
												</td>
												<td width="29%">
													<input type="text" name="item_name[]" id="itmdes_<?php echo e($i); ?>" autocomplete="off"readonly  class="form-control" value="<?php echo e($item->item_name); ?>">
												</td>
												<td width="7%">
													<select id="itmunt_<?php echo e($i); ?>" class="form-control select2 line-unit"  readonly style="width:100%" name="unit_id[]">
													<option value="<?php echo e($item->unit_id); ?>"><?php echo e($item->unit_name); ?></option></select>
													</select>
												</td>
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" name="quantity[]" readonly step="any" autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
													<input type="number" id="itmcst_<?php echo e($i); ?>" step="any" name="cost[]" readonly autocomplete="off" class="form-control line-cost" value="<?php echo e($unit_price); ?>">
												</td>
												<td width="6%">
													<select id="taxcode_<?php echo e($i); ?>" class="form-control select2 tax-code" style="width:100%" readonly  name="tax_code[]"><option value="SR" <?php if($item->tax_code=="SR") echo 'selected'; ?>>SR</option><option value="EX" <?php if($item->tax_code=="EX") echo 'selected'; ?>>EX</option><option value="ZR" <?php if($item->tax_code=="ZR") echo 'selected'; ?>>ZR</option></select>
												</td>
												<td width="6%">
													<select id="txincld_<?php echo e($i); ?>" class="form-control select2 taxinclude" style="width:100%"  readonly name="tax_include[]"><option <?php if($item->tax_include==0) echo 'selected';?> value="0">No</option><option <?php if($item->tax_include==1) echo 'selected';?> value="1">Yes</option></select>
												</td>
												<td width="9%">
