                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableInvRetList">
                                    ...
                                    <tbody>
									<?php foreach($pidata as $sdo): ?>
                                    <tr>
										<td><input type="radio" name="supplierDO" value="<?php echo e($sdo->voucher_no); ?>"/></td>
                                        <td><?php echo e($sdo->voucher_no); ?></td>
                                        <td><?php echo e($sdo->reference_no); ?></td>
                                        <td><?php echo e(date('d-m-Y',strtotime($sdo->voucher_date))); ?></td>
                                        <td><?php echo e($sdo->supplier); ?></td>
                                        <td><?php echo e(number_format($sdo->net_amount,2)); ?></td>
										<td><a href="" class="poclk" data-id="<?php echo e($sdo->id); ?>" data-name="<?php echo e($sdo->reference_no); ?>" data-toggle="modal" data-target="#item_modal">View Items</a></td>
                                    </tr>
                                   <?php endforeach; ?>
                                    </tbody>
                                </table>
...
function setTransfer() {
	...
	//alert(items);
	 sdourl = "<?php echo e(url('purchase_return/add/')); ?>/"+item;
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('purchase_invoice/item_details/')); ?>";
