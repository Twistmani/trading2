                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmWageEntry" id="frmWageEntry" action="<?php echo e(url('wage_entry/timesheet/save/')); ?>">
                           ...
                           <div class="col-sm-2">
							<button type="button" id="search" class="btn btn-primary">Load</button></div>
												<a href="<?php echo e(url('wage_entry/timesheet')); ?>" class="btn btn-danger">Clear</a>
						</div>
						</div>	
									...
									<?php 
										...
										<tr>
											...
											<td width="12%">
												...
												<input type="hidden" name="employee_id[]" id="empid_<?php echo e($i); ?>" value="<?php echo e($emp->id); ?>">
												
												<input type="text" id="empname_<?php echo e($i); ?>" name="employee_name[]" class="form-control" autocomplete="off" value="<?php echo e($emp->name); ?>" autocomplete="off"  placeholder="Employee Name">
											</td>
											
											<td width="6%">
												<span class="small">Start Time</span><input type="time" value="" name="start_time[]"  id="start_<?php echo e($i); ?>" step="any" autocomplete="off" class="form-control start-time" >
											</td>
											<td width="6%">
												<span class="small">End Time</span><input type="time" id="end_<?php echo e($i); ?>" step="any" value="" name="end_time[]" autocomplete="off" class="form-control end-time" >
											</td>
											<td width="6%">
												<span class="small">Break</span><input type="text" id="break_<?php echo e($i); ?>" step="any" value="" name="break_time[]" autocomplete="off" class="form-control break-time" >
											</td>
											<td width="4%">
												<span class="small">TWH</span> <input type="number" id="twh_<?php echo e($i); ?>" step="any" name="twh[]" autocomplete="off" class="form-control line-twh" value="" readonly>
											</td>
											<td width="4%">
												<span class="small">NWH</span> <input type="number" id="nwh_<?php echo e($i); ?>" step="any" name="nwh[]" autocomplete="off" class="form-control line-nwh" value="<?php echo e($parameter->nwh); ?>" readonly>
											</td>
											<td width="4%">
												<span class="small">OTHr(G)</span> <input type="number" id="otg_<?php echo e($i); ?>" step="any" name="otg[]" value="" autocomplete="off" class="form-control line-otg" >
												<input type="hidden" id="otgst_<?php echo e($i); ?>" name="otgst[]" class="otgst">
											</td>
											<td width="4%">
												<span class="small">OTHr(H)</span><input type="number" id="oth_<?php echo e($i); ?>" step="any" name="oth[]" value="" autocomplete="off" class="form-control line-oth" >
												<input type="hidden" id="othst_<?php echo e($i); ?>" name="othst[]" class="othst">
											</td>
											<td width="8%">
						                         <span class="small">Job Code</span>
						                        <input type="hidden" name="job_id[]" id="jobid_<?php echo e($i); ?>" value="">
						                         <input type="hidden" name="job_data[]" id="jobdata_<?php echo e($i); ?>">
						                           <input type="text" id="jobcod_<?php echo e($i); ?>" name="job_code[]" class="form-control"  value="" autocomplete="off" data-toggle="modal" data-target="#job_modal" placeholder="Job Code">
					                        </td>
											<td width="4%">
											<input type="hidden" id="wid_<?php echo e($i); ?>" name="work_id[]">
...
$(document).ready(function () {
	...
	//$('#date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
...
$(document).on('click', '.subjobRow', function(e) {
	...
	document.getElementById("search").onclick = function () {
       ...
       var cat=$('#category_id').val();
        location.href = "<?php echo e(url('wage_entry/timesheet/')); ?>/"+emp+"/"+cat;
    };
