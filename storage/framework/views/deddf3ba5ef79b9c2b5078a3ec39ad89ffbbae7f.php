                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsInvoice" id="frmGoodsInvoice" action="<?php echo e(url('goods_issued/save')); ?>">
									 ...
									 <div class="col-sm-10">
									   <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
										   <?php foreach($vouchers as $voucher): ?>
											 <?php if($voucher->department_id==$departments[0]->id): ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="stock_account" id="stock_account" class="form-control" autocomplete="off" data-toggle="modal" data-target="#stockac_modal" value="<?php echo e($voucher['master_name']); ?>">
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="<?php echo e($voucher['cr_account_master_id']); ?>">
									</div>
                                </div>
								...
								<div class="form-group jobDtls">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="job_account" id="job_account" class="form-control" autocomplete="off" data-toggle="modal" data-target="#account_modal" value="<?php echo e($voucher['dr_master_name']); ?>">
										<input type="hidden" name="job_account_id" id="job_account_id" value="<?php echo e($voucher['dr_account_master_id']); ?>">
									</div>
                                </div>
...
$(function() {	
	...
	var supurl = "<?php echo e(url('jobmaster/job_data/')); ?>";
...
//VOUCHER NO DUPLICATE OR NOT
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('goods_issued/checkvchrno/')); ?>", 
			type: 'get',
