                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<a href="<?php echo e(url('subcategory/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    <td><input type='checkbox' name='subcategoryid[]' class='chk-subcategoryid' value='<?php echo e($subcategory->id); ?>'/></td>
                                    <td><?php echo e($subcategory->category_name); ?></td>
									<td><?php echo e($subcategory->description); ?></td>
                                    <td>
                                        <p>
											<button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('subcategory/edit/'.$subcategory->id)); ?>'"><span
                                    ...
                                    <td>
                                        <p>
                                            <button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($subcategory->id); ?>')"><span
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('subcategory/delete/')); ?>";
    ...
    if (!checked) {
        ...
        if(con==true) {
           ...
           $('#chkids').val(id);
            ...
            document.frmUnits.action="<?php echo e(url('subcategory/group_delete')); ?>"
