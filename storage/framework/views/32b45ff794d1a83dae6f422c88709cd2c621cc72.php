        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
							...
							<thead>
								...
								<tr>
									<td align="left" valign="top" style="padding-left:0px;">
										<h6><b>Item Code: <b><?php echo e($results['opn_details'][0]->item_code); ?><br/>
											   Item Name: <b><?php echo e($results['opn_details'][0]->description); ?></b></h6>
									</td>
								...
								<tr style="border:0px solid black;">
									...
									<table border="0" style="width:100%;" class="tblstyle table-bordered">
										<tr>
											...
											<?php if($jobno): ?><td width="20%"><b>Job No</b></td><?php endif; ?>
										...
										<?php foreach($results['opn_details'] as $opndetails): ?>
										<tr>
											<td>OQ</td>
											<td></td>
											<td></td>
											<td>Opening Quantity</td>
											<td class="text-right"><?php echo e($opndetails->opn_quantity); ?></td>
											<?php if($jobno): ?><td></td><?php endif; ?>
										...
										<?php foreach($results['pursales'] as $result): ?>
										<tr>
											...
											<td><?php echo e(date('d-m-Y',strtotime($result->voucher_date))); ?></td>
											<td><?php echo e($result->master_name); ?></td>
											<?php if($jobno): ?><td><?php echo e($result->jobno); ?></td><?php endif; ?>
											...
											<td class="text-right"><?php echo e($bal); ?></td>
									...
									<?php $balance = $qtyin - $qtyout; ?>
										<tr>
											...
											<?php if($jobno): ?><td></td><?php endif; ?>
											<td class="text-right"><b><?php echo e($qtyin); ?></b></td>
											<td class="text-right"><b><?php echo e($qtyout); ?></b></td>
											<td class="text-right"><b><?php echo e($balance); ?></b></td>
										</tr>
								...
								<thead>
									...
									<tr>
										<td align="left" colspan="2" valign="top" style="padding-left:0px;">
											<h5> Item Code: <b><?php echo e($item->item_code); ?></b>,  Item Name: <b><?php echo e($item->description); ?></b></h5>
										</td>
									</tr>
								</thead>
									<tbody id="bod">
											...
											<?php foreach($results['pursales'] as $ky => $results) {  ?>
												<tr>
													<td align="left" valign="top" style="padding-left:0px;" colspan="7">
														<h6><b>Location Code: <?php echo e($locdata[$ky]->code); ?>, Location Name: <?php echo e($locdata[$ky]->name); ?></b></h6>
													</td>
												</tr>
												<tr>
													<td width="10%"><b>Type</b></td>
												...
												<tr>
													...
													<?php if($result->type=='OQ' || $result->type=='PI' || $result->type=='SR' || $result->type=='DO' || $result->type=='LT IN' || $result->type=='SDO') 
														   ...
														   elseif($result->type=='CDO' || $result->type=='SI' || $result->type=='PR' || $result->type=='LT OUT') 
																$qtyout += $result->lqty; ?>
													<td class="text-right"><?php echo e($qtyin - $qtyout); ?></td>
												</tr>
												<?php endforeach; ?>
												<?php $balance = $qtyin - $qtyout; ?>
													<tr>
										...
										<tr style="border:0px solid black;">
											...
											<table border="0" style="width:100%;" class="tblstyle table-bordered">
												...
												<tr>
													...
													<?php if($jobno): ?><td><strong>Job No</strong></td><?php endif; ?>
												...
												<tr>
													...
													<td class="text-right"><?php echo e($curbalance); ?></td>
												</tr>
												<?php endforeach; ?>
											...
											<tr>
												...
												<?php if($jobno): ?><td></td><?php endif; ?>
												<td class="text-right"><b><?php echo e($qtyin); ?></b></td>
												<td class="text-right"><b><?php echo e(number_format($pcost,2)); ?></b></td>
												<td class="text-right"><b><?php echo e($costavg); ?></b></td>
												<td class="text-right"><b><?php echo e($costsi); ?></b></td>
												<td class="text-right"><b><?php echo e($qtyout); ?></b></td>
												<td class="text-right"><b><?php echo e(number_format($scost,2)); ?></b></td>
												<td class="text-right"><b><?php echo e($balance); ?></b></td>
											</tr>
												<?php } ?>
											</table>
						...
						<?php } else if($voucherhead == 'Stock Ledger Quantity with Cost & Value') { ?>
								<table border="0" style="width:100%;height:100%;">
									<thead>
										...
										<tr>
											<td colspan="2" align="center"><b style="font-size:16px;"><b><u><?php echo e($titles['subhead']); ?></u></b></b><br/></td>
										</tr>
										<tr>
											<td align="left" valign="top" style="padding-left:0px;">
												<h6><b>Item Code: <b><?php echo e($results['opn_details'][0]->item_code); ?><br/>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('stock_ledger/export')); ?>">
				...
				<!--	<input type="hidden" name="date_from" value="<?php echo e($fromdate); ?>" >
					...
					<input type="hidden" name="document_id" value="<?php echo e($docid); ?>" >-->
