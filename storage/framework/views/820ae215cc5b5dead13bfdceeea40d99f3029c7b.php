                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmDepartment" id="frmDepartment" action="<?php echo e(url('department/update/'.$departmentrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="code" name="code" value="<?php echo e($departmentrow->code); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo e($departmentrow->name); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         <a href="<?php echo e(url('department')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(document).ready(function () {
	var urlcode = "<?php echo e(url('department/checkcode/')); ?>";
	var urlname = "<?php echo e(url('department/checkname/')); ?>";
