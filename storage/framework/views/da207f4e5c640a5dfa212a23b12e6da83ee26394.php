        ...
        <section class="content p-l-r-15" id="cost-job">
            <div class="panel">
                ...
                <div class="panel-body">
							...
							<table class="table">
										...
										<?php foreach($reports as $key => $report): ?>
											...
											<tr>
												...
												<td><b>Total in <?php echo e(date("F", mktime(0, 0, 0, $date, 10)).' '.$yr); ?>: </b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('pdc_report/export')); ?>">
						...
						<input type="hidden" name="account_id" value="<?php echo e($account); ?>" >
						<input type="hidden" name="ob_only" value="<?php echo e($obonly); ?>" >
					</form>
					<?php } ?>
                    </div>
                </div>
