                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmGroup" id="frmGroup" action="<?php echo e(url('subgroup/update/'.$grouprow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Sub Group Description" value="<?php echo e($grouprow->description); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit
                                                         ...
                                                         <a href="<?php echo e(url('subgroup')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
...
$(document).ready(function () {
	var url = "<?php echo e(url('subgroup/checkname/')); ?>";
