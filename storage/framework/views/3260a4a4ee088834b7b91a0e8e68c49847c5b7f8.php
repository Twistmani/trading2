            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" name="frmReport" id="frmReport" action="<?php echo e(url('employee_report/search')); ?>" target="_blank">
...
function getDetail() {	
	//document.frmDOCReport.action = "<?php echo e(url('document_report/print')); ?>";
