...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('ss-create'))) : ?>
                             <a href="<?php echo e(url('sales_split_return/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmPOReport" id="frmPOReport" action="<?php echo e(url('sales_split_return/search')); ?>" target="_blank">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('sales_split_return/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePurSplit").DataTable({
			...
			"order": [[ 0, 'desc' ]],
			"ajax":{
					 "url": "<?php echo e(url('sales_split_return/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
			...
			{ "data": "supplier" },
			{ "data": "net_total" },
			<?php if (\Entrust::can(('ss-edit'))) : ?>{ "data": "edit","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('ss-print'))) : ?>{ "data": "print","bSortable": false },<?php endif; // Entrust::can ?>
			<?php if (\Entrust::can(('ss-delete'))) : ?>{ "data": "delete","bSortable": false }<?php endif; // Entrust::can ?>
		]	
   ...
   /*  $("#multiselect2").multiselect({
	...
	$(document).on('change', '#search_type', function(e) { //$('#search_type').on('change', function(e){
		...
		if(vchr=='customer') {
			...
			$.ajax({
				url: "<?php echo e(url('sales_split_return/getcustomer/')); ?>",
				//type: 'get',
