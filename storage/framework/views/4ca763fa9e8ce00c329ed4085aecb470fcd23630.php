...
<head>
	...
	<link href="<?php echo e(asset('css/stimulsoft.viewer.office2013.whiteteal.css')); ?>" rel="stylesheet">

	<!-- Stimusloft Reports.JS -->
	<script src="<?php echo e(asset('scripts/stimulsoft.reports.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('scripts/stimulsoft.viewer.js')); ?>" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		viewer.onBeginProcessData = function (event, callback) {
			event.connectionString = 'Server=localhost;Database=<?php echo e(env('DB_DATABASE')); ?>;uid=<?php echo e(env('DB_USERNAME')); ?>;password=<?php echo e(env('DB_PASSWORD')); ?>;';
		...
		var report = new Stimulsoft.Report.StiReport(); var view = '<?php echo e($view); ?>';
		report.loadFile("<?php echo e(asset('reports/')); ?>/"+view); var id; //Numak1.mrt Numak2.mrt Numak3.mrt
