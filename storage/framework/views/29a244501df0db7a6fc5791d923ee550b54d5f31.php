                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurReturn" id="frmPurReturn" action="<?php echo e(url('purchase_return/save')); ?>">
								...
								<div class="form-group">
									...
									<input type="hidden" name="curno" id="curno" value="<?php echo e($vouchers[0]['voucher_no']); ?>">
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('purchase_invoice_id')) echo 'form-error';?>"> <b>Purchase Invoice#</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?php if($errors->has('purchase_invoice_id')) echo 'form-error';?>" id="purchase_invoice_id" name="purchase_invoice_id" value="<?php echo e(old('purchase_invoice_id')); ?>" placeholder="Purchase Invoice No" autocomplete="off" onclick="getPurchaseInvoice(this)">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en'  autocomplete="off" readonly id="voucher_date" value="<?php echo e((old('voucher_date')=='')?date('d-m-Y'):old('voucher_date')); ?>" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
									...
									<?php if(old('item_code')) { $i = 0; 
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="6%">
													<select id="taxcode_<?php echo e($j); ?>" class="form-control select2 tax-code" style="width:100%" name="tax_code[]"><option value="SR">SR</option><option value="RC">RC</option><option value="ZR">ZR</option><option value="EX">EX</option></select>
												</td>
												<td width="6%">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="7%">
														...
														<input type="number" name="oc_rate[]" id="ocrate_<?php echo e($l); ?>" step="any" value="<?php echo e(old('oc_rate')[$k]); ?>" readonly class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small">Currency Dhs</span>	<input type="number" id="total" step="any" name="total" value="<?php echo e(old('total')); ?>" class="form-control spl" readonly placeholder="0">
										</div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">FC Currency</span>	<input type="number" id="total_fc" step="any" value="<?php echo e(old('total_fc')); ?>" name="total_fc" class="form-control spl" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="<?php echo e(old('discount')); ?>" autocomplete="off" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount_fc" name="discount_fc" value="<?php echo e(old('discount_fc')); ?>" autocomplete="off" class="form-control spl" placeholder="0">
										</div>
									</div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('purchase_return/add')); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
//	$('#voucher_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
	...
	$('#voucher_id').on('change', function(e){
		...
		$.get("<?php echo e(url('purchase_return/getvoucher/')); ?>/" + vchr_id, function(data) { //console.log(data);
	...
	$('#department_id').on('change', function(e){
		...
		$.get("<?php echo e(url('purchase_return/getdeptvoucher/')); ?>/" + dept_id, function(data) {  console.log(data);
...
function getPurchaseInvoice(e) {
	if(e.value=='') { 
		...
		if($('#department_id').length) {
			...
			var pourl = "<?php echo e(url('purchase_invoice/pi_data/')); ?>/"+did;
		} else 
