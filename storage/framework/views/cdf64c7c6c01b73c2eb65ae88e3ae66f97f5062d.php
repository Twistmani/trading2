                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmAdvanceset" id="frmAdvanceset" action="<?php echo e(url('advance_set/save')); ?>">
...
$(function(){
  $(':input[type=number]').on('mousewheel',function(e){ $(this).blur(); });
	...
	var custurl = "<?php echo e(url('sales_invoice/customer_data/')); ?>";
	...
	$(document).on('click', '.custRow', function(e) {
	   ...
	   var url = "<?php echo e(url('account_enquiry/os_bills_adv/')); ?>/"+$(this).attr("data-id");
	   ...
	   var url = "<?php echo e(url('sales_invoice/get_invoiceset/')); ?>/"+$(this).attr("data-id");
	   $('#crTransactionData').load(url, function(result) {
		  $('#myModal').modal({show:true});
	   });*/
	...
	var suppurl = "<?php echo e(url('purchase_invoice/supplier_data/')); ?>";
	...
	$(document).on('click', '.supp', function(e) {
	   ...
	   /*var url = "<?php echo e(url('purchase_invoice/get_invoiceset/')); ?>/"+$(this).attr("data-id");
