        ...
        <section class="content p-l-r-15" id="invoice-stmt">
            <div class="panel">
                ...
                <div class="panel-body" style="width:100%; !important; border:0px solid red;">
										...
										<td colspan="2" align="center">
											...
											<body>
												...
												<tr>
													...
													<td class="text-right"><b><?php echo e(number_format($total_amt,2)); ?></b></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php  $i++;  ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($i); ?> &nbsp; <b>SO.#:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>SO Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>SO.Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
								...
								<tbody id="bod">
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<?php foreach($reports as $report): ?>
											<tr>
												<td><b>SI.No:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>SO.#:</b> <?php echo e($report[0]->voucher_no); ?> &nbsp; <b>SO Date</b> <?php echo e(date('d-m-Y', strtotime($report[0]->voucher_date))); ?></td>
												<td><b>SO.Ref.#:</b> <?php echo e($report[0]->reference_no); ?></td>
									...
									<tr style="border:0px solid black;">
										...
										<table class="tblstyle table-bordered" width="100%">
											...
											<tr>
												...
												<td ><b>Job No.</b> <?php echo e($report[0]->jobcode); ?></td>
												<td ><b>Salesman:</b> <?php echo e($report[0]->salesman); ?></td>
												<td  class="text-right"><b>Customer:</b> <?php echo e($report[0]->master_name); ?></td>
											</tr>
											<tr>
												<td><b>Item Code</b></td>
												<td><b>Description</b></td>
					...
					<form class="form-horizontal" role="form" method="POST" name="frmExport" id="frmExport" action="<?php echo e(url('sales_order/export')); ?>">
