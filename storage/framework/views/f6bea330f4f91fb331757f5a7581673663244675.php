                    ...
                    <div class="panel panel-<?php echo ($orderrow->is_editable==1)?'danger':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('si-print'))) : ?>
							 <a href="<?php echo e(url('job_invoice/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('job_invoice/update/'.$orderrow->id)); ?>">
                               ...
                               <?php if($formdata['job_account']==1) { ?>
								...
								<?php if(Session::get('mod_vehicle_cust')==0): ?>
    								<div class="form-group">
                                       <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
    									...
    									<button type="button" id="customer_info" class="btn btn-primary btn-xs cust-info">Customer Info</button>
    										...
    										<div class="col-xs-10" style="float: right;" id="newcustomerInfo">
    											<div class="col-xs-3">
    												<span class="small">Customer Name</span> <input type="text" id="customername" name="customername" value="<?php echo e($orderrow->customer_name); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#newcustomer_modal">
    											</div>
    											<div class="col-xs-3">
    											...
    											<div class="col-xs-3">
    												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e($orderrow->customer_phone); ?>" class="form-control" autocomplete="off">
    											</div>
    								...
    								<div class="form-group">
    									...
    									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
    										...
    										<div class="col-sm-10" style="float: right;" id="vehicleInfo">
    											...
    											<div class="col-xs-2">
    												<span class="small">ChasisNo</span> <input type="text" id="chasis_no" name="chasis_no" value="<?php echo e($orderrow->chasis_no); ?>" readonly class="form-control">
    											</div>
    											<div class="col-xs-2">
    											...
    											<div class="col-xs-1">
    												...
    												<div class="col-xs-1">
    												<span class="small">MetreIn</span> <input type="text" id="metre_in" name="metre_in" value="<?php echo e($orderrow->metre_in); ?>" class="form-control">
    											</div>
    											<div class="col-xs-1">
    												<span class="small">MetreOut</span> <input type="text" id="metre_out" name="metre_out"value="<?php echo e($orderrow->metre_out); ?>"  class="form-control">
    											</div>
    											<div class="col-xs-1"><br/>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_type" class="form-control select2 <?php if($errors->has('job_type')) echo 'form-error';?>" style="width:100%" name="job_type">
											...
											<option value="<?php echo e($row->id); ?>" <?php if($orderrow->job_type==$row->id) echo 'selected'; ?>><?php echo e($row->name); ?></option>
											<?php } ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jobname" id="jobname" tabindex="2" class="form-control" autocomplete="off" data-toggle="modal" value="<?php echo e($orderrow->code); ?>" data-target="#job_modal" placeholder="Job Code">
								...
								<label for="input-text" class="col-sm-2 control-label " id="">Items Description </label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="items_description" autocomplete="off" name="items_description"value="<?php echo e($orderrow->items_description); ?>" placeholder="Items Description">
											</div>
								</div>
								<?php } else {?>
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($j); ?>" autocomplete="off" name="quantity[]" step="any" class="form-control <?php if($errors->has('quantity.'.$i)) echo 'form-error';?> line-quantity" value="<?php echo e(old('quantity')[$i]); ?>">
												</td>
												<td width="8%">
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	...
																	<td><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($quantity); ?>">
									...
									<div class="itemdivChld">	
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" autocomplete="off" name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
												...
												<td width="9%">
													<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:$item->packing); ?>">
												...
												<td width="11%">
													<input type="text" id="itmttl_<?php echo e($i); ?>" name="line_total[]" class="form-control line-total" readonly value="<?php echo e(intval($line_total*100)/100); ?>">
								         ...
								         <?php } ?>
											...
											<div id="loc" style="float:left; padding-right:5px;">
												<button type="button" id="loc_<?php echo e($i); ?>" class="btn btn-primary btn-xs loc-info">Location22</button>
											</div>
											<?php } else { ?>
							 	                     <input type="hidden" name="item_loc" id="item_loc">
								            <?php } ?>
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														...
														<input type="text" name="rv_dr_account[]" id="rvdraccount_<?php echo e($i); ?>" autocomplete="off" class="form-control" value="<?php echo e($rowrv->master_name); ?>">
										...
										<div class="RVdivChld">	
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="20%">
														<span class="small">Debit Account</span>
														<input type="text" name="rv_dr_account[]" id="rvdraccount_1" autocomplete="off" class="form-control" value="<?php echo e($rvvoucher['account_name']); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('job_invoice')); ?>" class="btn btn-danger">Cancel</a>
										<a href="<?php echo e(url('job_invoice/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	<?php if( sizeof(array($vouchers)) > 0 && $vouchers->is_cash_voucher==1) { ?> //cash customer.... 
		...
		//	$('#newcustomerInfo').toggle();
		$('#customer_id').val(<?php echo e($vouchers->default_account_id); ?>);
		$('#dr_account_id').val(<?php echo e($vouchers->default_account_id); ?>);
...
$(function() {	
    ...
    <?php else: ?>
        var vclurl = "<?php echo e(url('job_order/all_vehicle/')); ?>"
    	$('#vehicle_name').click(function() { 
	...
	$(document).on('click', '.vclRow', function(e) {
		...
		<?php if(Session::get('mod_vehicle_cust')==1): ?>
		...
		var vehurl = "<?php echo e(url('sales_invoice/vehicle_history/')); ?>";
