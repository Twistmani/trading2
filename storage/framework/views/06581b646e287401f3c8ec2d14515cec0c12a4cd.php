                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('sr-print'))) : ?>
							 <a href="<?php echo e(url('sales_return/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesReturn" id="frmSalesReturn" action="<?php echo e(url('sales_return/update/'.$orderrow->id)); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="sales_return_id" id="sales_return_id" value="<?php echo e($orderrow->id); ?>">
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"> <b>Sales Invoice No.</b></label></font>
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="sales_invoice_no" name="sales_invoice_no" value="<?php echo e($orderrow->sales_invoice_no); ?>" placeholder="Sales Invoice ID" autocomplete="off" onclick="getSalesInvoice(this)">
                                        <input type="hidden" class="form-control" id="sales_invoice_id" name="sales_invoice_id" value="<?php echo e($orderrow->sales_invoice_id); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
									<div class="input-group">
                                        <input type="text" name="sales_ret_account" id="sales_ret_account" class="form-control" value="<?php echo e($orderrow->account); ?>" readonly>
										<span class="input-group-addon inputsa"><i class="fa fa-edit" style="font-size:22px;color:#ff9f2c"></i></span>
									</div>
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="<?php echo e($orderrow->dr_account_id); ?>" class="form-control">
									</div>
                                </div>
								...
								<div class="form-group">
                                   <font color="#16A085"> <label for="input-text" class="col-sm-2 control-label"><b>Customer</b></label></font>
                                    <div class="col-sm-10">
                                        <input type="text" name="customer_name" id="customer_name" value="<?php echo e($orderrow->customer); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e($orderrow->customer_id); ?>">
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e($orderrow->cr_account_id); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' readonly id="voucher_date" value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo e($orderrow->description); ?>" placeholder="Description">
                                    </div>
                                </div>
                                <?php } else { ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="13%">
													...
													<option value="<?php echo e($cat->id); ?>" <?php echo e(($item->cat_id==$cat->id)?'selected':''); ?> ><?php echo e($cat->category_name); ?></option>
													<?php endforeach; ?>
												...
												<td width="8%">
													...
													<input type="number" id="itmqty_<?php echo e($i); ?>" autocomplete="off" step="any" name="quantity[]" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>" readonly>
												</td>
												<td width="8%">
								...
								<?php //} ?>
											...
											<div id="cnloc" style="float:left; padding-right:5px;">
												...
												<input type="hidden" name="nwconloc_id[]" id="conlocid_<?php echo e($i); ?>">
												<input type="hidden" name="nwconloc_qty[]" id="conlocqty_<?php echo e($i); ?>">
											</div>
											<div>
														...
														<div class="col-xs-4">
															<table class="table table-bordered table-hover">
																...
																<tr>
																	...
																	<td><input type="number" name="locqty[<?php echo $i-1;?>][]" value="<?php echo e($qty_entry); ?>" class="loc-qty-<?php echo e($i); ?>" data-id="<?php echo e($i); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
										<span class="small" id="fc_label">Currency</span>	<input type="number" id="total" step="any" name="total" class="form-control spl" readonly value="<?php echo e(intval($total*100)/100); ?>">
										</div>
										<div class="col-xs-2">
										<span class="small" id="c_label">Currency Dhs</span>	<input type="number" id="total_fc" step="any" name="total_fc" class="form-control spl" value="<?php echo e(intval($orderrow->total*100)/100); ?>" readonly placeholder="0">
										</div>
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="vatcur" name="vatcur" value="<?php echo e($orderrow->vat_amount); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" class="form-control" readonly value="<?php echo e((old('net_amount_hid'))?old('net_amount_hid'):$orderrow->net_amount); ?>">
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount')?old('net_amount'):$orderrow->is_fc==1)?$orderrow->net_amount_fc:$orderrow->net_amount); ?>" placeholder="0">
										</div>
										<div class="col-xs-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('sales_return/edit/'.$orderrow->id)); ?>" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
	...
	var urlcode = "<?php echo e(url('sales_return/checkrefno/')); ?>";
	var urlvchr = "<?php echo e(url('sales_return/checkvchrno/')); ?>"; //CHNG
...
$(function() {	
	...
	$('#voucher_id').on('blur', function(e){
		...
		$.ajax({
			url: "<?php echo e(url('sales_return/set_session/')); ?>",
			type: 'get',
	...
	$(document).on('click', '.view-cnloc-info', function(e) { 
	   ...
	   if(cnloc_id!='') {
		   var vwUrl = "<?php echo e(url('itemmaster/view_conloc_items/')); ?>/"+cnloc_id+'/'+cnloc_qty+'/SR/'+curNum+'/'+rwid; 
