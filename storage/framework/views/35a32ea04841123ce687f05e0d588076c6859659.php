                    ...
                    <div class="panel panel-success filterable">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-columns"></i> <?php  echo (Session::get('trip_entry')==1)?'Daily Entry':'Delivery Order';  ?>
                            </h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
								...
								<input type="hidden" name="url" id="sid" value="<?php echo e($sid); ?>">
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											<td><input type="checkbox" name="quotaion[]" value="<?php echo e($order->id); ?>"/></td>
											...
											<td><a href="#" class="quot-data" data-id="<?php echo e($order->id); ?>" data-name="<?php echo e($order->reference_no); ?>" data-toggle="modal" data-target="#quot_modal">View Items</td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"><?php  echo (Session::get('trip_entry')==1)?'Trip Entry':'Delivery Order';  ?></h4>
                                        </div>
...
function setTransfer() {
	...
	if(curl=='CDO') {
		if(sid=='')
			url = "<?php echo e(url('sales_invoice/add/')); ?>/"+items+"/CDO";
		else
			url = "<?php echo e(url('sales_invoice/edit/')); ?>/"+sid+"/CDO/"+items;
	} else
		url = "<?php echo e(url('customers_do/add/')); ?>/"+items+"/2";
...
$(document).on('click', '.quot-data', function(e) {
	...
	var itmurl = "<?php echo e(url('customers_do/item_details/')); ?>";
