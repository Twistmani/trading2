                    ...
                    <div class="panel panel-primary">
						   ...
						   <div class="pull-right">
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('pc-print'))) : ?>
								 <a href="<?php echo e(url('pettycash/print/'.$printid->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
                          <div class="controls"> 
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPettyCash" id="frmPettyCash" action="<?php echo e(url('pettycash/save')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="draccount_1" name="account_name[]" value="<?php echo e($cashac->master_name); ?>" readonly autocomplete="off" data-toggle="modal" data-target="#cash_modal">
                                        <input type="hidden" name="account_id[]" id="draccountid_1" value="<?php echo e($cashac->id); ?>">
...
$(document).ready(function () {
	...
	var urlvchr = "<?php echo e(url('pettycash/checkvchrno/')); ?>"; //CHNG
...
$(document).on('click', '.ref-invoice', function(e) {
    ...
    if( $('.itemdivPrnt #groupid_'+curNum).val()=='SUPPLIER' ) { //supplier type.........
        var url = "<?php echo e(url('account_enquiry/os_bills/')); ?>/"+$('.itemdivPrnt #draccountid_'+curNum).val();
