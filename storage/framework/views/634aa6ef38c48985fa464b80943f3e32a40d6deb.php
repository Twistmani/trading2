        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
						   ...
						   <div class="pull-right">
								<?php if (\Entrust::can(('rv-print'))) : ?>
								 <a href="<?php echo e(url('journal/print/'.$jrow->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="<?php echo e(url('journal/update/'.$jrow->id)); ?>">
					...
					<?php /**/ $i++; /**/ ?>
											<div class="itemdivChld">							
												...
												<?php if($item->category=='PDCR' || $item->category=='PDCI'): ?>
													<?php if($isdept): ?>
													...
													<input type="hidden" name="group_id[]" value="<?php echo e($item->group_id ?? $item->category); ?>" id="groupid_<?php echo e($i); ?>" data-group="<?php echo e($item->category); ?>" data-acct-group="<?php echo e(strtoupper($item->category)); ?>" data-vat-rate="<?php echo e($item->ac_vat_percentage ?? ''); ?>" data-vat-flag="<?php echo e(($item->ac_vat_assign ?? 0) ? '1' : '0'); ?>">
													<input type="hidden" name="vatamt[]" id="vatamt_<?php echo e($i); ?>" value="<?php echo e($item->ac_vat_percentage ?? ''); ?>">
													<input type="hidden" name="je_id[]" id="jeid_<?php echo e($i); ?>" value="<?php echo e($item->id); ?>">
													<input type="hidden" name="bill_type[]" id="biltyp_<?php echo e($i); ?>" value="">
													</div>
														...
														<div class="col-xs-2" style="width:9%;">
															...
															<input type="text" id="ref_<?php echo e($i); ?>" name="reference[]" autocomplete="off" value="<?php echo e($item->reference); ?>" class="form-control ref-invoice" data-toggle="modal" data-target="#reference_modal">
															</div>
														...
														<div class="col-xs-1 pdcfm" style="width:8%;">
															<span class="small">Chq. No</span><input type="text" autocomplete="off" id="chkno_<?php echo e($i); ?>" value="<?php echo e($item->cheque_no); ?>" name="cheque_no[]" class="form-control" >
															<input type="hidden" id="oldchkno_<?php echo e($i); ?>" value="<?php echo e($item->cheque_no); ?>" name="oldcheque_no[]">
														</div>
														<div class="col-xs-1 pdcfm" style="width:8%;">
															<span class="small">Chq. Date</span> <input type="text" autocomplete="off" id="chkdate_<?php echo e($i); ?>" value="<?php echo ($item->cheque_date=='0000-00-00')?'':date('d-m-Y',strtotime($item->cheque_date));?>" name="cheque_date[]" class="form-control chqdate" data-language='en'>
														</div>
														...
														<div class="col-xs-1 pdcfm" style="width:8%;">
																...
																<input type="text" id="party_<?php echo e($i); ?>" name="party_name[]" value="<?php echo e($item->party_name); ?>" class="form-control" data-toggle="modal" data-target="#paccount_modal">
														</div>
														...
														<?php endif; ?> <!--PDC DEPARTMENT ENDIF-->
													
													<?php elseif($item->category=='BANK'): ?>
    													<?php if($isdept): ?>
    													...
    													<input type="hidden" name="bill_type[]" id="biltyp_<?php echo e($i); ?>" value="">
															...
															<input type="hidden" name="vatamt[]" id="vatamt_<?php echo e($i); ?>" value="<?php echo e($item->ac_vat_percentage ?? ''); ?>">
    															...
    															<input type="hidden" name="bill_type[]" id="biltyp_<?php echo e($i); ?>" value="">
    																...
    																<div class="col-xs-1 pdcfm" style="width:9%;">
    																	<span class="small">Chq. Date</span> <input type="text" autocomplete="off" id="chkdate_<?php echo e($i); ?>" value="<?php echo ($item->cheque_date=='0000-00-00' || $item->cheque_date=='1970-01-01')?'':date('d-m-Y',strtotime($item->cheque_date));?>" name="cheque_date[]" class="form-control chqdate" data-language='en'>
    																</div>
    														...
    														<?php endif; ?> <!--BANK DEPARTMENT ENDIF-->
			...
			<input type="hidden" name="vatamt[]" id="vatamt_<?php echo e($i); ?>" value="<?php echo e($item->ac_vat_percentage ?? ''); ?>">
														...
														<div class="col-xs-1 abc" style="width:3%;"><br/>
															...
															<?php endif; ?>  <!-- CASH DEPARTMENT ENDIF -->
															<div class="form-group" style="display:none;">
																<div class="col-xs-15">
																	...
																	<div class="col-sm-2"> 
																		<span class="small">Cheque No</span><input type="text" autocomplete="off" id="chkno_<?php echo e($i); ?>"  name="cheque_no[]" class="form-control" >
																		<input type="hidden" id="oldchkno_<?php echo e($i); ?>" name="oldcheque_no[]">
																	</div>
																	
																	<div class="col-xs-2">
																		<span class="small">Cheque Date</span> <input type="text" autocomplete="off" id="chkdate_<?php echo e($i); ?>" name="cheque_date[]" class="form-control chqdate" data-language='en'>
																	</div>
																	
																	<div class="col-xs-2">
																			<input type="hidden" name="partyac_id[]" id="partyac_<?php echo e($i); ?>">
																			<span class="small">Party Name</span> <input type="text" id="party_<?php echo e($i); ?>" name="party_name[]" class="form-control" data-toggle="modal" data-target="#paccount_modal">
																		</div>
								...
								<div class="form-group" id="trndtl_1" class="divTrn">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-5"> 
											<span class="small"><b>Supplier Name</b></span><input autocomplete="off" type="text" id="supname_1" value="<?php echo e($jrow->supplier_name); ?>" name="supplier_name" class="form-control" >
										</div>
										<div class="col-xs-5">
											<span class="small"><b>TRN No</b></span> <input type="text" autocomplete="off" id="trnno_1" name="trn_no" value="<?php echo e($jrow->trn_no); ?>" class="form-control">
										</div>
                                </div>
								<?php } ?>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary submit" <?php echo e(($jrow->is_transfer==1)?"disabled":""); ?>>Submit</button>
...
$(document).ready(function () {
	...
	$('#voucher').on('change', function(e){
		var vchr_id = e.target.value; 
		$.get("<?php echo e(url('journal/getvoucher/')); ?>/" + vchr_id, function(data) { 
			$('#voucher_no').val(data);
		});
	});
...
$(function(){
  ...
  $('#department_id').on('change', function(e){ 
		...
		$.get("<?php echo e(url('sales_voucher/getdeptvoucher/')); ?>/" + dept_id, function(data) { 
...
$(document).on('click', '.addRecu', function(e) {
	...
	$.ajax({
		url: "<?php echo e(url('journal/recurring_add/')); ?>",
		type: 'post',
		data: formData, 
		success: function(data) { 
			$('.toRc').html(data);
