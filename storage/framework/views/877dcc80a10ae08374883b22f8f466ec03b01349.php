                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmWageEntry" id="frmWageEntry" action="<?php echo e(url('wage_entry/timesheet/approve/')); ?>" >
                           ...
                           <div class="col-sm-2">
							<button type="button" id="search" class="btn btn-primary">Search</button></div>
												<a href="<?php echo e(url('wage_entry/timesheet/view')); ?>" class="btn btn-danger">Clear</a>
						</div>
						</div>	
									...
									<?php 
										...
										<tr>
											...
											<td width="10%">
                                                ...
                                                <input type="hidden" name="id[]" id="id_<?php echo e($i); ?>" value="<?php echo e($row->id); ?>">
												<input type="hidden" name="employee_id[]" id="empid_<?php echo e($i); ?>" value="<?php echo e($row->employee_id); ?>">
												
												<input type="text" id="empname_<?php echo e($i); ?>" name="employee_name[]" class="form-control" autocomplete="off" value="<?php echo e($row->name); ?>" autocomplete="off" readonly  placeholder="Employee Name">
											</td>
                                            <td width="8%">
                                            <span class="small">Date</span>
                                            <input type="text" class="form-control " name="date[]" value="<?php echo e(date('d-m-Y',strtotime($row->date))); ?>" id="date" data-language='en' autocomplete="off"/>
                                            </td>
                                            <td width="6%">
												<span class="small">Day Type</span><input type="text"  name="day_type[]" value="<?php echo ($row->day_type=='wday')?'Working':'Holiday'; ?>" id="daytype_<?php echo e($i); ?>" readonly step="any" autocomplete="off" class="form-control" >
											</td>
											
											<td width="5%">
												<span class="small">Start Time</span><input type="time"  name="start_time[]" value="<?php echo ($row->start_time=='00:00:00')?'':$row->start_time; ?>" id="start_<?php echo e($i); ?>" readonly step="any" autocomplete="off" class="form-control start-time" >
											</td>
											<td width="5%">
												<span class="small">End Time</span><input type="time" id="end_<?php echo e($i); ?>" step="any" value="<?php echo ($row->end_time=='00:00:00')?'':$row->end_time; ?>" name="end_time[]" readonly autocomplete="off" class="form-control end-time" >
											</td>
											<td width="5%">
												<span class="small">Break</span><input type="text" id="break_<?php echo e($i); ?>" step="any" value="<?php echo e($row->break_time); ?>" name="break_time[]" readonly autocomplete="off" class="form-control break-time" >
											</td>
											<td width="4%">
												<span class="small">TWH</span> <input type="number" id="twh_<?php echo e($i); ?>" step="any" name="twh[]" autocomplete="off" class="form-control line-twh" value="<?php echo e($row->twh); ?>" readonly>
											</td>
											<td width="4%">
												<span class="small">NWH</span> <input type="number" id="nwh_<?php echo e($i); ?>" step="any" name="nwh[]" autocomplete="off" class="form-control line-nwh" value="<?php echo e($row->nwh); ?>" readonly>
											</td>
											<td width="4%">
												<span class="small">OTHr(G)</span> <input type="number" id="otg_<?php echo e($i); ?>" step="any" name="otg[]" value="<?php echo e($row->otg); ?>" autocomplete="off" class="form-control line-otg" readonly>
												
											</td>
											<td width="4%">
												<span class="small">OTHr(H)</span><input type="number" id="oth_<?php echo e($i); ?>" step="any" name="oth[]" value="<?php echo e($row->oth); ?>" autocomplete="off" class="form-control line-oth" readonly>
												
											</td>
											<td width="8%">
						                         <span class="small">Job Code</span>
						                        <input type="hidden" name="job_id[]" id="jobid_<?php echo e($i); ?>" value="<?php echo e($row->job_id); ?>">
						                         <input type="hidden" name="job_data[]" id="jobdata_<?php echo e($i); ?>">
						                           <input type="text" id="jobcod_<?php echo e($i); ?>" name="job_code[]" class="form-control"  value="<?php echo e($row->job_name); ?>" autocomplete="off"  placeholder="Job Code">
					                        </td>
											<td width="5%">
											<input type="hidden" id="wid_<?php echo e($i); ?>" value="<?php echo e($row->subjob_id); ?>"name="work_id[]">
											<a href="" class="btn btn-primary btn-sm work-order" data-toggle="modal" data-target="#work_modal" id="wrkcod_<?php echo e($i); ?>">Job Split</a>
											</td>
											<td width="6%">
						                               <span class="small">Status</span>
						                              <select id="leaves_<?php echo e($i); ?>" name="leaves[]" class="form-control leaves">
                                            ...
                                            <td width="6%">
										   <div class="levtyp" id="levtyp_<?php echo e($i); ?>" >
                                           <span class="small">Type</span>
										   <select id="levstus_<?php echo e($i); ?>" name="leave_status[]" class="form-control ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Approve</button>
                                         <a href="<?php echo e(url('wage_entry/timesheet')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
                                <?php }  ?>
...
$(function() {	
	...
	document.getElementById("search").onclick = function () {
       ...
       var mon=$('#date').val();
        location.href = "<?php echo e(url('wage_entry/timesheet/view/')); ?>/"+emp+"/"+cat+"/"+mon;
    };
    ...
    $(document).on('click', '.work-order', function(e) {
        ...
        //console.log(wid);
		if(wid!=0) {
		var wrkurl = "<?php echo e(url('wage_entry/subjob_template/view/')); ?>";
