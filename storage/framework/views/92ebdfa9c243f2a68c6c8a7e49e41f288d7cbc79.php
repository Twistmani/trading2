                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('po-print'))) : ?>
								 <a href="<?php echo e(url('suppliers_do/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" enctype="multipart/form-data" action="<?php echo e(url('suppliers_do/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="default_location" value="<?php echo e((Session::get('mod_location')==1)?Auth::user()->location_id:Session::get('location_id')); ?>"/>
										...
										<?php $i++; } } else { ?>
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="8%" class="itcod">
														<input type="number" id="itmqty_1" autocomplete="off" step="any" name="quantity[]" class="form-control line-quantity" placeholder="Qty." <?php echo e(($formdata['location_item']==1)?'readonly':''); ?> ><!--MAY25-->
													</td>
													<td width="8%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('suppliers_do/add')); ?>" class="btn btn-warning">Clear</a>
...
$(document).ready(function () { 
	...
	$('#othrcstItm_1').toggle();$('.locPrntItm').toggle();
	 ...
	 <?php  if (isset(old('dr_acnt')[0]) && isset(old('dr_acnt')[0])) { ?>
		...
		<?php  } ?> 
	<?php  } ?>
	var urlvchr = "<?php echo e(url('suppliers_do/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('suppliers_do/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
...
$(function() {	
	...
	$(document).on('blur', '.line-quantity', function(e) {
		...
		if(curNum==1) {
    		<?php if(Session::get('item_location_warn')==1): ?>
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('suppliers_do/checkvchrno/')); ?>", 
			type: 'get',
...
function getDocument() { 
	...
	console.log(doc);
	if(doc=='PO')
		var pourl = "<?php echo e(url('purchase_order/po_data/')); ?>/"+supplier_id+"/SDO";
	else if(doc=='MR')
...
function getSupplierDo() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('suppliers_do/get_supplierdo/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
