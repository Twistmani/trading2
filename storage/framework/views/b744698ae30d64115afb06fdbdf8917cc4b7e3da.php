            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPayslip" id="frmPayslip" action="<?php echo e(url('pay_slip/search')); ?>">
							...
							<div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableEmployee">
                                    ...
                                    <tr>
										...
										<td>
                                        <p><button class="btn btn-primary btn-xs" onClick="window.open('<?php echo e(url('pay_slip/employee/'.$employee->id.'/'.$month.'/'.$year)); ?>','_blank')">Pay Slip</button></p></p>
											<!-- <p><button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('pay_slip/employee/'.$employee->id.'/'.$month)); ?>'">Pay Slip</button></p></p> -->
										</td>
                                    </tr>
                                    <?php endforeach; ?>
                                    </tbody>
