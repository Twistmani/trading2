            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                        ...
                        <div class="panel-body">
							<form class="form-horizontal" role="form" method="POST" target="_blank" name="frmBatchReport" id="frmBatchReport" action="<?php echo e(url('batch_report/search')); ?>">
...
function getSummary() {	
	document.frmQuantityReport.action = "<?php echo e(url('batch_report/print')); ?>";
