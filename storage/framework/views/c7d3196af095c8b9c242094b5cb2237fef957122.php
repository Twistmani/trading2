                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" name="frmUnit" id="frmUnit" action="<?php echo e(url('unit/update/'.$unitrow->id)); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="unit_name" name="unit_name" value="<?php echo e($unitrow->unit_name); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Unit Description" value="<?php echo e($unitrow->description); ?>">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="fracount" name="fracount" placeholder="Fra Count" value="<?php echo e($unitrow->fracount); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                         <a href="<?php echo e(url('unit')); ?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
