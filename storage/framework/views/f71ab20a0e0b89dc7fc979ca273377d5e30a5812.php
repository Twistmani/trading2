                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmQuotationSales" id="frmQuotationSales" action="<?php echo e(url('quotation/save')); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">
											...
											<input type="number" step="any" id="net_amount" name="net_amount" class="form-control spl" readonly value="<?php echo e((old('net_amount'))?old('net_amount'):(($quoterow->is_fc==1)?$quoterow->net_amount_fc:$quoterow->net_amount)); ?>">
										</div>
										<div class="col-xs-2">
...
$(function() {	
	...
	var smpurl = "<?php echo e(url('sales_order/salesman_data/')); ?>";
	...
	$(document).on('blur', '#voucher_no', function() {
		...
		$.ajax({
			url: "<?php echo e(url('quotation/checkvchrno/')); ?>", 
			type: 'get',
