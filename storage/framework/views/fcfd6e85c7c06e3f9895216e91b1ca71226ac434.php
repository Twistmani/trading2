                    ...
                    <div class="panel panel-<?php echo ($orderrow->approval_status==1)?'warning':'primary';?>">
                        <div class="panel-heading clearfix">
							...
							<?php if (\Entrust::can(('qs-print'))) : ?>
							 <a href="<?php echo e(url('quotation_sales/print/'.$orderrow->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurorder" id="frmPurorder" action="<?php echo e(url('quotation_sales/update/'.$orderrow->id)); ?>">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" name="voucher_date" data-language='en' value="<?php echo e(date('d-m-Y',strtotime($orderrow->voucher_date))); ?>" id="voucher_date" placeholder="QS. Date"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="job_id" class="form-control select2" style="width:100%" name="job_id">
											...
											<option value="<?php echo e($job['id']); ?>" <?php if($job['id']==$orderrow->job_id) echo 'selected'; ?>><?php echo e($job['name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
									...
									<?php if($photos!='') { $arrp = explode(',',$photos); $i=1; ?>
										...
										<div class="file-preview">
											<div class="close fileinput-remove removeP" data-val="<?php echo e($prow); ?>">×</div>
										...
										<?php endforeach; ?>
									<?php } ?>
										<input type="file" id="input-23" name="photos" class="file-loading" data-show-preview="true" data-url="<?php echo e(url('job_order/upload/')); ?>" multiple="">
										<div id="files_list"></div>
										<p id="loading"></p>
										<input type="hidden" name="photo_name" id="photo_name" value="<?php echo e($photos); ?>">
										<input type="hidden" name="old_photo_name" id="old_photo_name" value="<?php echo e($photos); ?>">
									...
									<div class="itemdivChld">							
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="8%">
													<input type="number" id="itmqty_<?php echo e($i); ?>" step="any" name="quantity[]" autocomplete="off" class="form-control line-quantity" value="<?php echo e($item->quantity); ?>">
												</td>
												<td width="8%">
												...
												<td width="9%">
													<input type="hidden" id="hidunit_<?php echo e($i); ?>" name="hidunit[]" class="hidunt" value="<?php echo e($item->unit_name); ?>">
													<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($item->is_baseqty==1)?1:$item->packing); ?>">
													<input type="text" id="vatdiv_<?php echo e($i); ?>" step="any" readonly name="vatdiv[]" class="form-control vatdiv" value="<?php echo e($item->vat.'% - '.intval($vat_amount*100)/100); ?>"><!--<div class="h5" id="vatdiv_1"></div>--> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="number" step="any" id="discount" name="discount" value="<?php echo e($orderrow->discount); ?>" class="form-control spl discount-cal" placeholder="0">
										</div>
										<div class="col-xs-2">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="header_id" id="header_id" value="<?php echo e($orderrow->hid); ?>">
                                        <input type="text" class="form-control" id="headermsg" name="header" value="<?php echo e($orderrow->header); ?>" placeholder="Header" autocomplete="off" data-toggle="modal" data-target="#header_modal">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="footermsg" name="footer" value="<?php echo e($orderrow->footer_text); ?>" placeholder="Footer" autocomplete="off" data-toggle="modal" data-target="#footer_modal">
                                    </div>
                                </div>
								<?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="<?php echo e(url('quotation_sales/edit/'.$orderrow->id)); ?>" class="btn btn-danger">Clear</a>
                                    </div>
                                </div>
...
function funApproval(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('quotation_sales/approve/')); ?>";
...
$(function() {	
	...
	var custurl = "<?php echo e(url('quotation_sales/customer_data/')); ?>";
	...
	var supurl = "<?php echo e(url('quotation/supplier_data/')); ?>";
