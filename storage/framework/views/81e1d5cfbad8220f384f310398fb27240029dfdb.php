...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('goods_issued/add')); ?>" class="btn btn-primary btn-sm">
                                ...
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
												<p><button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('goods_issued/edit/'.$order->id)); ?>'"><span class="glyphicon glyphicon-pencil"></span></button></p>
											</td>
											<td>
												<p><a href="<?php echo e(url('goods_issued/print/'.$order->id)); ?>" class="btn btn-primary btn-xs" target="_blank"><span class="fa fa-fw fa-print"></span></a></p>
											</td>
											<td>
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmReport" target="_blank" id="frmReport" action="<?php echo e(url('goods_issued/search')); ?>">
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('goods_issued/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePorders").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('goods_issued/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
