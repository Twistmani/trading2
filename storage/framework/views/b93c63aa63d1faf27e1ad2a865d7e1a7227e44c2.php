                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('purchase_voucher/print/'.$printid->id.'/'.$prints[0]->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmJournal" id="frmJournal" action="<?php echo e(url('purchase_voucher/save')); ?>">
  ...
  $(document).on('click', '.btn-add-item', function(e)  { 
	...
	$(document).on('click', '.custRow', function(e) { 
		...
		if($(this).attr("data-group")=='PDCR') { 
			...
			var trnurl = "<?php echo e(url('purchase_voucher/set_transactions/')); ?>";
