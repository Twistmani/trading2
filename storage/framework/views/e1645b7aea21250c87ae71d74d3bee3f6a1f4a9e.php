                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('vp-create'))) : ?>
                             <a href="<?php echo e(url('purchase_voucher/add')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableAcsettings" border="0">
                                    ...
                                    <tr>
										...
										<td>
											<?php if (\Entrust::can(('vp-edit'))) : ?><p><button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('purchase_voucher/edit/'.$journal->id)); ?>'"><span class="glyphicon glyphicon-pencil"></span></button></p><?php endif; // Entrust::can ?>
										</td>
										<td>
											<?php if (\Entrust::can(('vp-delete'))) : ?><p><button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($journal->id); ?>')"><span class="glyphicon glyphicon-trash"></span></button></p><?php endif; // Entrust::can ?>
										</td>
										<td>
											<p><a href="<?php echo e(url('purchase_voucher/print/'.$journal->id.'/'.$prints[0]->id)); ?>" target='_blank'  class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>
										</td>
                                    </tr>
									<?php endforeach; ?>
