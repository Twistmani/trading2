                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tablePorders">
                                    ...
                                    <tbody>
										...
										<tr>
											<td><input type="checkbox" name="order[]" value="<?php echo e($order->id); ?>"/></td>
											...
											<td><a href="#" class="order-data" data-id="<?php echo e($order->id); ?>" data-name="<?php echo e($order->voucher_no); ?>" data-toggle="modal" data-target="#order_modal">View Items</a></td>
										</tr>
										<?php endforeach; ?>
                                    </tbody>
                                </table>
