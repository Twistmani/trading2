                    ...
                    <div class="row">
                        <div class="col-md-12">
							<table border="0" style="width:100%;">
								<tr><td width="60%" align="left"><h3><?php echo e(Session::get('company')); ?></h3></td>
									<td align="left"></td>
								</tr>
								<tr>
									<td width="60%" align="right"><h4><u><?php echo e($voucherhead); ?></u></h4>
									</td><td align="left"></td>
								</tr>
							</table><br/>
                        </div>
									...
									<table class="table horizontal_table table-striped" id="tableAcmaster" border="0">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo e($row->cheque_no); ?></td>
                                            ...
                                            <tr>
												<td colspan="7" class="text-right" style="background-color:#d4eaf7 !important;"><b>Total <?php echo e(date("F", mktime(0, 0, 0, $key, 10)).' '.$yr); ?>: </b></td>
												<td class="text-right" style="background-color:#d4eaf7 !important;"><b><?php echo e(number_format($mtotal,2)); ?></b></td>
											</tr>
                                            <?php } ?>
											
											<tr>
												<td colspan="7" class="text-right" style="background-color:#d4eaf7 !important;"><b>Net Total: </b></td>
												<td class="text-right" style="background-color:#d4eaf7 !important;"><b><?php echo e(number_format($total,2)); ?></b></td>
											</tr>
