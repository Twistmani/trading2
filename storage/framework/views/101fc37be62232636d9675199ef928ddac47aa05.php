                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="tableInvList">
                                    ...
                                    <tr>
										<td><input type="radio" name="supplierDO" value="<?php echo e($sdo->id); ?>"/></td>
...
function setTransfer() {
	...
	//alert(items);
	 sdourl = "<?php echo e(url('purchase_split_return/add/')); ?>/"+item;
...
$(document).on('click', '.poclk', function(e) {
	...
	var itmurl = "<?php echo e(url('purchase_split/item_details/')); ?>";
