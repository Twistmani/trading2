				...
				<?php } else { ?>
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								<?php if (\Entrust::can(('si-print'))) : ?>
								 <a href="<?php echo e(url('job_invoice/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="<?php echo e(url('job_invoice/save')); ?>">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<input type="hidden" name="default_location" value="<?php echo e($locdefault->id); ?>">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="department_id" class="form-control select2" style="width:100%" name="department_id">
											<?php foreach($departments as $drow): ?>
												<option value="<?php echo e($drow->id); ?>" ><?php echo e($drow->name); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											...
											<option value="<?php echo e($voucher['id']); ?>"><?php echo e($voucher['voucher_name']); ?></option>
											<?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>JI. No.</b></label></font>
									<input type="hidden" name="curno" id="curno" value="<?php echo e((old('curno'))?old('curno'):$voucher['voucher_no']); ?>">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="voucher_no" value="<?php echo e((old('voucher_no'))?old('voucher_no'):$voucher['voucher_no']); ?>" readonly name="voucher_no">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right"  <?php if(old('voucher_date')!='') { ?> value="<?php echo e(old('voucher_date')); ?>" <?php } ?> name="voucher_date" data-language='en' readonly id="voucher_date" placeholder="<?php echo e(date('d-m-Y')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="hidden" name="cr_account_id" id="cr_account_id" value="<?php echo e((old('cr_account_id'))?old('cr_account_id'):$vouchers[0]['cr_account_master_id']); ?>" class="form-control">
										<div class="input-group">
								...
								<div class="form-group">
                                  <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('customer_name')) echo 'form-error';?>"><b>Customer</b></label></font>
                                    <div class="col-sm-8">
										...
										<input type="text" name="customer_name" id="customer_name" value="<?php echo e(old('customer_name')); ?>" class="form-control <?php if($errors->has('customer_name')) echo 'form-error';?>" autocomplete="off" data-toggle="modal" data-target="#customer_modal" placeholder="Customer">
										<input type="hidden" name="customer_id" id="customer_id" value="<?php echo e(old('customer_id')); ?>">
										<input type="hidden" name="dr_account_id" id="dr_account_id" value="<?php echo e(old('dr_account_id')); ?>">
										</div>
									<div class="col-sm-2">
									<button type="button" id="customer_info" class="btn btn-primary btn-xs cust-info">Customer Info</button>
										...
										<div class="col-sm-10" style="float: right;" id="newcustomerInfo">
											<div class="col-sm-4">
												<span class="small">Customer Name</span> <input type="text" id="customername" name="customername" value="<?php echo e(old('customername')); ?>" class="form-control" autocomplete="off" data-toggle="modal" data-target="#newcustomer_modal">
											</div>
											<div class="col-sm-4">
											...
											<div class="col-sm-3">
												<span class="small">Phone No</span> <input type="text" id="customer_phone" name="customer_phone" value="<?php echo e(old('customer_phone')); ?>" class="form-control" autocomplete="off">
											</div>
											<div class="col-sm-1"><br/>
											<!--	<?php if (\Entrust::can(('si-history'))) : ?>
								...
								<div class="form-group">
									...
									<button type="button" id="vehicle_info" class="btn btn-primary btn-xs vehicle-info">Vehicle Info</button>
										...
										<div class="col-xs-10" style="float: right;" id="vehicleInfo">
											<div class="col-xs-2">
												<span class="small">Vehicle Reg.No.</span> <input type="text" id="vehicle_regno" name="vehicle_regno" value="<?php echo e(old('vehicle_regno')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">ChasisNo</span> <input type="text" id="chasis_no" name="chasis_no" value="<?php echo e(old('chasis_no')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-2">
												<span class="small">Issue Plate</span> <input type="text" id="issue_plate" name="issue_plate" value="<?php echo e(old('issue_plate')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-1">
												<span class="small">CodePlate</span> <input type="text" id="code_plate" name="code_plate" value="<?php echo e(old('code_plate')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-1">
												<span class="small">Make</span> <input type="text" id="make" name="make" value="<?php echo e(old('make')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-1">
												<span class="small">Model</span> <input type="text" id="model" name="model" value="<?php echo e(old('model')); ?>" readonly class="form-control">
											</div>
											<div class="col-xs-1">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="kilometer" autocomplete="off" value="<?php echo e(old('kilometer')); ?>" name="kilometer" placeholder="Kilometer">
                                    </div>
                                </div>
								<?php } else { ?>
							...
							<div class="form-group">
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
											<tr>
												...
												<td width="6%">
													<select id="txincld_<?php echo e($j); ?>" class="form-control select2 taxinclude" style="width:100%" name="tax_include[]"><option value="0">No</option><option value="1">Yes</option></select>
												</td>
												<td width="9%">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2"></div>
										<div class="col-xs-2">
											<input type="hidden" id="net_amount_hid" name="net_amount_hid" value="<?php echo e(old('net_amount_hid')); ?>" class="form-control" readonly>
...
$('#voucher_date').datepicker( { autoClose: true,dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
...
//$('#voucher_date').datepicker( { dateFormat: 'dd-mm-yyyy',minDate: new Date('<?php echo e($settings->from_date); ?>'),maxDate: new Date('<?php echo e($settings->to_date); ?>') } );
   ...
   $(document).on('click', '.vehicle-info', function(e) { 
	...
	$(document).on('blur', '.line-cost', function(e) {
		...
		var is_itemprofit = <?php echo e($settings->item_profit); ?>;
		if(is_itemprofit==1) {
			var per = <?php echo e($settings->profit_per); ?>;
			//var costtype = <?php echo e($settings->cost_type); ?>;
			var salecost = parseFloat( $('#<?php echo e($settings->cost_type); ?>_'+curNum).val() );//(costtype=='cost_avg')?parseFloat( $('#costavg_'+curNum).val() ):parseFloat( $('#purcost_'+curNum).val() );
...
var supurl = "<?php echo e(url('jobmaster/jobb_data/')); ?>";
...
function getDocument() { 
	...
	if(doc=='SQ')
		var pourl = "<?php echo e(url('job_estimate/get_quotation/')); ?>/"+customer_id+"/QSI";
	else if(doc=='SO')
		var pourl = "<?php echo e(url('job_order/get_order/')); ?>/"+customer_id+"/SOI";
	else if(doc=='CDO')
...
function getJobInvoice() { 
	...
	var ht = $(window).height();
	var wt = $(window).width();
	var pourl = "<?php echo e(url('job_invoice/get_jobinvoice/')); ?>";
	popup = window.open(pourl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
