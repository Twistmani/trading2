...
<?php $__env->startSection('header_styles'); ?>
	...
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendors/datatables/css/dataTables.bootstrap.min.css')); ?>"/> -->
                            ...
                            <div class="table-responsive m-t-10">
                                <table class="table horizontal_table table-striped" id="Acenquiry">
                                    ...
                                    <tr>
										...
										<?php if($isdept): ?><th>Department</th><?php endif; ?>
					...
					<div id="date_modal" class="modal fade animated" role="dialog" >
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form class="form-horizontal" role="form" method="POST" target="_blank" name="frmSearchAccount" id="frmSearchAccount" action="<?php echo e(url('account_enquiry/search_account')); ?>">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									...
									<div id="custom">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" name="date_from" id="date_from" value="<?php echo e(date('d-m-Y',strtotime($settings->from_date))); ?>" class="form-control input-sm" data-language='en' autocomplete="off">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" name="date_to" id="date_to" value="<?php echo e(date('d-m-Y')); ?>" class="form-control input-sm" data-language='en' autocomplete="off">
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												...
												<?php foreach($salesman as $sman): ?>
												<option value="<?php echo e($sman->id.'|'.$sman->name); ?>"><?php echo e($sman->name); ?></option>
												<?php endforeach; ?>
											</select>
											</div>
										</div>
...
$(function() {	
	...
	$(function() {
		...
		var dtInstance = $("#Acenquiry").DataTable({
			...
			"serverSide": true,
			"ajax":{
					 "url": "<?php echo e(url('account_enquiry/suppaging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
					 "data": function(data){
			...
			//{ "data": "group_name" },
			//{ "data": "category_name" },
			<?php if($isdept): ?>{ "data": "department" },<?php endif; ?>
			{ "data": "cl_balance" },
			{ "data": "op_balance" },
...
function updateCB() {
	document.frmAccUtility.action="<?php echo e(url('utilities/updateAccMaster/CB')); ?>";
