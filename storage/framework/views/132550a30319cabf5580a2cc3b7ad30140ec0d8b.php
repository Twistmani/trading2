                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="<?php echo e(url('purchase_invoice/save/'.$docrow->id)); ?>">
								...
								<div class="form-group">
                                   <font color="#16A085">  <label for="input-text" class="col-sm-2 control-label"><b>PI. No.</b></label></font>
									<input type="hidden" name="curno" id="curno" value="<?php echo e($voucherno); ?>"> <input type="hidden" name="vat_no">
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control pull-right" autocomplete="off" name="voucher_date" readonly data-language='en' id="voucher_date" value="<?php echo e(($voucherdt=='')?date('d-m-Y'):$voucherdt); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_no" autocomplete="off" name="lpo_no" value="<?php echo e(old('lpo_no')); ?>" placeholder="LPO No.">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lpo_date" autocomplete="off" name="lpo_date" readonly data-language='en' value="<?php echo e((old('lpo_date'))?old('lpo_date'):$lpodt); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="purchase_account" id="purchase_account" class="form-control" readonly value="<?php echo e($purchaseac); ?>">
										<input type="hidden" name="account_master_id" id="account_master_id" class="form-control" value="<?php echo e($accountmstr); ?>">
									</div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" id="document" readonly name="document_no" value="<?php echo e(old('document')?old('document'):$pordid); ?>" autocomplete="off" onclick="getDocument()">
										<input type="hidden" id="document_id" name="document_id" value="<?php echo e(old('document_id')?old('document_id'):$pordid); ?>">
                                    </div>
                                </div>
								<?php } else { ?>
								...
								<?php if(old('item_code')) { $i = 0; 
									...
									<div class="itemdivChld">
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													<?php if($doctype=='PO' || $doctype=='MR'): ?>
													<input type="hidden" name="purchase_order_item_id[]" id="p_orditmid_<?php echo e($j); ?>" value="<?php echo e(old('purchase_order_item_id')[$i]); ?>">
													<?php elseif($doctype=='SDO'): ?>
													<input type="hidden" name="supplier_do_item_id[]" id="sdo_itemid_<?php echo e($j); ?>" value="<?php echo e(old('supplier_do_item_id')[$i]); ?>">
													<?php endif; ?>
										...
										<table border="0" class="table-dy-row">
											<tr>
												<td width="16%">
													...
													<?php elseif($doctype=='SDO'): ?>
													<input type="hidden" name="supplier_do_item_id[]" id="sdo_itemid_<?php echo e($i); ?>" value="<?php echo e($poitem->id); ?>">
													<?php endif; ?>
													<input type="hidden" name="item_id[]" id="itmid_<?php echo e($i); ?>" value="<?php echo e($poitem->item_id); ?>">
													<input type="text" id="itmcod_<?php echo e($i); ?>" name="item_code[]" class="form-control" autocomplete="off" value="<?php echo e($poitem->item_code); ?>" data-toggle="modal" data-target="#item_modal">
												</td>
												<td width="29%">
												...
												<td width="9%">
													<input type="hidden" id="packing_<?php echo e($i); ?>" name="packing[]" value="<?php echo e(($poitem->is_baseqty==1)?1:$poitem->pkno.'-'.$poitem->packing); ?>">
								...
								<div id="batchdiv_<?php echo e($i); ?>" style="float:left; padding-right:5px;" class="addBatchBtn">
									...
									<div class="form-group"><input type="text" name="batchNos[]" id="batchNos_<?php echo e($i); ?>" style="border:none;color:#FFF;" value="<?php echo e($batchitems[$poitem->id]['batches']); ?>"></div>
									<input type="hidden" id="mfgDates_<?php echo e($i); ?>" name="mfgDates[]" value="<?php echo e($batchitems[$poitem->id]['mfgs']); ?>">
                                    <input type="hidden" id="expDates_<?php echo e($i); ?>" name="expDates[]" value="<?php echo e($batchitems[$poitem->id]['exps']); ?>">
                                    <input type="hidden" id="qtyBatchs_<?php echo e($i); ?>" name="qtyBatchs[]" value="<?php echo e($batchitems[$poitem->id]['qtys']); ?>">
								</div>
								...
								<?php } ?>
											...
											<div class="locPrntItm" id="locPrntItm_<?php echo e($i); ?>">
												<div class="locChldItm">							
													...
													<?php 
														...
														</div><script> if(document.getElementById('iloc_<?php echo e($i); ?>')) { document.getElementById('iloc_<?php echo e($i); ?>').value='<?php echo e($tQty); ?>'; }</script><!--NOV24-->
															<?php  } ?>
													</div>
												</div>
											</div>
											...
											<div class="form-group oc" id="othrcstItm_<?php echo e($i); ?>">
												...
												<div class="col-xs-10">
													...
													<div class="col-xs-2">
														<span class="small">Other Cost/Unit</span> <input type="text" id="othrcst_<?php echo e($i); ?>" value="<?php echo e($poitem->othercost_unit); ?>" step="any" name="othr_cost[]" class="form-control" readonly><!--MY27-->
													</div>
													<div class="col-xs-2">
														<span class="small">Net Cost/Unit</span> <input type="text" id="netcst_<?php echo e($i); ?>" step="any" value="<?php echo e($poitem->netcost_unit); ?>" name="net_cost[]" class="form-control" readonly>
													</div>
													<div class="col-xs-1">
											...
											<table border="0" class="table-dy-row">
												<tr>
													...
													<td width="7%">
														...
														<input type="number" name="oc_rate[]" id="ocrate_<?php echo e($i); ?>" step="any" value="<?php echo e(($row->currency_rate==0)?'':$row->currency_rate); ?>"  class="form-control oc-rate" placeholder="Rate">
													</td>
													<td width="10%">
								...
								<?php } ?>
								<input type="hidden" step="any" id="other_cost" name="other_cost" value="<?php echo e($docrow->other_cost); ?>" readonly class="form-control" placeholder="0">
								<input type="hidden" step="any" id="other_cost_fc" name="other_cost_fc" value="<?php echo e($docrow->other_cost_fc); ?>" readonly class="form-control spl" placeholder="0">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-xs-10">
										...
										<div class="col-xs-2">																								
											<input type="number" step="any" id="net_amount_fc" name="net_amount_fc" class="form-control spl" readonly value="<?php echo e((old('net_amount_fc'))?old('net_amount_fc'):$docrow->net_total); ?>">
										</div>
									</div>
                                </div>
...
$(function() {	
	...
	$(document).on('click', '.loc-info', function(e) { 
	   ...
	   if(item_id!='') {
		   var locUrl = "<?php echo e(url('itemmaster/get_locinfo/')); ?>/"+item_id+"/"+curNum+"/"+pi_id+"/"+dt;
