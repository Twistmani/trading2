                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                             <a href="<?php echo e(url('group/add')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tr>
                                    <td><input type='checkbox' name='groupid[]' class='chk-groupid' value='<?php echo e($group->id); ?>'/></td>
                                    <td><?php echo e($group->group_name); ?></td>
									<td><?php echo e($group->description); ?></td>
                                    <td>
                                        <p>
                                            <button class="btn btn-primary btn-xs" onClick="location.href='<?php echo e(url('group/edit/'.$group->id)); ?>'">
                                    ...
                                    <td>
                                        <p>
                                            <!--<button class="btn btn-danger btn-xs delete"  data-toggle="modal"
                                                    data-target="#delete" data-placement="top" data-id="<?php echo e($group->id); ?>"><span
                                                        class="glyphicon glyphicon-trash"></span></button>-->
											<button class="btn btn-danger btn-xs delete" onClick="funDelete('<?php echo e($group->id); ?>')"><span
                                                        class="glyphicon glyphicon-trash"></span></button>
...
function funDelete(id) {
	...
	if(con==true) {
		var url = "<?php echo e(url('group/delete/')); ?>";
    ...
    if (!checked) {
        ...
        if(con==true) {
           ...
           $('#chkids').val(id);
            ...
            document.frmUnits.action="<?php echo e(url('group/group_delete')); ?>"
