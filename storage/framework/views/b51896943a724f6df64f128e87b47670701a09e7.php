...
<?php $__env->startSection('content'); ?>
    <!-- Content Header (Page header) -->
                    ...
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
							<?php if (\Entrust::can(('qs-create'))) : ?>
                             <a href="<?php echo e(url('quotation/add')); ?>" class="btn btn-primary btn-sm">
		...
		<section class="content">
			<form class="form-horizontal" role="form" method="POST" name="frmQReport" id="frmQReport" target="_blank" action="<?php echo e(url('quotation/search')); ?>">
...
function funDelete(id,no) {
	if(no=='0') {
		...
		if(con==true) {
			var url = "<?php echo e(url('quotation/delete/')); ?>";
...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			"searching": true,
			"ajax":{
					 "url": "<?php echo e(url('quotation/paging/')); ?>",
					 "dataType": "json",
					 "type": "POST",
