                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
							...
							<?php if($printid) { ?>
								 ...
								 <a href="<?php echo e(url('purchase_split_return/print/'.$printid->id.'/'.$print->id)); ?>" target="_blank" class="btn btn-info btn-sm">
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseSplit" id="frmPurchaseSplit" enctype="multipart/form-data" action="<?php echo e(url('purchase_split_return/save')); ?>">
...
$(document).ready(function () { 
	...
	var urlvchr = "<?php echo e(url('purchase_split/checkvchrno/')); ?>";
	var urlcode = "<?php echo e(url('purchase_split/checkrefno/')); ?>"; //CHNG
	$('.sedePrntItm').toggle();
	...
	if(e.value=='') { 
		...
		if($('#department_id').length) {
			...
			var pourl = "<?php echo e(url('purchase_split/ps_data/')); ?>/"+did;
		} else 
			var pourl = "<?php echo e(url('purchase_split/ps_data/')); ?>";
...
$(function() {	
	...
	$('#supplier_name').click(function() {
		if($('#department_id').length)
			supurl2 = "<?php echo e(url('purchase_order/supplier_datadept/')); ?>"+'/'+$('#department_id option:selected').val();
		else
			supurl2 = "<?php echo e(url('purchase_order/supplier_data/')); ?>";
...
function getAccountCr(e) { 
	...
	var res = e.id.split('_');
	var curNum = res[1]; 
	var itmurl = "<?php echo e(url('purchase_split/account_data/')); ?>/"+curNum+"/cr";
	popup = window.open(itmurl, "Popup", "width=900,height=500,top=100,left=200");
	popup.focus();
	return false
}
