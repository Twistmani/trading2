                        ...
                        <div class="panel-body">
                            <div class="table-responsive m-t-10"> <button type="button" class="btn btn-primary createCust">Create Vehicle</button>
                                <table class="table horizontal_table table-striped" id="tableVehList">
                                    ...
                                    <tr>
                                        <td><a href="" class="vclRow" data-id="<?php echo e($vehicle->id); ?>" data-name="<?php echo e($vehicle->name); ?>" data-custid="<?php echo e($vehicle->cust_id); ?>" data-custname="<?php echo e($vehicle->master_name); ?>" data-regno="<?php echo e($vehicle->reg_no); ?>" data-issue="<?php echo e($vehicle->issue_plate); ?>" data-code="<?php echo e($vehicle->code_plate); ?>" data-chasis="<?php echo e($vehicle->chasis_no); ?>" data-make="<?php echo e($vehicle->make); ?>" data-model="<?php echo e($vehicle->model); ?>" data-dismiss="modal"><?php echo e($vehicle->reg_no); ?></a></td>
                                        <td><a href="" class="vclRow" data-id="<?php echo e($vehicle->id); ?>" data-name="<?php echo e($vehicle->name); ?>" data-custid="<?php echo e($vehicle->cust_id); ?>" data-custname="<?php echo e($vehicle->master_name); ?>" data-regno="<?php echo e($vehicle->reg_no); ?>" data-issue="<?php echo e($vehicle->issue_plate); ?>" data-code="<?php echo e($vehicle->code_plate); ?>" data-chasis="<?php echo e($vehicle->chasis_no); ?>" data-make="<?php echo e($vehicle->make); ?>" data-model="<?php echo e($vehicle->model); ?>" data-dismiss="modal"><?php echo e($vehicle->name); ?></a></td>
                                        <td><?php echo e($vehicle->issue_plate); ?></td>
										<td><?php echo e($vehicle->code_plate); ?></td>
...
$(function() {
	...
	$('#createV').on('click', function(e) { 
		...
		if(vn=="") {
			...
			$.ajax({
				url: "<?php echo e(url('job_estimate/ajax_create/')); ?>",
				type: 'get',
