	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->pwidth, $this->pheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->pthumbWidth, $this->pthumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				 $pimage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->vwidth, $this->vheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->vthumbWidth, $this->vthumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$vimage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->lwidth, $this->lheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->lthumbWidth, $this->lthumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$limage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->hwidth, $this->hheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->hthumbWidth, $this->hthumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$himage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->iwidth, $this->iheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->ithumbWidth, $this->ithumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$iimage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->mewidth, $this->meheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->methumbWidth, $this->methumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$meimage = rand(1, 999).$fname.'.'.$ext;
	...
	{ 
		...
		if($file) {
			...
			if($ext=='.jpg' ||$ext=='.JPG' || $ext=='.png' || $ext=='.PNG') {
				...
				// resizing an uploaded file
				Image::make($file->getRealPath())->resize($this->fwidth, $this->fheight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPath);

				// thumb
				Image::make($file->getRealPath())->resize($this->fthumbWidth, $this->fthumbHeight, function($constraint) { $constraint->aspectRatio(); })->save($destinationPathThumb);
			} else {
				$fimage = rand(1, 999).$fname.'.'.$ext;
