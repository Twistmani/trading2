...
class AccountSettingRepository extends AbstractValidator implements AccountSettingInterface {
	...
	public function create($attributes)
	{
		if($this->isValid($attributes)) { 
			...
			$this->accountsetting->created_at = date('Y-m-d H:i:s');
	...
	{	//echo '<pre>';print_r($attributes);exit;
		...
		if($this->isValid($attributes, ['voucher_name' => 'required'])) {
			...
			$this->accountsetting->bank_account_id = isset($attributes['drbank_account_master_id'])?$attributes['drbank_account_master_id']:'';
			$this->accountsetting->pdc_account_id = isset($attributes['drpdc_account_master_id'])?$attributes['drpdc_account_master_id']:'';
			$this->accountsetting->modified_at = date('Y-m-d H:i:s');
			$this->accountsetting->is_cash_voucher = $attributes['is_cash_voucher'];
			$this->accountsetting->default_account_id = isset($attributes['cash_account_id'])?$attributes['cash_account_id']:'';
	...
	{ //echo $type;exit;
		switch($type) {
			case 1:
				$count = DB::table('purchase_invoice')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 2:
				$count = DB::table('purchase_return')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 3:
				$count = DB::table('sales_invoice')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 4:
				$count = DB::table('sales_return')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 5:
				$count = DB::table('journal')->where('voucher_type','PIN')->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 6:
				$count = DB::table('journal')->where('voucher_type','SIN')->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 7:
				$count = DB::table('credit_note')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 8:
				$count = DB::table('debit_note')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 9:
				$count = DB::table('receipt_voucher')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 10:
				$count = DB::table('payment_voucher')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 13:
				$count = DB::table('goods_issued')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 14:
				$count = DB::table('goods_return')->where('voucher_id',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 16:
				$count = DB::table('journal')->where('voucher_type','JV')->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 20:
				$count = DB::table('petty_cash')->where('voucher_type','PC')->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 21:
				$count = DB::table('stock_transferin')->where('voucher_no',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 22:
				$count = DB::table('stock_transferout')->where('voucher_no',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 15:
				$count = DB::table('manufacture')->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 23:
				$count = DB::table('purchase_split')->where('voucher_no',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
			...
			case 24:
				$count = DB::table('sales_split')->where('voucher_no',$id)->where('deleted_at','0000-00-00 00:00:00')->count();
				if($count > 0)
					return false;
				else
					return true;
