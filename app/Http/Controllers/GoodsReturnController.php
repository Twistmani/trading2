...
class GoodsReturnController extends Controller
{
	...
	public function save($id = null) {
		...
		$this->goods_return->create(Input::all());//exit;
	...
	{
		$this->goods_return->update($id, Input::all());
		//AUTO COST REFRESH CHECK ENABLE OR NOT
		if($this->mod_autocost->is_active==1) {
			$this->objUtility->reEvalItemCostQuantity(Input::get('item_id'),$this->acsettings);
		}
	...
	public function checkRefNo() {
		...
		$check = $this->goods_return->check_reference_no(Input::get('reference_no'), Input::get('id'));
	...
	public function getSearch()
	{
		...
		$report = $this->goods_return->getReport(Input::all());
	...
	{
		$data = array();
		$reports = $this->goods_return->getReport(Input::all());
