...
class SalesOrderController extends Controller
{
	...
	public function Settlement($id){
       	...
       	public function saveDraft(Request $request) { //echo '<pre>';print_r(Input::all());exit;
	...
	public function checkVchrNo() { 
		...
		$check = $this->sales_order->check_voucher_no(Input::get('voucher_no'), Input::get('id'));
		$isAvailable = ($check) ? false : true;
		echo json_encode(array(
							'valid' => $isAvailable,
						));
