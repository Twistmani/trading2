...
class DashboardController extends Controller
{
    ...
    {	//echo Auth::user()->roles[0]->name;
		...
		/* Session::set('company', $company->company_name);
		Session::set('city', $company->city);
		Session::set('state', $company->state);
		Session::set('country', $company->country);
		Session::set('address', $company->address);
		Session::set('pin', $company->pin);
		Session::set('phone', $company->phone);
		Session::set('vatno', $company->vat_no);
		Session::set('logo', $company->logo);
