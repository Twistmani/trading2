...
Route::group(['middleware' => ['web']], function () {
	...
	Route::group(['middleware' => ['auth']], function() { 
		...
		Route::get('/dashboard/get_settings', 'DashboardController@getSettings');
		Route::get('/dashboard/setting_update', "DashboardController@settingUpdate");
		Route::get('/dashboard/setting_delete/{id}', "DashboardController@settingDelete");
		Route::get('/dashboard/get_advsettings', 'DashboardController@getadvSettings');
		Route::get('/dashboard/advsetting_update', "DashboardController@advsettingUpdate");
		Route::get('/dashboard/advsetting_delete/{id}', "DashboardController@advsettingDelete");
		Route::get('/dashboard/get_contract_expiry', 'DashboardController@getContractExpiry');
		Route::get('/dashboard/pv_approve/{id}', 'DashboardController@pvApprove');
		Route::get('/dashboard/approval_alert', 'DashboardController@approvalAlert');
		...
		Route::get('/itemmaster/get_dimn_info/{id}', 'ItemmasterController@getDimnInfo');
		Route::get('/itemmaster/batch-view', 'ItemmasterController@getBatchView');
		Route::get('/itemmaster/check_batchno', 'ItemmasterController@checkBatchno');
		Route::get('/itemmaster/batch-get', 'ItemmasterController@getBatchGet');
		Route::get('/itemmaster/get_batch/{id}', 'ItemmasterController@getBatch');
		...
		Route::get('/itemmaster/get_langtrans', 'ItemmasterController@getLangTrans');
		...
		Route::get('/itemmaster/get_rawmatwe/{id}', 'ItemmasterController@getRawmatWe');
		...
		Route::get('/currency/getcurrency/{id}', 'CurrencyController@getCurrency');
		...
		Route::get('/location/bin_data/{n}', 'LocationController@getBin');
		Route::get('/location/ajax_create', 'LocationController@ajaxSave');
		...
		Route::get('/jobmaster/jobb_data', "JobmasterController@getJobbdata");
     ...
     Route::post('/accategory/destroy', ['uses' => 'AccategoryController@destroyCate']);
       //Route::post('/accategory/destroy', 'AccategoryController@destroy');
		...
		Route::get('/account_master/get_account_list/{code}/{n}', 'AccountMasterController@getAccountList');
		...
		Route::get('/account_master/get_account_all', 'AccountMasterController@getAccountAll');
		...
		Route::get('/account_master/get_accounts', 'AccountMasterController@getAccounts');
		...
		Route::get('/account_master/checkacno', 'AccountMasterController@checkacno');
		...
		Route::get('/account_enquiry/bank', "AccountEnquiryController@indexBank");
		Route::get('/account_enquiry/cash', "AccountEnquiryController@indexCash");
		...
		Route::post('/account_enquiry/bankpaging', 'AccountEnquiryController@ajaxBankPaging');
		Route::post('/account_enquiry/cashpaging', 'AccountEnquiryController@ajaxCashPaging');
		...
		Route::get('/account_enquiry/os_bills_adv/{id}', 'AccountEnquiryController@outStandingBillsAdv');
		...
		Route::get('/account_setting/check-accounts', 'AccountSettingController@checkAccounts');
		...
		Route::get('/purchase_order/viewonly/{id}', ['as' => 'purchase_order.viewonly', 'uses' => 'PurchaseOrderController@viewonly', 'middleware' => ['permission:po-view']]);
		...
		Route::get('/purchase_order/checkvchrno', 'PurchaseOrderController@checkVchrNo');
		Route::get('/purchase_order/add-from-so/{id}/{n}', 'PurchaseOrderController@addFromSo');
		Route::get('/purchase_order/views/{id}','PurchaseOrderController@getViews');
		Route::get('/purchase_order/approve/{id}', 'PurchaseOrderController@getApproval');
        Route::get('/purchase_order/settlement/{id}', "PurchaseOrderController@Settlement");//April 2025 
        Route::get('/purchase_order/getjob/{id}', "PurchaseOrderController@getJob");
        Route::get('/purchase_order/refresh_po/{id}', "PurchaseOrderController@refreshPO");
        
        Route::post('/purchase_order/save_draft', "PurchaseOrderController@saveDraft");//Draft
		Route::get('/purchase_order/edit_draft/{id}', "PurchaseOrderController@editDraft");
		Route::post('/purchase_order/update_draft/{id}', "PurchaseOrderController@updateDraft");
	...
	Route::post('/employee/save', 'EmployeeController@save');
		...
		Route::get('/employee/payrise/{id}', 'EmployeeController@payrise');
		Route::post('/employee/payrise/update', 'EmployeeController@payriseUpdate');
		
		
		Route::get('/emp_category', "EmployeeCategoryController@index");
		Route::get('/emp_category/add', 'EmployeeCategoryController@add');
		Route::post('/emp_category/save', 'EmployeeCategoryController@save');
		Route::get('/emp_category/edit/{id}', 'EmployeeCategoryController@edit');
		Route::post('/emp_category/update/{id}', 'EmployeeCategoryController@update');
		Route::get('/emp_category/delete/{id}', 'EmployeeCategoryController@destroy');
		Route::post('/emp_category/group_delete', ['uses' => 'EmployeeCategoryController@destroyGroup']);
		Route::get('/emp_category/checkname', 'EmployeeCategoryController@checkname');
		...
		Route::get('/quotation/viewonly/{id}', 'QuotationController@viewonly');
		...
		Route::get('/quotation/checkvchrno', 'QuotationController@checkVchrNo');
		Route::post('/quotation/import', "QuotationController@getImport");
		...
		Route::get('/suppliers_do/viewonly/{id}', 'SuppliersDOController@viewonly');
		...
		Route::get('/suppliers_do/getjob/{id}', "SuppliersDOController@getJob");
		Route::get('/suppliers_do/refresh_sdo/{id}', "SuppliersDOController@refreshSDO");
		...
		Route::get('/purchase_invoice/viewonly/{id}', ['as' => 'purchase_invoice.viewonly', 'uses' => 'PurchaseInvoiceController@viewonly', 'middleware' => ['permission:pi-view']]);
		...
		Route::get('/purchase_invoice/getjob/{id}', "PurchaseInvoiceController@getJob");
		...
		Route::get('/purchase_return/viewonly/{id}', 'PurchaseReturnController@viewonly');
		...
		Route::get('/purchase_return/getjob/{id}', "PurchaseReturnController@getJob");
		...
		Route::get('/quotation_sales/viewonly/{id}', ['as' => 'quotation_sales.viewonly', 'uses' => 'QuotationSalesController@viewonly', 'middleware' => ['permission:qs-view']]);
		...
		Route::post('/quotation_sales/import', "QuotationSalesController@getImport");
		Route::get('/quotation_sales/views/{id}','QuotationSalesController@getViews');
		Route::get('/quotation_sales/approve/{id}', 'QuotationSalesController@getApproval');
		Route::get('/quotation_sales/getjob/{id}', "QuotationSalesController@getJob");
		Route::get('/quotation_sales/refresh_qs/{id}', "QuotationSalesController@refreshQS");
		...
		Route::get('/sales_order/viewonly/{id}', ['as' => 'sales_order.viewonly', 'uses' => 'SalesOrderController@viewonly', 'middleware' => ['permission:so-view']]);
		...
		Route::post('/sales_order/customer_list', "SalesOrderController@ajaxCustomerList"); 
		Route::get('/sales_order/account_data/{type}', "SalesOrderController@getAccount");
		//work order
		Route::get('/sales_order/revice/{id}', "SalesOrderController@revice");
		Route::get('/sales_order/work_order', "SalesOrderController@windex");
		Route::post('/sales_order/work_paging', 'SalesOrderController@ajaxWorkPaging');
		
		Route::get('/sales_order/settlement/{id}', "SalesOrderController@Settlement");//April 2025 
		Route::get('/sales_order/getjob/{id}', "SalesOrderController@getJob");
		Route::get('/sales_order/getworkjob/{id}', "SalesOrderController@getWorkJob");
		
		
		Route::post('/sales_order/save_draft', "SalesOrderController@saveDraft");//Draft
		Route::get('/sales_order/edit_draft/{id}', "SalesOrderController@editDraft");
		Route::post('/sales_order/update_draft/{id}', "SalesOrderController@updateDraft");
		
		Route::get('/sales_order/refresh_so/{id}', "SalesOrderController@refreshSO");
		...
		Route::get('/customers_do/viewonly/{id}', ['as' => 'customers_do.viewonly', 'uses' => 'CustomersDOController@viewonly', 'middleware' => ['permission:do-view']]);
		...
		Route::get('/customers_do/getjob/{id}', "CustomersDOController@getJob");
		Route::get('/customers_do/refresh_do/{id}', "CustomersDOController@refreshDO");
		...
		Route::get('/sales_invoice/viewonly/{id}', ['as' => 'sales_invoice.viewonly', 'uses' => 'SalesInvoiceController@viewonly', 'middleware' => ['permission:si-view']]);
		...
		Route::get('/sales_invoice/salesman_data/{n}', "SalesInvoiceController@getSalesman");
		...
		Route::get('/sales_invoice/refresh_do/{id}', "SalesInvoiceController@refreshDO");
		Route::get('/sales_invoice/getjob/{id}', "SalesInvoiceController@getJob");
		...
		Route::get('/sales_return/viewonly/{id}', ['as' => 'sales_return.viewonly', 'uses' => 'SalesReturnController@viewonly', 'middleware' => ['permission:sr-view']]);
		...
		Route::post('/sales_return/export', ['as' => 'sales_return.dataExport', 'uses' => 'SalesReturnController@dataExport', 'middleware' => ['permission:sr-print']]);
		...
		Route::get('/sales_return/getjob/{id}', "SalesReturnController@getJob");
		...
		Route::get('/customer_receipt/delete/{id}/{n}', ['as' => 'customer_receipt.destroy', 'uses' => 'CustomerReceiptController@destroy', 'middleware' => ['permission:rv-delete']]);
		...
		Route::get('/customer_receipt/add-rv', ['as'=>'customer_receipt.add','uses'=>'CustomerReceiptController@addRV','middleware' => ['permission:rv-create']]);
		Route::get('/customer_receipt/set_transactions/{type}/{id}/{n}', "CustomerReceiptController@setTransactions");
		...
		Route::get('/supplier_payment/views/{id}','SupplierPaymentController@getViews');
		Route::get('/supplier_payment/approve/{id}', 'SupplierPaymentController@getApproval');

		Route::get('/supplier_payment/quick-add', ['as'=>'supplier_payment.add','uses'=>'SupplierPaymentController@quickAdd','middleware' => ['permission:pv-create']]);
		
		//NEW SECTION FEB25
		Route::get('/supplier_payment/add-pv', ['as'=>'supplier_payment.add-pv','uses'=>'SupplierPaymentController@addPV','middleware' => ['permission:pv-create']]);
		Route::get('/supplier_payment/set_transactions/{type}/{id}/{n}', "SupplierPaymentController@setTransactions");
		
		
		//New feb25
		Route::get('/receipt_voucher', ['as' => 'receipt_voucher.index', 'uses' => 'CustomerReceiptController@indexrv', 'middleware' => ['permission:rv-list|rv-create|rv-edit|rv-delete']]);
		Route::get('/receipt_voucher/add', ['as'=>'receipt_voucher.add','uses'=>'CustomerReceiptController@addjrv','middleware' => ['permission:rv-create']]);
		Route::post('/receipt_voucher/save', "CustomerReceiptController@saverv");
		Route::post('/receipt_voucher/paging', 'CustomerReceiptController@ajaxPagingrv');
		Route::get('/receipt_voucher/edit/{id}', ['as' => 'receipt_voucher.edit', 'uses' => 'CustomerReceiptController@editrv', 'middleware' => ['permission:rv-edit']]);
		Route::get('/receipt_voucher/printgrprv/{id}', ['as' => 'customer_receipt.getGrpPrintrv', 'uses' => 'CustomerReceiptController@getGrpPrintrv', 'middleware' => ['permission:rv-print']]);

		
		Route::get('/payment_voucher', ['as' => 'payment_voucher.index', 'uses' => 'SupplierPaymentController@indexpv', 'middleware' => ['permission:si-list|pv-create|pv-edit|pv-delete']]);
		Route::get('/payment_voucher/add', ['as'=>'payment_voucher.add','uses'=>'SupplierPaymentController@addjpv','middleware' => ['permission:pv-create']]);
		Route::post('/payment_voucher/save', "SupplierPaymentController@savepv");
		Route::post('/payment_voucher/paging', 'SupplierPaymentController@ajaxPagingpv');
		Route::get('/payment_voucher/edit/{id}', ['as' => 'payment_voucher.edit', 'uses' => 'SupplierPaymentController@editpv', 'middleware' => ['permission:pv-edit']]);

		Route::get('/contra_voucher', ['as' => 'contra_voucher.index', 'uses' => 'ContraVoucherController@index']);
		Route::get('/contra_voucher/add', ['as'=>'contra_voucher.add','uses'=>'ContraVoucherController@add']);
		Route::post('/contra_voucher/save', "ContraVoucherController@save");
		Route::get('/contra_voucher/delete/{id}', ['as' => 'ContraVoucherController.destroy', 'uses' => 'ContraVoucherController@destroy']);
		Route::get('/contra_voucher/edit/{id}', ['as'=>'contra_voucher.edit','uses'=>'ContraVoucherController@edit']);
		Route::post('/contra_voucher/update/{id}', 'ContraVoucherController@update');
        Route::get('/contra_voucher/printgrp/{id}/{rid}', ['as'=>'contra_voucher.printgrp','uses'=>'ContraVoucherController@printGrp']);
        Route::get('/contra_voucher/checkvchrno', 'ContraVoucherController@checkVchrNo');
		...
		Route::get('/pdc_received/delete/{id}', 'PdcReceivedController@delete');
		...
		Route::get('/pdc_issued/delete/{id}', 'PdcIssuedController@delete');
		...
		Route::get('/journal/checkvno', 'JournalController@checkVNo');
		...
		Route::get('/journal/set_transactions/{type}/{id}/{n}/{j}', "JournalController@setTransactions");
		Route::post('/journal/paging', 'JournalController@ajaxPaging');
		Route::post('/journal/recurring_add', 'JournalController@recurringAdd');
		Route::post('/journal/quicksave', "JournalController@quickSave");
		Route::get('/journal/add-jv', ['as'=>'journal.add','uses'=>'JournalController@addJV','middleware' => ['permission:jv-create']]);
		...
		Route::get('/cash_inhand', "CashInhandController@index");
		Route::post('/cash_inhand/search', "CashInhandController@getSearch");
		Route::post('/cash_inhand/export', 'CashInhandController@dataExport');
		...
		Route::get('/batch_report', "BatchReportController@index");
		Route::post('/batch_report/search', "BatchReportController@getSearch");
		Route::post('/batch_report/export', 'BatchReportController@dataExport');
		...
		Route::get('/goods_issued/viewonly/{id}', 'GoodsIssuedController@viewonly');
		...
		Route::get('/goods_issued/checkvchrno', 'GoodsIssuedController@checkVchrNo');
		...
		Route::get('/goods_return/viewonly/{id}', 'GoodsReturnController@viewonly');
		...
		Route::get('/job_report/vehicleindex', "JobReportController@vehicleIndex");
		Route::get('/job_report/vehicle_search/{val}', "JobReportController@vehicleSearch");
		Route::get('/job_report/job_details/{id}', 'JobReportController@jobDetails');
		
		//work order report
		Route::get('/job_report/jobindex', "JobReportController@jobIndex");
		Route::get('/job_report/sojob_search/{val}', "JobReportController@sojobSearch");
		Route::get('/job_report/workjob_details/{id}', 'JobReportController@workjobDetails');
		...
		Route::post('/utilities/inventory-log-update/{doc}', "UtilityController@inventoryLogUpdate");
		Route::post('/utilities/update-cos/{doc}', "UtilityController@UpdateCOS");
		Route::post('/utilities/update-sih/{doc}', "UtilityController@UpdateSIH");
		...
		Route::post('/pettycash/paging', 'PettyCashController@ajaxPaging');
		...
		Route::get('/pettycash/printgrp/{id}', ['as' => 'pettycash.getGrpPrint', 'uses' => 'PettyCashController@getGrpPrint', 'middleware' => ['permission:pc-print']]);
		...
		Route::get('/pettycash/quick-add', ['as'=>'pettycash.add','uses'=>'PettyCashController@quickAdd','middleware' => ['permission:pc-create']]);

		Route::get('/pettycash/add-pc', ['as'=>'pettycash.add','uses'=>'PettyCashController@addPC','middleware' => ['permission:pc-create']]);
		Route::get('/pettycash/edit-pc/{id}', ['as' => 'pettycash.edit', 'uses' => 'PettyCashController@edit', 'middleware' => ['permission:pc-edit']]);
		...
		Route::post('/sales_voucher/paging', 'SalesVoucherController@ajaxPaging');
		...
		Route::post('/pdc_report/export', "PdcReportController@dataExport");
		...
		Route::get('/year_endingquick', "YearendingquickController@index");
		Route::post('/year_ending/quickbackup', "YearendingquickController@backup");
		Route::get('/year_endingquick/step2', "YearendingquickController@step2");
		Route::post('/year_endingquick/step2_quicksubmit', "YearendingquickController@step2Submit");
		
		Route::get('/job_estimate', ['as' => 'job_estimate.index', 'uses' => 'JobEstimateController@index', 'middleware' => ['permission:qs-list|qs-create|qs-edit|qs-delete']]);
		Route::get('/job_estimate/add', ['as'=>'job_estimate.add','uses'=>'JobEstimateController@add','middleware' => ['permission:qs-create']]);
		Route::get('/job_estimate/add/{id}/{n}',['as'=>'job_estimate.add','uses'=>'JobEstimateController@add','middleware' => ['permission:qs-create']]);
		Route::post('/job_estimate/save', ['as' => 'job_estimate.save', 'uses' => 'JobEstimateController@save', 'middleware' => ['permission:qs-create']] );
		Route::get('/job_estimate/edit/{id}', ['as' => 'job_estimate.edit', 'uses' => 'JobEstimateController@edit', 'middleware' => ['permission:qs-edit']]);
		Route::post('/job_estimate/update/{id}', ['as' => 'job_estimate.update', 'uses' => 'JobEstimateController@update', 'middleware' => ['permission:qs-edit']]);
		...
		Route::get('/job_estimate/delete/{id}', ['as' => 'job_estimate.destroy', 'uses' => 'JobEstimateController@destroy', 'middleware' => ['permission:qs-delete']]);
		...
		Route::get('/job_estimate/get_estimate', "JobEstimateController@getEstimate");
			Route::post('/job_estimate/upload', 'JobEstimateController@uploadSubmit');

		Route::get('/job_estimate/print/{id}', ['as' => 'job_estimate.getPrint', 'uses' => 'JobEstimateController@getPrint', 'middleware' => ['permission:qs-print']]);
		...
		Route::post('/job_estimate/export', ['as' => 'job_estimate.dataExport', 'uses' => 'JobEstimateController@dataExport', 'middleware' => ['permission:qs-print']]);
		...
		Route::get('/job_estimate/docs/{id}', 'JobEstimateController@getDocs'); //OCT24
		Route::get('/job_estimate/views/{id}','JobEstimateController@getViews'); 
		Route::get('/job_estimate/add/{id}', 'JobEstimateController@add');
		...
		Route::get('/job_order/viewonly/{id}', ['as' => 'job_order.viewonly', 'uses' => 'JobOrderController@viewonly', 'middleware' => ['permission:job-order-view']]);
		...
		Route::get('/job_order/docs/{id}', 'JobOrderController@getDocs'); //OCT24
		...
		Route::get('/job_invoice/viewonly/{id}', ['as' => 'job_invoice.viewonly', 'uses' => 'JobInvoiceController@viewonly', 'middleware' => ['permission:job-invoice-view']]);
		...
		Route::get('/job_invoice/docs/{id}', 'JobInvoiceController@getDocs'); //OCT24
		...
		Route::get('/stock_transferin/viewonly/{id}', "StockTransferinController@viewonly");
		...
		Route::get('/stock_transferin/checkvchrno', 'StockTransferinController@checkVchrNo');
		...
		Route::get('/stock_transferout/viewonly/{id}', "StockTransferoutController@viewonly");
		...
		Route::get('/stock_transferout/checkvchrno', 'StockTransferoutController@checkVchrNo');
		...
		Route::get('/importdata/accounts_master', "ImportDataController@importAccountMaster");
		...
		Route::get('/importdata/opn-balance-sup', "ImportDataController@importOpnBalanceSup");
		Route::get('/importdata/cust-vehicle', "ImportDataController@importCustVehicle");
		Route::get('/importdata/jobmaster', "ImportDataController@importJobmaster");
		Route::get('/importdata/joborder', "ImportDataController@importJoborder");
		Route::get('/importdata/tallyitems', "ImportDataController@importTallyItems");
		...
		Route::get('/pay_slip/employee/{id}/{m}/{y}', "PaySlipController@employeeSlip");
		
		
		Route::get('/wage_entry/timesheet', "WageEntryController@timesheetadd");
        Route::get('/wage_entry/timesheet/{eid}/{cid}', "WageEntryController@timesheetadd");
        Route::post('/wage_entry/timesheet/save', "WageEntryController@timesheetSave"); 
        Route::get('/wage_entry/subjob_template/{jid}/{n}', "WageEntryController@subJobTemplate");
		Route::post('/wage_entry/subjob_template/save', "WageEntryController@subJobTemplateSave");
		Route::get('/wage_entry/subjob_template/edit/{jid}/{n}/{wid}', "WageEntryController@subJobTemplateEdit");
		Route::get('/wage_entry/subjob_template/view/{n}/{wid}/{tid}', "WageEntryController@subJobTemplateView");
		Route::get('/wage_entry/timesheet/edit', "WageEntryController@timesheetEdit");
        Route::get('/wage_entry/timesheet/edit/{eid}/{cid}/{m}', "WageEntryController@timesheetEdit");
		Route::post('/wage_entry/timesheet/update', "WageEntryController@timesheetUpdate");
		Route::get('/wage_entry/timesheet/view', "WageEntryController@timesheetView");
        Route::get('/wage_entry/timesheet/view/{eid}/{cid}/{m}', "WageEntryController@timesheetView");
		Route::post('/wage_entry/timesheet/approve', "WageEntryController@timesheetApprove");
		
		Route::get('/wage_entry/timesheet/leave', "WageEntryController@timesheetLeave");
		Route::post('/wage_entry/timesheet/leave_search', "WageEntryController@timesheetLeaveSearch");
		Route::get('/wage_entry/time/leave_edit/{id}', "WageEntryController@timesheetLeaveEdit");
		Route::post('/wage_entry/time/leave_update/{id}', "WageEntryController@timesheetLeaveUpdate");
        Route::post('/wage_entry/leave/upload', 'WageEntryController@uploadSubmit');
		Route::get('/wage_entry/leave/approve/{id}', "WageEntryController@timesheetLeaveApprove");
		
		
			Route::get('/timesheet_report', "TimesheetReportController@index");
		Route::post('/timesheet_report/search', 'TimesheetReportController@getSearch');
		Route::get('/timesheet_report/payroll', "TimesheetReportController@payroll");
        Route::post('/timesheet_payrollreport/search', 'TimesheetReportController@getpayrollSearch');
		...
		Route::post('/customer_enquiry/import', "CustomerEnquiryController@getImport");
		Route::get('/customer_enquiry/getjob/{id}', "CustomerEnquiryController@getJob");
		...
		Route::post('/production/export', ['as' => 'production.dataExport', 'uses' => 'ProductionController@dataExport', 'middleware' => ['permission:do-print']]);
		...
		Route::get('/production/planning/{id}', ['as' => 'production.planning', 'uses' => 'ProductionController@planning', 'middleware' => ['permission:do-edit']]);
		Route::get('/production/get_data', "ProductionController@getProdata");
		Route::get('/production/item_details/{id}', "ProductionController@getItemDetails");
		Route::get('/production/getjob/{id}', "ProductionController@getJob");
		...
		Route::get('/manufacture/viewonly/{id}', ['as' => 'manufacture.viewonly', 'uses' => 'ManufactureController@viewonly', 'middleware' => ['permission:pi-view']]);
		Route::get('/manufacture/print/{id}', 'ManufactureController@getPrint');
		Route::post('/manufacture/printexport', "ManufactureController@printExport");
		...
		Route::get('/manufacture/getvoucher/{id}', "ManufactureController@getVoucher");
		Route::get('/manufacture/add/{id}', ['as' => 'manufacture.add', 'uses' => 'ManufactureController@add', 'middleware' => ['permission:pi-create']]);
		...
		Route::get('/purchase_split/cash_data/{cum}', "PurchaseSplitController@getCash");
		Route::get('/purchase_split/ps_data', "PurchaseSplitController@getPS");
		Route::get('/purchase_split/ps_data/{did}', "PurchaseSplitController@getPS");
		Route::get('/purchase_split/item_details/{id}', "PurchaseSplitController@getItemDetails");
		
		
		Route::get('/purchase_split_return', "PurchaseSplitReturnController@index");
		Route::get('/purchase_split_return/add', "PurchaseSplitReturnController@add");
		Route::get('/purchase_split_return/add/{id}', "PurchaseSplitReturnController@add");
		Route::post('/purchase_split_return/save/{id}', 'PurchaseSplitReturnController@save');
		Route::post('/purchase_split_return/save', 'PurchaseSplitReturnController@save');
		Route::get('/purchase_split_return/edit/{id}', 'PurchaseSplitReturnController@edit');
        Route::post('/purchase_split_return/search', "PurchaseSplitReturnController@getSearch");

		Route::get('/purchase_split_return/delete/{id}', 'PurchaseSplitReturnController@destroy');
		Route::get('/purchase_split_return/checkrefno', 'PurchaseSplitReturnController@checkRefNo');
		Route::get('/purchase_split_return/print/{id}', "PurchaseSplitReturnController@getPrint");
		Route::get('/purchase_split_return/checkvchrno', 'PurchaseSplitReturnController@checkVchrNo');
		Route::post('/purchase_split_return/paging', 'PurchaseSplitReturnController@ajaxPaging');
		Route::post('/purchase_split_return/update/{id}', 'PurchaseSplitReturnController@update');
		Route::get('/purchase_split_return/print/{id}/{rid}', "PurchaseSplitReturnController@getPrint");
		Route::post('/purchase_split_return/export', "PurchaseSplitReturnController@dataExport");
		Route::get('/purchase_split_return/getcustomer', "PurchaseSplitReturnController@getCustomer");
		Route::get('/purchase_split_return/cash_data/{cum}', "PurchaseSplitReturnController@getCash");
		...
		Route::get('/sales_split/split_data', "SalesSplitController@getSplit");
		Route::get('/sales_split/split_data/{did}', "SalesSplitController@getSplit");
		Route::post('/sales_split/paging_split_data', 'SalesSplitController@ajaxPagingSplitData');
		Route::get('/sales_split/item_details/{id}', "SalesSplitController@getItemDetails");
		Route::post('/sales_split/export', "SalesSplitController@dataExport");
		Route::post('/sales_split/search', "SalesSplitController@getSearch");
		...
		Route::get('/sales_split_return', "SalesSplitReturnController@index");
		Route::get('/sales_split_return/add', "SalesSplitReturnController@add");
		Route::get('/sales_split_return/add/{id}', "SalesSplitReturnController@add");
		Route::post('/sales_split_return/save/{id}', 'SalesSplitReturnController@save');
		Route::post('/sales_split_return/save', 'SalesSplitReturnController@save');
		Route::get('/sales_split_return/edit/{id}', 'SalesSplitReturnController@edit');
		Route::get('/sales_split_return/delete/{id}', 'SalesSplitReturnController@destroy');
		Route::get('/sales_split_return/checkrefno', 'SalesSplitReturnController@checkRefNo');
		Route::get('/sales_split_return/print/{id}', "SalesSplitReturnController@getPrint");
		Route::get('/sales_split_return/checkvchrno', 'SalesSplitReturnController@checkVchrNo');
		Route::post('/sales_split_return/paging', 'SalesSplitReturnController@ajaxPaging');
		Route::post('/sales_split_return/update/{id}', 'SalesSplitReturnController@update');
		Route::get('/sales_split_return/print/{id}/{rid}', "SalesSplitReturnController@getPrint");
		Route::post('/sales_split_return/export', "SalesSplitReturnController@dataExport");
		Route::post('/sales_split_return/search', "SalesSplitReturnController@getSearch");
		Route::post('/sales_split_return/export', "SalesSplitReturnController@dataExport");
		Route::post('/sales_split_return/search', "SalesSplitReturnController@getSearch");
		Route::get('/sales_split_return/getcustomer', "SalesSplitReturnController@getCustomer"); 
		//
		...
		Route::get('/buildingmaster/getvals/{id}', 'BuildingMasterController@getValues');
		Route::get('/buildingmaster/get_flat/{id}', 'BuildingMasterController@getFlat');
		...
		Route::get('/manual_journal/printgrp/{id}', "ManualJournalController@getPrintgrp");
		Route::get('/manual_journal/print/{id}/{rid}', "ManualJournalController@getPrint");
	...
	//Route::get('/cheque_details/bank_data', "SalesOrderController@getBank");	
		...
		Route::post('/contract-connection/readsave', 'ContractConnectionController@readUpdate');
		...
		Route::get('/contract-connection/reading-add', 'ContractConnectionController@readingAdd');
		Route::get('/contract-connection/getreading/{cid}/{fid}/{type}', 'ContractConnectionController@getReading');
		Route::get('/contract-connection/disconnection-add', 'ContractConnectionController@disconnectAdd');
		Route::post('/contract-connection/disconsave', 'ContractConnectionController@disconUpdate');
		Route::get('/contract-connection/disconnection-list', 'ContractConnectionController@disconnectionList');
		Route::get('/contract-connection/print_all/{id}', 'ContractConnectionController@printAll');
		Route::get('/contract-connection/building_read', 'ContractConnectionController@buildingRead');
		Route::get('/contract-connection/get_billdata/{id}', "ContractConnectionController@getBilldata");
		Route::get('/contract-connection/print-read/{id}/{rid}', 'ContractConnectionController@getPrintRead');
		...
		Route::get('/packing_list', 'PackingListController@index');
		Route::get('/packing_list/add', 'PackingListController@add','middleware');
		Route::get('/packing_list/add/{id}', 'PackingListController@add');
		Route::get('/packing_list/add/{id}/{n}', 'PackingListController@add');
		Route::post('/packing_list/save', 'PackingListController@save');
		Route::get('/packing_list/edit/{id}', 'PackingListController@edit');
		Route::post('/packing_list/update/{id}', 'PackingListController@update');
		Route::get('/packing_list/customer_data', "PackingListController@getCustomer");
		Route::get('/packing_list/salesman_data', "PackingListController@getSalesman");
		Route::get('/packing_list/item_data/{id}', "PackingListController@getItem");
		Route::get('/packing_list/checkrefno', 'PackingListController@checkRefNo');
		Route::get('/packing_list/delete/{id}', 'PackingListController@destroy');
		Route::get('/packing_list/get_invoice/{id}/{n}', "PackingListController@getInvoice");
		Route::get('/packing_list/item_details/{id}', "PackingListController@getItemDetails");
		Route::get('/packing_list/print/{id}', 'PackingListController@getPrint');
		Route::get('/packing_list/set_session', 'PackingListController@setSessionVal');
		Route::post('/packing_list/search', "PackingListController@getSearch");
		Route::get('/packing_list/print/{id}/{fc}', 'PackingListController@getPrint');
		Route::post('/packing_list/export', 'PackingListController@dataExport');
		Route::get('/packing_list/newcustomer_data', "PackingListController@getNewCustomer");
		Route::get('/packing_list/checkvchrno', 'PackingListController@checkVchrNo');
		Route::post('/packing_list/paging', 'PackingListController@ajaxPaging');
		Route::get('/packing_list/customer_data/{did}', "PackingListController@getCustomer");
		Route::get('/packing_list/newcustomer_data/{did}', "PackingListController@getNewCustomer");
		Route::get('/packing_list/poadd/{id}', 'PackingListController@poadd');
		Route::post('/packing_list/get_orderno', 'PackingListController@getOrderNo');
		Route::get('/packing_list/getcounter/{id}', 'PackingListController@getCounter');
		Route::get('/packing_list/get_report/{id}', 'PackingListController@getReport');
		Route::get('/packing_list/get_packinglist', "PackingListController@getPackingList");
		Route::post('/packing_list/customer_list', "PackingListController@ajaxCustomerList"); 
		Route::get('/packing_list/account_data/{type}', "PackingListController@getAccount");

		//TRIAL BALANCE...
		Route::get('/trial_balance2', "TrialBalanceController2@index");
		Route::get('/trial_balance2/search', "TrialBalanceController2@searchReport");
		Route::get('/trial_balance2/sb', "TrialBalanceController2@indexsubmit");
		
		Route::get('balancesheet2', 'BalanceSheetController2@index')->name('balancesheet2.index');
		Route::get('balancesheet2/search', 'BalanceSheetController2@report')->name('balancesheet2.report');
		//Route::get('/balancesheet2/export', 'BalanceSheetController2@export')->name('balancesheet2.export');


		Route::get('/profit_loss2', "ProfitLossController2@index");
		Route::get('/profit_loss2/search', 'ProfitLossController2@profitLoss');
