...
$(function() {
		...
		//	{ "data": "debitor" },
			...
			@permission('pv-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('pv-print'){ "data": "print","bSortable": false },@endpermission
			//{ "data": "view","bSortable": false },
			@permission('pv-delete'){ "data": "delete","bSortable": false }@endpermission
		]
