                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesOrder" id="frmSalesOrder" action="{{ url('buildingmaster/save') }}">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="security_deposit" step="any" name="security_deposit" autocomplete="off" placeholder="Security Deposit">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="connection_charge" step="any" name="connection_charge" autocomplete="off" placeholder="Connection Charge">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="other_charge_con" step="any" name="other_charge_con" autocomplete="off" placeholder="Other Charges(Connection)">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="unit_price" step="any" name="unit_price" autocomplete="off" placeholder="Unit Price">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="other_charge" step="any" name="other_charge" autocomplete="off" placeholder="Other Charges(Reading)">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="disconnection_charge" step="any" name="disconnection_charge" autocomplete="off" placeholder="Disconnection Charge">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" class="form-control" id="other_charge_dis" step="any" name="other_charge_dis" autocomplete="off" placeholder="Other Charges(Disconnection)">
										</div>
									</div>
