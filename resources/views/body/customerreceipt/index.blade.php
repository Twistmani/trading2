...
$(function() {
		...
		var dtInstance = $("#tableRVlist").DataTable({
			...
			//{ "data": "creditor" },
			{ "data": "amount" },
			@permission('rv-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('rv-print'){ "data": "print","bSortable": false },@endpermission
			@permission('rv-delete'){ "data": "delete","bSortable": false }@endpermission
		]	
