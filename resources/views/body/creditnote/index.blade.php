                        ...
                        <div class="table-responsive">
                                <table class="table table-striped" id="tableCrNote">
                                    ...
                                    <tr>
										...
										<td>
											@permission('rv-edit')<p><button class="btn btn-primary btn-xs" onClick="location.href='{{ url('credit_note/edit/'.$row->id)}}'"><span class="glyphicon glyphicon-pencil"></span></button></p>@endpermission
										</td>
										<td>
											@permission('rv-delete')<p><button class="btn btn-danger btn-xs delete" onClick="funDelete('{{ $row->id }}')"><span class="glyphicon glyphicon-trash"></span></button></p>@endpermission
										</td>
										<td>
											@permission('rv-print')<p><a href="{{url('credit_note/print/'.$row->id.'/'.$prints[0]->id)}}" target='_blank' class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>@endpermission
										</td>
                                    </tr>
									@endforeach
