										...
										<fieldset>
											...
											@foreach($orvs as $orow)
											  ...
											  <div class="itemdivChldDr">
												<div class="col-xs-15">
													<div class="col-xs-3" style="width:15%;">
														<span class="small">Debit A/c.</span> <input type="text" id="rvOdracname_1" value="{{($rvrow)?$rvrow->cash:$orow->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-toggle="modal" data-target="#accounts_modal">
									...
									<div class="tab-pane fade {{(Session::get('active')=='settle') ? ' active in' : '' }}" id="settle">
										...
										<hr/>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<button type="button" class="btn btn-warning btn-calcu">Calculate Settlement Rent</button>
												</div>
											</div>
											
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Days Stayed</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="stay_days" id="stay_days" value="{{($settle)?$settle->days_stayed:''}}" readonly >
												</div>
												
												<label for="input-text" class="col-sm-2 control-label">Total Rent</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="total_rent" id="total_rent" readonly value="{{$crow->rent_amount}}">
												</div>
												
											</div>
											<input type="hidden" name="sjv_id" value="{{($settle)?$settle->sjv_id:''}}">
											<div class="form-group">
												
												<label for="input-text" class="col-sm-2 control-label">Rent for Period</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" id="actual_rent" name="actual_rent" value="{{($settle)?$settle->rent_period:''}}">
												</div>
												
												<label for="input-text" class="col-sm-2 control-label">Account Balance</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" id="ac_balance" name="ac_balance" >
												</div>
											</div>
											
											<div class="form-group">
												
												<label for="input-text" class="col-sm-2 control-label">Gross Payable</label>
												<div class="col-sm-4">
													<input type="text" class="form-control pull-right" name="payable" autocomplete="off"  readonly id="payable" value="{{($settle)?$settle->gpayable:''}}"/>
												</div>
												
												<label for="input-text" class="col-sm-2 control-label">Deposit</label>
												<div class="col-sm-4">
													<input type="text" readonly  class="form-control" id="dep_amount" name="dep_amount" value="{{(isset($payacnts[1])?$payacnts[1]->amount:'')}}">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<label for="input-text" class="col-sm-2 control-label">Uncleared PDC</label>
												<div class="col-sm-4">
													<input type="text" class="form-control" name="pdc_amount" id="pdc_amount" value="{{($settle)?$settle->unpdc:(($pdc)?$pdc->pdc_amount:'')}}" readonly>
												</div>
											</div>
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Cancellation Fee</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_1" name="acname[]" value="{{($stlrow)?$stlrow->acname1:(($incmac)?$incmac->acname8:'')}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_1" name="acid[]" value="{{($stlrow)?$stlrow->canid:(($incmac)?$incmac->cancellation:'')}}">
												</div>
												
												<div class="col-sm-4">
													<input type="number" class="form-control feeAmt" id="feeamt_1" step="any" name="settleAmount[]" value="{{($stlrow)?$stlrow->cancellation_fee:''}}" placeholder="Amount">
												</div>
											</div>
											
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Repair & Maintenance</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_2" name="acname[]" value="{{($stlrow)?$stlrow->acname2:(($incmac)?$incmac->acname9:'')}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_2" name="acid[]" value="{{($stlrow)?$stlrow->rmid:(($incmac)?$incmac->repair:'')}}">
												</div>
												
												<div class="col-sm-4">
													<input type="number" class="form-control feeAmt" step="any" id="feeamt_2" name="settleAmount[]" value="{{($stlrow)?$stlrow->rm_fee:''}}" placeholder="Amount">
												</div>
											</div>
											
											<div class="form-group">
												<label for="input-text" class="col-sm-2 control-label">Electricity & Water</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_3" name="acname[]" value="{{($stlrow)?$stlrow->acname3:(($incmac)?$incmac->acname10:'')}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_3" name="acid[]" value="{{($stlrow)?$stlrow->ewid:(($incmac)?$incmac->water_ecty_bill:'')}}">
												</div>
												
												<div class="col-sm-4">
													<input type="number" class="form-control feeAmt" step="any" id="feeamt_3" name="settleAmount[]" value="{{($stlrow)?$stlrow->ew_fee:''}}" placeholder="Amount">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" id="acname_4" name="acname[]" value="{{($stlrow)?$stlrow->acname4:(($incmac)?$incmac->acname11:'')}}" data-toggle="modal" data-target="#ac_modal" readonly>
													<input type="hidden" id="acid_4" name="acid[]" value="{{($stlrow)?$stlrow->ocid:(($incmac)?$incmac->closing_oth:'')}}">
												</div>
												
												<div class="col-sm-4">
													<input type="number" class="form-control feeAmt" step="any" id="feeamt_4" name="settleAmount[]" value="{{($stlrow)?$stlrow->other:''}}" placeholder="Amount">
												</div>
											</div>
											
											<div class="form-group">
												<label for="input-text" class="col-sm-8 control-label"><b>Total Charge</b></label>
												<div class="col-sm-4">
													<input type="number" class="form-control" id="totalChrg" step="any" name="total" value="{{($settle)?$settle->total:''}}" readonly placeholder="Total">
												</div>
											</div>
											<div class="form-group">
												<label for="input-text" class="col-sm-8 control-label"><b>Amount Refunded</b></label>
												<div class="col-sm-4">
													<input type="number" class="form-control" id="refundAmount" step="any" name="refunded" readonly value="{{($settle)?$settle->refunded:''}}" placeholder="Amount Refunded">
												</div>
											</div>
											<div class="form-group">
												<label for="input-text" class="col-sm-8 control-label"><b>Net Receivable</b></label>
												<div class="col-sm-4">
													<input type="number" class="form-control" id="recAmount" step="any" name="reveivable" readonly value="{{($settle)?$settle->reveivable:''}}" placeholder="Net Receivable">
												</div>
											</div>
											
											<fieldset><legend><h4>Amount Settlement</h4></legend>
											<div class="col-xs-15 Crcontrols">
													<input type="hidden" name="settlejv_id" value="{{($jvsettle)?$jvsettle[0]->jid:''}}">
													<div class="col-sm-2" style="width:15%;"> <span class="small">Voucher No.</span>
														<input type="text" id="jv_no" name="jv_no" class="form-control" value="{{($jvsettle)?$jvsettle[0]->voucher_no:(($jv)?$jv->voucher_no+1:'')}}" autocomplete="off">
													</div>
													
													<div class="col-sm-2" style="width:15%;"> <span class="small">Voucher Date</span>
														<input type="text" id="jv_date" name="jv_date" class="form-control" readonly value="{{($jvsettle)?date('d-m-Y' ,strtotime($jvsettle[0]->voucher_date)):date('d-m-Y')}}" autocomplete="off" autocomplete="off" data-language='en'>
													</div>
													
													<div class="col-sm-2" style="width:25%;"> <span class="small">Cash A/c.</span>
													<input type="text" id="jvaccount_1" name="jv_account_name" class="form-control" value="{{$rvrow->cash}}" autocomplete="off">
													<input type="hidden" name="jvaccount_id" id="jvaccountid_1" value="{{$rvrow->cashid}}">
													</div>
													<div class="col-xs-15 divchq">
														<div class="col-xs-2" style="width:25%;">
															<span class="small">Description</span> <input type="text" id="crdescr_1" value="{{($jvsettle)?$jvsettle[0]->description:'Rent Settlement/'.$crow->contract_no}}" autocomplete="off" name="jv_description" class="form-control" >
														</div>
														
														<div class="col-xs-2" style="width:15%;">
															<span class="small">Amount</span> <input type="number" id="jvamount" autocomplete="off" readonly step="any" name="jv_amount" value="{{($jvsettle)?$jvsettle[0]->amount:''}}" class="form-control">
														</div>
													</div>	
