                                ...
                                <div id="myTabContent" class="tab-content">
									<div class="tab-pane fade {{(Session::get('active')=='home') ? ' active in' : '' }}" id="home">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[1]) && $payacnts[1]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[1])?$acrow[1]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Security Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[2]) && $payacnts[2]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[2])?$acrow[2]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Commission @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[3]) && $payacnts[3]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[3])?$acrow[3]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Other Deposit A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[4]) && $payacnts[4]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[4])?$acrow[4]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Parking Income A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[5]) && $payacnts[5]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[5])?$acrow[5]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Ejarie Fee A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" {{ (isset($payacnts[6]) && $payacnts[6]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[6])?$acrow[6]->account_id:''}}]" value="1"> @endif</label>
												<div class="col-sm-5">
									...
									<div class="tab-pane fade {{(Session::get('active')=='receipt') ? ' active in' : '' }}" id="receipt">
										...
										<fieldset>
											...
											<div class="col-xs-15" id="receipt_add">
												...
												<input type="text" id="dracname_{{$i}}" value="{{$row->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-toggle="modal" data-target="#RVaccounts_modal">
									...
									<div class="tab-pane fade {{(Session::get('active')=='otherrv') ? ' active in' : '' }}" id="otherrv">
										...
										<input type="hidden" class="form-control" id="oinstallment" step="any" value="{{($prvs)?$prvs[0]->installment:''}}" name="installment">
										...
										<div id="orvdetails">
											<fieldset>
												...
												@foreach($orvs as $orow)
												  ...
												  <div class="itemdivChldDr">
													<div class="col-xs-15">
														<div class="col-xs-3" style="width:15%;">
															<span class="small">Debit A/c.</span> <input type="text" id="rvOdracname_{{$i}}" value="{{($orow)?$orow->master_name:(($rvrow)?$rvrow->cash:'')}}" autocomplete="off" name="drac_name[]" class="form-control" data-toggle="modal" data-target="#ORVaccounts_modal">
														...
														<div class="col-xs-2" style="width:10%;">
															<span class="small">Amount</span> <input type="number" id="drdamount_{{$i}}" placeholder="Amount" value="{{$orow->amount}}" autocomplete="off" step="any" name="Damount[]" class="form-control drAmt">
														</div>
											...
											<fieldset>
												...
												<div class="col-xs-15 Crcontrols">
													...
													@foreach($orvs as $orow)
														...
														<div class="itemdivChld">							
															<div class="form-group" style="margin-bottom: 1px;">
																...
																<input type="text" id="craccount_{{$i}}" name="account_name[]" class="form-control acname" value="{{($crow)?$crow->master_name:$orow->master_name}}" autocomplete="off">
													...
													@foreach($drjeid as $jid)
													<input type="hidden" name="je_id[]" value="{{$jid}}">
													@endforeach
													</div>
													 <!-- NOV24 -->
												</div>
...
function checkORVdrAmt() {
	var amtodr=0;
	$( ".drAmt" ).each(function() { 
	 amtodr += (this.value=='')?0:parseFloat(this.value);
	});
	return amtodr;
}
...
//new change.................
$(document).on('click', '#account_data .accountRow', function(e) { 
