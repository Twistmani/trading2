										...
										<form class="form-horizontal" role="form" method="POST" name="frmContract" id="frmContract" action="{{url('contractbuilding/update_renew/'.$crow->id)}}">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													...
													<input type="text" name="jeremove" id="jeremove">
												</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_1" name="acid[]" value="{{$aid = ($acrow[0])?$acrow[0]->account_id:''}}">
													<input type="hidden" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_2" {{ (isset($payacnts[1]) && $payacnts[1]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[1])?$acrow[1]->account_id:''}}]" value="2" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_2" name="acid[]" value="{{$aid=($acrow[1])?$acrow[1]->account_id:''}}">
													<input type="hidden" id="jeid_2" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Security Deposit @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_3" {{ (isset($payacnts[2]) && $payacnts[2]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[2])?$acrow[2]->account_id:''}}]" value="3" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_3" name="acid[]" value="{{$aid=($acrow[2])?$acrow[2]->account_id:''}}">
													<input type="hidden" id="jeid_3" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Commission @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_4" {{ (isset($payacnts[3]) && $payacnts[3]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[3])?$acrow[3]->account_id:''}}]" value="4" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_4" name="acid[]" value="{{$aid=($acrow[3])?$acrow[3]->account_id:''}}">
													<input type="hidden" id="jeid_4" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Other Deposit A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_5" {{ (isset($payacnts[4]) && $payacnts[4]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[4])?$acrow[4]->account_id:''}}]" value="5" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_5" name="acid[]" value="{{$aid=($acrow[4])?$acrow[4]->account_id:''}}">
													<input type="hidden" id="jeid_5" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Parking Income A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_6" {{ (isset($payacnts[5]) && $payacnts[5]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[5])?$acrow[5]->account_id:''}}]" value="6" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_6" name="acid[]" value="{{$aid=($acrow[5])?$acrow[5]->account_id:''}}">
													<input type="hidden" id="jeid_6" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label for="input-text" class="col-sm-3 control-label">Ejarie Fee A/c. @if($crow && $crow->renew_id!='')<input type="checkbox" class="jechk" id="chk_7" {{ (isset($payacnts[6]) && $payacnts[6]->is_add==1) ? "checked" : "" }} name="check[{{($acrow[6])?$acrow[6]->account_id:''}}]" value="7" onClick='check_uncheck_checkbox(this.checked);'> @endif</label>
												<div class="col-sm-5">
													...
													<input type="hidden" id="acid_7" name="acid[]" value="{{$aid=($acrow[6])?$acrow[6]->account_id:''}}">
													<input type="hidden" id="jeid_7" name="je_id[]" value="{{isset($jerowarr[$aid])?$jerowarr[$aid]->id:''}}">
												</div>
												<div class="col-sm-2">
	...
	$('.jechk').each(function() { 
		if($(this).is(':checked')) {
		   ...
		   amount = amount + amt + tax;
			...
			var no = this.value;
			jrem += (jrem=='')?$('#jeid_'+no).val():','+$('#jeid_'+no).val();
		}
	});
...
$(document).on('click', '.rvadd', function(e) { //NOV22
	...
	$.ajax({
		...
		success: function(data) { ddracid_
...
$(document).on('click', '.accountRow', function(e) { 
	...
	$('#craccountid__'+num).val( $(this).attr("data-id") );
