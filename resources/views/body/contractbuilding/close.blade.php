                                ...
                                <div id="myTabContent" class="tab-content">
										...
										<fieldset>
											...
											<div class="col-xs-15" id="receipt_add">
												...
												<div class="col-xs-3" style="width:15%;">
													<span class="small">Debit A/c.1</span> <input type="text" id="dracname_{{$i}}" value="{{$row->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-target="#accounts_modal">
									...
									<div class="tab-pane fade {{(Session::get('active')=='deposit') ? ' active in' : '' }}" id="deposit">
										...
										<fieldset>
											...
											<div class="col-xs-15">
												<div class="col-xs-3" style="width:15%;">
													<span class="small">Debit A/c.</span> <input type="text" id="ddracname_1" value="{{($rvrow)?$rvrow->cash:''}}" autocomplete="off" name="drac_name[]" class="form-control" data-target="#accounts_modal">
											...
											<div class="col-xs-15">
												<div class="col-xs-3" style="width:15%;">
													<span class="small">Debit A/c.</span> <input type="text" id="ddracname_1" value="{{$drow->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-target="#accounts_modal">
										...
										<fieldset>
											...
											@foreach($orvs as $orow)
											  ...
											  <div class="itemdivChldDr">
												<div class="col-xs-15">
													<div class="col-xs-3" style="width:15%;">
														<span class="small">Debit A/c.</span> <input type="text" id="rvOdracname_1" value="{{($rvrow)?$rvrow->cash:$orow->master_name}}" autocomplete="off" name="drac_name[]" class="form-control" data-target="#accounts_modal">
