                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmContratype" id="frmContratype" action="{{url('contra_type/update/'.$crow->id)}}">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control other-account" id="acname_4" name="acname_4" value="{{$crow->acname4}}" autocomplete="off" placeholder="Water and Electricity Deposit A/c." data-toggle="modal" data-target="#account_modal">
