...
$(function() {
		...
		var dtInstance = $("#tablePorders1").DataTable({
			...
			{ "data": "chasis_no" },
			{ "data": "technician" },
			@permission('job-order-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('job-order-view'){ "data": "viewonly","bSortable": false },@endpermission
			@permission('job-order-print'){ "data": "print","bSortable": false },@endpermission
			@permission('job-order-delete'){ "data": "delete","bSortable": false },@endpermission
		]	
