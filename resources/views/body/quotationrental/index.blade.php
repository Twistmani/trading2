...
$(function() {
		...
		var dtInstance = $("#tableQrl").DataTable({
			...
			@permission('qrl-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('qrl-print'){ "data": "print","bSortable": false },@endpermission
			@permission('qrl-delete'){ "data": "delete","bSortable": false },@endpermission
		]	
