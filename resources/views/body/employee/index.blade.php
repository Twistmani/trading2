...
$(function() {
		...
		var dtInstance = $("#tableEmployee").DataTable({
			...
			"columns": [
				...
				{ "data": "nationality" },
				{ "data": "phone" },
				@permission('emp-view'){ "data": "view","bSortable": false },@endpermission
				@permission('emp-edit'){ "data": "edit","bSortable": false },@endpermission
				{ "data": "payrise","bSortable": false },
				@permission('emp-delete'){ "data": "delete","bSortable": false },@endpermission
			]	
