                                ...
                                <table class="table horizontal_table table-striped" id="tablePordersList">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td>
												@permission('do-edit')<p><button class="btn btn-primary btn-xs" onClick="location.href='{{ url('production/edit/'.$order->id)}}'"><span class="glyphicon glyphicon-pencil"></span></button></p>@endpermission
											</td>
											<td>
												@permission('do-print')<p><a href="{{url('production/print/'.$order->id)}}" target="_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span></a></p>@endpermission
											</td>
											<?php if($order->is_fc==1) { ?><td>
												@permission('do-print')<p><a href="{{url('production/print/'.$order->id.'/FC')}}" target="_blank" class="btn btn-primary btn-xs"><span class="fa fa-fw fa-print"></span> FC</a></p>@endpermission
											</td><?php } ?>
