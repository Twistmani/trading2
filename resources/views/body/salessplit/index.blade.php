...
$(function() {
		...
		var dtInstance = $("#tablePurSplit").DataTable({
			...
			{ "data": "supplier" },
			{ "data": "net_total" },
			@permission('ss-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('ss-print'){ "data": "print","bSortable": false },@endpermission
			@permission('ss-delete'){ "data": "delete","bSortable": false }@endpermission
		]	
