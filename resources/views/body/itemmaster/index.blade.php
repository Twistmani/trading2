                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="posts">
                                  ...
                                  <!--<th>Item Code</th>
										<th>Description</th>
										<th>Qty. in Hand</th>
										@permission('item-cost-view')<th>Cost Avg.</th>@endpermission
										@permission('item-cost-view')<th>Last P. Cost</th>@endpermission
										<th>Net Cost</th>
										<th>Rcvd. Qty.</th>
										<th>Issued Qty.</th>
										<th></th>
...
$(function() {
	...
	$(function() {
            ...
            var dtInstance = $("#posts").DataTable({
                ...
                { "data": "description" },
                { "data": "quantity" },
                @permission('item-cost-view'){ "data": "cost_avg" },@endpermission
                @permission('item-cost-view'){ "data": "last_purchase_cost" },@endpermission
				{ "data": "other_cost" },
				{ "data": "issued_qty" },
