                        ...
                        <div class="table-responsive m-t-10">
							<table class="table horizontal_table table-striped" id="SalesInvoiceList">
								...
								<tr>
									...
									<th>Chasis No.</th>
									<th>Amount</th>
									@permission('job-invoice-edit')<th></th>@endpermission
									@permission('job-invoice-view')<th></th>@endpermission
									@permission('job-invoice-print')<th></th>@endpermission
									@permission('job-invoice-delete')<th></th>@endpermission
									<th></th>
								</tr>
								</thead>
...
$(function() {
		...
		var dtInstance = $("#SalesInvoiceList").DataTable({
			...
			{ "data": "chasis_no" },
			{ "data": "net_total" },
			@permission('job-invoice-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('job-invoice-view'){ "data": "viewonly","bSortable": false },@endpermission
			@permission('job-invoice-print'){ "data": "print","bSortable": false },@endpermission
			@permission('job-invoice-delete'){ "data": "delete","bSortable": false },@endpermission
