...
$(function() {
		...
		var dtInstance = $("#tablePordersList").DataTable({
			...
			@permission('ce-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('ce-print'){ "data": "print","bSortable": false },@endpermission
			{ "data": "open","bSortable": false },
			@permission('ce-delete'){ "data": "delete","bSortable": false },@endpermission
		]	
