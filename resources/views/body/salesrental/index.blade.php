...
$(function() {
		...
		var dtInstance = $("#tableSrl").DataTable({
			...
			{ "data": "net_total" },
			<?php if($settings->doc_approve==1) { ?>{ "data": "status" },<?php } ?>
			@permission('srl-edit'){ "data": "edit","bSortable": false },@endpermission
			@permission('srl-print'){ "data": "print","bSortable": false },@endpermission
			@permission('srl-delete'){ "data": "delete","bSortable": false },@endpermission
		]	
