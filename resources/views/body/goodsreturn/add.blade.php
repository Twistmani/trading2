                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmGoodsReturn" id="frmGoodsReturn" action="{{ url('goods_return/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<?php } else { ?>
										<div class="input-group">
											<input type="text" class="form-control" id="voucher_no" name="voucher_no" <?php if($voucherno->autoincrement==1) { ?> readonly value="{{$vouchers[0]['voucher_no']}}" <?php } else { ?> value="{{old('voucher_no')}}" <?php } ?>>
											<input type="hidden" value="{{$voucherno->prefix}}" name="prefix">
											<input type="hidden" value="{{$voucherno->voucher_type}}" name="voucher_type">
											<input type="hidden" value="{{$voucherno->autoincrement}}" name="autoincrement">
											<span class="input-group-addon inputvn"><i class="fa fa-fw fa-edit"></i></span>
